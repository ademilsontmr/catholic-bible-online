...
export const metadata: Metadata = {
  title: 'St. John of God - Life, Legacy & Feast Day | Catholic Bible Online',
  description: 'Discover the life, legacy, and feast day of St. John of God, founder of the Brothers Hospitallers and patron of hospitals.',
  keywords: [
    'st john of god',
    'saint john of god',
    'john of god biography',
    'john of god feast day',
    'john of god patron saint',
    'brothers hospitallers',
    'hospital patron saint',
    'firefighters patron saint',
    'booksellers patron saint',
    'march 8 feast day'
  ],
  openGraph: {
    title: 'St. John of God - Life, Legacy & Feast Day',
    description: 'Discover the life, legacy, and feast day of St. John of God, founder of the Brothers Hospitallers and patron of hospitals.',
    url: 'https://catholicbibleonline.com/saints/st-john-of-god',
  },
  twitter: {
    title: 'St. John of God - Life, Legacy & Feast Day',
    description: 'Discover the life, legacy, and feast day of St. John of God, founder of the Brothers Hospitallers and patron of hospitals.',
...
export default function StJohnOfGodPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <nav className="text-sm text-gray-500 mb-8">
            ...
            <span className="text-gray-800">St. John of God</span>
          </nav>

          {/* Quick Stats */}
          <div className="flex justify-center space-x-8 mb-8">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-800">March 8</div>
              <div className="text-sm text-gray-600">Feast Day</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-800">🏥</div>
              <div className="text-sm text-gray-600">Hospital Founder</div>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">📖 Life of St. John of God</h2>
        ...
        {/* Legacy Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">🌟 Legacy of St. John of God: Impulsive Love in Action</h2>
          
          <div className="bg-blue-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <h3 className="text-xl font-semibold text-black mb-4">Founder of the Brothers Hospitallers</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Model of Impulsive Charity</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Patron of Healthcare Workers</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Transformation Through Repentance</h3>
              <p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="text-center mb-6">
              <div className="text-4xl font-bold text-blue-600 mb-2">March 8</div>
              <p className="text-gray-600">Feast of St. John of God, Founder of the Brothers Hospitallers</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>Hospitals:</strong> All healthcare facilities</li>
                  <li>• <strong>Nurses:</strong> Healthcare workers</li>
                  <li>• <strong>Booksellers:</strong> Those who sell books</li>
                  <li>• <strong>Printers:</strong> Printing industry workers</li>
                  <li>• <strong>Firefighters:</strong> Emergency responders</li>
                  <li>• <strong>Heart Patients:</strong> Those with heart conditions</li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>The Sick:</strong> All who suffer from illness</li>
                  <li>• <strong>Brothers Hospitallers:</strong> His religious order</li>
                  <li>• <strong>Impulsive Love:</strong> Acting on God's promptings</li>
                  <li>• <strong>Repentance:</strong> Conversion and transformation</li>
                  <li>• <strong>Charity:</strong> Serving the poor and needy</li>
                  <li>• <strong>Healthcare Ministry:</strong> Medical mission work</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="space-y-8">
              <div className="bg-yellow-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-black mb-4">Prayer to St. John of God</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/saints/st-camillus-de-lellis" className="group block">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <p className="text-gray-700 text-sm">
                  Founder of the Camillians, another order dedicated to healthcare ministry.
                </p>
              </div>
            </Link>
            ...
            <Link href="/saints/st-vincent-de-paul" className="group block">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <p className="text-gray-700 text-sm">
                  Known for his work with the poor and founder of the Vincentians.
                </p>
              </div>
            </Link>
            ...
            <Link href="/saints/st-francis-of-assisi" className="group block">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <p className="text-gray-700 text-sm">
                  Known for his love of the poor and radical commitment to poverty.
                </p>
              </div>
            </Link>
          </div>
