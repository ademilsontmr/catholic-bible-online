...
export const metadata: Metadata = {
  title: 'St. Damien of Molokai - Life, Legacy & Feast Day | Catholic Bible Online',
  description: 'Discover the life, legacy, and feast day of St. Damien of Molokai, the Belgian priest who dedicated his life to serving leprosy patients in Hawaii.',
  keywords: [
    'st damien of molokai',
    'saint damien',
    'st damien biography',
    'st damien feast day',
    'st damien patron saint',
    'leprosy patients',
    'molokai',
    'hawaii missionary',
    'may 10 feast day'
  ...
  openGraph: {
    title: 'St. Damien of Molokai - Life, Legacy & Feast Day',
    description: 'Discover the life, legacy, and feast day of St. Damien of Molokai, the Belgian priest who dedicated his life to serving leprosy patients in Hawaii.',
    url: 'https://catholicbibleonline.com/saints/st-damien-molokai',
  },
  twitter: {
    title: 'St. Damien of Molokai - Life, Legacy & Feast Day',
    description: 'Discover the life, legacy, and feast day of St. Damien of Molokai, the Belgian priest who dedicated his life to serving leprosy patients in Hawaii.',
...
export default function StDamienMolokaiPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <nav className="text-sm text-gray-500 mb-8">
            ...
            <span className="text-gray-800">St. Damien of Molokai</span>
          </nav>

          {/* Quick Stats */}
          <div className="flex justify-center space-x-8 mb-8">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-800">May 10</div>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">📖 Life of St. Damien of Molokai</h2>
          
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-6">
                The man who would become St. Damien of Molokai was born in rural Belgium on January 3, 1840. His name was <strong>Jozef De Veuster</strong>, and he was the youngest of seven children. Growing up on the farm, Jozef was prepared to take over for his family, but he did not want the responsibility. Instead, he wanted to follow his older brother and two sisters who took religious vows.
              </p>
              
              <p className="mb-6">
                Jozef attended school until the age of 13 when his help was needed on the family farm full-time. He aided his family until he was old enough to enter the <strong>Congregation of the Sacred Hearts of Jesus and Mary</strong>. He took the name Damien, after a sixth century martyr.
              </p>
        ...
        {/* Legacy Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">🌟 Legacy of St. Damien of Molokai: Apostle to the Lepers</h2>
          
          <div className="bg-blue-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <h3 className="text-xl font-semibold text-black mb-4">Transformation of Molokai</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Model of Self-Sacrifice</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Advocate for the Marginalized</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Spiritual Strength</h3>
              <p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="text-center mb-6">
              <div className="text-4xl font-bold text-blue-600 mb-2">May 10</div>
              <p className="text-gray-600">Feast of St. Damien of Molokai, Apostle to the Lepers</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>Leprosy Patients:</strong> Those suffering from Hansen's disease</li>
                  <li>• <strong>Outcasts and Marginalized:</strong> People rejected by society</li>
                  <li>• <strong>Missionaries:</strong> Those serving in difficult missions</li>
                  <li>• <strong>Healthcare Workers:</strong> Those caring for the sick and dying</li>
                  <li>• <strong>Hawaii:</strong> The state where he served</li>
                  <li>• <strong>Belgium:</strong> His homeland</li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>Chronic Illness:</strong> Those facing long-term health challenges</li>
                  <li>• <strong>Terminal Illness:</strong> People dealing with life-threatening diseases</li>
                  <li>• <strong>Social Justice:</strong> Advocates for the poor and marginalized</li>
                  <li>• <strong>Missionary Zeal:</strong> Those called to serve in difficult places</li>
                  <li>• <strong>Perseverance:</strong> Strength to continue serving despite difficulties</li>
                  <li>• <strong>Compassion:</strong> Grace to see Christ in the suffering</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="space-y-8">
              <div className="bg-yellow-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-black mb-4">Prayer to St. Damien of Molokai</h3>
              ...
              <div className="bg-purple-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-black mb-4">Prayer for Those Suffering from Illness</h3>
                <div className="text-gray-700 italic">
                  <p className="mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/saints/st-mother-teresa" className="group block">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 hover:shadow-md transition-all">
                <div className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium mb-4 inline-block">
                  Charity Saints
                </div>
