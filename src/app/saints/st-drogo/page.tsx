    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">📖 Life of St. Drogo</h2>
        ...
        {/* Legacy Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-6 text-center">🌟 Legacy of St. Drogo: Hermit and Patron of Shepherds</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>Shepherds:</strong> Patron saint of shepherds</li>
                  <li>• <strong>Sheep Herders:</strong> Patron of sheep herders</li>
                  <li>• <strong>Flanders:</strong> Patron saint of Flanders</li>
                  <li>• <strong>Sebourg:</strong> Patron of the town of Sebourg</li>
                  <li>• <strong>Orphans:</strong> Patron of orphans</li>
                  <li>• <strong>Hermits:</strong> Patron of hermits and solitary religious</li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>• <strong>Physical Illness:</strong> Helper for those with physical afflictions</li>
                  <li>• <strong>Penance:</strong> Patron of those seeking to do penance</li>
                  <li>• <strong>Humility:</strong> Helper for developing humility</li>
                  <li>• <strong>Contemplation:</strong> Patron of contemplative prayer</li>
                  <li>• <strong>Pilgrimage:</strong> Helper for those on spiritual journeys</li>
                  <li>• <strong>Solitude:</strong> Patron of those seeking spiritual solitude</li>
                </ul>
              </div>
            </div>
          </div>
