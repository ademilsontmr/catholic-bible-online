...
export const metadata: Metadata = {
  title: "Stations of the Cross – Meditation on Christ's Passion | Catholic Bible Online",
  description: "Complete Stations of the Cross devotion with prayers and meditations for each station. Walk with Jesus through His passion and death.",
  alternates: {
    canonical: "https://www.catholicbibleonline.com/prayers/stations-cross",
  },
  openGraph: {
    title: "Stations of the Cross – Meditation on Christ's Passion",
    description: "Complete Stations of the Cross devotion with prayers and meditations for each station.",
    url: "https://www.catholicbibleonline.com/prayers/stations-cross",
    type: "article",
  },
  twitter: {
...
export default function StationsCrossPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-gray-900 mb-6">✝️ Stations of the Cross</h1>
      
      <p className="text-lg text-gray-700 mb-8">
        The Stations of the Cross is a powerful devotion that allows us to walk with Jesus through His passion and death. 
        By meditating on each station, we enter more deeply into the mystery of Christ's suffering and love, 
        and we learn to carry our own crosses with courage and faith.
      </p>
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mb-4">When to Pray the Stations</h2>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-gray-700 mb-4">
          The Stations of the Cross is more than just a historical remembrance of Jesus' passion. It is a spiritual journey 
        ...
        <p className="text-gray-700 mb-6">
          ...
          Through the Stations of the Cross, we learn to carry our crosses with courage and to trust in God's plan.
        </p>
      </div>
      ...
      <section className="border-t border-gray-200 pt-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/prayers/way-cross" className="group block">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300">
              <div className="p-4">
                ...
                <p className="text-gray-600 text-sm mt-2">
                  Traditional devotion following Jesus' final journey to Calvary.
                </p>
              </div>
            </div>
          </Link>
