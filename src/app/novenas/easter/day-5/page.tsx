...
export const metadata: Metadata = {
  title: 'Easter Novena - Day 5: Victory Over Sin',
  description: 'Pray the Easter Novena - Day 5 focusing on victory over sin. Join in praying the traditional novena.',
  keywords: [
    'easter novena day 5',
    'easter prayer day 5',
    'day 5 easter novena',
    'victory over sin easter novena'
  ],
  openGraph: {
    title: 'Easter Novena - Day 5: Victory Over Sin',
    description: 'Pray the Easter Novena - Day 5 focusing on victory over sin.',
    url: 'https://catholicbible-online.com/novenas/easter/day-5',
  },
  twitter: {
    title: 'Easter Novena - Day 5: Victory Over Sin',
    description: 'Pray the Easter Novena - Day 5 focusing on victory over sin.',
...
export default function EasterNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Easter Novena – Day 5: Victory Over Sin
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Victory Over Sin</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on victory over sin in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on victory over sin, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on victory over sin. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Easter Novena - Day 5: Victory Over Sin" 
            url="/novenas/easter/day-5"
            excerpt="Join me in praying the Easter Novena - Day 5 focusing on victory over sin." 
          />
        </div>
