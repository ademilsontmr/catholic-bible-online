...
export const metadata: Metadata = {
  title: 'Easter Novena - Day 1: The Resurrection',
  description: 'Pray the Easter Novena - Day 1 focusing on the resurrection. Join in praying the traditional novena.',
  keywords: [
    'easter novena day 1',
    'easter prayer day 1',
    'day 1 easter novena',
    'the resurrection easter novena'
  ],
  openGraph: {
    title: 'Easter Novena - Day 1: The Resurrection',
    description: 'Pray the Easter Novena - Day 1 focusing on the resurrection.',
    url: 'https://catholicbible-online.com/novenas/easter/day-1',
  },
  twitter: {
    title: 'Easter Novena - Day 1: The Resurrection',
    description: 'Pray the Easter Novena - Day 1 focusing on the resurrection.',
...
export default function EasterNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Easter Novena – Day 1: The Resurrection
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: The Resurrection</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on the resurrection in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on the resurrection, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on the resurrection. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Easter Novena - Day 1: The Resurrection" 
            url="/novenas/easter/day-1"
            excerpt="Join me in praying the Easter Novena - Day 1 focusing on the resurrection." 
          />
        </div>
