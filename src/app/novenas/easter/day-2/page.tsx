...
export const metadata: Metadata = {
  title: 'Easter Novena - Day 2: New Life',
  description: 'Pray the Easter Novena - Day 2 focusing on new life. Join in praying the traditional novena.',
  keywords: [
    'easter novena day 2',
    'easter prayer day 2',
    'day 2 easter novena',
    'new life easter novena'
  ],
  openGraph: {
    title: 'Easter Novena - Day 2: New Life',
    description: 'Pray the Easter Novena - Day 2 focusing on new life.',
    url: 'https://catholicbible-online.com/novenas/easter/day-2',
  },
  twitter: {
    title: 'Easter Novena - Day 2: New Life',
    description: 'Pray the Easter Novena - Day 2 focusing on new life.',
...
export default function EasterNovenaDay2Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: New Life</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on new life in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on new life, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on new life. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Easter Novena - Day 2: New Life" 
            url="/novenas/easter/day-2"
            excerpt="Join me in praying the Easter Novena - Day 2 focusing on new life." 
          />
        </div>
