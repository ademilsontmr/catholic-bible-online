...
export const metadata: Metadata = {
  ...
  description: 'Pray the Easter Novena - Day 7 focusing on peace of christ. Join in praying the traditional novena.',
  keywords: [
    'easter novena day 7',
    'easter prayer day 7',
    'day 7 easter novena',
    'peace of christ easter novena'
  ],
  openGraph: {
    title: 'Easter Novena - Day 7: Peace of Christ',
    description: 'Pray the Easter Novena - Day 7 focusing on peace of christ.',
    url: 'https://catholicbible-online.com/novenas/easter/day-7',
  },
  twitter: {
    title: 'Easter Novena - Day 7: Peace of Christ',
    description: 'Pray the Easter Novena - Day 7 focusing on peace of christ.',
...
export default function EasterNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Easter Novena – Day 7: Peace of Christ
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Peace of Christ</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on peace of christ in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on peace of christ, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on peace of christ. This aspect of our faith helps us to grow spiritually 
