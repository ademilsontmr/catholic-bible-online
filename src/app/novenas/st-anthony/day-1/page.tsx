...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 1: Power of Miracles',
  description: "Pray St. Anthony Novena - Day 1 focusing on Power of Miracles. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 1',
    'saint anthony novena day 1',
    'st anthony day 1',
    'day 1 st anthony novena',
    'power of miracles prayer',
    'st anthony novena power of miracles',
    'saint anthony power of miracles',
    'blessed virgin mary novena day 1'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 1: Power of Miracles',
    description: 'Pray St. Anthony Novena - Day 1 focusing on Power of Miracles. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-1',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 1: Power of Miracles',
    description: 'Pray St. Anthony Novena - Day 1 focusing on Power of Miracles. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 1: Power of Miracles
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Power of Miracles</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of St. Anthony Novena, we focus on the power and abundance of St. Anthony's miracles. We recognize his ability to work wonders through God's grace.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony is known for the power and abundance of his miracles. Through this devotion, we acknowledge his special relationship with God and his ability to intercede for us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to trust in the power and abundance of your miracles. May we always turn to you with confidence in our needs. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 1: Power of Miracles" 
            url="/novenas/st-anthony/day-1"
            excerpt="Join me in praying St. Anthony Novena - Day 1 focusing on Power of Miracles." 
          />
        </div>
