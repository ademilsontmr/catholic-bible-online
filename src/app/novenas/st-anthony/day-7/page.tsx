...
export const metadata: Metadata = {
  ...
  description: "Pray St. Anthony Novena - Day 7 focusing on Praising God in Heaven. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 7',
    'saint anthony novena day 7',
    'st anthony day 7',
    'day 7 st anthony novena',
    'praising god in heaven prayer',
    'st anthony novena praising god in heaven',
    'saint anthony praising god in heaven',
    'blessed virgin mary novena day 7'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 7: Praising God in Heaven',
    description: 'Pray St. Anthony Novena - Day 7 focusing on Praising God in Heaven. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-7',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 7: Praising God in Heaven',
    description: 'Pray St. Anthony Novena - Day 7 focusing on Praising God in Heaven. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 7: Praising God in Heaven
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Praising God in Heaven</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying with St. Anthony who praises God in heaven. We join our prayers with his heavenly worship.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony is in heaven praising God with a particular closeness to the King of Kings. We join our prayers with his heavenly worship.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to praise God with you in heaven. May we always join our prayers with your heavenly worship. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 8: Closeness to the King of Kings →
          </Link>
