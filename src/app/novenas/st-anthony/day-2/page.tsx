...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 2: Child Jesus',
  description: "Pray St. Anthony Novena - Day 2 focusing on Child Jesus. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 2',
    'saint anthony novena day 2',
    'st anthony day 2',
    'day 2 st anthony novena',
    'child jesus prayer',
    'st anthony novena child jesus',
    'saint anthony child jesus',
    'blessed virgin mary novena day 2'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 2: Child Jesus',
    description: 'Pray St. Anthony Novena - Day 2 focusing on Child Jesus. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-2',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 2: Child Jesus',
    description: 'Pray St. Anthony Novena - Day 2 focusing on Child Jesus. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 2: Child Jesus
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Child Jesus</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying to the Child Jesus through St. Anthony's intercession. We remember that Jesus came into St. Anthony's arms as a humble little child.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Child Jesus came into St. Anthony's arms, showing the special relationship he had with the Divine. This is why we pray to St. Anthony to intercede with the Child Jesus for our needs.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to pray to the Child Jesus through your intercession. May we always remember your special relationship with Him. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 2: Child Jesus" 
            url="/novenas/st-anthony/day-2"
            excerpt="Join me in praying St. Anthony Novena - Day 2 focusing on Child Jesus." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-anthony/day-1"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Power of Miracles
          </Link>
