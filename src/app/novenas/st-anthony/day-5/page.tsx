...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 5: Giving Everything to Christ',
  description: "Pray St. Anthony Novena - Day 5 focusing on Giving Everything to Christ. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 5',
    'saint anthony novena day 5',
    'st anthony day 5',
    'day 5 st anthony novena',
    'giving everything to christ prayer',
    'st anthony novena giving everything to christ',
    'saint anthony giving everything to christ',
    'blessed virgin mary novena day 5'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 5: Giving Everything to Christ',
    description: 'Pray St. Anthony Novena - Day 5 focusing on Giving Everything to Christ. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-5',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 5: Giving Everything to Christ',
    description: 'Pray St. Anthony Novena - Day 5 focusing on Giving Everything to Christ. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 5: Giving Everything to Christ
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Giving Everything to Christ</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on asking St. Anthony to help us give everything to Christ. We seek his guidance in following his example of complete surrender.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony gave everything to Christ and to his neighbor. His life was a perfect example of what it means to surrender completely to God's will.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to give everything to Christ as you did. May we always follow your example of complete surrender. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 5: Giving Everything to Christ" 
            url="/novenas/st-anthony/day-5"
            excerpt="Join me in praying St. Anthony Novena - Day 5 focusing on Giving Everything to Christ." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-anthony/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 4: Cooperation with Grace
          </Link>
          
          
          <Link
            href="/novenas/st-anthony/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Example of Holiness →
          </Link>
