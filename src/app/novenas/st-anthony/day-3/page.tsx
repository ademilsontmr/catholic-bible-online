...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 3: Mercy and Compassion',
  description: "Pray St. Anthony Novena - Day 3 focusing on Mercy and Compassion. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 3',
    'saint anthony novena day 3',
    'st anthony day 3',
    'day 3 st anthony novena',
    'mercy and compassion prayer',
    'st anthony novena mercy and compassion',
    'saint anthony mercy and compassion',
    'blessed virgin mary novena day 3'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 3: Mercy and Compassion',
    description: 'Pray St. Anthony Novena - Day 3 focusing on Mercy and Compassion. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-3',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 3: Mercy and Compassion',
    description: 'Pray St. Anthony Novena - Day 3 focusing on Mercy and Compassion. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 3: Mercy and Compassion
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on seeking St. Anthony's mercy and compassion for sinners. We ask him to pay no attention to our unworthiness.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony has great mercy and compassion for sinners, just like our Lord. He asks God to show His glory through the answer of our requests, despite our unworthiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to seek your mercy and compassion. May we always trust in your intercession despite our unworthiness. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 3: Mercy and Compassion" 
            url="/novenas/st-anthony/day-3"
            excerpt="Join me in praying St. Anthony Novena - Day 3 focusing on Mercy and Compassion." 
          />
        </div>
