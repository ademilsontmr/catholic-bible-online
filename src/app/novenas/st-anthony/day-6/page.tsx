...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 6: Example of Holiness',
  description: "Pray St. Anthony Novena - Day 6 focusing on Example of Holiness. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 6',
    'saint anthony novena day 6',
    'st anthony day 6',
    'day 6 st anthony novena',
    'example of holiness prayer',
    'st anthony novena example of holiness',
    'saint anthony example of holiness',
    'blessed virgin mary novena day 6'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 6: Example of Holiness',
    description: 'Pray St. Anthony Novena - Day 6 focusing on Example of Holiness. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-6',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 6: Example of Holiness',
    description: 'Pray St. Anthony Novena - Day 6 focusing on Example of Holiness. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 6: Example of Holiness
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Example of Holiness</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on following St. Anthony's example of holiness. We recognize him as an example that we should try to follow in our own lives.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony is an example of holiness that we should try to follow. His life shows us what it means to live a truly holy and virtuous life.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to follow your example of holiness. May we always strive to live a virtuous life like yours. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 6: Example of Holiness" 
            url="/novenas/st-anthony/day-6"
            excerpt="Join me in praying St. Anthony Novena - Day 6 focusing on Example of Holiness." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-anthony/day-5"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 5: Giving Everything to Christ
          </Link>
