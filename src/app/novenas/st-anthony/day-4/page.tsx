...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 4: Cooperation with Grace',
  description: "Pray St. Anthony Novena - Day 4 focusing on Cooperation with Grace. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 4',
    'saint anthony novena day 4',
    'st anthony day 4',
    'day 4 st anthony novena',
    'cooperation with grace prayer',
    'st anthony novena cooperation with grace',
    'saint anthony cooperation with grace',
    'blessed virgin mary novena day 4'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 4: Cooperation with Grace',
    description: 'Pray St. Anthony Novena - Day 4 focusing on Cooperation with Grace. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-4',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 4: Cooperation with Grace',
    description: 'Pray St. Anthony Novena - Day 4 focusing on Cooperation with Grace. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 4: Cooperation with Grace
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Cooperation with Grace</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for cooperation with God's grace like St. Anthony. We ask him to help us cooperate with God's grace in a radical way.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anthony cooperated with the grace of God in a radical way with his life. He gave everything to Christ and to his neighbor, making his life glorify God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to cooperate with God's grace like you did. May we always give everything to Christ and to our neighbor. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="St. Anthony Novena - Day 4: Cooperation with Grace"
          text="Join me in praying St. Anthony Novena - Day 4 focusing on Cooperation with Grace."
        />
