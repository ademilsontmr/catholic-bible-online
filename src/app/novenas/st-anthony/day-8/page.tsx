...
export const metadata: Metadata = {
  title: 'St. Anthony Novena - Day 8: Closeness to the King of Kings',
  description: "Pray St. Anthony Novena - Day 8 focusing on Closeness to the King of Kings. Join in praying the traditional novena for special intentions.",
  keywords: [
    'st anthony novena day 8',
    'saint anthony novena day 8',
    'st anthony day 8',
    'day 8 st anthony novena',
    'closeness to the king of kings prayer',
    'st anthony novena closeness to the king of kings',
    'saint anthony closeness to the king of kings',
    'blessed virgin mary novena day 8'
  ],
  openGraph: {
    title: 'St. Anthony Novena - Day 8: Closeness to the King of Kings',
    description: 'Pray St. Anthony Novena - Day 8 focusing on Closeness to the King of Kings. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anthony/day-8',
  },
  twitter: {
    title: 'St. Anthony Novena - Day 8: Closeness to the King of Kings',
    description: 'Pray St. Anthony Novena - Day 8 focusing on Closeness to the King of Kings. Join in praying the traditional novena.',
...
export default function StAnthonyNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Anthony Novena – Day 8: Closeness to the King of Kings
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Closeness to the King of Kings</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on seeking St. Anthony's closeness to the King of Kings. We ask him to use his seat of honor to beg God for our requests.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              With his seat of honor in heaven, St. Anthony has a particular closeness to the King of Kings. He uses this privileged position to beg God for our needs.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anthony, help us to seek your closeness to the King of Kings. May we always trust in your powerful intercession. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Anthony Novena - Day 8: Closeness to the King of Kings" 
            url="/novenas/st-anthony/day-8"
            excerpt="Join me in praying St. Anthony Novena - Day 8 focusing on Closeness to the King of Kings." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-anthony/day-7"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 7: Praising God in Heaven
          </Link>
          
          
          <Link
            href="/novenas/st-anthony/day-9"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Eternal Rest →
          </Link>
