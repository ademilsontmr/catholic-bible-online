    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, help us to always seek Your assistance when we are struggling in our lives. Give us the grace to grow in intimacy with You each day of our lives. 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Doctors - Day 3: Diagnosis Struggles" 
            url="/novenas/doctors/day-3"
            excerpt="Join me in praying the Novena for Doctors - Day 3 focusing on Diagnosis Struggles." 
          />
        </div>
