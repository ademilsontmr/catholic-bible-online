...
export const metadata: Metadata = {
  title: 'The Presentation of Mary Novena - Day 5: Bible Study',
  description: 'Pray The Presentation of Mary Novena - Day 5 focusing on bible study. Join in praying for dedication to God and service to priests.',
  keywords: [
    'presentation of mary novena day 5',
    'presentation mary novena day 5',
    'day 5 presentation of mary novena',
    'bible study mary presentation'
  ],
  openGraph: {
    title: 'The Presentation of Mary Novena - Day 5: Bible Study',
    description: 'Pray The Presentation of Mary Novena - Day 5 focusing on Bible Study.',
    url: 'https://catholicbibleonline.com/novenas/presentation-of-mary/day-5',
  },
  twitter: {
    title: 'The Presentation of Mary Novena - Day 5: Bible Study',
    description: 'Pray The Presentation of Mary Novena - Day 5 focusing on Bible Study.',
...
export default function PresentationOfMaryNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Presentation of Mary Novena – Day 5: Bible Study
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Bible Study</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for understanding and dedication to God's word.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Mary, you would have been very familiar with God's word. As a girl dedicated in the Temple, you spent much time studying it.</p>

              <p className="mb-4">You would have understood the Old Testament. You would know the prophecies for the Messiah by heart.</p>

              <p className="mb-4">That's why, when the angel Gabriel appeared to you, you knew exactly what was going on.</p>

              <p className="mb-4">Sometimes, the Bible can seem inaccessible. I don't understand some of the meaning. So I don't give it as much attention as I should.</p>
              ...
              <p className="mb-6">
                <strong>God, I know that the fullness of revelation is contained in Scripture. Help me to better understand You through it!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on bible study. This aspect of honoring The Presentation of Mary helps us to grow in dedication to God 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Presentation of Mary Novena - Day 5: Bible Study" 
            url="/novenas/presentation-of-mary/day-5"
            excerpt="Join me in praying The Presentation of Mary Novena - Day 5 focusing on bible study." 
          />
        </div>
