...
export const metadata: Metadata = {
  ...
  description: 'Pray Guardian Angel Novena - Day 6 focusing on divine helper. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 6',
    'angel novena day 6',
    'day 6 guardian angel novena',
    'divine helper guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 6: Divine Helper',
    description: 'Pray Guardian Angel Novena - Day 6 focusing on Divine Helper.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-6',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 6: Divine Helper',
    description: 'Pray Guardian Angel Novena - Day 6 focusing on Divine Helper.',
...
export default function GuardianAngelNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 6: Divine Helper
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Helper</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for support and assistance in your spiritual journey.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my helper every day of my life. Support me to be holy and good like you. Help me to be the person that God is calling me to be. Support me to be a light for others to know and love the Lord.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my helper, support me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine helper. This aspect of honoring your guardian angel helps you to recognize 
