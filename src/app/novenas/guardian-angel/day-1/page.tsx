...
export const metadata: Metadata = {
  title: 'Guardian Angel Novena - Day 1: Divine Counselor',
  description: 'Pray Guardian Angel Novena - Day 1 focusing on divine counselor. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 1',
    'angel novena day 1',
    'day 1 guardian angel novena',
    'divine counselor guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 1: Divine Counselor',
    description: 'Pray Guardian Angel Novena - Day 1 focusing on Divine Counselor.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-1',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 1: Divine Counselor',
    description: 'Pray Guardian Angel Novena - Day 1 focusing on Divine Counselor.',
...
export default function GuardianAngelNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 1: Divine Counselor
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying Guardian Angel Novena to honor your personal guardian angel and seek divine guidance.
          </p>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Counselor</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of Guardian Angel Novena, we pray for inspiration and guidance from your guardian angel as your daily counselor.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my counselor every day of my life. Inspire me to be holy and good like you. Inspire me to be the person that God is calling me to be. Inspire me to be a light for others to know and love the Lord.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my counselor, inspire me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine counselor. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Guardian Angel Novena - Day 1: Divine Counselor" 
            url="/novenas/guardian-angel/day-1"
            excerpt="Join me in praying Guardian Angel Novena - Day 1 focusing on divine counselor." 
          />
        </div>
