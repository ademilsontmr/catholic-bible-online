...
export const metadata: Metadata = {
  title: 'Guardian Angel Novena - Day 4: Divine Teacher',
  description: 'Pray Guardian Angel Novena - Day 4 focusing on divine teacher. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 4',
    'angel novena day 4',
    'day 4 guardian angel novena',
    'divine teacher guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 4: Divine Teacher',
    description: 'Pray Guardian Angel Novena - Day 4 focusing on Divine Teacher.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-4',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 4: Divine Teacher',
    description: 'Pray Guardian Angel Novena - Day 4 focusing on Divine Teacher.',
...
export default function GuardianAngelNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 4: Divine Teacher
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Teacher</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for instruction and wisdom to become the person God calls you to be.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my teacher every day of my life. Instruct me to be holy and good like you. Teach me to be the person that God is calling me to be. Help me to be a light for others to know and love the Lord.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my teacher, instruct me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine teacher. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Guardian Angel Novena - Day 4: Divine Teacher" 
            url="/novenas/guardian-angel/day-4"
            excerpt="Join me in praying Guardian Angel Novena - Day 4 focusing on divine teacher." 
          />
        </div>
