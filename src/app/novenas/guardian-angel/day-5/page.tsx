...
export const metadata: Metadata = {
  title: 'Guardian Angel Novena - Day 5: Divine Witness',
  description: 'Pray Guardian Angel Novena - Day 5 focusing on divine witness. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 5',
    'angel novena day 5',
    'day 5 guardian angel novena',
    'divine witness guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 5: Divine Witness',
    description: 'Pray Guardian Angel Novena - Day 5 focusing on Divine Witness.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-5',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 5: Divine Witness',
    description: 'Pray Guardian Angel Novena - Day 5 focusing on Divine Witness.',
...
export default function GuardianAngelNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 5: Divine Witness
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Witness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for purification and cleansing from sinful habits and temptations.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are a witness to all of my actions every day of my life. Purify me to be holy and good like you. Refine and cleanse me of my sinful habits and keep me from temptation so that I may be the person God is calling me to be.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, witness of all my actions, purify me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine witness. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Guardian Angel Novena - Day 5: Divine Witness" 
            url="/novenas/guardian-angel/day-5"
            excerpt="Join me in praying Guardian Angel Novena - Day 5 focusing on divine witness." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/guardian-angel/day-4"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 4: Divine Teacher
          </Link>
