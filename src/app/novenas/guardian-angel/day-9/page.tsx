...
export const metadata: Metadata = {
  ...
  description: 'Pray Guardian Angel Novena - Day 9 focusing on divine light. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 9',
    'angel novena day 9',
    'day 9 guardian angel novena',
    'divine light guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 9: Divine Light',
    description: 'Pray Guardian Angel Novena - Day 9 focusing on Divine Light.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-9',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 9: Divine Light',
    description: 'Pray Guardian Angel Novena - Day 9 focusing on Divine Light.',
...
export default function GuardianAngelNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 9: Divine Light
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Today we pray for enlightenment and to become a light for others through our guardian angel.
          </p>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Light</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day, we pray for enlightenment to see God's loving face and become a light for others.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my light every day of my life. Enlighten me to be holy and good like you. Open my eyes so that I may see how to be the person that God is calling me to be. Enlighten my heart and my mind so I can be a light for others to know and love the Lord.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my light, enlighten me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine light. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless you abundantly with your guardian angel's guidance and protection throughout your life. May you always 
            remember that your guardian angel is with you always, ready to counsel, defend, and guide you on your journey to Heaven.
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed Guardian Angel Novena! As you continue to honor your guardian angel and seek their guidance 
            and protection, may your heart be filled with gratitude for their constant presence and care. May God continue 
            to bless you and provide all the strength you need to follow your guardian angel's guidance safely to Heaven.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <Link 
            href="/novenas/guardian-angel/day-8"
      ...
      <RelatedNovenas currentNovena="Guardian Angel Novena" />
