...
export const metadata: Metadata = {
  title: 'Guardian Angel Novena - Day 7: Divine Intercessor',
  description: 'Pray Guardian Angel Novena - Day 7 focusing on divine intercessor. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 7',
    'angel novena day 7',
    'day 7 guardian angel novena',
    'divine intercessor guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 7: Divine Intercessor',
    description: 'Pray Guardian Angel Novena - Day 7 focusing on Divine Intercessor.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-7',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 7: Divine Intercessor',
    description: 'Pray Guardian Angel Novena - Day 7 focusing on Divine Intercessor.',
...
export default function GuardianAngelNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 7: Divine Intercessor
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Intercessor</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for your guardian angel to speak on your behalf to the Lord.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my intercessor every day of my life. Speak for me to the Lord. Ask Him to help me see His loving face. Speak to him about my life and whisper my prayers into his ear so that I may be the person that God is calling me to be.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my intercessor, speak for me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine intercessor. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Guardian Angel Novena - Day 7: Divine Intercessor" 
            url="/novenas/guardian-angel/day-7"
            excerpt="Join me in praying Guardian Angel Novena - Day 7 focusing on divine intercessor." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/guardian-angel/day-6"
