...
export const metadata: Metadata = {
  title: 'Guardian Angel Novena - Day 3: Divine Consoler',
  description: 'Pray Guardian Angel Novena - Day 3 focusing on divine consoler. Join in praying for protection, guidance, and divine assistance from your personal guardian angel.',
  keywords: [
    'guardian angel novena day 3',
    'angel novena day 3',
    'day 3 guardian angel novena',
    'divine consoler guardian angel'
  ],
  openGraph: {
    title: 'Guardian Angel Novena - Day 3: Divine Consoler',
    description: 'Pray Guardian Angel Novena - Day 3 focusing on Divine Consoler.',
    url: 'https://catholicbibleonline.com/novenas/guardian-angel/day-3',
  },
  twitter: {
    title: 'Guardian Angel Novena - Day 3: Divine Consoler',
    description: 'Pray Guardian Angel Novena - Day 3 focusing on Divine Consoler.',
...
export default function GuardianAngelNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Guardian Angel Novena – Day 3: Divine Consoler
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Consoler</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we pray for strength and fortification during life's difficult moments.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">My sweet Guardian Angel, you are my consoler every day of my life. Fortify me to be strong when life is hard and my body and soul are hurting. Fortify me to have the strength to be the person that God is calling me to be.</p>
              ...
              <p className="mb-6">
                <strong>My guardian angel, my consoler, fortify me!</strong>
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine consoler. This aspect of honoring your guardian angel helps you to recognize 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Guardian Angel Novena - Day 3: Divine Consoler" 
            url="/novenas/guardian-angel/day-3"
            excerpt="Join me in praying Guardian Angel Novena - Day 3 focusing on divine consoler." 
          />
        </div>
