      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            ...
            url="/novenas/our-lady-of-sorrows/day-9"
            excerpt="Join me in praying the Our Lady of Sorrows Novena - Day 9 focusing on Mercy." 
          />
        </div>
...
{/* Navigation */}
      ...
      <RelatedNovenas currentNovena="Our Lady of Sorrows Novena" />
    </div>
  )
} 