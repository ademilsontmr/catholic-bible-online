...
export const metadata: Metadata = {
  title: 'Novena for Peace to Our Lady of Sorrows - Day 8: Comfort and Healing',
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 8 focusing on Comfort and Healing. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 8',
    'our lady of sorrows peace novena day 8',
    'lady of sorrows novena day 8',
    'peace novena our lady of sorrows day 8',
    'day 8 novena for peace to our lady of sorrows',
    'comfort and healing prayer',
    'our lady of sorrows novena comfort and healing',
    'peace prayer novena comfort and healing'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 8: Comfort and Healing',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 8 focusing on Comfort and Healing. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-8',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 8: Comfort and Healing',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 8 focusing on Comfort and Healing. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 8: Comfort and Healing
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Comfort and Healing</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the comfort of families and healing of the injured. We ask for the recovery of those injured in terrorist attacks and for families to know the comfort of Christ's constant love.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Sorrows knows the pain of losing loved ones and the need for comfort in times of grief. She will intercede for healing and comfort for all who suffer from loss and injury.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, comfort all families who have lost loved ones and bring healing to all who are injured. May they know the comfort of Christ's constant love. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Peace to Our Lady of Sorrows - Day 8: Comfort and Healing" 
            url="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-8"
            excerpt="Join me in praying the Novena for Peace to Our Lady of Sorrows - Day 8 focusing on Comfort and Healing." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-7"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 7: Protection of Innocents
          </Link>
          
          
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-9"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Repentance and Grace →
          </Link>
