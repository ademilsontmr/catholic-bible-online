...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 6 focusing on Sword of Sorrow. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 6',
    'our lady of sorrows peace novena day 6',
    'lady of sorrows novena day 6',
    'peace novena our lady of sorrows day 6',
    'day 6 novena for peace to our lady of sorrows',
    'sword of sorrow prayer',
    'our lady of sorrows novena sword of sorrow',
    'peace prayer novena sword of sorrow'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 6: Sword of Sorrow',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 6 focusing on Sword of Sorrow. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-6',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 6: Sword of Sorrow',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 6 focusing on Sword of Sorrow. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 6: Sword of Sorrow
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Sword of Sorrow</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for Our Lady's intercession through her pierced soul. We ask her to intercede for us and obtain from Jesus our petitions if they be for His honor and glory and for our good.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady's soul was pierced by a sword of sorrow at the sight of her Son's passion. This deep wound makes her intercession particularly powerful, as she understands the pain of losing innocent life.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, your soul was pierced by a sword of sorrow. Intercede for us and obtain from Jesus our petitions if they be for His honor and glory and for our good. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-5"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 5: Chalice of Sorrow
          </Link>
