...
export const metadata: Metadata = {
  title: 'Novena for Peace to Our Lady of Sorrows - Day 3: Sacred Passion and Death',
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 3 focusing on Sacred Passion and Death. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 3',
    'our lady of sorrows peace novena day 3',
    'lady of sorrows novena day 3',
    'peace novena our lady of sorrows day 3',
    'day 3 novena for peace to our lady of sorrows',
    'sacred passion and death prayer',
    'our lady of sorrows novena sacred passion and death',
    'peace prayer novena sacred passion and death'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 3: Sacred Passion and Death',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 3 focusing on Sacred Passion and Death. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-3',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 3: Sacred Passion and Death',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 3 focusing on Sacred Passion and Death. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 3: Sacred Passion and Death
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Sacred Passion and Death</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying through the merits of Christ's Sacred Passion and Death. We ask Our Lady to present our petitions to Jesus through His sufferings and her own sufferings at the foot of the cross.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The united efficacy of Christ's Passion and Our Lady's sufferings at the foot of the cross has infinite power. Through this combination, our prayers become more powerful and acceptable to God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, present our petitions to Jesus through the merits of His Sacred Passion and Death, together with your sufferings at the foot of the cross. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Peace to Our Lady of Sorrows - Day 3: Sacred Passion and Death" 
            url="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-3"
            excerpt="Join me in praying the Novena for Peace to Our Lady of Sorrows - Day 3 focusing on Sacred Passion and Death." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-2"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 2: Sanctuary of Wounded Heart
          </Link>
          
          
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-4"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
