...
export const metadata: Metadata = {
  title: 'Novena for Peace to Our Lady of Sorrows - Day 5: Chalice of Sorrow',
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 5 focusing on Chalice of Sorrow. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 5',
    'our lady of sorrows peace novena day 5',
    'lady of sorrows novena day 5',
    'peace novena our lady of sorrows day 5',
    'day 5 novena for peace to our lady of sorrows',
    'chalice of sorrow prayer',
    'our lady of sorrows novena chalice of sorrow',
    'peace prayer novena chalice of sorrow'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 5: Chalice of Sorrow',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 5 focusing on Chalice of Sorrow. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-5',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 5: Chalice of Sorrow',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 5 focusing on Chalice of Sorrow. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 5: Chalice of Sorrow
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Chalice of Sorrow</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for Our Lady's compassion through her deep sorrow. We acknowledge that she has drunk so deeply of the chalice of her Son's suffering that she can receive our sorrows with understanding.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady's deep sorrow has made her uniquely qualified to understand and receive our sufferings. Her compassion flows from her own experience of pain and loss, making her the perfect intercessor for our needs.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, you have drunk so deeply of the chalice of your Son, you can with compassion receive our sorrows. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Peace to Our Lady of Sorrows - Day 5: Chalice of Sorrow" 
            url="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-5"
            excerpt="Join me in praying the Novena for Peace to Our Lady of Sorrows - Day 5 focusing on Chalice of Sorrow." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-6"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Sword of Sorrow →
          </Link>
