...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 7 focusing on Protection of Innocents. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 7',
    'our lady of sorrows peace novena day 7',
    'lady of sorrows novena day 7',
    'peace novena our lady of sorrows day 7',
    'day 7 novena for peace to our lady of sorrows',
    'protection of innocents prayer',
    'our lady of sorrows novena protection of innocents',
    'peace prayer novena protection of innocents'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 7: Protection of Innocents',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 7 focusing on Protection of Innocents. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-7',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 7: Protection of Innocents',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 7 focusing on Protection of Innocents. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 7: Protection of Innocents
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Protection of Innocents</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for the protection of innocent travelers and the end of abortion. We ask for the removal of U.S. Marshals from abortion chambers and their stationing on airplanes to protect innocent travelers.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The protection of innocent life is a fundamental principle of our faith. Our Lady of Sorrows, who witnessed the death of her innocent Son, understands the value of every human life and will intercede for its protection.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, protect innocent life and help to end the scourge of abortion. May all innocent travelers be protected and may life be respected from conception to natural death. Amen.
          </p>
        </section>
