...
export const metadata: Metadata = {
  title: "Novena for Peace to Our Lady of Sorrows - Day 1: Mother's Tenderness",
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 1 focusing on Mother's Tenderness. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 1',
    'our lady of sorrows peace novena day 1',
    'lady of sorrows novena day 1',
    'peace novena our lady of sorrows day 1',
    'day 1 novena for peace to our lady of sorrows',
    "mother's tenderness prayer",
    "our lady of sorrows novena mother's tenderness",
    "peace prayer novena mother's tenderness"
  ],
  openGraph: {
    title: "Novena for Peace to Our Lady of Sorrows - Day 1: Mother's Tenderness",
    description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 1 focusing on Mother's Tenderness. Join in praying the traditional novena.",
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-1',
  },
  twitter: {
    title: "Novena for Peace to Our Lady of Sorrows - Day 1: Mother's Tenderness",
    description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 1 focusing on Mother's Tenderness. Join in praying the traditional novena.",
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 1: Mother's Tenderness
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother's Tenderness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Peace to Our Lady of Sorrows, we focus on praying for Our Lady's motherly tenderness and pity. We ask her to look upon us with a mother's love as we kneel before her.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Sorrows, as a mother who witnessed the agony of her dying Son, understands our sufferings and looks upon us with tender compassion. Her motherly heart is always open to receive our prayers and petitions.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, help us to experience your motherly tenderness and pity. May we always turn to you in our needs, knowing that you understand our sufferings. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Peace to Our Lady of Sorrows - Day 1: Mother's Tenderness" 
            url="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-1"
            excerpt="Join me in praying the Novena for Peace to Our Lady of Sorrows - Day 1 focusing on Mother's Tenderness." 
          />
        </div>
