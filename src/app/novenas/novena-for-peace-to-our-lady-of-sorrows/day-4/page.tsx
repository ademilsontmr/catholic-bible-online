...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 4 focusing on Mother of Mercy. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 4',
    'our lady of sorrows peace novena day 4',
    'lady of sorrows novena day 4',
    'peace novena our lady of sorrows day 4',
    'day 4 novena for peace to our lady of sorrows',
    'mother of mercy prayer',
    'our lady of sorrows novena mother of mercy',
    'peace prayer novena mother of mercy'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 4: Mother of Mercy',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 4 focusing on Mother of Mercy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-4',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 4: Mother of Mercy',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 4 focusing on Mother of Mercy. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 4: Mother of Mercy
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother of Mercy</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying to Our Lady as Mother of Mercy in our wants and miseries. We recognize that to whom shall we have recourse in our needs if not to her, who is full of mercy and compassion.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Sorrows is truly our Mother of Mercy. She has experienced the depths of human suffering and can understand our needs and intercede for us with her Son with great compassion.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, be our Mother of Mercy in our wants and miseries. To whom shall we have recourse if not to you, who are full of compassion and love? Amen.
          </p>
        </section>
