...
export const metadata: Metadata = {
  title: 'Novena for Peace to Our Lady of Sorrows - Day 2: Sanctuary of Wounded Heart',
  description: "Pray the Novena for Peace to Our Lady of Sorrows - Day 2 focusing on Sanctuary of Wounded Heart. Join in praying the traditional novena for peace and protection.",
  keywords: [
    'novena for peace to our lady of sorrows day 2',
    'our lady of sorrows peace novena day 2',
    'lady of sorrows novena day 2',
    'peace novena our lady of sorrows day 2',
    'day 2 novena for peace to our lady of sorrows',
    'sanctuary of wounded heart prayer',
    'our lady of sorrows novena sanctuary of wounded heart',
    'peace prayer novena sanctuary of wounded heart'
  ],
  openGraph: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 2: Sanctuary of Wounded Heart',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 2 focusing on Sanctuary of Wounded Heart. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-peace-to-our-lady-of-sorrows/day-2',
  },
  twitter: {
    title: 'Novena for Peace to Our Lady of Sorrows - Day 2: Sanctuary of Wounded Heart',
    description: 'Pray the Novena for Peace to Our Lady of Sorrows - Day 2 focusing on Sanctuary of Wounded Heart. Join in praying the traditional novena.',
...
export default function NovenaForPeaceToOurLadyOfSorrowsDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Peace to Our Lady of Sorrows – Day 2: Sanctuary of Wounded Heart
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Sanctuary of Wounded Heart</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on placing our requests with dutiful confidence in the sanctuary of Our Lady's wounded heart. We venerate her sorrows and entrust our needs to her care.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The sanctuary of Our Lady's wounded heart is a sacred place where our prayers are safe and cherished. Her heart, pierced by sorrow, is the perfect refuge for our petitions and concerns.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Sorrows, may your wounded heart be our sanctuary. Help us to place all our requests with confidence in your care, knowing that you will present them to your Son. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Peace to Our Lady of Sorrows - Day 2: Sanctuary of Wounded Heart" 
            url="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-2"
            excerpt="Join me in praying the Novena for Peace to Our Lady of Sorrows - Day 2 focusing on Sanctuary of Wounded Heart." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-1"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Mother's Tenderness
          </Link>
          
          
          <Link
            href="/novenas/novena-for-peace-to-our-lady-of-sorrows/day-3"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Sacred Passion and Death →
          </Link>
