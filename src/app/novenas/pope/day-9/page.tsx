...
export const metadata: Metadata = {
  title: 'Novena for the Pope - Day 9: Love and Peace',
  description: "Pray the Novena for the Pope - Day 9 focusing on Love and Peace. Join in praying the traditional novena to support the Holy Father.",
  keywords: [
    'novena for the pope day 9',
    'pope novena day 9',
    'holy father novena day 9',
    'vicar of christ novena day 9',
    'day 9 pope novena',
    'love and peace prayer',
    'pope novena love and peace',
    'holy father novena love and peace'
  ],
  openGraph: {
    title: 'Novena for the Pope - Day 9: Love and Peace',
    description: 'Pray the Novena for the Pope - Day 9 focusing on Love and Peace. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/pope/day-9',
  },
  twitter: {
    title: 'Novena for the Pope - Day 9: Love and Peace',
    description: 'Pray the Novena for the Pope - Day 9 focusing on Love and Peace. Join in praying the traditional novena.',
...
export default function PopeNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for the Pope – Day 9: Love and Peace
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Love and Peace</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on praying for the Pope to bring love and peace to all the world. We ask that his ministry may be a source of love and peace for all people.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Pope is called to be a messenger of peace and love to the entire world. Through his words and actions, he can help bring about the peace that Christ promised to His followers.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through your prayers for the Holy Father. 
            May you always remember the importance of praying for the Pope and supporting his ministry. 
            May your heart be filled with love for the Church and fidelity to her teachings.
          </p>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena for the Pope! As you continue your spiritual journey, 
            may your heart be filled with love for the Holy Father, fidelity to the Church, 
            and commitment to praying for the Pope's intentions. May the Lord continue to bless 
            and protect the Holy Father in his sacred ministry as Vicar of Christ and successor to Peter.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for the Pope - Day 9: Love and Peace" 
            url="/novenas/pope/day-9"
            excerpt="Join me in praying the Novena for the Pope - Day 9 focusing on Love and Peace." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Novena for the Pope" />
    </div>
  )
}
