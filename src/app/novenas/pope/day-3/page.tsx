...
export const metadata: Metadata = {
  title: 'Novena for the Pope - Day 3: Spirit of Knowledge',
  description: "Pray the Novena for the Pope - Day 3 focusing on Spirit of Knowledge. Join in praying the traditional novena to support the Holy Father.",
  keywords: [
    'novena for the pope day 3',
    'pope novena day 3',
    'holy father novena day 3',
    'vicar of christ novena day 3',
    'day 3 pope novena',
    'spirit of knowledge prayer',
    'pope novena spirit of knowledge',
    'holy father novena spirit of knowledge'
  ],
  openGraph: {
    title: 'Novena for the Pope - Day 3: Spirit of Knowledge',
    description: 'Pray the Novena for the Pope - Day 3 focusing on Spirit of Knowledge. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/pope/day-3',
  },
  twitter: {
    title: 'Novena for the Pope - Day 3: Spirit of Knowledge',
    description: 'Pray the Novena for the Pope - Day 3 focusing on Spirit of Knowledge. Join in praying the traditional novena.',
...
export default function PopeNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for the Pope – Day 3: Spirit of Knowledge
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spirit of Knowledge</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for the Holy Father to be filled with divine knowledge. We ask that he may understand deeply the mysteries of faith and the needs of the Church.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Pope needs divine knowledge to understand the complexities of the modern world and to apply the timeless truths of the Gospel to contemporary challenges. This knowledge comes from the Holy Spirit.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Lord, fill the Holy Father with divine knowledge to understand deeply the mysteries of faith and the needs of Your people. May he be enlightened by Your Holy Spirit. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for the Pope - Day 3: Spirit of Knowledge" 
            url="/novenas/pope/day-3"
            excerpt="Join me in praying the Novena for the Pope - Day 3 focusing on Spirit of Knowledge." 
          />
        </div>
