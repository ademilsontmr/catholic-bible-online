...
export const metadata: Metadata = {
  title: 'Novena for the Pope - Day 6: Successor of Peter',
  description: "Pray the Novena for the Pope - Day 6 focusing on Successor of Peter. Join in praying the traditional novena to support the Holy Father.",
  keywords: [
    'novena for the pope day 6',
    'pope novena day 6',
    'holy father novena day 6',
    'vicar of christ novena day 6',
    'day 6 pope novena',
    'successor of peter prayer',
    'pope novena successor of peter',
    'holy father novena successor of peter'
  ],
  openGraph: {
    title: 'Novena for the Pope - Day 6: Successor of Peter',
    description: 'Pray the Novena for the Pope - Day 6 focusing on Successor of Peter. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/pope/day-6',
  },
  twitter: {
    title: 'Novena for the Pope - Day 6: Successor of Peter',
    description: 'Pray the Novena for the Pope - Day 6 focusing on Successor of Peter. Join in praying the traditional novena.',
...
export default function PopeNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for the Pope – Day 6: Successor of Peter
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Successor of Peter</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the Pope as successor to the Apostle Peter. We ask that he may be strengthened in his role as the rock upon which Christ built His Church.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Pope is the direct successor to Saint Peter, the first Pope. This apostolic succession is a visible sign of the continuity of Christ's Church and the fulfillment of His promise that the gates of hell would not prevail against it.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Lord, strengthen the Pope as successor to the Apostle Peter. May he be the rock upon which Your Church stands firm against all challenges. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for the Pope - Day 6: Successor of Peter" 
            url="/novenas/pope/day-6"
            excerpt="Join me in praying the Novena for the Pope - Day 6 focusing on Successor of Peter." 
          />
        </div>
