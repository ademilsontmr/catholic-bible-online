...
export const metadata: Metadata = {
  title: 'New Year Novena - Day 6: Deeper Trust',
  description: 'Pray the New Year Novena - Day 6 focusing on deeper trust. Join in praying for blessings and a holy new year.',
  keywords: [
    'new year novena day 6',
    'new year prayer day 6',
    'day 6 new year novena',
    'deeper trust new year blessing'
  ],
  openGraph: {
    title: 'New Year Novena - Day 6: Deeper Trust',
    description: 'Pray the New Year Novena - Day 6 focusing on Deeper Trust.',
    url: 'https://catholicbibleonline.com/novenas/new-year/day-6',
  },
  twitter: {
    title: 'New Year Novena - Day 6: Deeper Trust',
    description: 'Pray the New Year Novena - Day 6 focusing on Deeper Trust.',
...
export default function NewYearNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            New Year Novena – Day 6: Deeper Trust
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Deeper Trust</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for growth in deeper trust in God.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">In our fallen world, we face many struggles and difficulties at times. It is not always easy to surrender our lives fully to You in trust when we are in the midst of struggles. You can help us to grow to a deeper trust in You in our lives.</p>

              <p className="mb-4">Please pour out Your grace on our lives during this new year, and we particularly ask today that You help us and all people to grow to a deeper trust in You.</p>

              <p className="mb-4">Help us serve You more devotedly each day of our lives. Give us the grace to truly surrender all parts of our lives to You.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on deeper trust. This aspect of beginning a new year helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="New Year Novena - Day 6: Deeper Trust" 
            url="/novenas/new-year/day-6"
            excerpt="Join me in praying the New Year Novena - Day 6 focusing on deeper trust." 
          />
        </div>
