...
export const metadata: Metadata = {
  title: 'New Year Novena - Day 4: Unknown Assistance',
  description: 'Pray the New Year Novena - Day 4 focusing on unknown assistance. Join in praying for blessings and a holy new year.',
  keywords: [
    'new year novena day 4',
    'new year prayer day 4',
    'day 4 new year novena',
    'unknown assistance new year blessing'
  ],
  openGraph: {
    title: 'New Year Novena - Day 4: Unknown Assistance',
    description: 'Pray the New Year Novena - Day 4 focusing on Unknown Assistance.',
    url: 'https://catholicbibleonline.com/novenas/new-year/day-4',
  },
  twitter: {
    title: 'New Year Novena - Day 4: Unknown Assistance',
    description: 'Pray the New Year Novena - Day 4 focusing on Unknown Assistance.',
...
export default function NewYearNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            New Year Novena – Day 4: Unknown Assistance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Unknown Assistance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for assistance we do not know we need.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">We know that You truly know what is best for us in our lives. We often think we know what kind of help we need most in our lives, but there are also many things we do not realize we need Your help with.</p>

              <p className="mb-4">Please pour out Your grace on our lives during this new year, and we particularly ask today that You give us and all people the assistance we do not know we need in our lives during the new year.</p>

              <p className="mb-4">Help us to truly rely on You for all things each day. Give us the grace to strive for saintliness in every circumstance we face.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on unknown assistance. This aspect of beginning a new year helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="New Year Novena - Day 4: Unknown Assistance" 
            url="/novenas/new-year/day-4"
            excerpt="Join me in praying the New Year Novena - Day 4 focusing on unknown assistance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/new-year/day-5"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 5: Help for Struggles →
          </Link>
