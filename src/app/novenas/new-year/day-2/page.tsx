...
export const metadata: Metadata = {
  title: 'New Year Novena - Day 2: Material Assistance',
  description: 'Pray the New Year Novena - Day 2 focusing on material assistance. Join in praying for blessings and a holy new year.',
  keywords: [
    'new year novena day 2',
    'new year prayer day 2',
    'day 2 new year novena',
    'material assistance new year blessing'
  ],
  openGraph: {
    title: 'New Year Novena - Day 2: Material Assistance',
    description: 'Pray the New Year Novena - Day 2 focusing on Material Assistance.',
    url: 'https://catholicbibleonline.com/novenas/new-year/day-2',
  },
  twitter: {
    title: 'New Year Novena - Day 2: Material Assistance',
    description: 'Pray the New Year Novena - Day 2 focusing on Material Assistance.',
...
export default function NewYearNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            New Year Novena – Day 2: Material Assistance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this second day, we pray for material assistance needed in the new year.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">There are many material things we need in order to be able to live our lives. You know better than we do ourselves what we are in need of. We know that You are able to provide all that we need in order to carry out our lives.</p>

              <p className="mb-4">Please pour out Your grace on our lives during this new year, and we particularly ask today that You give us and all people the material assistance we need in the new year.</p>

              <p className="mb-4">Help us to grow in holiness and virtue at every opportunity You place in our lives. Give us the grace to grow in holy dependence on You each day.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on material assistance. This aspect of beginning a new year helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="New Year Novena - Day 2: Material Assistance" 
            url="/novenas/new-year/day-2"
            excerpt="Join me in praying the New Year Novena - Day 2 focusing on material assistance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ← Day 1: Spiritual Blessings
          </Link>
          
          
          
          <Link 
            href="/novenas/new-year/day-3"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 3: Blessing of Happiness →
          </Link>
