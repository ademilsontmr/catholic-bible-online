...
export const metadata: Metadata = {
  title: 'New Year Novena - Day 1: Spiritual Blessings',
  description: 'Pray the New Year Novena - Day 1 focusing on spiritual blessings. Join in praying for blessings and a holy new year.',
  keywords: [
    'new year novena day 1',
    'new year prayer day 1',
    'day 1 new year novena',
    'spiritual blessings new year blessing'
  ],
  openGraph: {
    title: 'New Year Novena - Day 1: Spiritual Blessings',
    description: 'Pray the New Year Novena - Day 1 focusing on Spiritual Blessings.',
    url: 'https://catholicbibleonline.com/novenas/new-year/day-1',
  },
  twitter: {
    title: 'New Year Novena - Day 1: Spiritual Blessings',
    description: 'Pray the New Year Novena - Day 1 focusing on Spiritual Blessings.',
...
export default function NewYearNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            New Year Novena – Day 1: Spiritual Blessings
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying the New Year Novena to seek blessings and grace for a holy new year.
          </p>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spiritual Blessings</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the New Year Novena, we pray for spiritual blessings needed in the new year.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">We know that we depend on You for all things in our lives, and Your loving providence keeps our lives in existence. As we begin a new year, we acknowledge Your power over our lives and seek Your help in all that we need.</p>

              <p className="mb-4">Please pour out Your grace on our lives during this new year, and we particularly ask today that You give us and all people the spiritual blessings we need in the new year.</p>

              <p className="mb-4">Help us to always turn to You for all that we need in our lives. Give us the grace to truly place our trust in You in all circumstances.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on spiritual blessings. This aspect of beginning a new year helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="New Year Novena - Day 1: Spiritual Blessings" 
            url="/novenas/new-year/day-1"
            excerpt="Join me in praying the New Year Novena - Day 1 focusing on spiritual blessings." 
          />
        </div>
