...
export const metadata: Metadata = {
  title: 'Novena for Children - Day 4: Child Faith',
  description: 'Pray the Novena for Children - Day 4 focusing on child faith.',
  keywords: ['children novena day 4', 'children prayer day 4'],
  openGraph: {
    title: 'Novena for Children - Day 4: Child Faith',
    description: 'Pray the Novena for Children - Day 4 focusing on child faith.',
    url: 'https://catholic-bible-online.com/novenas/children/day-4',
  },
  twitter: {
    title: 'Novena for Children - Day 4: Child Faith',
    description: 'Pray the Novena for Children - Day 4 focusing on child faith.',
...
export default function NovenaForChildrenDay4Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Children – Day 4: Child Faith
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Child Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on child faith in our children prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on child faith, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on child faith. This aspect of children's well-being helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Children - Day 4: Child Faith" 
            url="/novenas/children/day-4"
            excerpt="Join me in praying the Novena for Children - Day 4 focusing on child faith." 
          />
        </div>
