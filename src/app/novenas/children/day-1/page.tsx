...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for Children - Day 1 focusing on child protection.',
  keywords: ['children novena day 1', 'children prayer day 1'],
  openGraph: {
    title: 'Novena for Children - Day 1: Child Protection',
    description: 'Pray the Novena for Children - Day 1 focusing on child protection.',
    url: 'https://catholic-bible-online.com/novenas/children/day-1',
  },
  twitter: {
    title: 'Novena for Children - Day 1: Child Protection',
    description: 'Pray the Novena for Children - Day 1 focusing on child protection.',
...
export default function NovenaForChildrenDay1Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Children – Day 1: Child Protection
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Child Protection</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on child protection in our children prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on child protection, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on child protection. This aspect of children's well-being helps us to grow spiritually 
