...
export const metadata: Metadata = {
  title: 'Novena for Children - Day 9: Child Blessings',
  description: 'Pray the Novena for Children - Day 9 focusing on child blessings.',
  keywords: ['children novena day 9', 'children prayer day 9'],
  openGraph: {
    title: 'Novena for Children - Day 9: Child Blessings',
    description: 'Pray the Novena for Children - Day 9 focusing on child blessings.',
    url: 'https://catholic-bible-online.com/novenas/children/day-9',
  },
  twitter: {
    title: 'Novena for Children - Day 9: Child Blessings',
    description: 'Pray the Novena for Children - Day 9 focusing on child blessings.',
...
export default function NovenaForChildrenDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Children – Day 9: Child Blessings
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Child Blessings</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on child blessings in our children prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on child blessings, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on child blessings. This aspect of children's well-being helps us to grow spiritually 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless all children abundantly and fill their lives with His love, protection, and guidance.
          </p>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena for Children! May God continue to guide you and bless you.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Children - Day 9: Child Blessings" 
            url="/novenas/children/day-9"
            excerpt="Join me in praying the Novena for Children - Day 9 focusing on child blessings." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Children Novena" />
    </div>
  )
}