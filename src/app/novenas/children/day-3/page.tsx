...
export const metadata: Metadata = {
  title: 'Novena for Children - Day 3: Child Wisdom',
  description: 'Pray the Novena for Children - Day 3 focusing on child wisdom.',
  keywords: ['children novena day 3', 'children prayer day 3'],
  openGraph: {
    title: 'Novena for Children - Day 3: Child Wisdom',
    description: 'Pray the Novena for Children - Day 3 focusing on child wisdom.',
    url: 'https://catholic-bible-online.com/novenas/children/day-3',
  },
  twitter: {
    title: 'Novena for Children - Day 3: Child Wisdom',
    description: 'Pray the Novena for Children - Day 3 focusing on child wisdom.',
...
export default function NovenaForChildrenDay3Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Children – Day 3: Child Wisdom
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Child Wisdom</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on child wisdom in our children prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on child wisdom, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on child wisdom. This aspect of children's well-being helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Children - Day 3: Child Wisdom" 
            url="/novenas/children/day-3"
            excerpt="Join me in praying the Novena for Children - Day 3 focusing on child wisdom." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/children/day-2"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 2: Child Innocence
          </Link>
          
          <Link 
            href="/novenas/children/day-4"
