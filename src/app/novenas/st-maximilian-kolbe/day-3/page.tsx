...
export const metadata: Metadata = {
  title: 'Novena to Saint Maximilian Kolbe - Day 3: Militia Immaculata',
  description: "Pray the Novena to Saint Maximilian Kolbe - Day 3 focusing on Militia Immaculata. Join in praying the traditional novena to seek St. Maximilian's intercession.",
  keywords: [
    'novena to saint maximilian kolbe day 3',
    'st maximilian kolbe novena day 3',
    'maximilian kolbe novena day 3',
    'st maximilian kolbe prayer day 3',
    'day 3 st maximilian kolbe novena',
    'militia immaculata prayer',
    'st maximilian kolbe novena militia immaculata',
    'maximilian kolbe novena militia immaculata'
  ],
  openGraph: {
    title: 'Novena to Saint Maximilian Kolbe - Day 3: Militia Immaculata',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 3 focusing on Militia Immaculata. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-maximilian-kolbe/day-3',
  },
  twitter: {
    title: 'Novena to Saint Maximilian Kolbe - Day 3: Militia Immaculata',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 3 focusing on Militia Immaculata. Join in praying the traditional novena.',
...
export default function StMaximilianKolbeNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Maximilian Kolbe – Day 3: Militia Immaculata
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Militia Immaculata</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on the Militia Immaculata movement that St. Maximilian founded. This movement was dedicated to spreading devotion to the Immaculate Conception and converting sinners through her intercession.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Militia Immaculata shows us that we are called to be active apostles of Our Lady, spreading her message of love and conversion to the world around us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Maximilian Kolbe, help me to be an active member of the Militia Immaculata. May your zeal for spreading devotion to Our Lady inspire me to be an apostle of her love and mercy. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Maximilian Kolbe - Day 3: Militia Immaculata" 
            url="/novenas/st-maximilian-kolbe/day-3"
            excerpt="Join me in praying the Novena to Saint Maximilian Kolbe - Day 3 focusing on Militia Immaculata." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-maximilian-kolbe/day-2"
          ...
          <Link
            href="/novenas/st-maximilian-kolbe/day-4"
            className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Selfless Sacrifice →
          </Link>
