...
export const metadata: Metadata = {
  title: 'Novena to Saint Maximilian Kolbe - Day 2: Devotion to Our Lady',
  description: "Pray the Novena to Saint Maximilian Kolbe - Day 2 focusing on Devotion to Our Lady. Join in praying the traditional novena to seek St. Maximilian's intercession.",
  keywords: [
    'novena to saint maximilian kolbe day 2',
    'st maximilian kolbe novena day 2',
    'maximilian kolbe novena day 2',
    'st maximilian kolbe prayer day 2',
    'day 2 st maximilian kolbe novena',
    'devotion to our lady prayer',
    'st maximilian kolbe novena devotion to our lady',
    'maximilian kolbe novena devotion to our lady'
  ],
  openGraph: {
    title: 'Novena to Saint Maximilian Kolbe - Day 2: Devotion to Our Lady',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 2 focusing on Devotion to Our Lady. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-maximilian-kolbe/day-2',
  },
  twitter: {
    title: 'Novena to Saint Maximilian Kolbe - Day 2: Devotion to Our Lady',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 2 focusing on Devotion to Our Lady. Join in praying the traditional novena.',
...
export default function StMaximilianKolbeNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Maximilian Kolbe – Day 2: Devotion to Our Lady
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Devotion to Our Lady</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Maximilian's deep devotion to Our Lady. His love for the Blessed Virgin Mary was the foundation of his spiritual life and inspired all his works and sacrifices.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Maximilian's devotion to Our Lady teaches us that true love for God is inseparable from love for His Mother. Through her intercession, we can grow closer to Jesus and receive the graces we need.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Maximilian Kolbe, help me to grow in devotion to Our Lady as you did. May your love for the Blessed Virgin Mary inspire me to turn to her in all my needs and to spread devotion to her. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Maximilian Kolbe - Day 2: Devotion to Our Lady" 
            url="/novenas/st-maximilian-kolbe/day-2"
            excerpt="Join me in praying the Novena to Saint Maximilian Kolbe - Day 2 focusing on Devotion to Our Lady." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-maximilian-kolbe/day-1"
          ...
          <Link
            href="/novenas/st-maximilian-kolbe/day-3"
            className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Militia Immaculata →
          </Link>
