...
export const metadata: Metadata = {
  title: 'Novena to Saint Maximilian Kolbe - Day 8: Humble Service',
  description: "Pray the Novena to Saint Maximilian Kolbe - Day 8 focusing on Humble Service. Join in praying the traditional novena to seek St. Maximilian's intercession.",
  keywords: [
    'novena to saint maximilian kolbe day 8',
    'st maximilian kolbe novena day 8',
    'maximilian kolbe novena day 8',
    'st maximilian kolbe prayer day 8',
    'day 8 st maximilian kolbe novena',
    'humble service prayer',
    'st maximilian kolbe novena humble service',
    'maximilian kolbe novena humble service'
  ],
  openGraph: {
    title: 'Novena to Saint Maximilian Kolbe - Day 8: Humble Service',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 8 focusing on Humble Service. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-maximilian-kolbe/day-8',
  },
  twitter: {
    title: 'Novena to Saint Maximilian Kolbe - Day 8: Humble Service',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 8 focusing on Humble Service. Join in praying the traditional novena.',
...
export default function StMaximilianKolbeNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Maximilian Kolbe – Day 8: Humble Service
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Humble Service</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Maximilian's humility in serving God and neighbor. He never sought recognition or praise for his good works, but served with true humility.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Maximilian's humble service reminds us that true greatness lies in serving others with humility, following the example of Jesus who came to serve, not to be served.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Maximilian Kolbe, help me to serve with true humility as you did. May your humble service inspire me to seek only God's glory and the good of others. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Maximilian Kolbe - Day 8: Humble Service" 
            url="/novenas/st-maximilian-kolbe/day-8"
            excerpt="Join me in praying the Novena to Saint Maximilian Kolbe - Day 8 focusing on Humble Service." 
          />
        </div>
