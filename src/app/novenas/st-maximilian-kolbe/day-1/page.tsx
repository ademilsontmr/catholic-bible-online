...
export const metadata: Metadata = {
  title: 'Novena to Saint Maximilian Kolbe - Day 1: Greater Love',
  description: "Pray the Novena to Saint Maximilian Kolbe - Day 1 focusing on Greater Love. Join in praying the traditional novena to seek St. Maximilian's intercession.",
  keywords: [
    'novena to saint maximilian kolbe day 1',
    'st maximilian kolbe novena day 1',
    'maximilian kolbe novena day 1',
    'st maximilian kolbe prayer day 1',
    'day 1 st maximilian kolbe novena',
    'greater love prayer',
    'st maximilian kolbe novena greater love',
    'maximilian kolbe novena greater love'
  ],
  openGraph: {
    title: 'Novena to Saint Maximilian Kolbe - Day 1: Greater Love',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 1 focusing on Greater Love. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-maximilian-kolbe/day-1',
  },
  twitter: {
    title: 'Novena to Saint Maximilian Kolbe - Day 1: Greater Love',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 1 focusing on Greater Love. Join in praying the traditional novena.',
...
export default function StMaximilianKolbeNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Maximilian Kolbe – Day 1: Greater Love
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Greater Love</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to Saint Maximilian Kolbe, we focus on the greater love that Jesus spoke of - the love that lays down one's life for friends. St. Maximilian exemplified this love when he gave his life for a stranger in Auschwitz.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Maximilian's sacrifice reminds us that true love knows no bounds. He showed us that the greatest act of love is to give one's life for another, following the example of Jesus Christ Himself.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Maximilian Kolbe, martyr of charity, help me to love as you loved. May your example of greater love inspire me to lay down my life for others and to serve God and neighbor with complete generosity. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Maximilian Kolbe - Day 1: Greater Love" 
            url="/novenas/st-maximilian-kolbe/day-1"
            excerpt="Join me in praying the Novena to Saint Maximilian Kolbe - Day 1 focusing on Greater Love." 
          />
        </div>
