...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to Saint Maximilian Kolbe - Day 4 focusing on Selfless Sacrifice. Join in praying the traditional novena to seek St. Maximilian's intercession.",
  keywords: [
    'novena to saint maximilian kolbe day 4',
    'st maximilian kolbe novena day 4',
    'maximilian kolbe novena day 4',
    'st maximilian kolbe prayer day 4',
    'day 4 st maximilian kolbe novena',
    'selfless sacrifice prayer',
    'st maximilian kolbe novena selfless sacrifice',
    'maximilian kolbe novena selfless sacrifice'
  ],
  openGraph: {
    title: 'Novena to Saint Maximilian Kolbe - Day 4: Selfless Sacrifice',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 4 focusing on Selfless Sacrifice. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-maximilian-kolbe/day-4',
  },
  twitter: {
    title: 'Novena to Saint Maximilian Kolbe - Day 4: Selfless Sacrifice',
    description: 'Pray the Novena to Saint Maximilian Kolbe - Day 4 focusing on Selfless Sacrifice. Join in praying the traditional novena.',
...
export default function StMaximilianKolbeNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Maximilian Kolbe – Day 4: Selfless Sacrifice
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Selfless Sacrifice</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Maximilian's selfless sacrifice. He not only gave his life for another, but he also endured great suffering and persecution for the sake of others.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Maximilian's selfless sacrifice teaches us that true love involves giving of ourselves completely, without counting the cost or expecting anything in return.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Maximilian Kolbe, help me to make selfless sacrifices for others as you did. May your courage and generosity inspire me to give of myself completely for the good of others. Amen.
          </p>
        </section>
