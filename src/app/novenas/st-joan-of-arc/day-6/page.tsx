...
export const metadata: Metadata = {
  ...
  description: 'Pray St. Joan of Arc Novena - Day 6 focusing on devout christian life. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 6',
    'st joan of arc prayer novena day 6',
    'day 6 st joan of arc novena',
    'devout christian life st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 6: Devout Christian Life',
    description: 'Pray St. Joan of Arc Novena - Day 6 focusing on Devout Christian Life.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-6',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 6: Devout Christian Life',
    description: 'Pray St. Joan of Arc Novena - Day 6 focusing on Devout Christian Life.',
...
export default function StJoanOfArcNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 6: Devout Christian Life
          </h1>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Devout Christian Life</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray to become a truly devout and loving Christian like St. Joan.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on devout christian life. This aspect of honoring St. Joan of Arc helps you to understand 
