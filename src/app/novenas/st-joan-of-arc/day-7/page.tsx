...
export const metadata: Metadata = {
  title: 'St. Joan of Arc Novena - Day 7: Love for the Lord',
  description: 'Pray St. Joan of Arc Novena - Day 7 focusing on love for the lord. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 7',
    'st joan of arc prayer novena day 7',
    'day 7 st joan of arc novena',
    'love for the lord st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 7: Love for the Lord',
    description: 'Pray St. Joan of Arc Novena - Day 7 focusing on Love for the Lord.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-7',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 7: Love for the Lord',
    description: 'Pray St. Joan of Arc Novena - Day 7 focusing on Love for the Lord.',
...
export default function StJoanOfArcNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 7: Love for the Lord
          </h1>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Love for the Lord</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray to love the Lord with all heart, soul, and mind.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on love for the lord. This aspect of honoring St. Joan of Arc helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Joan of Arc Novena - Day 7: Love for the Lord" 
            url="/novenas/st-joan-of-arc/day-7"
            excerpt="Join me in praying St. Joan of Arc Novena - Day 7 focusing on love for the lord." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/st-joan-of-arc/day-6"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 6: Devout Christian Life
          </Link>
