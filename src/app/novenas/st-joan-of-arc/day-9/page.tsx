...
export const metadata: Metadata = {
  title: 'St. Joan of Arc Novena - Day 9: Eternal Guidance',
  description: 'Pray St. Joan of Arc Novena - Day 9 focusing on eternal guidance. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 9',
    'st joan of arc prayer novena day 9',
    'day 9 st joan of arc novena',
    'eternal guidance st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 9: Eternal Guidance',
    description: 'Pray St. Joan of Arc Novena - Day 9 focusing on Eternal Guidance.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-9',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 9: Eternal Guidance',
    description: 'Pray St. Joan of Arc Novena - Day 9 focusing on Eternal Guidance.',
...
export default function StJoanOfArcNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 9: Eternal Guidance
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Today we pray for St. Joan to always be near, guiding us closer to Jesus.
          </p>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Eternal Guidance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day, we pray for St. Joan to always be near, guiding us closer to Jesus.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on eternal guidance. This aspect of honoring St. Joan of Arc helps you to understand 
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless you abundantly with St. Joan\'s courage and faithfulness. May you always 
            remember her extraordinary example of victory in spiritual battles and be inspired to 
            remain faithful to God\'s divine mission throughout your life.
          </p>
        </section>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed St. Joan of Arc Novena! As you continue to honor St. Joan and seek her intercession 
            for courage and faithfulness, may your heart be filled with gratitude for her example. May God 
            continue to bless you and provide all the strength you need to be victorious in your spiritual battles.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Joan of Arc Novena - Day 9: Eternal Guidance" 
            url="/novenas/st-joan-of-arc/day-9"
            excerpt="Join me in praying St. Joan of Arc Novena - Day 9 focusing on eternal guidance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <Link 
            href="/novenas/st-joan-of-arc/day-8"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 8: Divine Protection
          </Link>
          
          
          
          <Link 
            href="/novenas/st-joan-of-arc"
      ...
      <RelatedNovenas currentNovena="St. Joan of Arc Novena" />
