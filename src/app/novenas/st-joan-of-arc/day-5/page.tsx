...
export const metadata: Metadata = {
  title: 'St. Joan of Arc Novena - Day 5: Divine Guidance',
  description: 'Pray St. Joan of Arc Novena - Day 5 focusing on divine guidance. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 5',
    'st joan of arc prayer novena day 5',
    'day 5 st joan of arc novena',
    'divine guidance st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 5: Divine Guidance',
    description: 'Pray St. Joan of Arc Novena - Day 5 focusing on Divine Guidance.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-5',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 5: Divine Guidance',
    description: 'Pray St. Joan of Arc Novena - Day 5 focusing on Divine Guidance.',
...
export default function StJoanOfArcNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 5: Divine Guidance
          </h1>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Guidance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for guidance to know and see the will of God clearly.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine guidance. This aspect of honoring St. Joan of Arc helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Joan of Arc Novena - Day 5: Divine Guidance" 
            url="/novenas/st-joan-of-arc/day-5"
            excerpt="Join me in praying St. Joan of Arc Novena - Day 5 focusing on divine guidance." 
          />
        </div>
