...
export const metadata: Metadata = {
  title: 'St. Joan of Arc Novena - Day 1: Courage and Witness',
  description: 'Pray St. Joan of Arc Novena - Day 1 focusing on courage and witness. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 1',
    'st joan of arc prayer novena day 1',
    'day 1 st joan of arc novena',
    'courage and witness st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 1: Courage and Witness',
    description: 'Pray St. Joan of Arc Novena - Day 1 focusing on Courage and Witness.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-1',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 1: Courage and Witness',
    description: 'Pray St. Joan of Arc Novena - Day 1 focusing on Courage and Witness.',
...
export default function StJoanOfArcNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 1: Courage and Witness
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying St. Joan of Arc Novena to honor the Maid of Orléans and seek her powerful intercession for courage and faithfulness.
          </p>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Courage and Witness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of St. Joan of Arc Novena, we pray for courage to be a witness to Jesus Christ and do God\'s will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on courage and witness. This aspect of honoring St. Joan of Arc helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Joan of Arc Novena - Day 1: Courage and Witness" 
            url="/novenas/st-joan-of-arc/day-1"
            excerpt="Join me in praying St. Joan of Arc Novena - Day 1 focusing on courage and witness." 
          />
        </div>
