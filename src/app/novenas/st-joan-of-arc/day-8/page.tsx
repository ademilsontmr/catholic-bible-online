...
export const metadata: Metadata = {
  title: 'St. Joan of Arc Novena - Day 8: Divine Protection',
  description: 'Pray St. Joan of Arc Novena - Day 8 focusing on divine protection. Join in praying for courage, strength, and faithfulness to God\'s will.',
  keywords: [
    'st joan of arc novena day 8',
    'st joan of arc prayer novena day 8',
    'day 8 st joan of arc novena',
    'divine protection st joan of arc'
  ],
  openGraph: {
    title: 'St. Joan of Arc Novena - Day 8: Divine Protection',
    description: 'Pray St. Joan of Arc Novena - Day 8 focusing on Divine Protection.',
    url: 'https://catholicbibleonline.com/novenas/st-joan-of-arc/day-8',
  },
  twitter: {
    title: 'St. Joan of Arc Novena - Day 8: Divine Protection',
    description: 'Pray St. Joan of Arc Novena - Day 8 focusing on Divine Protection.',
...
export default function StJoanOfArcNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Joan of Arc Novena – Day 8: Divine Protection
          </h1>
        ...
        <section className="bg-orange-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for St. Joan\'s continuing protection of God\'s people.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine protection. This aspect of honoring St. Joan of Arc helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Joan of Arc Novena - Day 8: Divine Protection" 
            url="/novenas/st-joan-of-arc/day-8"
            excerpt="Join me in praying St. Joan of Arc Novena - Day 8 focusing on divine protection." 
          />
        </div>
