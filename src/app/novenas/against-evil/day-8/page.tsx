...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena Against Evil - Day 8 focusing on virtue of perseverance. Join in praying for protection and triumph over evil.',
  keywords: [
    'novena against evil day 8',
    'evil prayer day 8',
    'day 8 evil novena',
    'virtue of perseverance evil protection'
  ],
  openGraph: {
    title: 'Novena Against Evil - Day 8: Virtue of Perseverance',
    description: 'Pray the Novena Against Evil - Day 8 focusing on Virtue of Perseverance.',
    url: 'https://catholicbibleonline.com/novenas/against-evil/day-8',
  },
  twitter: {
    title: 'Novena Against Evil - Day 8: Virtue of Perseverance',
    description: 'Pray the Novena Against Evil - Day 8 focusing on Virtue of Perseverance.',
...
export default function NovenaAgainstEvilDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Evil – Day 8: Virtue of Perseverance
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Virtue of Perseverance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for growth in the virtue of perseverance.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">You call us to be persistent in prayer even when it seems as if You do not hear us. In the battle against evil, it can be easy for us to become discouraged because the forces of evil seem so strong. We must grow in the virtue of perseverance as we fight against the work of the devil.</p>

              <p className="mb-4">Please bring about the triumph of Your goodness over all evil. And we particularly ask today that You help us and all people to grow in the virtue of perseverance.</p>

              <p className="mb-4">Help us to do all we can to grow in holiness. Give us the grace to submit ourselves fully to You in every circumstance.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on virtue of perseverance. This aspect of spiritual warfare helps us to grow in faith 
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/against-evil/day-9"
