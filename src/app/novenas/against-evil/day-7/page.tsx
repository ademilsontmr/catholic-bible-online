...
export const metadata: Metadata = {
  title: 'Novena Against Evil - Day 7: Virtue of Hope',
  description: 'Pray the Novena Against Evil - Day 7 focusing on virtue of hope. Join in praying for protection and triumph over evil.',
  keywords: [
    'novena against evil day 7',
    'evil prayer day 7',
    'day 7 evil novena',
    'virtue of hope evil protection'
  ],
  openGraph: {
    title: 'Novena Against Evil - Day 7: Virtue of Hope',
    description: 'Pray the Novena Against Evil - Day 7 focusing on Virtue of Hope.',
    url: 'https://catholicbibleonline.com/novenas/against-evil/day-7',
  },
  twitter: {
    title: 'Novena Against Evil - Day 7: Virtue of Hope',
    description: 'Pray the Novena Against Evil - Day 7 focusing on Virtue of Hope.',
...
export default function NovenaAgainstEvilDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Evil – Day 7: Virtue of Hope
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for growth in the virtue of hope.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">At times, the battle against evil can be very discouraging for us. It can seem that the devil is winning souls and that evil is running rampant in the world. As we continue to fight against evil even when we feel discouraged, we are in great need of hope for Your final victory over evil.</p>

              <p className="mb-4">Please bring about the triumph of Your goodness over all evil. And we particularly ask today that You help us and all people to grow in the virtue of hope.</p>

              <p className="mb-4">Help us to never become discouraged in the battle for souls. Give us the grace to rely on You for all that we need, even when we face great difficulties.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on virtue of hope. This aspect of spiritual warfare helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena Against Evil - Day 7: Virtue of Hope" 
            url="/novenas/against-evil/day-7"
            excerpt="Join me in praying the Novena Against Evil - Day 7 focusing on virtue of hope." 
          />
        </div>
