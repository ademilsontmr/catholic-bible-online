...
export const metadata: Metadata = {
  title: 'Novena Against Evil - Day 2: Grace of Repentance',
  description: 'Pray the Novena Against Evil - Day 2 focusing on grace of repentance. Join in praying for protection and triumph over evil.',
  keywords: [
    'novena against evil day 2',
    'evil prayer day 2',
    'day 2 evil novena',
    'grace of repentance evil protection'
  ],
  openGraph: {
    title: 'Novena Against Evil - Day 2: Grace of Repentance',
    description: 'Pray the Novena Against Evil - Day 2 focusing on Grace of Repentance.',
    url: 'https://catholicbibleonline.com/novenas/against-evil/day-2',
  },
  twitter: {
    title: 'Novena Against Evil - Day 2: Grace of Repentance',
    description: 'Pray the Novena Against Evil - Day 2 focusing on Grace of Repentance.',
...
export default function NovenaAgainstEvilDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Evil – Day 2: Grace of Repentance
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Grace of Repentance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day, we pray for the grace of repentance for those who regularly participate in evil acts.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">In our fallen world, there are many temptations to sin and many opportunities to do evil. Some people even become enmeshed in a lifestyle of sin and grave evil. Though the hold of sin can be very strong, You can help people overcome it.</p>

              <p className="mb-4">Please bring about the triumph of Your goodness over all evil. And we particularly ask today that You give the grace of repentance to all people who regularly participate in evil acts.</p>

              <p className="mb-4">Help us to never lose hope in this spiritual battle. Give us the grace to do all we can to combat evil in our world.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on grace of repentance. This aspect of spiritual warfare helps us to grow in faith 
        ...
        <ShareButton 
          title="Novena Against Evil - Day 2: Grace of Repentance"
          text="Join me in praying the Novena Against Evil - Day 2 focusing on grace of repentance."
        />
