...
export const metadata: Metadata = {
  title: 'Novena to St. Joseph - Day 6: Patron of Families',
  description: "Pray the Novena to St. Joseph - Day 6 focusing on Patron of Families. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 6',
    'st joseph novena day 6',
    'joseph novena day 6',
    'st joseph prayer day 6',
    'day 6 st joseph novena',
    'patron of families prayer',
    'st joseph novena patron of families',
    'joseph novena patron of families'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 6: Patron of Families',
    description: 'Pray the Novena to St. Joseph - Day 6 focusing on Patron of Families. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-6',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 6: Patron of Families',
    description: 'Pray the Novena to St. Joseph - Day 6 focusing on Patron of Families. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 6: Patron of Families
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patron of Families</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we focus on St. Joseph as the patron of families. He was the gentle head of the Holy Family, providing protection, guidance, and support. His family life at Nazareth was radiant with divine charity.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Saint Joseph, I venerate you as the gentle head of the Holy Family.</strong> The Holy Family was the scene of your life's work in its origin, in its guidance, in its protection, in your labor for Jesus and Mary, and even in your death in their arms. You lived, moved, and acted in the loving company of Jesus and Mary. Your family life at Nazareth was all radiant with the light of divine charity.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's patronage of families reminds us of the importance of family life and the need for strong, loving fathers. He helps all families to be sanctuaries of prayer, love, and work.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, patron of families, help me to build a holy family like yours. May your example of fatherhood and family life inspire me to create a home filled with love, prayer, and virtue. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Joseph - Day 6: Patron of Families" 
            url="/novenas/st-joseph/day-6"
            excerpt="Join me in praying the Novena to St. Joseph - Day 6 focusing on Patron of Families." 
          />
        </div>
