...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to St. Joseph - Day 9 focusing on Patron of a Happy Death. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 9',
    'st joseph novena day 9',
    'joseph novena day 9',
    'st joseph prayer day 9',
    'day 9 st joseph novena',
    'patron of a happy death prayer',
    'st joseph novena patron of a happy death',
    'joseph novena patron of a happy death'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 9: Patron of a Happy Death',
    description: 'Pray the Novena to St. Joseph - Day 9 focusing on Patron of a Happy Death. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-9',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 9: Patron of a Happy Death',
    description: 'Pray the Novena to St. Joseph - Day 9 focusing on Patron of a Happy Death. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay9Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 9: Patron of a Happy Death
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patron of a Happy Death</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on St. Joseph as the patron of a happy death. At the hour of his death, Jesus stood at his bedside with Mary. He died in their loving arms, accepting death in the spirit of loving submission to God's will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Saint Joseph, how fitting it was that at the hour of your death Jesus should stand at your bedside with Mary, the sweetness and hope of all mankind.</strong> You gave your entire life to the service of Jesus and Mary; at death you enjoyed the consolation of dying in Their loving arms. You accepted death in the spirit of loving submission to the Will of God, and this acceptance crowned your hidden life of virtue.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's happy death shows us the reward of a life lived in service to God. He helps us to prepare for death and to die in the arms of Jesus and Mary.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of St. Joseph. 
            May you always remember his powerful protection and his miraculous help in all your needs. 
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena to St. Joseph! As you continue your spiritual journey, 
            may your heart be filled with foster father love, virginal purity, divine selection, 
            faithful service, church patronage, family protection, worker blessing, suffering comfort, 
            and happy death grace. May St. Joseph continue to watch over you and work miracles in your life.
          </p>
        </section>
