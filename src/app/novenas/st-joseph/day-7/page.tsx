...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to St. Joseph - Day 7 focusing on Patron of Workers. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 7',
    'st joseph novena day 7',
    'joseph novena day 7',
    'st joseph prayer day 7',
    'day 7 st joseph novena',
    'patron of workers prayer',
    'st joseph novena patron of workers',
    'joseph novena patron of workers'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 7: Patron of Workers',
    description: 'Pray the Novena to St. Joseph - Day 7 focusing on Patron of Workers. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-7',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 7: Patron of Workers',
    description: 'Pray the Novena to St. Joseph - Day 7 focusing on Patron of Workers. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 7: Patron of Workers
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patron of Workers</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Joseph as the patron of workers. He devoted his time at Nazareth to the work of a carpenter, ennobling manual labor and teaching us to work for God and with God in the spirit of humility and prayer.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's work as a carpenter shows us that all honest work is dignified and pleasing to God. He teaches us to offer our labor as a prayer and sacrifice.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, patron of workers, help me to offer my work to God as you did. May your example of laboring with Jesus inspire me to work with love and dedication for God's glory. Amen.
          </p>
        </section>
