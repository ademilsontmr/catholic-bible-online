...
export const metadata: Metadata = {
  title: 'Novena to St. Joseph - Day 5: Patron of the Church',
  description: "Pray the Novena to St. Joseph - Day 5 focusing on Patron of the Church. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 5',
    'st joseph novena day 5',
    'joseph novena day 5',
    'st joseph prayer day 5',
    'day 5 st joseph novena',
    'patron of the church prayer',
    'st joseph novena patron of the church',
    'joseph novena patron of the church'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 5: Patron of the Church',
    description: 'Pray the Novena to St. Joseph - Day 5 focusing on Patron of the Church. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-5',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 5: Patron of the Church',
    description: 'Pray the Novena to St. Joseph - Day 5 focusing on Patron of the Church. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 5: Patron of the Church
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patron of the Church</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Joseph as the patron of the Catholic Church. God appointed him patron because he was the head of the Holy Family, the starting-point of the Church. He is the patriarch of patriarchs, the most venerable of all.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Saint Joseph, God has appointed you patron of the Catholic Church because you were the head of the Holy Family, the starting-point of the Church.</strong> You were the father, protector, guide and support of the Holy Family. For that reason you belong in a particular way to the Church, which was the purpose of the Holy Family's existence. You have a special relationship to the priesthood because you possessed a wonderful power over our Savior Himself.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's patronage of the Church shows us his continued care for God's people. He watches over the Church and intercedes for all its members, especially in times of need.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, patron of the Church, help me to be a faithful member of the Church and to contribute to its mission. May your protection and guidance help the Church to grow in holiness and love. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="Novena to St. Joseph - Day 5: Patron of the Church"
          text="Join me in praying the Novena to St. Joseph - Day 5 focusing on Patron of the Church."
        />
