...
export const metadata: Metadata = {
  title: 'Novena to St. Joseph - Day 4: Faithful Servant',
  description: "Pray the Novena to St. Joseph - Day 4 focusing on Faithful Servant. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 4',
    'st joseph novena day 4',
    'joseph novena day 4',
    'st joseph prayer day 4',
    'day 4 st joseph novena',
    'faithful servant prayer',
    'st joseph novena faithful servant',
    'joseph novena faithful servant'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 4: Faithful Servant',
    description: 'Pray the Novena to St. Joseph - Day 4 focusing on Faithful Servant. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-4',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 4: Faithful Servant',
    description: 'Pray the Novena to St. Joseph - Day 4 focusing on Faithful Servant. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 4: Faithful Servant
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Faithful Servant</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we focus on St. Joseph as a faithful servant. He lived for one purpose - to be the personal servant of Jesus Christ, the Word made flesh. His obedience was perfect, submitting to God, civil rulers, and his conscience.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's faithful service teaches us that true greatness comes from serving God and others. His obedience and devotion are models for all who seek to follow Christ.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, help me to be a faithful servant of God like you. May your example of perfect obedience and service inspire me to serve God and others with love and devotion. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Joseph - Day 4: Faithful Servant" 
            url="/novenas/st-joseph/day-4"
            excerpt="Join me in praying the Novena to St. Joseph - Day 4 focusing on Faithful Servant." 
          />
        </div>
