...
export const metadata: Metadata = {
  title: 'Novena to St. Joseph - Day 3: Man Chosen by the Blessed Trinity',
  description: "Pray the Novena to St. Joseph - Day 3 focusing on Man Chosen by the Blessed Trinity. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 3',
    'st joseph novena day 3',
    'joseph novena day 3',
    'st joseph prayer day 3',
    'day 3 st joseph novena',
    'man chosen by the blessed trinity prayer',
    'st joseph novena man chosen by the blessed trinity',
    'joseph novena man chosen by the blessed trinity'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 3: Man Chosen by the Blessed Trinity',
    description: 'Pray the Novena to St. Joseph - Day 3 focusing on Man Chosen by the Blessed Trinity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-3',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 3: Man Chosen by the Blessed Trinity',
    description: 'Pray the Novena to St. Joseph - Day 3 focusing on Man Chosen by the Blessed Trinity. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 3: Man Chosen by the Blessed Trinity
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Man Chosen by the Blessed Trinity</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Joseph as the man chosen by the Blessed Trinity. He was selected by God the Father, chosen by God the Son, and guided by the Holy Spirit in his exalted vocation as foster-father of Jesus and head of the Holy Family.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Saint Joseph, you were the man chosen by God the Father.</strong> He selected you to be His representative on earth, hence He granted you all the graces and blessings you needed to be His worthy representative. You were the man chosen by God the Son. Desirous of a worthy foster-father, He added His own riches and gifts, and above all, His love. You were chosen by the Holy Spirit. He is the mutual Love of the Father and the Son -- the heart of the Holy Trinity.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's selection by the Blessed Trinity shows us that God has a special plan for each of us. His cooperation with God's will made him the holiest of saints after Mary.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, help me to recognize God's plan for my life as you did. May your example of being chosen by the Blessed Trinity inspire me to cooperate fully with God's will. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Joseph - Day 3: Man Chosen by the Blessed Trinity" 
            url="/novenas/st-joseph/day-3"
            excerpt="Join me in praying the Novena to St. Joseph - Day 3 focusing on Man Chosen by the Blessed Trinity." 
          />
        </div>
