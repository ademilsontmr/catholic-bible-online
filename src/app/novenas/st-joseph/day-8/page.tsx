...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to St. Joseph - Day 8 focusing on Friend in Suffering. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 8',
    'st joseph novena day 8',
    'joseph novena day 8',
    'st joseph prayer day 8',
    'day 8 st joseph novena',
    'friend in suffering prayer',
    'st joseph novena friend in suffering',
    'joseph novena friend in suffering'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 8: Friend in Suffering',
    description: 'Pray the Novena to St. Joseph - Day 8 focusing on Friend in Suffering. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-8',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 8: Friend in Suffering',
    description: 'Pray the Novena to St. Joseph - Day 8 focusing on Friend in Suffering. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 8: Friend in Suffering
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Friend in Suffering</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we focus on St. Joseph as a friend in suffering. His share of suffering was great because of his close union with the Divine Savior. He bore all suffering in a truly Christ-like manner, submitting to God's will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Saint Joseph, your share of suffering was very great because of your close union with the Divine Savior.</strong> All the mysteries of His life were more or less mysteries of suffering. Poverty pressed upon you, and the cross of labor followed you everywhere. Nor were you spared domestic crosses, owing to misunderstandings in regard to the holiest and most cherished of all beings, Jesus and Mary, who were all to you.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's example in suffering teaches us to accept trials with faith and patience. He is a faithful friend to all who turn to him in distress and need.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, friend in suffering, help me to bear my trials with patience and faith like you. May your example of accepting suffering inspire me to trust in God's plan for my life. Amen.
          </p>
        </section>
