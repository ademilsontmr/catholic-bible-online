...
export const metadata: Metadata = {
  title: 'Novena to St. Joseph - Day 2: Virginal Husband of Mary',
  description: "Pray the Novena to St. Joseph - Day 2 focusing on Virginal Husband of Mary. Join in praying the traditional novena to seek St. Joseph's intercession.",
  keywords: [
    'novena to st joseph day 2',
    'st joseph novena day 2',
    'joseph novena day 2',
    'st joseph prayer day 2',
    'day 2 st joseph novena',
    'virginal husband of mary prayer',
    'st joseph novena virginal husband of mary',
    'joseph novena virginal husband of mary'
  ],
  openGraph: {
    title: 'Novena to St. Joseph - Day 2: Virginal Husband of Mary',
    description: 'Pray the Novena to St. Joseph - Day 2 focusing on Virginal Husband of Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-joseph/day-2',
  },
  twitter: {
    title: 'Novena to St. Joseph - Day 2: Virginal Husband of Mary',
    description: 'Pray the Novena to St. Joseph - Day 2 focusing on Virginal Husband of Mary. Join in praying the traditional novena.',
...
export default function StJosephNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Joseph – Day 2: Virginal Husband of Mary
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Virginal Husband of Mary</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day of our novena, we focus on St. Joseph as the virginal husband of Mary. Their marriage was a sacred contract by which they gave themselves to each other, and St. Joseph was the protector and witness of Mary's virginity.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Joseph's virginal marriage to Mary shows us the beauty of pure love and the sanctity of marriage. His respect for Mary's virginity and his own purity are models for all married couples.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Joseph, help me to imitate your pure and holy marriage to Mary. May your example of virginal love and respect inspire me to live a life of purity and holiness. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="Novena to St. Joseph - Day 2: Virginal Husband of Mary"
          text="Join me in praying the Novena to St. Joseph - Day 2 focusing on Virginal Husband of Mary."
        />
