...
export const metadata: Metadata = {
  title: 'Novena Against Fear - Day 8: Virtue of Courage',
  description: 'Pray the Novena Against Fear - Day 8 focusing on virtue of courage. Join in praying for courage and freedom from fear.',
  keywords: [
    'novena against fear day 8',
    'fear prayer day 8',
    'day 8 fear novena',
    'virtue of courage fear courage'
  ],
  openGraph: {
    title: 'Novena Against Fear - Day 8: Virtue of Courage',
    description: 'Pray the Novena Against Fear - Day 8 focusing on Virtue of Courage.',
    url: 'https://catholicbibleonline.com/novenas/against-fear/day-8',
  },
  twitter: {
    title: 'Novena Against Fear - Day 8: Virtue of Courage',
    description: 'Pray the Novena Against Fear - Day 8 focusing on Virtue of Courage.',
...
export default function NovenaAgainstFearDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Fear – Day 8: Virtue of Courage
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Virtue of Courage</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for help to practice the virtue of courage.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Many of us do not fully understand the great heights of virtue You call us to practice in our lives. It can be easy for us to become discouraged as we try to practice courage over our fears, and we might even begin to think we are not able to be courageous.</p>

              <p className="mb-4">We pray for Your help against our fear, and we particularly ask today that You help all people who do not think they can practice the virtue of courage.</p>

              <p className="mb-4">Help us to rely on You through every discouragement we face in our lives. Give us the grace to submit our lives fully to You, even in the midst of great difficulties.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on virtue of courage. This aspect of overcoming fear helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena Against Fear - Day 8: Virtue of Courage" 
            url="/novenas/against-fear/day-8"
            excerpt="Join me in praying the Novena Against Fear - Day 8 focusing on virtue of courage." 
          />
        </div>
