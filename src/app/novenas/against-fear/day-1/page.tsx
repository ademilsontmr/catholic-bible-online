...
export const metadata: Metadata = {
  title: 'Novena Against Fear - Day 1: True Courage',
  description: 'Pray the Novena Against Fear - Day 1 focusing on true courage. Join in praying for courage and freedom from fear.',
  keywords: [
    'novena against fear day 1',
    'fear prayer day 1',
    'day 1 fear novena',
    'true courage fear courage'
  ],
  openGraph: {
    title: 'Novena Against Fear - Day 1: True Courage',
    description: 'Pray the Novena Against Fear - Day 1 focusing on True Courage.',
    url: 'https://catholicbibleonline.com/novenas/against-fear/day-1',
  },
  twitter: {
    title: 'Novena Against Fear - Day 1: True Courage',
    description: 'Pray the Novena Against Fear - Day 1 focusing on True Courage.',
...
export default function NovenaAgainstFearDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Fear – Day 1: True Courage
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying the Novena Against Fear to seek courage and freedom from fear.
          </p>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: True Courage</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena Against Fear, we pray for help to grow in true courage in the face of fear.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">You are all good, and we know that You care for each one of our needs. But even when we know this, it is not always easy to put a stop to our fears. There are many things we might fear in our fallen world, but You can help us to have true courage in the face of fear.</p>

              <p className="mb-4">We pray for Your help against our fear, and we particularly ask today that You help us and all who struggle with fear to grow in true courage.</p>

              <p className="mb-4">Help us to grow in every virtue we need for holiness. Give us the grace to put our holiness and our relationship with You above all else in our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on true courage. This aspect of overcoming fear helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena Against Fear - Day 1: True Courage" 
            url="/novenas/against-fear/day-1"
            excerpt="Join me in praying the Novena Against Fear - Day 1 focusing on true courage." 
          />
        </div>
