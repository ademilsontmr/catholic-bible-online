...
export const metadata: Metadata = {
  title: 'Novena Against Fear - Day 7: Prayer Life',
  description: 'Pray the Novena Against Fear - Day 7 focusing on prayer life. Join in praying for courage and freedom from fear.',
  keywords: [
    'novena against fear day 7',
    'fear prayer day 7',
    'day 7 fear novena',
    'prayer life fear courage'
  ],
  openGraph: {
    title: 'Novena Against Fear - Day 7: Prayer Life',
    description: 'Pray the Novena Against Fear - Day 7 focusing on Prayer Life.',
    url: 'https://catholicbibleonline.com/novenas/against-fear/day-7',
  },
  twitter: {
    title: 'Novena Against Fear - Day 7: Prayer Life',
    description: 'Pray the Novena Against Fear - Day 7 focusing on Prayer Life.',
...
export default function NovenaAgainstFearDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Fear – Day 7: Prayer Life
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Prayer Life</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for help when fear interferes in relationship with God.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">You call each one of us to have an intimate relationship with You. There are many things in our lives that can interfere with our prayer lives and can cause difficulties in our relationship with You. When we are struggling with excessive fear, our prayer life can have a lot of difficulties.</p>

              <p className="mb-4">We pray for Your help against our fear, and we particularly ask today that You help all people whose fear is interfering in their relationship with You.</p>

              <p className="mb-4">Help us to always make our relationship with You our top priority in life. Each day, give us the grace to surrender to You all difficulties we face.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on prayer life. This aspect of overcoming fear helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena Against Fear - Day 7: Prayer Life" 
            url="/novenas/against-fear/day-7"
            excerpt="Join me in praying the Novena Against Fear - Day 7 focusing on prayer life." 
          />
        </div>
