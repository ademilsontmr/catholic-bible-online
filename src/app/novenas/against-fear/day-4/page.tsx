...
export const metadata: Metadata = {
  title: 'Novena Against Fear - Day 4: Perseverance',
  description: 'Pray the Novena Against Fear - Day 4 focusing on perseverance. Join in praying for courage and freedom from fear.',
  keywords: [
    'novena against fear day 4',
    'fear prayer day 4',
    'day 4 fear novena',
    'perseverance fear courage'
  ],
  openGraph: {
    title: 'Novena Against Fear - Day 4: Perseverance',
    description: 'Pray the Novena Against Fear - Day 4 focusing on Perseverance.',
    url: 'https://catholicbibleonline.com/novenas/against-fear/day-4',
  },
  twitter: {
    title: 'Novena Against Fear - Day 4: Perseverance',
    description: 'Pray the Novena Against Fear - Day 4 focusing on Perseverance.',
...
export default function NovenaAgainstFearDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena Against Fear – Day 4: Perseverance
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for perseverance in the battle against fear.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">The battle against harmful fears can be very difficult at times. You call us to place our trust in You and to fight against undue fear in our lives, but we must persevere in order to be successful against fear.</p>

              <p className="mb-4">We pray for Your help against our fear, and we particularly ask today that You help us and all who struggle with fear to grow in perseverance in the battle against fear.</p>

              <p className="mb-4">Help us to do all we can to be able to serve You as You call us to. Give us the grace to serve You worthily no matter what difficulties we might face.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on perseverance. This aspect of overcoming fear helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena Against Fear - Day 4: Perseverance" 
            url="/novenas/against-fear/day-4"
            excerpt="Join me in praying the Novena Against Fear - Day 4 focusing on perseverance." 
          />
        </div>
