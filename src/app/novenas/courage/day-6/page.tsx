...
export const metadata: Metadata = {
  title: 'Novena for Courage - Day 6: Obedience',
  description: 'Pray the Novena for Courage - Day 6 focusing on Obedience. Join in praying the traditional novena to seek God\'s strength and courage.',
  keywords: [
    'novena for courage day 6',
    'courage novena day 6',
    'obedience prayer courage',
    'catholic prayer for obedience',
    'novena for courage prayer',
    'day 6 courage novena',
    'obedience god courage',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Courage - Day 6: Obedience',
    description: 'Pray the Novena for Courage - Day 6 focusing on Obedience. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/courage/day-6',
  },
  twitter: {
    title: 'Novena for Courage - Day 6: Obedience',
    description: 'Pray the Novena for Courage - Day 6 focusing on Obedience. Join in praying the traditional novena.',
...
export default function NovenaForCourageDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Courage – Day 6: Obedience
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this sixth day of the Novena for Courage, we pray for obedience in God's plan and His ability
            to grant us courage. We focus particularly on facing persecution for faith and ask God to help us grow in obedience and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">We can face many difficulties in our lives on account of our Faith. Sometimes, we even face the possibility of great suffering because of our Faith. When we face such persecution for our Faith, we often need great courage to persevere.</p>
              <p className="mb-6">We ask You to bless and assist all who are in need of courage, and we particularly ask You today to grant courage to all who are being persecuted for their Faith!</p>
              <p className="mb-6">Help us to grow stronger in our Faith each day of our lives. Help our love for You grow deeper and more intimate at every opportunity.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for obedience in God's plan and His ability to grant us courage in all situations.
                Obedience is the foundation of our relationship with God and the key to finding strength in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on facing persecution for faith reminds us that courage is not just about physical bravery, but about 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all courage, increase our obedience in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Courage - Day 6: Obedience" 
            url="/novenas/courage/day-6"
            excerpt="Join me in praying the Novena for Courage - Day 6 focusing on Obedience." 
          />
        </div>
