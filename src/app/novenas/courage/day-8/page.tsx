...
export const metadata: Metadata = {
  title: 'Novena for Courage - Day 8: Intercession',
  description: 'Pray the Novena for Courage - Day 8 focusing on Intercession. Join in praying the traditional novena to seek God\'s strength and courage.',
  keywords: [
    'novena for courage day 8',
    'courage novena day 8',
    'intercession prayer courage',
    'catholic prayer for intercession',
    'novena for courage prayer',
    'day 8 courage novena',
    'intercession god courage',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Courage - Day 8: Intercession',
    description: 'Pray the Novena for Courage - Day 8 focusing on Intercession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/courage/day-8',
  },
  twitter: {
    title: 'Novena for Courage - Day 8: Intercession',
    description: 'Pray the Novena for Courage - Day 8 focusing on Intercession. Join in praying the traditional novena.',
...
export default function NovenaForCourageDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Courage – Day 8: Intercession
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day of the Novena for Courage, we pray for intercession in God's plan and His ability
            to grant us courage. We focus particularly on overcoming past failures and ask God to help us grow in intercession and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">It is often very difficult to be courageous in the face of physical danger or other threats to our happiness. We do not always act with virtue when we're faced with such difficulties, but You can help us to act courageously at every opportunity we face from now on.</p>
              <p className="mb-6">We ask You to bless and assist all who are in need of courage, and we particularly ask You today to grant courage to all who have wavered in courage in the past!</p>
              <p className="mb-6">Help us to strive for holiness and growth in virtue each day. Help us to devote ourselves more fully to You at every opportunity.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for intercession in God's plan and His ability to grant us courage in all situations.
                Intercession is the foundation of our relationship with God and the key to finding strength in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on overcoming past failures reminds us that courage is not just about physical bravery, but about 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all courage, increase our intercession in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Courage - Day 8: Intercession" 
            url="/novenas/courage/day-8"
            excerpt="Join me in praying the Novena for Courage - Day 8 focusing on Intercession." 
          />
        </div>
