...
export const metadata: Metadata = {
  title: 'Novena for Courage - Day 4: Humility',
  description: 'Pray the Novena for Courage - Day 4 focusing on Humility. Join in praying the traditional novena to seek God\'s strength and courage.',
  keywords: [
    'novena for courage day 4',
    'courage novena day 4',
    'humility prayer courage',
    'catholic prayer for humility',
    'novena for courage prayer',
    'day 4 courage novena',
    'humility god courage',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Courage - Day 4: Humility',
    description: 'Pray the Novena for Courage - Day 4 focusing on Humility. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/courage/day-4',
  },
  twitter: {
    title: 'Novena for Courage - Day 4: Humility',
    description: 'Pray the Novena for Courage - Day 4 focusing on Humility. Join in praying the traditional novena.',
...
export default function NovenaForCourageDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Courage – Day 4: Humility
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Novena for Courage, we pray for humility in God's plan and His ability
            to grant us courage. We focus particularly on fighting against addiction and ask God to help us grow in humility and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">Courage is an important virtue that can help us overcome many difficulties and sins in our lives. You know well how much we are in need of courage, especially those of us who must fight against such things as addiction.</p>
              <p className="mb-6">We ask You to bless and assist all who are in need of courage, and we particularly ask You today to grant courage to all who must fight against addiction!</p>
              <p className="mb-6">Help us to rely on You more fully, no matter what difficulties we might be facing in our lives. Help us to grow in our love for You each day.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for humility in God's plan and His ability to grant us courage in all situations.
                Humility is the foundation of our relationship with God and the key to finding strength in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on fighting against addiction reminds us that courage is not just about physical bravery, but about 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all courage, increase our humility in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Courage - Day 4: Humility" 
            url="/novenas/courage/day-4"
            excerpt="Join me in praying the Novena for Courage - Day 4 focusing on Humility." 
          />
        </div>
