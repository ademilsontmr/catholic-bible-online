...
export const metadata: Metadata = {
  title: 'Novena for Courage - Day 3: Love',
  description: 'Pray the Novena for Courage - Day 3 focusing on Love. Join in praying the traditional novena to seek God\'s strength and courage.',
  keywords: [
    'novena for courage day 3',
    'courage novena day 3',
    'love prayer courage',
    'catholic prayer for love',
    'novena for courage prayer',
    'day 3 courage novena',
    'love god courage',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Courage - Day 3: Love',
    description: 'Pray the Novena for Courage - Day 3 focusing on Love. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/courage/day-3',
  },
  twitter: {
    title: 'Novena for Courage - Day 3: Love',
    description: 'Pray the Novena for Courage - Day 3 focusing on Love. Join in praying the traditional novena.',
...
export default function NovenaForCourageDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day of the Novena for Courage, we pray for love in God's plan and His ability
            to grant us courage. We focus particularly on ending harmful relationships and ask God to help us grow in love and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">There are many reasons we might be in need of courage in our lives, and many difficult circumstances that we must confront for our own spiritual and temporal good. You sometimes call us to have the courage to cut off relationships with those who are harmful to us.</p>
              <p className="mb-6">We ask You to bless and assist all who are in need of courage, and we particularly ask You today to grant courage to all who must end harmful relationships in their lives!</p>
              <p className="mb-6">Help us to offer all sufferings in union with You each day. Help us to grow in all the virtues needed for holiness.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for love in God's plan and His ability to grant us courage in all situations.
                Love is the foundation of our relationship with God and the key to finding strength in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on ending harmful relationships reminds us that courage is not just about physical bravery, but about 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all courage, increase our love in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Courage - Day 3: Love" 
            url="/novenas/courage/day-3"
            excerpt="Join me in praying the Novena for Courage - Day 3 focusing on Love." 
          />
        </div>
