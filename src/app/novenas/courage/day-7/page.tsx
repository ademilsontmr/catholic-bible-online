...
export const metadata: Metadata = {
  title: 'Novena for Courage - Day 7: Perseverance',
  description: 'Pray the Novena for Courage - Day 7 focusing on Perseverance. Join in praying the traditional novena to seek God\'s strength and courage.',
  keywords: [
    'novena for courage day 7',
    'courage novena day 7',
    'perseverance prayer courage',
    'catholic prayer for perseverance',
    'novena for courage prayer',
    'day 7 courage novena',
    'perseverance god courage',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Courage - Day 7: Perseverance',
    description: 'Pray the Novena for Courage - Day 7 focusing on Perseverance. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/courage/day-7',
  },
  twitter: {
    title: 'Novena for Courage - Day 7: Perseverance',
    description: 'Pray the Novena for Courage - Day 7 focusing on Perseverance. Join in praying the traditional novena.',
...
export default function NovenaForCourageDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Courage – Day 7: Perseverance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day of the Novena for Courage, we pray for perseverance in God's plan and His ability
            to grant us courage. We focus particularly on following God's call and ask God to help us grow in perseverance and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">You often call us to paths that seem frightening to us during our lives. You truly know what is best for us, but we are often in need of great courage to truly surrender ourselves to Your will and to follow Your call.</p>
              <p className="mb-6">We ask You to bless and assist all who are in need of courage, and we particularly ask You today to grant courage to all who are struggling to follow God's call in their lives!</p>
              <p className="mb-6">Help us to trust You more fully each day. Help us to grow stronger in our desire to serve You.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for perseverance in God's plan and His ability to grant us courage in all situations.
                Perseverance is the foundation of our relationship with God and the key to finding strength in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on following God's call reminds us that courage is not just about physical bravery, but about 
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all courage, increase our perseverance in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Courage - Day 7: Perseverance" 
            url="/novenas/courage/day-7"
            excerpt="Join me in praying the Novena for Courage - Day 7 focusing on Perseverance." 
          />
        </div>
