...
export const metadata: Metadata = {
  title: 'Novena in Honor of Saint John Marie Vianney - Day 7: Victory Over Temptation',
  description: "Pray the Novena in Honor of Saint John Marie Vianney - Day 7 focusing on Victory Over Temptation. Join in praying the traditional novena to seek St. John Vianney's intercession.",
  keywords: [
    'novena in honor of saint john marie vianney day 7',
    'st john vianney novena day 7',
    'john vianney novena day 7',
    'st john vianney prayer day 7',
    'day 7 st john vianney novena',
    'victory over temptation prayer',
    'st john vianney novena victory over temptation',
    'john vianney novena victory over temptation'
  ],
  openGraph: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 7: Victory Over Temptation',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 7 focusing on Victory Over Temptation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-vianney/day-7',
  },
  twitter: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 7: Victory Over Temptation',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 7 focusing on Victory Over Temptation. Join in praying the traditional novena.',
...
export default function StJohnVianneyNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of Saint John Marie Vianney – Day 7: Victory Over Temptation
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Victory Over Temptation</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on St. John Vianney's victory over the devil's attacks. Despite the infamous attacks and trials that disheartened him, he did not give up his sublime task of converting souls.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Vianney's victory over temptation shows us that through mortification and prayer, we can overcome the devil's attacks. His example teaches us to be vigilant against the tempter's desire to harm our souls.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint John Marie Vianney, help me to overcome temptation as you did. May your victory through mortification and prayer give me strength against the devil's attacks. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena in Honor of Saint John Marie Vianney - Day 7: Victory Over Temptation" 
            url="/novenas/st-john-vianney/day-7"
            excerpt="Join me in praying the Novena in Honor of Saint John Marie Vianney - Day 7 focusing on Victory Over Temptation." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-john-vianney/day-6"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Eucharistic Devotion
          </Link>
