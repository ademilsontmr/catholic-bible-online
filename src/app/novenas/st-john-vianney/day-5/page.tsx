...
export const metadata: Metadata = {
  title: 'Novena in Honor of Saint John Marie Vianney - Day 5: Frequent Confession',
  description: "Pray the Novena in Honor of Saint John Marie Vianney - Day 5 focusing on Frequent Confession. Join in praying the traditional novena to seek St. John Vianney's intercession.",
  keywords: [
    'novena in honor of saint john marie vianney day 5',
    'st john vianney novena day 5',
    'john vianney novena day 5',
    'st john vianney prayer day 5',
    'day 5 st john vianney novena',
    'frequent confession prayer',
    'st john vianney novena frequent confession',
    'john vianney novena frequent confession'
  ],
  openGraph: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 5: Frequent Confession',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 5 focusing on Frequent Confession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-vianney/day-5',
  },
  twitter: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 5: Frequent Confession',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 5 focusing on Frequent Confession. Join in praying the traditional novena.',
...
export default function StJohnVianneyNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of Saint John Marie Vianney – Day 5: Frequent Confession
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on St. John Vianney's understanding of the importance of a good confession for the Christian life. He spent up to 15 to 16 hours in the confessional to procure the happy fruits for millions of souls.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Vianney's dedication to the sacrament of confession teaches us the importance of frequent confession, proper preparation, and sincere regret for our sins. This sacrament assures us of God's grace and mercy.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint John Marie Vianney, help me to develop the habit of frequent confession. May your dedication to this sacrament inspire me to approach it with proper preparation and sincere regret. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena in Honor of Saint John Marie Vianney - Day 5: Frequent Confession" 
            url="/novenas/st-john-vianney/day-5"
            excerpt="Join me in praying the Novena in Honor of Saint John Marie Vianney - Day 5 focusing on Frequent Confession." 
          />
        </div>
