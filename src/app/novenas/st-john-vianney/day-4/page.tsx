...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena in Honor of Saint John Marie Vianney - Day 4 focusing on Horror of Sin. Join in praying the traditional novena to seek St. John Vianney's intercession.",
  keywords: [
    'novena in honor of saint john marie vianney day 4',
    'st john vianney novena day 4',
    'john vianney novena day 4',
    'st john vianney prayer day 4',
    'day 4 st john vianney novena',
    'horror of sin prayer',
    'st john vianney novena horror of sin',
    'john vianney novena horror of sin'
  ],
  openGraph: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 4: Horror of Sin',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 4 focusing on Horror of Sin. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-vianney/day-4',
  },
  twitter: {
    title: 'Novena in Honor of Saint John Marie Vianney - Day 4: Horror of Sin',
    description: 'Pray the Novena in Honor of Saint John Marie Vianney - Day 4 focusing on Horror of Sin. Join in praying the traditional novena.',
...
export default function StJohnVianneyNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of Saint John Marie Vianney – Day 4: Horror of Sin
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Horror of Sin</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. John Vianney's adamant stance against sin, yet his sympathy and readiness to welcome the sinner. He wanted us first to avoid the occasion of sin and to break bad habits.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Vianney's horror of sin reminds us of the importance of avoiding occasions of sin and examining our conscience regularly. His mercy towards sinners shows us God's infinite love and forgiveness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint John Marie Vianney, help me to develop a horror of sin and to avoid occasions of sin. May your mercy towards sinners remind me of God's infinite love and forgiveness. Amen.
          </p>
        </section>
