...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 6: Charity to Parents',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 6 focusing on charity to parents. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 6',
    'nativity mary novena day 6',
    'day 6 nativity blessed virgin mary novena',
    'charity to parents mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 6: Charity to Parents',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 6 focusing on Charity to Parents.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-6',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 6: Charity to Parents',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 6 focusing on Charity to Parents.',
...
export default function NativityBlessedVirginMaryNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 6: Charity to Parents
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Charity to Parents</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for greater charity to our parents and grandparents.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on charity to parents. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 6: Charity to Parents" 
            url="/novenas/nativity-blessed-virgin-mary/day-6"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 6 focusing on charity to parents." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/nativity-blessed-virgin-mary/day-7"
