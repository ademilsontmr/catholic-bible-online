...
export const metadata: Metadata = {
  ...
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 3 focusing on daughter of saints. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 3',
    'nativity mary novena day 3',
    'day 3 nativity blessed virgin mary novena',
    'daughter of saints mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 3: Daughter of Saints',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 3 focusing on Daughter of Saints.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-3',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 3: Daughter of Saints',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 3 focusing on Daughter of Saints.',
...
export default function NativityBlessedVirginMaryNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 3: Daughter of Saints
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Daughter of Saints</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we pray for devotion to the Precious Blood and honor Mary as the daughter of Saints Joachim and Anne.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on daughter of saints. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
