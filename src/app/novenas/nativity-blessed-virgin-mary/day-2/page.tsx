...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 2: Daughter of Adam',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 2 focusing on daughter of adam. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 2',
    'nativity mary novena day 2',
    'day 2 nativity blessed virgin mary novena',
    'daughter of adam mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 2: Daughter of Adam',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 2 focusing on Daughter of Adam.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-2',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 2: Daughter of Adam',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 2 focusing on Daughter of Adam.',
...
export default function NativityBlessedVirginMaryNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 2: Daughter of Adam
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Daughter of Adam</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day, we pray for new life through Mary's Son and honor her as the daughter of Adam.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on daughter of adam. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 2: Daughter of Adam" 
            url="/novenas/nativity-blessed-virgin-mary/day-2"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 2 focusing on daughter of adam." 
          />
        </div>
