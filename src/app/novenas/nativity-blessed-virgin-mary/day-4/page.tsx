...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 4: Daughter of Israel',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 4 focusing on daughter of israel. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 4',
    'nativity mary novena day 4',
    'day 4 nativity blessed virgin mary novena',
    'daughter of israel mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 4: Daughter of Israel',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 4 focusing on Daughter of Israel.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-4',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 4: Daughter of Israel',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 4 focusing on Daughter of Israel.',
...
export default function NativityBlessedVirginMaryNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 4: Daughter of Israel
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Continue praying the Nativity of the Blessed Virgin Mary Novena to honor Mary's birth and grow in family holiness.
          </p>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Daughter of Israel</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for love and devotion to our parents and honor Mary as the daughter of Israel.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Oh most holy daughter of Israel, the Redeemer of the world loves you with the singular love of a Child for His mother. Pray for me today that the feast of your birth may give great joy to my soul that I may have a greater love and devotion to my Mother and Father.
              </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on daughter of israel. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 4: Daughter of Israel" 
            url="/novenas/nativity-blessed-virgin-mary/day-4"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 4 focusing on daughter of israel." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/nativity-blessed-virgin-mary/day-3"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 3: Daughter of Saints
          </Link>
          
          
          
          <Link 
            href="/novenas/nativity-blessed-virgin-mary/day-5"
            className="inline-flex items-center px-6 py-3 bg-pink-600 text-white rounded-md hover:bg-pink-700 transition-colors"
          >
            Day 5: Preserved by Holy Spirit →
          </Link>
