...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 5: Preserved by Holy Spirit',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 5 focusing on preserved by holy spirit. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 5',
    'nativity mary novena day 5',
    'day 5 nativity blessed virgin mary novena',
    'preserved by holy spirit mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 5: Preserved by Holy Spirit',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 5 focusing on Preserved by Holy Spirit.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-5',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 5: Preserved by Holy Spirit',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 5 focusing on Preserved by Holy Spirit.',
...
export default function NativityBlessedVirginMaryNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 5: Preserved by Holy Spirit
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Preserved by Holy Spirit</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for faithfulness to Mary's Son and honor her preservation by the Holy Spirit.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on preserved by holy spirit. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 5: Preserved by Holy Spirit" 
            url="/novenas/nativity-blessed-virgin-mary/day-5"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 5 focusing on preserved by holy spirit." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/nativity-blessed-virgin-mary/day-4"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 4: Daughter of Israel
          </Link>
          
          
          
          <Link 
            href="/novenas/nativity-blessed-virgin-mary/day-6"
            className="inline-flex items-center px-6 py-3 bg-pink-600 text-white rounded-md hover:bg-pink-700 transition-colors"
          >
            Day 6: Charity to Parents →
          </Link>
