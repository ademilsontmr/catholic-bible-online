...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 7: Joy to Angels',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 7 focusing on joy to angels. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 7',
    'nativity mary novena day 7',
    'day 7 nativity blessed virgin mary novena',
    'joy to angels mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 7: Joy to Angels',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 7 focusing on Joy to Angels.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-7',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 7: Joy to Angels',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 7 focusing on Joy to Angels.',
...
export default function NativityBlessedVirginMaryNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 7: Joy to Angels
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Joy to Angels</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for graces to rain down on all married couples.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on joy to angels. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 7: Joy to Angels" 
            url="/novenas/nativity-blessed-virgin-mary/day-7"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 7 focusing on joy to angels." 
          />
        </div>
