...
export const metadata: Metadata = {
  title: 'Nativity of the Blessed Virgin Mary Novena - Day 8: Joy to the World',
  description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 8 focusing on joy to the world. Join in praying for family holiness and stronger marriages.',
  keywords: [
    'nativity blessed virgin mary novena day 8',
    'nativity mary novena day 8',
    'day 8 nativity blessed virgin mary novena',
    'joy to the world mary nativity'
  ],
  openGraph: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 8: Joy to the World',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 8 focusing on Joy to the World.',
    url: 'https://catholicbibleonline.com/novenas/nativity-blessed-virgin-mary/day-8',
  },
  twitter: {
    title: 'Nativity of the Blessed Virgin Mary Novena - Day 8: Joy to the World',
    description: 'Pray the Nativity of the Blessed Virgin Mary Novena - Day 8 focusing on Joy to the World.',
...
export default function NativityBlessedVirginMaryNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Nativity of the Blessed Virgin Mary Novena – Day 8: Joy to the World
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Joy to the World</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for patience with our family and loved ones.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on joy to the world. This aspect of honoring the Nativity of the Blessed Virgin Mary helps us to grow in family holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Nativity of the Blessed Virgin Mary Novena - Day 8: Joy to the World" 
            url="/novenas/nativity-blessed-virgin-mary/day-8"
            excerpt="Join me in praying the Nativity of the Blessed Virgin Mary Novena - Day 8 focusing on joy to the world." 
          />
        </div>
