...
export const metadata: Metadata = {
  title: 'Novena for Students - Day 8: Desire for Holy Knowledge',
  description: 'Pray the Novena for Students - Day 8 focusing on desire for holy knowledge. Join in praying for academic success and spiritual growth.',
  keywords: [
    'novena for students day 8',
    'student prayer day 8',
    'day 8 student novena',
    'desire for holy knowledge student prayer'
  ],
  openGraph: {
    title: 'Novena for Students - Day 8: Desire for Holy Knowledge',
    description: 'Pray the Novena for Students - Day 8 focusing on Desire for Holy Knowledge.',
    url: 'https://catholic-bible-online.com/novenas/students/day-8',
  },
  twitter: {
    title: 'Novena for Students - Day 8: Desire for Holy Knowledge',
    description: 'Pray the Novena for Students - Day 8 focusing on Desire for Holy Knowledge.',
...
export default function NovenaForStudentsDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Students – Day 8: Desire for Holy Knowledge
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Desire for Holy Knowledge</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for desire to know God better through learning and study.
          </p>
        </section>
...
Amen.</strong>
              ...
              <p className="mb-4">We can never fully know all that there is to know about You. We should seek to continue learning more about You throughout our entire lives so that we can grow in our relationship with You. You can inspire us with the desire to know You better.</p>

<p className="mb-4">Please bless and assist all students. And we particularly ask today that You help us and all students to grow in the desire for holy knowledge!</p>

<p className="mb-4">Help us to always strive to serve You more devotedly each day of our lives. Give us the grace to do whatever is necessary for our growth in holiness.</p>
...
Amen.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on desire for holy knowledge. This aspect of student life helps us to grow spiritually 
        ...
        <ShareButton 
          title="Novena for Students - Day 8: Desire for Holy Knowledge"
          text="Join me in praying the Novena for Students - Day 8 focusing on desire for holy knowledge."
        />
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/students/day-9"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 9: Offering Studies to God →
          </Link>
