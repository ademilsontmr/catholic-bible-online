...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for Students - Day 1 focusing on gratitude for learning. Join in praying for academic success and spiritual growth.',
  keywords: [
    'novena for students day 1',
    'student prayer day 1',
    'day 1 student novena',
    'gratitude for learning student prayer'
  ],
  openGraph: {
    title: 'Novena for Students - Day 1: Gratitude for Learning',
    description: 'Pray the Novena for Students - Day 1 focusing on Gratitude for Learning.',
    url: 'https://catholic-bible-online.com/novenas/students/day-1',
  },
  twitter: {
    title: 'Novena for Students - Day 1: Gratitude for Learning',
    description: 'Pray the Novena for Students - Day 1 focusing on Gratitude for Learning.',
...
export default function NovenaForStudentsDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Students – Day 1: Gratitude for Learning
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying the Novena for Students to seek God's guidance and wisdom for academic success.
          </p>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Gratitude for Learning</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Students, we pray for gratitude for the gift of learning and growth in knowledge.
          </p>
        </section>
...
Amen.</strong>
              ...
              <p className="mb-4">From the time we are young children, most of us become students and begin the task of lifelong learning. Many young children do not know that the ability to learn is a gift from You, and many of them do not know that they can grow in holiness through their work of learning.</p>

<p className="mb-4">Please bless and assist all students. And we particularly ask today that You pour out Your grace upon all young children who are students!</p>

<p className="mb-4">Help us to always offer You all that we do. Give us the grace to take every opportunity to grow in holiness and friendship with You.</p>
...
Amen.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on gratitude for learning. This aspect of student life helps us to grow spiritually 
