...
export const metadata: Metadata = {
  title: 'Novena for Students - Day 5: Gratitude for Education',
  description: 'Pray the Novena for Students - Day 5 focusing on gratitude for education. Join in praying for academic success and spiritual growth.',
  keywords: [
    'novena for students day 5',
    'student prayer day 5',
    'day 5 student novena',
    'gratitude for education student prayer'
  ],
  openGraph: {
    title: 'Novena for Students - Day 5: Gratitude for Education',
    description: 'Pray the Novena for Students - Day 5 focusing on Gratitude for Education.',
    url: 'https://catholic-bible-online.com/novenas/students/day-5',
  },
  twitter: {
    title: 'Novena for Students - Day 5: Gratitude for Education',
    description: 'Pray the Novena for Students - Day 5 focusing on Gratitude for Education.',
...
export default function NovenaForStudentsDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Students – Day 5: Gratitude for Education
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Gratitude for Education</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for gratitude for the blessing of education and learning.
          </p>
        </section>
...
Amen.</strong>
              ...
              <p className="mb-4">The ability to learn and to get a good education is a blessing from You. Being a student can be very difficult at times, and the years we spend as students can bring trials into our lives. But we should always be thankful for the many ways that learning and education can improve our lives. </p>

<p className="mb-4">Please bless and assist all students. And we particularly ask today that You help us and all students to grow in gratitude for Your blessings!</p>

<p className="mb-4">Help us to appreciate more deeply the many ways You provide for us. Give us the grace to understand more fully the depths of Your love for us.</p>
...
Amen.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on gratitude for education. This aspect of student life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Students - Day 5: Gratitude for Education" 
            url="/novenas/students/day-5"
            excerpt="Join me in praying the Novena for Students - Day 5 focusing on gratitude for education." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/students/day-6"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 6: Perseverance in Studies →
          </Link>
