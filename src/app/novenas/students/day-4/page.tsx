...
export const metadata: Metadata = {
  title: 'Novena for Students - Day 4: Adult Students',
  description: 'Pray the Novena for Students - Day 4 focusing on adult students. Join in praying for academic success and spiritual growth.',
  keywords: [
    'novena for students day 4',
    'student prayer day 4',
    'day 4 student novena',
    'adult students student prayer'
  ],
  openGraph: {
    title: 'Novena for Students - Day 4: Adult Students',
    description: 'Pray the Novena for Students - Day 4 focusing on Adult Students.',
    url: 'https://catholic-bible-online.com/novenas/students/day-4',
  },
  twitter: {
    title: 'Novena for Students - Day 4: Adult Students',
    description: 'Pray the Novena for Students - Day 4 focusing on Adult Students.',
...
export default function NovenaForStudentsDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Students – Day 4: Adult Students
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Adult Students</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for adults returning to school and pursuing further education.
          </p>
        </section>
...
Amen.</strong>
              ...
              <p className="mb-4">Many of us spend years of our lives pursuing knowledge as students. Though the time spent as a student ends for many of us in early adulthood, many adults have reason to return to school. Adult students often face numerous difficulties as they work to improve their lives through further educational pursuits.</p>

<p className="mb-4">Please bless and assist all students. And we particularly ask today that You pour out Your grace upon all adults who have chosen to go back to school!</p>

<p className="mb-4">Help us to bring all of our needs in confidence to You. Give us the grace to trust in Your providence for us, even in the midst of difficulties.</p>
...
Amen.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on adult students. This aspect of student life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Students - Day 4: Adult Students" 
            url="/novenas/students/day-4"
            excerpt="Join me in praying the Novena for Students - Day 4 focusing on adult students." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/students/day-5"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 5: Gratitude for Education →
          </Link>
