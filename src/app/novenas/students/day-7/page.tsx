...
export const metadata: Metadata = {
  title: 'Novena for Students - Day 7: Trust in God',
  description: 'Pray the Novena for Students - Day 7 focusing on trust in god. Join in praying for academic success and spiritual growth.',
  keywords: [
    'novena for students day 7',
    'student prayer day 7',
    'day 7 student novena',
    'trust in god student prayer'
  ],
  openGraph: {
    title: 'Novena for Students - Day 7: Trust in God',
    description: 'Pray the Novena for Students - Day 7 focusing on Trust in God.',
    url: 'https://catholic-bible-online.com/novenas/students/day-7',
  },
  twitter: {
    title: 'Novena for Students - Day 7: Trust in God',
    description: 'Pray the Novena for Students - Day 7 focusing on Trust in God.',
...
export default function NovenaForStudentsDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Students – Day 7: Trust in God
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for trust in God's providence during academic challenges.
          </p>
        </section>
...
Amen.</strong>
              ...
              <p className="mb-4">Whenever we face trials and suffering in our lives, it can be difficult to trust that You will provide for us. During their time as students, many people face a lot of difficulties. You can help all students to grow in trust in You as they endure the many trials that come with the life of a student.</p>

<p className="mb-4">Please bless and assist all students. And we particularly ask today that You help us and all students to grow in trust in You!</p>

<p className="mb-4">Help us to grow to a more intimate friendship with You each day of our lives. Give us the grace to make growth in holiness our top priority in life.</p>
...
Amen.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on trust in god. This aspect of student life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Students - Day 7: Trust in God" 
            url="/novenas/students/day-7"
            excerpt="Join me in praying the Novena for Students - Day 7 focusing on trust in god." 
          />
        </div>
