...
export const metadata: Metadata = {
  title: 'Novena for Grandchildren - Day 4: Hope',
  description: 'Pray the Novena for Grandchildren - Day 4 focusing on Hope. Join in praying for your grandchildren to grow in hope.',
  keywords: [
    'novena for grandchildren day 4',
    'grandchildren prayer day 4',
    'hope grandchildren prayer',
    'grandchildren novena day 4',
    'catholic grandchildren prayer day 4',
    'grandchildren hope novena day 4',
    'prayer for grandchildren day 4',
    'grandchildren novena prayer day 4',
    'catholic novena grandchildren day 4',
    'grandchildren hope prayer day 4'
  ],
  openGraph: {
    title: 'Novena for Grandchildren - Day 4: Hope',
    description: 'Pray the Novena for Grandchildren - Day 4 focusing on Hope. Join in praying for your grandchildren to grow in hope.',
...
export default function NovenaForGrandchildrenDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grandchildren – Day 4: Hope
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Novena for Grandchildren, we pray for your grandchildren to grow in hope. We ask God to pour out His grace upon them and help them develop this important virtue.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for our grandchildren to grow in hope. As grandparents, we have a special role in helping our grandchildren develop the virtues they need for holiness.
              </p>
              ...
              <p className="mb-4">
                God wants our grandchildren to grow in hope and all the virtues. When we pray for them and model these virtues in our own lives, we help them to understand what it means to live a holy life.
              </p>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grandchildren - Day 4: Hope" 
            url="/novenas/grandchildren/day-4"
            excerpt="Join me in praying the Novena for Grandchildren - Day 4 focusing on Hope." 
          />
        </div>
