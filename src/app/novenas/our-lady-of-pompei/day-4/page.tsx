...
export const metadata: Metadata = {
  title: 'Our Lady of Pompei Novena - Day 4: World Peace',
  description: "Pray the Our Lady of Pompei Novena - Day 4 focusing on World Peace. Join in praying the traditional novena to Our Lady of the Rosary of Pompei.",
  keywords: [
    'our lady of pompei novena day 4',
    'lady of pompei novena day 4',
    'pompei novena day 4',
    'rosary of pompei novena day 4',
    'day 4 our lady of pompei novena',
    'world peace prayer',
    'pompei novena world peace',
    'gospel of life novena world peace'
  ],
  openGraph: {
    title: 'Our Lady of Pompei Novena - Day 4: World Peace',
    description: 'Pray the Our Lady of Pompei Novena - Day 4 focusing on World Peace. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-pompei/day-4',
  },
  twitter: {
    title: 'Our Lady of Pompei Novena - Day 4: World Peace',
    description: 'Pray the Our Lady of Pompei Novena - Day 4 focusing on World Peace. Join in praying the traditional novena.',
...
export default function OurLadyOfPompeiNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of Pompei Novena – Day 4: World Peace
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for peace throughout the world. We ask Our Lady of Pompei to intercede for all nations, that they may live in harmony and respect for human dignity.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              World peace is a gift from God that we must pray for earnestly. Our Lady of Pompei, as Queen of the Rosary, has the power to bring peace to the world when we pray the Rosary with faith and devotion.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Rosary of Mary, bring peace to the entire world. May all nations live in harmony and respect for human dignity. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of Pompei Novena - Day 4: World Peace" 
            url="/novenas/our-lady-of-pompei/day-4"
            excerpt="Join me in praying the Our Lady of Pompei Novena - Day 4 focusing on World Peace." 
          />
        </div>
