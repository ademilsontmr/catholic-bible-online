...
export const metadata: Metadata = {
  title: 'Our Lady of Pompei Novena - Day 6: Bond of Love',
  description: "Pray the Our Lady of Pompei Novena - Day 6 focusing on Bond of Love. Join in praying the traditional novena to Our Lady of the Rosary of Pompei.",
  keywords: [
    'our lady of pompei novena day 6',
    'lady of pompei novena day 6',
    'pompei novena day 6',
    'rosary of pompei novena day 6',
    'day 6 our lady of pompei novena',
    'bond of love prayer',
    'pompei novena bond of love',
    'gospel of life novena bond of love'
  ],
  openGraph: {
    title: 'Our Lady of Pompei Novena - Day 6: Bond of Love',
    description: 'Pray the Our Lady of Pompei Novena - Day 6 focusing on Bond of Love. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-pompei/day-6',
  },
  twitter: {
    title: 'Our Lady of Pompei Novena - Day 6: Bond of Love',
    description: 'Pray the Our Lady of Pompei Novena - Day 6 focusing on Bond of Love. Join in praying the traditional novena.',
...
export default function OurLadyOfPompeiNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of Pompei Novena – Day 6: Bond of Love
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Bond of Love</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the bond of love that unites us to the angels. We ask Our Lady of Pompei to help us experience this heavenly bond and to grow in our love for God and neighbor.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The bond of love that unites us to the angels is a gift of grace. Our Lady of Pompei helps us to experience this divine love and to share it with others, creating a chain of love that extends to heaven.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Rosary of Mary, strengthen the bond of love that unites us to the angels. Help us to experience and share divine love with others. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of Pompei Novena - Day 6: Bond of Love" 
            url="/novenas/our-lady-of-pompei/day-6"
            excerpt="Join me in praying the Our Lady of Pompei Novena - Day 6 focusing on Bond of Love." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-pompei/day-5"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 5: Sweet Chain of Unity
          </Link>
          
          
          <Link
            href="/novenas/our-lady-of-pompei/day-7"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 7: Tower of Salvation →
          </Link>
