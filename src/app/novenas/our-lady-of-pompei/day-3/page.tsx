...
export const metadata: Metadata = {
  title: 'Our Lady of Pompei Novena - Day 3: Peace in Our Country',
  description: "Pray the Our Lady of Pompei Novena - Day 3 focusing on Peace in Our Country. Join in praying the traditional novena to Our Lady of the Rosary of Pompei.",
  keywords: [
    'our lady of pompei novena day 3',
    'lady of pompei novena day 3',
    'pompei novena day 3',
    'rosary of pompei novena day 3',
    'day 3 our lady of pompei novena',
    'peace in our country prayer',
    'pompei novena peace in our country',
    'gospel of life novena peace in our country'
  ],
  openGraph: {
    title: 'Our Lady of Pompei Novena - Day 3: Peace in Our Country',
    description: 'Pray the Our Lady of Pompei Novena - Day 3 focusing on Peace in Our Country. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-pompei/day-3',
  },
  twitter: {
    title: 'Our Lady of Pompei Novena - Day 3: Peace in Our Country',
    description: 'Pray the Our Lady of Pompei Novena - Day 3 focusing on Peace in Our Country. Join in praying the traditional novena.',
...
export default function OurLadyOfPompeiNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of Pompei Novena – Day 3: Peace in Our Country
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Peace in Our Country</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for peace and harmony in our country. We ask Our Lady of Pompei to intercede for our nation, that it may be guided by justice, truth, and the Gospel values.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Peace in our country begins with peace in our hearts and families. Our Lady of Pompei, as Queen of Peace, can help bring harmony to our nation when we turn to her with trust and devotion.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Rosary of Mary, bring peace and harmony to our country. May it be guided by justice, truth, and the values of the Gospel. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of Pompei Novena - Day 3: Peace in Our Country" 
            url="/novenas/our-lady-of-pompei/day-3"
            excerpt="Join me in praying the Our Lady of Pompei Novena - Day 3 focusing on Peace in Our Country." 
          />
        </div>
