...
export const metadata: Metadata = {
  title: 'Our Lady of Pompei Novena - Day 8: Safe Port',
  description: "Pray the Our Lady of Pompei Novena - Day 8 focusing on Safe Port. Join in praying the traditional novena to Our Lady of the Rosary of Pompei.",
  keywords: [
    'our lady of pompei novena day 8',
    'lady of pompei novena day 8',
    'pompei novena day 8',
    'rosary of pompei novena day 8',
    'day 8 our lady of pompei novena',
    'safe port prayer',
    'pompei novena safe port',
    'gospel of life novena safe port'
  ],
  openGraph: {
    title: 'Our Lady of Pompei Novena - Day 8: Safe Port',
    description: 'Pray the Our Lady of Pompei Novena - Day 8 focusing on Safe Port. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-pompei/day-8',
  },
  twitter: {
    title: 'Our Lady of Pompei Novena - Day 8: Safe Port',
    description: 'Pray the Our Lady of Pompei Novena - Day 8 focusing on Safe Port. Join in praying the traditional novena.',
...
export default function OurLadyOfPompeiNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of Pompei Novena – Day 8: Safe Port
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Safe Port</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for Our Lady of Pompei as our safe port in universal shipwreck. We ask her to be our refuge in times of trouble and to guide us safely through life's storms.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              In the storms of life, Our Lady of Pompei is our safe port. She welcomes all who are shipwrecked by sin and guides them safely to the harbor of her Son's mercy and love.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Rosary of Mary, be our safe port in universal shipwreck. Welcome all who are troubled and guide them safely to the harbor of your Son's mercy. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="Our Lady of Pompei Novena - Day 8: Safe Port"
          text="Join me in praying the Our Lady of Pompei Novena - Day 8 focusing on Safe Port."
        />
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-pompei/day-9"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Final Comfort →
          </Link>
