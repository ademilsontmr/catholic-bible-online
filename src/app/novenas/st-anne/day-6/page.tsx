...
export const metadata: Metadata = {
  title: 'Novena to St. Anne - Day 6: Purity and Simplicity',
  description: "Pray the Novena to St. Anne - Day 6 focusing on Purity and Simplicity. Join in praying the traditional novena to seek St. Anne's intercession.",
  keywords: [
    'novena to st anne day 6',
    'st anne novena day 6',
    'anne novena day 6',
    'st anne prayer day 6',
    'day 6 st anne novena',
    'purity and simplicity prayer',
    'st anne novena purity and simplicity',
    'anne novena purity and simplicity'
  ],
  openGraph: {
    title: 'Novena to St. Anne - Day 6: Purity and Simplicity',
    description: 'Pray the Novena to St. Anne - Day 6 focusing on Purity and Simplicity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-anne/day-6',
  },
  twitter: {
    title: 'Novena to St. Anne - Day 6: Purity and Simplicity',
    description: 'Pray the Novena to St. Anne - Day 6 focusing on Purity and Simplicity. Join in praying the traditional novena.',
...
export default function StAnneNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Anne – Day 6: Purity and Simplicity
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Purity and Simplicity</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we focus on St. Anne's help in achieving purity and simplicity. She helps us free our hearts of pride, vanity, and self-love, teaching us meekness and simplicity of heart.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Good St. Ann, do not allow my soul, a masterpiece of God's creative power, to be lost forever.</strong> Free my heart of pride, vanity, self-love. May I know myself as I really am and learn meekness and simplicity of heart.
              </p>

              <p className="mb-6">
                <strong>God's great love for me leaves me cold and unresponsive.</strong> I must reflect this love through works of mercy and charity toward my neighbor.
              </p>

              <p className="mb-6">
                <strong>In your boundless charity, good St. Ann, help me to merit the glorious crown which is given to those who have fought the good fight against the world, the devil and the flesh.</strong> Assist me to preserve purity of heart and body. With Mary and her divine Son, protect me always.
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Anne's emphasis on purity and simplicity reminds us of the importance of humility and virtue. Her example guides us toward a more holy and righteous life.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Anne, help me to achieve purity and simplicity of heart. May your emphasis on virtue inspire me to live a more holy and righteous life. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="Novena to St. Anne - Day 6: Purity and Simplicity"
          text="Join me in praying the Novena to St. Anne - Day 6 focusing on Purity and Simplicity."
        />
