...
export const metadata: Metadata = {
  title: 'Holy Cross Novena - Day 1: Divine Mercy',
  description: "Pray the Holy Cross Novena - Day 1 focusing on Divine Mercy. Join in praying the traditional novena to seek God's mercy through the intercession of the Holy Cross.",
  keywords: [
    'holy cross novena day 1',
    'cross novena day 1',
    'jesus crucified novena day 1',
    'holy cross prayer day 1',
    'day 1 holy cross novena',
    'divine mercy prayer',
    'holy cross novena divine mercy',
    'cross novena divine mercy'
  ],
  openGraph: {
    title: 'Holy Cross Novena - Day 1: Divine Mercy',
    description: 'Pray the Holy Cross Novena - Day 1 focusing on Divine Mercy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-cross/day-1',
  },
  twitter: {
    title: 'Holy Cross Novena - Day 1: Divine Mercy',
    description: 'Pray the Holy Cross Novena - Day 1 focusing on Divine Mercy. Join in praying the traditional novena.',
...
export default function HolyCrossNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Holy Cross Novena – Day 1: Divine Mercy
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Holy Cross Novena, we focus on God's divine mercy and our complete trust in His love. We remember that Jesus willingly suffered and died on the Cross for our redemption and salvation.
          </p>
        </section>
...
Your Peace, which is the only true peace, so that by obeying Your Commandments we may come at last to the glory of Heaven.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus' burning love for us led Him to the Cross, where He shed His Most Precious Blood for our salvation. His mercy is infinite and available to all who turn to Him with trust and confidence.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, through the power of the Holy Cross, help me to trust completely in Your divine mercy. May Your burning love for me give me confidence in all my needs. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Holy Cross Novena - Day 1: Divine Mercy" 
            url="/novenas/holy-cross/day-1"
            excerpt="Join me in praying the Holy Cross Novena - Day 1 focusing on Divine Mercy." 
          />
        </div>
