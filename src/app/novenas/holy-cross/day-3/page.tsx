...
export const metadata: Metadata = {
  ...
  description: "Pray the Holy Cross Novena - Day 3 focusing on Daily Bread. Join in praying the traditional novena to seek God's mercy through the intercession of the Holy Cross.",
  keywords: [
    'holy cross novena day 3',
    'cross novena day 3',
    'jesus crucified novena day 3',
    'holy cross prayer day 3',
    'day 3 holy cross novena',
    'daily bread prayer',
    'holy cross novena daily bread',
    'cross novena daily bread'
  ],
  openGraph: {
    title: 'Holy Cross Novena - Day 3: Daily Bread',
    description: 'Pray the Holy Cross Novena - Day 3 focusing on Daily Bread. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-cross/day-3',
  },
  twitter: {
    title: 'Holy Cross Novena - Day 3: Daily Bread',
    description: 'Pray the Holy Cross Novena - Day 3 focusing on Daily Bread. Join in praying the traditional novena.',
...
export default function HolyCrossNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Holy Cross Novena – Day 3: Daily Bread
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Daily Bread</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for our daily bread and the needs of all those who are dear to us. We trust that God will provide for our material and spiritual needs.
          </p>
        </section>
...
Your Peace, which is the only true peace, so that by obeying Your Commandments we may come at last to the glory of Heaven.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus taught us to pray for our daily bread, trusting in God's providence. Through the Holy Cross, we can confidently ask for all our needs, knowing that God cares for us and those we love.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, through the Holy Cross, provide for my daily bread and the needs of all those who are dear to me. May I trust in Your providence and care. Amen.
          </p>
        </section>
