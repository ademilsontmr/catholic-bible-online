...
export const metadata: Metadata = {
  title: 'Holy Cross Novena - Day 7: Obedience to Commandments',
  description: "Pray the Holy Cross Novena - Day 7 focusing on Obedience to Commandments. Join in praying the traditional novena to seek God's mercy through the intercession of the Holy Cross.",
  keywords: [
    'holy cross novena day 7',
    'cross novena day 7',
    'jesus crucified novena day 7',
    'holy cross prayer day 7',
    'day 7 holy cross novena',
    'obedience to commandments prayer',
    'holy cross novena obedience to commandments',
    'cross novena obedience to commandments'
  ],
  openGraph: {
    title: 'Holy Cross Novena - Day 7: Obedience to Commandments',
    description: 'Pray the Holy Cross Novena - Day 7 focusing on Obedience to Commandments. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-cross/day-7',
  },
  twitter: {
    title: 'Holy Cross Novena - Day 7: Obedience to Commandments',
    description: 'Pray the Holy Cross Novena - Day 7 focusing on Obedience to Commandments. Join in praying the traditional novena.',
...
export default function HolyCrossNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Holy Cross Novena – Day 7: Obedience to Commandments
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Obedience to Commandments</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for the grace to obey God's commandments faithfully. We ask that through the Holy Cross, we may have the strength to follow God's will.
          </p>
        </section>
...
Your Peace, which is the only true peace, so that by obeying Your Commandments we may come at last to the glory of Heaven.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus' obedience to the Father's will led Him to the Cross. Through His example and the grace won by His sacrifice, we can learn to obey God's commandments with love and fidelity.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, through the Holy Cross, help me to obey Your commandments faithfully. May I follow Your example of obedience to the Father's will. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Holy Cross Novena - Day 7: Obedience to Commandments" 
            url="/novenas/holy-cross/day-7"
            excerpt="Join me in praying the Holy Cross Novena - Day 7 focusing on Obedience to Commandments." 
          />
        </div>
