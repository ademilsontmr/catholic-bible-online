...
export const metadata: Metadata = {
  title: 'Holy Cross Novena - Day 5: Family Blessings',
  description: "Pray the Holy Cross Novena - Day 5 focusing on Family Blessings. Join in praying the traditional novena to seek God's mercy through the intercession of the Holy Cross.",
  keywords: [
    'holy cross novena day 5',
    'cross novena day 5',
    'jesus crucified novena day 5',
    'holy cross prayer day 5',
    'day 5 holy cross novena',
    'family blessings prayer',
    'holy cross novena family blessings',
    'cross novena family blessings'
  ],
  openGraph: {
    title: 'Holy Cross Novena - Day 5: Family Blessings',
    description: 'Pray the Holy Cross Novena - Day 5 focusing on Family Blessings. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-cross/day-5',
  },
  twitter: {
    title: 'Holy Cross Novena - Day 5: Family Blessings',
    description: 'Pray the Holy Cross Novena - Day 5 focusing on Family Blessings. Join in praying the traditional novena.',
...
export default function HolyCrossNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Holy Cross Novena – Day 5: Family Blessings
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Family Blessings</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for God's blessings upon our families. We ask that the Holy Cross may protect and sanctify our families, bringing them closer to God.
          </p>
        </section>
...
Your Peace, which is the only true peace, so that by obeying Your Commandments we may come at last to the glory of Heaven.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The family is the domestic church, and through the Holy Cross, Jesus blesses and sanctifies family life. His sacrifice on the Cross shows us the depth of love that should exist in our families.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, through the Holy Cross, bless my family and all families. May Your love and protection be upon us always. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Holy Cross Novena - Day 5: Family Blessings" 
            url="/novenas/holy-cross/day-5"
            excerpt="Join me in praying the Holy Cross Novena - Day 5 focusing on Family Blessings." 
          />
        </div>
