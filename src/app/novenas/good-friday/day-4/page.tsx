...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Good Friday - Day 4 focusing on Hostility. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 4',
    'good friday prayer day 4',
    'hostility good friday prayer',
    'good friday novena day 4',
    'catholic good friday prayer day 4',
    'good friday hostility novena day 4',
    'prayer for good friday day 4',
    'good friday novena prayer day 4',
    'catholic novena good friday day 4',
    'good friday hostility prayer day 4'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 4: Hostility',
    description: "Pray the Novena for Good Friday - Day 4 focusing on Hostility. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-4',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 4: Hostility',
    description: "Pray the Novena for Good Friday - Day 4 focusing on Hostility. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 4: Hostility
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Hostility</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Novena for Good Friday, we focus on hostility. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">You knew well that some people would choose to reject Your love, but still You chose to die for us on the cross. Despite the immeasurable graces You continue to give us each day and the guidance You give us through Your Church, some of Your people still reject You and hold hatred in their hearts toward You.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You pour out the grace of conversion on all who are hostile toward You.</p>
              <p className="mb-6">Help us to make our relationship with You our top priority in life. Give us the grace to devote ourselves more fully to You each day of our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on hostility as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in hostility and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
