...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Good Friday - Day 6 focusing on Friendship. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 6',
    'good friday prayer day 6',
    'friendship good friday prayer',
    'good friday novena day 6',
    'catholic good friday prayer day 6',
    'good friday friendship novena day 6',
    'prayer for good friday day 6',
    'good friday novena prayer day 6',
    'catholic novena good friday day 6',
    'good friday friendship prayer day 6'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 6: Friendship',
    description: "Pray the Novena for Good Friday - Day 6 focusing on Friendship. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-6',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 6: Friendship',
    description: "Pray the Novena for Good Friday - Day 6 focusing on Friendship. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 6: Friendship
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Friendship</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day of the Novena for Good Friday, we focus on friendship. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">During Your Passion and Your agony on the cross, You were abandoned by nearly all of Your friends. You call each of us to remain with You during Your agony on the cross. You can lead us to a deeper friendship with You this Good Friday.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You help us and all people to grow to a deeper friendship with You.</p>
              <p className="mb-6">Help us to do all we can to serve You faithfully each day of our lives. Give us the grace to always seek growth in holiness at every opportunity we encounter in our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on friendship as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in friendship and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/good-friday/day-5"
          ...
          <Link 
            href="/novenas/good-friday/day-7"
