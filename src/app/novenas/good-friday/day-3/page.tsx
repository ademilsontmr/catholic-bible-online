...
export const metadata: Metadata = {
  title: 'Novena for Good Friday - Day 3: Conversion',
  description: "Pray the Novena for Good Friday - Day 3 focusing on Conversion. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 3',
    'good friday prayer day 3',
    'conversion good friday prayer',
    'good friday novena day 3',
    'catholic good friday prayer day 3',
    'good friday conversion novena day 3',
    'prayer for good friday day 3',
    'good friday novena prayer day 3',
    'catholic novena good friday day 3',
    'good friday conversion prayer day 3'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 3: Conversion',
    description: "Pray the Novena for Good Friday - Day 3 focusing on Conversion. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-3',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 3: Conversion',
    description: "Pray the Novena for Good Friday - Day 3 focusing on Conversion. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 3: Conversion
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day of the Novena for Good Friday, we focus on conversion. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">You chose to die a painful death on the cross out of love for all people, even though You knew that some of Your people would not care what You did for them. You can bring the grace of conversion to all who are indifferent to the great work of redemption.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You pour out the grace of conversion on all who are indifferent to Your death on this holy day!</p>
              <p className="mb-6">Help us to always love and serve You as we ought. Give us the grace to grow in friendship with You each day of our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on conversion as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in conversion and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Good Friday - Day 3: Conversion" 
            url="/novenas/good-friday/day-3"
            excerpt="Join me in praying the Novena for Good Friday - Day 3 focusing on Conversion." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/good-friday/day-2"
          ...
          <Link 
            href="/novenas/good-friday/day-4"
