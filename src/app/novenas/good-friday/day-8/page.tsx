...
export const metadata: Metadata = {
  title: 'Novena for Good Friday - Day 8: Charity',
  description: "Pray the Novena for Good Friday - Day 8 focusing on Charity. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 8',
    'good friday prayer day 8',
    'charity good friday prayer',
    'good friday novena day 8',
    'catholic good friday prayer day 8',
    'good friday charity novena day 8',
    'prayer for good friday day 8',
    'good friday novena prayer day 8',
    'catholic novena good friday day 8',
    'good friday charity prayer day 8'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 8: Charity',
    description: "Pray the Novena for Good Friday - Day 8 focusing on Charity. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-8',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 8: Charity',
    description: "Pray the Novena for Good Friday - Day 8 focusing on Charity. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 8: Charity
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day of the Novena for Good Friday, we focus on charity. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">You chose to die on the cross for all people because of Your love for us. You call us to imitate Your love. We are called to love You above all and to love all other people out of love for You. It is not always easy for us to practice the charity You call us to practice, but You can help us to grow in the true love of You that this charity requires.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You help us and all people to grow in charity.</p>
              <p className="mb-6">Help us to grow in all the virtues we need for holiness. Give us the grace to always love You as we ought.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on charity as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in charity and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Good Friday - Day 8: Charity" 
            url="/novenas/good-friday/day-8"
            excerpt="Join me in praying the Novena for Good Friday - Day 8 focusing on Charity." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/good-friday/day-9"
