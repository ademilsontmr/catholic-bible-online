...
export const metadata: Metadata = {
  title: 'Novena for Good Friday - Day 1: Gratitude',
  description: "Pray the Novena for Good Friday - Day 1 focusing on Gratitude. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 1',
    'good friday prayer day 1',
    'gratitude good friday prayer',
    'good friday novena day 1',
    'catholic good friday prayer day 1',
    'good friday gratitude novena day 1',
    'prayer for good friday day 1',
    'good friday novena prayer day 1',
    'catholic novena good friday day 1',
    'good friday gratitude prayer day 1'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 1: Gratitude',
    description: "Pray the Novena for Good Friday - Day 1 focusing on Gratitude. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-1',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 1: Gratitude',
    description: "Pray the Novena for Good Friday - Day 1 focusing on Gratitude. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 1: Gratitude
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Good Friday, we focus on gratitude. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">You chose to come down to earth as a Man out of unfathomable love for each of us. You willingly chose to suffer and die for us on the cross, to open the gates of heaven so that we might one day spend eternity in heaven with You. You have given us Your Church to guide us on the way to heaven.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You pour out grace upon Your Church on this holy day.</p>
              <p className="mb-6">Help us to serve You faithfully each day of our lives. Give us the grace to grow closer to You at every opportunity.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on gratitude as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in gratitude and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Good Friday - Day 1: Gratitude" 
            url="/novenas/good-friday/day-1"
            excerpt="Join me in praying the Novena for Good Friday - Day 1 focusing on Gratitude." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/good-friday/day-0"
