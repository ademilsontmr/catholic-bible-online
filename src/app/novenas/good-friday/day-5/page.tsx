...
export const metadata: Metadata = {
  title: 'Novena for Good Friday - Day 5: Piety',
  description: "Pray the Novena for Good Friday - Day 5 focusing on Piety. Join in praying to commemorate Christ's sacrifice on the cross.",
  keywords: [
    'novena for good friday day 5',
    'good friday prayer day 5',
    'piety good friday prayer',
    'good friday novena day 5',
    'catholic good friday prayer day 5',
    'good friday piety novena day 5',
    'prayer for good friday day 5',
    'good friday novena prayer day 5',
    'catholic novena good friday day 5',
    'good friday piety prayer day 5'
  ],
  openGraph: {
    title: 'Novena for Good Friday - Day 5: Piety',
    description: "Pray the Novena for Good Friday - Day 5 focusing on Piety. Join in praying to commemorate Christ's sacrifice on the cross.",
    url: 'https://catholicbibleonline.com/novenas/good-friday/day-5',
  },
  twitter: {
    title: 'Novena for Good Friday - Day 5: Piety',
    description: "Pray the Novena for Good Friday - Day 5 focusing on Piety. Join in praying to commemorate Christ's sacrifice on the cross.",
...
export default function NovenaForGoodFridayDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Good Friday – Day 5: Piety
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day of the Novena for Good Friday, we focus on piety. We ask God to help us grow in this virtue as we commemorate Christ's sacrifice on the cross.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">The commemoration of Your death on Good Friday can be a difficult day. You call us to offer sacrifices of our own to join You in Your suffering. You can help each of us to grow in piety as we join the rest of the Church in a spirit of sacrifice this Good Friday.</p>
              <p className="mb-6">Please help us to faithfully commemorate Your death on Good Friday, and we particularly ask today that You help us and all people to grow in piety.</p>
              <p className="mb-6">Help us to always offer all sufferings and difficulties to You. Give us the grace to grow to a deeper unity with You each day.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on piety as we commemorate Christ's sacrifice on the cross. Good Friday reminds us of the depth of Christ's love for us and His willingness to suffer and die for our salvation.
              </p>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dear Lord, we thank You for Your sacrifice on the cross. Help us to always be grateful for Your redemptive love and to unite our sufferings with Yours. May You help us grow in piety and all the virtues we need for holiness, and may we always seek to serve You faithfully. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Good Friday - Day 5: Piety" 
            url="/novenas/good-friday/day-5"
            excerpt="Join me in praying the Novena for Good Friday - Day 5 focusing on Piety." 
          />
        </div>
