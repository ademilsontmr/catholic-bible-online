...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 9: Eternal Companionship',
  description: "Pray the Novena to the Holy Family - Day 9 focusing on Eternal Companionship. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 9',
    'holy family novena day 9',
    'jesus mary joseph novena day 9',
    'holy family prayer day 9',
    'day 9 holy family novena',
    'eternal companionship prayer',
    'holy family novena eternal companionship',
    'jesus mary joseph novena eternal companionship'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 9: Eternal Companionship',
    description: 'Pray the Novena to the Holy Family - Day 9 focusing on Eternal Companionship. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-9',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 9: Eternal Companionship',
    description: 'Pray the Novena to the Holy Family - Day 9 focusing on Eternal Companionship. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 9: Eternal Companionship
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Eternal Companionship</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on praying to enjoy the everlasting companionship of the Holy Family. We ask that after death, we may be worthy to be received into the everlasting joys of heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family promises us eternal companionship in heaven if we follow their example on earth. Their intercession can help us persevere in faith and love so that we may one day join them in eternal glory.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of the Holy Family. 
            May you always remember the example of Jesus, Mary, and Joseph and their love for each other. 
            May your family continue to grow in holiness and harmony through their prayers.
          </p>
        </section>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena to the Holy Family! As you continue your spiritual journey, 
            may your heart be filled with love for Holy Church, courage to profess your faith, 
            defense of the Faith, family charity, harmony and unity, obedience to commandments, 
            living in charity, family dedication, and eternal companionship. May the Holy Family 
            continue to watch over your family and bring you peace and blessings.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 9: Eternal Companionship" 
            url="/novenas/holy-family/day-9"
            excerpt="Join me in praying the Novena to the Holy Family - Day 9 focusing on Eternal Companionship." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/holy-family/day-8"
      ...
      <RelatedNovenas currentNovena="Holy Family Novena" />
    </div>
  )
}
