...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 2: Profession of Faith',
  description: "Pray the Novena to the Holy Family - Day 2 focusing on Profession of Faith. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 2',
    'holy family novena day 2',
    'jesus mary joseph novena day 2',
    'holy family prayer day 2',
    'day 2 holy family novena',
    'profession of faith prayer',
    'holy family novena profession of faith',
    'jesus mary joseph novena profession of faith'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 2: Profession of Faith',
    description: 'Pray the Novena to the Holy Family - Day 2 focusing on Profession of Faith. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-2',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 2: Profession of Faith',
    description: 'Pray the Novena to the Holy Family - Day 2 focusing on Profession of Faith. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 2: Profession of Faith
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Profession of Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the courage to openly profess the faith we received as a gift in holy Baptism. We ask the Holy Family to help us overcome human respect and boldly witness to our Catholic faith.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family lived their faith openly and courageously. Mary proclaimed God's greatness, Joseph obeyed God's commands, and Jesus taught the truth fearlessly. We are called to do the same in our daily lives.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, give me the courage to openly profess my faith without human respect. May I boldly witness to the Catholic faith I received in Baptism. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 2: Profession of Faith" 
            url="/novenas/holy-family/day-2"
            excerpt="Join me in praying the Novena to the Holy Family - Day 2 focusing on Profession of Faith." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-family/day-1"
