...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 1: Love for Holy Church',
  description: "Pray the Novena to the Holy Family - Day 1 focusing on Love for Holy Church. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 1',
    'holy family novena day 1',
    'jesus mary joseph novena day 1',
    'holy family prayer day 1',
    'day 1 holy family novena',
    'love for holy church prayer',
    'holy family novena love for holy church',
    'jesus mary joseph novena love for holy church'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 1: Love for Holy Church',
    description: 'Pray the Novena to the Holy Family - Day 1 focusing on Love for Holy Church. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-1',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 1: Love for Holy Church',
    description: 'Pray the Novena to the Holy Family - Day 1 focusing on Love for Holy Church. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 1: Love for Holy Church
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Love for Holy Church</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to the Holy Family, we focus on praying for the grace to love Holy Church above every earthly thing. We ask Jesus, Mary, and Joseph to help us show our love for the Church by our deeds.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family teaches us to love the Church as our spiritual family. Jesus established the Church, Mary is its Mother, and Joseph is its protector. Our love for the Church should be demonstrated through our actions and fidelity to her teachings.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, help me to love Holy Church above every earthly thing and to show my love by deeds. May I always be faithful to the Church that Jesus established. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 1: Love for Holy Church" 
            url="/novenas/holy-family/day-1"
            excerpt="Join me in praying the Novena to the Holy Family - Day 1 focusing on Love for Holy Church." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-family/day-2"
