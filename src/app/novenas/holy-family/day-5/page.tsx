...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 5: Harmony and Unity',
  description: "Pray the Novena to the Holy Family - Day 5 focusing on Harmony and Unity. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 5',
    'holy family novena day 5',
    'jesus mary joseph novena day 5',
    'holy family prayer day 5',
    'day 5 holy family novena',
    'harmony and unity prayer',
    'holy family novena harmony and unity',
    'jesus mary joseph novena harmony and unity'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 5: Harmony and Unity',
    description: 'Pray the Novena to the Holy Family - Day 5 focusing on Harmony and Unity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-5',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 5: Harmony and Unity',
    description: 'Pray the Novena to the Holy Family - Day 5 focusing on Harmony and Unity. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 5: Harmony and Unity
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Harmony and Unity</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for perfect harmony of thought, will, and action in our families, under the rule and guidance of the shepherds of the Church.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family lived in perfect harmony, united in thought, will, and action. They were always obedient to God's will and the guidance of religious authority. This harmony brought them peace and joy.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, establish my family in perfect harmony of thought, will, and action. May we be united under the guidance of the Church. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 5: Harmony and Unity" 
            url="/novenas/holy-family/day-5"
            excerpt="Join me in praying the Novena to the Holy Family - Day 5 focusing on Harmony and Unity." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-family/day-6"
            className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Obedience to Commandments →
          </Link>
