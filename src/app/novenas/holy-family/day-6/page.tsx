...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to the Holy Family - Day 6 focusing on Obedience to Commandments. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 6',
    'holy family novena day 6',
    'jesus mary joseph novena day 6',
    'holy family prayer day 6',
    'day 6 holy family novena',
    'obedience to commandments prayer',
    'holy family novena obedience to commandments',
    'jesus mary joseph novena obedience to commandments'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 6: Obedience to Commandments',
    description: 'Pray the Novena to the Holy Family - Day 6 focusing on Obedience to Commandments. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-6',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 6: Obedience to Commandments',
    description: 'Pray the Novena to the Holy Family - Day 6 focusing on Obedience to Commandments. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 6: Obedience to Commandments
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the grace to conform our life fully to the commandments of God's law and those of His Holy Church, so as to live always in that charity which they set forth.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family perfectly obeyed God's commandments. Jesus was subject to Mary and Joseph, Mary said yes to God's will, and Joseph obeyed every divine command. Their obedience brought them holiness and peace.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, help me to conform my life to God's commandments and Church teachings. May I live always in the charity they set forth. Amen.
          </p>
        </section>
