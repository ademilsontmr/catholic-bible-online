...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to the Holy Family - Day 7 focusing on Living in Charity. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 7',
    'holy family novena day 7',
    'jesus mary joseph novena day 7',
    'holy family prayer day 7',
    'day 7 holy family novena',
    'living in charity prayer',
    'holy family novena living in charity',
    'jesus mary joseph novena living in charity'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 7: Living in Charity',
    description: 'Pray the Novena to the Holy Family - Day 7 focusing on Living in Charity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-7',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 7: Living in Charity',
    description: 'Pray the Novena to the Holy Family - Day 7 focusing on Living in Charity. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 7: Living in Charity
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Living in Charity</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying to live always in the charity that God's commandments set forth. We ask the Holy Family to help us understand and live the true meaning of charity.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family lived in perfect charity. Their love for God and neighbor was the foundation of all their actions. Charity is not just a feeling but a way of life that requires sacrifice and self-giving.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, teach me to live always in the charity that God's commandments require. May love be the foundation of all my actions. Amen.
          </p>
        </section>
