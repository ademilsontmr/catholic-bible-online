...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 3: Defense of Faith',
  description: "Pray the Novena to the Holy Family - Day 3 focusing on Defense of Faith. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 3',
    'holy family novena day 3',
    'jesus mary joseph novena day 3',
    'holy family prayer day 3',
    'day 3 holy family novena',
    'defense of faith prayer',
    'holy family novena defense of faith',
    'jesus mary joseph novena defense of faith'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 3: Defense of Faith',
    description: 'Pray the Novena to the Holy Family - Day 3 focusing on Defense of Faith. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-3',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 3: Defense of Faith',
    description: 'Pray the Novena to the Holy Family - Day 3 focusing on Defense of Faith. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 3: Defense of Faith
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Defense of Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for the grace to share in the defense and propagation of the Faith when duty calls, whether by word or by the sacrifice of our possessions and our life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family defended the Faith through their example and witness. We are called to defend and spread the Faith not only with words but also through our sacrifices and way of life, following their example.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, help me to defend and propagate the Faith when duty calls. May I be willing to sacrifice for the spread of the Gospel. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 3: Defense of Faith" 
            url="/novenas/holy-family/day-3"
            excerpt="Join me in praying the Novena to the Holy Family - Day 3 focusing on Defense of Faith." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-family/day-4"
            className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Family Charity →
          </Link>
