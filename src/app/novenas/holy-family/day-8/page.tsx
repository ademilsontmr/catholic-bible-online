...
export const metadata: Metadata = {
  title: 'Novena to the Holy Family - Day 8: Family Dedication',
  description: "Pray the Novena to the Holy Family - Day 8 focusing on Family Dedication. Join in praying the traditional novena to seek the intercession of Jesus, Mary, and Joseph.",
  keywords: [
    'novena to the holy family day 8',
    'holy family novena day 8',
    'jesus mary joseph novena day 8',
    'holy family prayer day 8',
    'day 8 holy family novena',
    'family dedication prayer',
    'holy family novena family dedication',
    'jesus mary joseph novena family dedication'
  ],
  openGraph: {
    title: 'Novena to the Holy Family - Day 8: Family Dedication',
    description: 'Pray the Novena to the Holy Family - Day 8 focusing on Family Dedication. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-family/day-8',
  },
  twitter: {
    title: 'Novena to the Holy Family - Day 8: Family Dedication',
    description: 'Pray the Novena to the Holy Family - Day 8 focusing on Family Dedication. Join in praying the traditional novena.',
...
export default function HolyFamilyNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to the Holy Family – Day 8: Family Dedication
          </h1>
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Family Dedication</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the dedication of our family to the Holy Family. We ask Jesus, Mary, and Joseph to look upon our family with loving kindness and preserve us from danger.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Family is the model for all families. By dedicating our family to them, we entrust our loved ones to their care and ask for their protection and guidance in all our family needs.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-indigo-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Family, look upon my family with loving kindness. Preserve us from danger, give us help in time of need, and grant us the grace to persevere to the end in imitation of Your holy Family, so that having revered You and loved You faithfully on earth, we may praise You eternally in heaven. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to the Holy Family - Day 8: Family Dedication" 
            url="/novenas/holy-family/day-8"
            excerpt="Join me in praying the Novena to the Holy Family - Day 8 focusing on Family Dedication." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-family/day-7"
          ...
          >
            ← Day 7: Living in Charity
          </Link>
          
          
          <Link
            href="/novenas/holy-family/day-9"
            className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Eternal Companionship →
          </Link>
