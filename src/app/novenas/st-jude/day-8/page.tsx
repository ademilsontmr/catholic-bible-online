...
export const metadata: Metadata = {
  ...
  description: "Pray St. Jude Novena - Day 8 focusing on Never Lose Hope. Join in praying the traditional novena for impossible causes.",
  keywords: [
    'st jude novena day 8',
    'saint jude novena day 8',
    'st jude day 8',
    'day 8 st jude novena',
    'never lose hope prayer',
    'st jude novena never lose hope',
    'saint jude never lose hope',
    'impossible causes prayer day 8'
  ],
  openGraph: {
    title: 'St. Jude Novena - Day 8: Never Lose Hope',
    description: 'Pray St. Jude Novena - Day 8 focusing on Never Lose Hope. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-jude/day-8',
  },
  twitter: {
    title: 'St. Jude Novena - Day 8: Never Lose Hope',
    description: 'Pray St. Jude Novena - Day 8 focusing on Never Lose Hope. Join in praying the traditional novena.',
...
export default function StJudeNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Jude Novena – Day 8: Never Lose Hope
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Never Lose Hope</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on asking St. Jude to help us never lose hope. We seek his intercession to maintain hope even in the darkest times.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Jude's devotion teaches us to never lose hope, even in the most desperate situations. He reminds us that with God, all things are possible.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Jude, help us to never lose hope. May we always maintain hope even in the darkest times. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-jude/day-9"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Never Lose Faith →
          </Link>
