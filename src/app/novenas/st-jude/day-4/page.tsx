...
export const metadata: Metadata = {
  ...
  description: "Pray St. Jude Novena - Day 4 focusing on Lost Causes. Join in praying the traditional novena for impossible causes.",
  keywords: [
    ...
    'lost causes prayer',
    'st jude novena lost causes',
    'saint jude lost causes',
    'impossible causes prayer day 4'
  ],
  openGraph: {
    title: 'St. Jude Novena - Day 4: Lost Causes',
    description: 'Pray St. Jude Novena - Day 4 focusing on Lost Causes. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-jude/day-4',
  },
  twitter: {
    title: 'St. Jude Novena - Day 4: Lost Causes',
    description: 'Pray St. Jude Novena - Day 4 focusing on Lost Causes. Join in praying the traditional novena.',
...
export default function StJudeNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Jude Novena – Day 4: Lost Causes
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Lost Causes</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on seeking St. Jude's help for our most impossible needs. We turn to him as the patron of lost causes when all hope seems gone.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Jude is particularly known for answering lost causes and impossible situations. When we have nowhere else to turn, he is there to help us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Jude, help us with our lost causes. May we always trust in your ability to help with impossible situations. Amen.
          </p>
        </section>
