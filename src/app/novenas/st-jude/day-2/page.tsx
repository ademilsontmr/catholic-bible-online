...
export const metadata: Metadata = {
  title: 'St. Jude Novena - Day 2: Zeal for the Gospel',
  description: "Pray St. Jude Novena - Day 2 focusing on Zeal for the Gospel. Join in praying the traditional novena for impossible causes.",
  keywords: [
    'st jude novena day 2',
    'saint jude novena day 2',
    'st jude day 2',
    'day 2 st jude novena',
    'zeal for the gospel prayer',
    'st jude novena zeal for the gospel',
    'saint jude zeal for the gospel',
    'impossible causes prayer day 2'
  ],
  openGraph: {
    title: 'St. Jude Novena - Day 2: Zeal for the Gospel',
    description: 'Pray St. Jude Novena - Day 2 focusing on Zeal for the Gospel. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-jude/day-2',
  },
  twitter: {
    title: 'St. Jude Novena - Day 2: Zeal for the Gospel',
    description: 'Pray St. Jude Novena - Day 2 focusing on Zeal for the Gospel. Join in praying the traditional novena.',
...
export default function StJudeNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Jude Novena – Day 2: Zeal for the Gospel
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Zeal for the Gospel</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on asking for St. Jude's zeal to preach the Gospel. We seek his help in spreading the Good News with the same passion he had.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Jude was known for his great zeal in preaching the Gospel. He traveled extensively and was willing to make great sacrifices to spread the Good News of Jesus Christ.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Jude, help us to have your zeal for the Gospel. May we always be willing to spread the Good News with passion and dedication. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Jude Novena - Day 2: Zeal for the Gospel" 
            url="/novenas/st-jude/day-2"
            excerpt="Join me in praying St. Jude Novena - Day 2 focusing on Zeal for the Gospel." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-jude/day-1"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Patron of the Impossible
          </Link>
          
          
          <Link
            href="/novenas/st-jude/day-3"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Patience in Struggles →
          </Link>
