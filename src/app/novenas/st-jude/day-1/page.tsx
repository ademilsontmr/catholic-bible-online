...
export const metadata: Metadata = {
  title: 'St. Jude Novena - Day 1: Patron of the Impossible',
  description: "Pray St. Jude Novena - Day 1 focusing on Patron of the Impossible. Join in praying the traditional novena for impossible causes.",
  keywords: [
    'st jude novena day 1',
    'saint jude novena day 1',
    'st jude day 1',
    'day 1 st jude novena',
    'patron of the impossible prayer',
    'st jude novena patron of the impossible',
    'saint jude patron of the impossible',
    'impossible causes prayer day 1'
  ],
  openGraph: {
    title: 'St. Jude Novena - Day 1: Patron of the Impossible',
    description: 'Pray St. Jude Novena - Day 1 focusing on Patron of the Impossible. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-jude/day-1',
  },
  twitter: {
    title: 'St. Jude Novena - Day 1: Patron of the Impossible',
    description: 'Pray St. Jude Novena - Day 1 focusing on Patron of the Impossible. Join in praying the traditional novena.',
...
export default function StJudeNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Jude Novena – Day 1: Patron of the Impossible
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patron of the Impossible</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of St. Jude Novena, we focus on St. Jude as the patron of the impossible. We recognize his special ability to help with seemingly hopeless situations.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Jude is known as the patron of impossible causes and lost causes. Through this devotion, we acknowledge his special power to intercede for us when all human help seems to fail.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Jude, help us to trust in your power as patron of the impossible. May we always turn to you with confidence in our most desperate needs. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Jude Novena - Day 1: Patron of the Impossible" 
            url="/novenas/st-jude/day-1"
            excerpt="Join me in praying St. Jude Novena - Day 1 focusing on Patron of the Impossible." 
          />
        </div>
