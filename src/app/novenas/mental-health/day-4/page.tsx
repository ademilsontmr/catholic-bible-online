...
export const metadata: Metadata = {
  title: 'Novena for Mental Health - Day 4: Humility',
  description: 'Pray the Novena for Mental Health - Day 4 focusing on Humility. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Mental Health – Day 4: Humility</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Novena for Mental Health, we pray for humility, following Jesus\' example of perfect humility before God. We ask God to help us imitate His humility and trust in God\'s will.</p>
        </section>
...
Teach us to trust in your timing.</strong>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for patience and perseverance in managing mental health.
...
May we always trust in your timing. Amen.
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/mental-health/day-5"
