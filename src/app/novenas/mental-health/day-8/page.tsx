...
export const metadata: Metadata = {
  title: 'Novena for Mental Health - Day 8: Intercession',
  description: 'Pray the Novena for Mental Health - Day 8 focusing on Intercession. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Mental Health – Day 8: Intercession</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day of the Novena for Mental Health, we pray for God\'s powerful intercession and His ability to help us with mental health. We ask God to intercede for us and guide us.</p>
        </section>
...
We come to you today with trust in your intercession.
              ...
              <p className="mb-6">
                <strong>Your love for us is perfect and your care is complete.</strong>
              </p>
              <p className="mb-6">
              ...
              <p className="mb-6">
                <strong>O Lord Jesus Christ, help us to love and care for ourselves!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for love and self-care in managing mental health.
                Love and Self-Care are gifts from God that help us face life's challenges.
              </p>
              ...
              <p className="mb-4">
                As we continue this novena, let us ask God to give us the love and self-care we need
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Lord Jesus Christ, help us to love and care for ourselves. Help us to love ourselves
as you love us and to commit to proper self-care.
May we always care for ourselves as we would care for others. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Mental Health - Day 8: Love and Self-Care" 
            url="/novenas/mental-health/day-8"
            excerpt="Join me in praying the Novena for Mental Health - Day 8 focusing on Love and Self-Care." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/mental-health/day-7"
          ...
          <Link 
            href="/novenas/mental-health/day-9"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 9: Surrender and Trust →
          </Link>
        </div>
      </div>
    </div>
