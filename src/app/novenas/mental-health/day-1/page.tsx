...
export const metadata: Metadata = {
  title: 'Novena for Mental Health - Day 1: Trust',
  description: 'Pray the Novena for Mental Health - Day 1 focusing on Trust. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Mental Health – Day 1: Trust</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Mental Health, we pray for trust in God\'s healing power and guidance in managing mental health. We ask God to help us trust in His care and His ability to guide us.</p>
        </section>
...
with confidence in every difficulty.
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for faith and trust in managing mental health.
...
in every need, knowing that you will always help us and guide us in managing our mental health.
