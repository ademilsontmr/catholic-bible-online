...
export const metadata: Metadata = {
  title: 'Novena for Mental Health - Day 5: Purity',
  description: 'Pray the Novena for Mental Health - Day 5 focusing on Purity. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Mental Health – Day 5: Purity</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day of the Novena for Mental Health, we pray for purity of heart and mind, like the pure Virgin Mary, Mother of God. We ask God to help us grow in purity and holiness.</p>
        </section>
...
Teach us to place our hope in you.</strong>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for hope and healing in managing mental health.
...
May we always place our hope in you. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Mental Health - Day 5: Hope and Healing" 
            url="/novenas/mental-health/day-5"
            excerpt="Join me in praying the Novena for Mental Health - Day 5 focusing on Hope and Healing." 
          />
        </div>
