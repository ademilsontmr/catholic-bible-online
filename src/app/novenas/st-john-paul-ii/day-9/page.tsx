...
export const metadata: Metadata = {
  ...
  description: 'Pray St. John Paul II Novena - Day 9 focusing on transforming hearts. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 9',
    'st john paul ii prayer novena day 9',
    'day 9 st john paul ii novena',
    'transforming hearts st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 9: Transforming Hearts',
    description: 'Pray St. John Paul II Novena - Day 9 focusing on Transforming Hearts.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-9',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 9: Transforming Hearts',
    description: 'Pray St. John Paul II Novena - Day 9 focusing on Transforming Hearts.',
...
export default function StJohnPaulIINovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 9: Transforming Hearts
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Today we pray that love transforms hearts and renews the face of the earth.
          </p>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Transforming Hearts</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day, we pray that love transforms hearts and renews the face of the earth.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that the love you have sparked in us transforms hearts and renews the face of the earth.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on transforming hearts. This aspect of honoring St. John Paul II helps you to understand 
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless you abundantly with St. John Paul II's witness and love. May you always 
            remember his extraordinary example of passion for Christ and be inspired to light 
            the world on fire with your love for the Church.
          </p>
        </section>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed St. John Paul II Novena! As you continue to honor St. John Paul II and seek his intercession 
            for youth and evangelization, may your heart be filled with gratitude for his example. May God 
            continue to bless you and help you become a witness of Jesus Christ for the whole world.
          </p>
        </section>
      ...
      <RelatedNovenas currentNovena="St. John Paul II Novena" />
