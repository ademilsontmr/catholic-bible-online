...
export const metadata: Metadata = {
  ...
  description: 'Pray St. John Paul II Novena - Day 6 focusing on sharing faith. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 6',
    'st john paul ii prayer novena day 6',
    'day 6 st john paul ii novena',
    'sharing faith st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 6: Sharing Faith',
    description: 'Pray St. John Paul II Novena - Day 6 focusing on Sharing Faith.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-6',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 6: Sharing Faith',
    description: 'Pray St. John Paul II Novena - Day 6 focusing on Sharing Faith.',
...
export default function StJohnPaulIINovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 6: Sharing Faith
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Sharing Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray that we may share the faith with those in doubt.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that we may share the faith to those in doubt.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on sharing faith. This aspect of honoring St. John Paul II helps you to understand 
