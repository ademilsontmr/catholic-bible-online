...
export const metadata: Metadata = {
  title: 'St. John Paul II Novena - Day 4: Seeing Goodness',
  description: 'Pray St. John Paul II Novena - Day 4 focusing on seeing goodness. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 4',
    'st john paul ii prayer novena day 4',
    'day 4 st john paul ii novena',
    'seeing goodness st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 4: Seeing Goodness',
    description: 'Pray St. John Paul II Novena - Day 4 focusing on Seeing Goodness.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-4',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 4: Seeing Goodness',
    description: 'Pray St. John Paul II Novena - Day 4 focusing on Seeing Goodness.',
...
export default function StJohnPaulIINovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 4: Seeing Goodness
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Seeing Goodness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for grace to see the goodness in our experiences every day.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that we will have the grace to see the goodness in our experiences every day.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on seeing goodness. This aspect of honoring St. John Paul II helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. John Paul II Novena - Day 4: Seeing Goodness" 
            url="/novenas/st-john-paul-ii/day-4"
            excerpt="Join me in praying St. John Paul II Novena - Day 4 focusing on seeing goodness." 
          />
        </div>
