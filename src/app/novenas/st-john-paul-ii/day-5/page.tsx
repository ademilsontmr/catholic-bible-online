...
export const metadata: Metadata = {
  ...
  description: 'Pray St. John Paul II Novena - Day 5 focusing on witness to mercy. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 5',
    'st john paul ii prayer novena day 5',
    'day 5 st john paul ii novena',
    'witness to mercy st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 5: Witness to Mercy',
    description: 'Pray St. John Paul II Novena - Day 5 focusing on Witness to Mercy.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-5',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 5: Witness to Mercy',
    description: 'Pray St. John Paul II Novena - Day 5 focusing on Witness to Mercy.',
...
export default function StJohnPaulIINovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 5: Witness to Mercy
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Witness to Mercy</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray that we may bear witness to God's mercy.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that we may bear witness to your mercy.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on witness to mercy. This aspect of honoring St. John Paul II helps you to understand 
