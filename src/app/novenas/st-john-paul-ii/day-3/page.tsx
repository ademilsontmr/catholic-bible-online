...
export const metadata: Metadata = {
  title: 'St. John Paul II Novena - Day 3: Guidance and Protection',
  description: 'Pray St. John Paul II Novena - Day 3 focusing on guidance and protection. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 3',
    'st john paul ii prayer novena day 3',
    'day 3 st john paul ii novena',
    'guidance and protection st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 3: Guidance and Protection',
    description: 'Pray St. John Paul II Novena - Day 3 focusing on Guidance and Protection.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-3',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 3: Guidance and Protection',
    description: 'Pray St. John Paul II Novena - Day 3 focusing on Guidance and Protection.',
...
export default function StJohnPaulIINovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 3: Guidance and Protection
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Guidance and Protection</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we pray that we will be guided and protected on difficult paths.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that we will be guided and protected as we walk the difficult paths of the world today.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on guidance and protection. This aspect of honoring St. John Paul II helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. John Paul II Novena - Day 3: Guidance and Protection" 
            url="/novenas/st-john-paul-ii/day-3"
            excerpt="Join me in praying St. John Paul II Novena - Day 3 focusing on guidance and protection." 
          />
        </div>
