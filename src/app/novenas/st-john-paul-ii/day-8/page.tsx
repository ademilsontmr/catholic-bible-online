...
export const metadata: Metadata = {
  title: 'St. John Paul II Novena - Day 8: Loving the Indifferent',
  description: 'Pray St. John Paul II Novena - Day 8 focusing on loving the indifferent. Join in praying for youth, mercy, and evangelization.',
  keywords: [
    'st john paul ii novena day 8',
    'st john paul ii prayer novena day 8',
    'day 8 st john paul ii novena',
    'loving the indifferent st john paul ii'
  ],
  openGraph: {
    title: 'St. John Paul II Novena - Day 8: Loving the Indifferent',
    description: 'Pray St. John Paul II Novena - Day 8 focusing on Loving the Indifferent.',
    url: 'https://catholicbibleonline.com/novenas/st-john-paul-ii/day-8',
  },
  twitter: {
    title: 'St. John Paul II Novena - Day 8: Loving the Indifferent',
    description: 'Pray St. John Paul II Novena - Day 8 focusing on Loving the Indifferent.',
...
export default function StJohnPaulIINovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. John Paul II Novena – Day 8: Loving the Indifferent
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Loving the Indifferent</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray that we may love those who feel indifferent.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Pray for us, that we may love those who feel indifferent.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on loving the indifferent. This aspect of honoring St. John Paul II helps you to understand 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. John Paul II Novena - Day 8: Loving the Indifferent" 
            url="/novenas/st-john-paul-ii/day-8"
            excerpt="Join me in praying St. John Paul II Novena - Day 8 focusing on loving the indifferent." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/st-john-paul-ii/day-7"
