...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 1: Power of the Virgin',
  description: "Pray The Three Hail Marys Novena - Day 1 focusing on Power of the Virgin. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 1',
    'hail mary novena day 1',
    'three hail marys day 1',
    'day 1 three hail marys novena',
    'power of the virgin prayer',
    'hail mary novena power of the virgin',
    'three hail marys power of the virgin',
    'blessed virgin mary novena day 1'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 1: Power of the Virgin',
    description: 'Pray The Three Hail Marys Novena - Day 1 focusing on Power of the Virgin. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-1',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 1: Power of the Virgin',
    description: 'Pray The Three Hail Marys Novena - Day 1 focusing on Power of the Virgin. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 1: Power of the Virgin
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Power of the Virgin</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of The Three Hail Marys Novena, we focus on praying through the immense Power of the Virgin Mary. We beseech her through that immense Power which she received from the Eternal Father.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Power of the Virgin Mary is immense and comes directly from the Eternal Father. Through this power, she can obtain for us purity of heart and strength to overcome all enemies of our soul.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to honor your Power and obtain purity of heart. May we always turn to you with confidence in your immense power. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 1: Power of the Virgin" 
            url="/novenas/three-hail-marys/day-1"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 1 focusing on Power of the Virgin." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-2"
