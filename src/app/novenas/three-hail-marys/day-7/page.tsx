...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 7: Mercy of Mary',
  description: "Pray The Three Hail Marys Novena - Day 7 focusing on Mercy of Mary. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 7',
    'hail mary novena day 7',
    'three hail marys day 7',
    'day 7 three hail marys novena',
    'mercy of mary prayer',
    'hail mary novena mercy of mary',
    'three hail marys mercy of mary',
    'blessed virgin mary novena day 7'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 7: Mercy of Mary',
    description: 'Pray The Three Hail Marys Novena - Day 7 focusing on Mercy of Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-7',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 7: Mercy of Mary',
    description: 'Pray The Three Hail Marys Novena - Day 7 focusing on Mercy of Mary. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 7: Mercy of Mary
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mercy of Mary</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying through the immense Love given to the Blessed Virgin Mary by the Holy Spirit for us poor sinners. We honor her mercy.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Mercy of Mary is immense and comes from the Holy Spirit. Through this mercy, she helps penitent sinners and obtains for us true contrition.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to honor your Mercy and obtain perfect contrition. May we always trust in your immense love for us sinners. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 7: Mercy of Mary" 
            url="/novenas/three-hail-marys/day-7"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 7 focusing on Mercy of Mary." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Christian Virtue
          </Link>
