...
export const metadata: Metadata = {
  ...
  description: "Pray The Three Hail Marys Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 5',
    'hail mary novena day 5',
    'three hail marys day 5',
    'day 5 three hail marys novena',
    'divine will prayer',
    'hail mary novena divine will',
    'three hail marys divine will',
    'blessed virgin mary novena day 5'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 5: Divine Will',
    description: 'Pray The Three Hail Marys Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-5',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 5: Divine Will',
    description: 'Pray The Three Hail Marys Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 5: Divine Will
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for a perfect knowledge of the divine Will and strength to accomplish it always. We seek to do what is most pleasing to God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Perfect knowledge of the divine Will is a great grace. Through Our Lady's wisdom, we can come to know God's will and have the strength to accomplish it.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to know and accomplish the divine Will. May we always do what is most pleasing to your beloved Son. Amen.
          </p>
        </section>
