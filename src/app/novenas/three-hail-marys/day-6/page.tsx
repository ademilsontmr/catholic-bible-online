...
export const metadata: Metadata = {
  ...
  description: "Pray The Three Hail Marys Novena - Day 6 focusing on Christian Virtue. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 6',
    'hail mary novena day 6',
    'three hail marys day 6',
    'day 6 three hail marys novena',
    'christian virtue prayer',
    'hail mary novena christian virtue',
    'three hail marys christian virtue',
    'blessed virgin mary novena day 6'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 6: Christian Virtue',
    description: 'Pray The Three Hail Marys Novena - Day 6 focusing on Christian Virtue. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-6',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 6: Christian Virtue',
    description: 'Pray The Three Hail Marys Novena - Day 6 focusing on Christian Virtue. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 6: Christian Virtue
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Christian Virtue</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for guidance in the path of Christian Virtue and perfection. We ask Our Lady to lead us as a tender Mother.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The path of Christian Virtue leads to perfection. Our Lady, as our tender Mother, guides us along this path and helps us grow in holiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to walk in the path of Christian Virtue. May we always be led by you as our tender Mother. Amen.
          </p>
        </section>
