...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 4: Meekness and Humility',
  description: "Pray The Three Hail Marys Novena - Day 4 focusing on Meekness and Humility. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 4',
    'hail mary novena day 4',
    'three hail marys day 4',
    'day 4 three hail marys novena',
    'meekness and humility prayer',
    'hail mary novena meekness and humility',
    'three hail marys meekness and humility',
    'blessed virgin mary novena day 4'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 4: Meekness and Humility',
    description: 'Pray The Three Hail Marys Novena - Day 4 focusing on Meekness and Humility. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-4',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 4: Meekness and Humility',
    description: 'Pray The Three Hail Marys Novena - Day 4 focusing on Meekness and Humility. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 4: Meekness and Humility
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Meekness and Humility</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for meekness and humility of heart. We ask Our Lady to obtain for us these essential virtues through her wisdom.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Meekness and humility are fundamental virtues in the Christian life. Through the wisdom of Our Lady, we can attain these virtues and grow in holiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to grow in meekness and humility through your wisdom. May we always be guided by your maternal care. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 4: Meekness and Humility" 
            url="/novenas/three-hail-marys/day-4"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 4 focusing on Meekness and Humility." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-3"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 3: Wisdom of Mary
          </Link>
          
          
          <Link
            href="/novenas/three-hail-marys/day-5"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 5: Divine Will →
          </Link>
