...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 2: Purity of Heart',
  description: "Pray The Three Hail Marys Novena - Day 2 focusing on Purity of Heart. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 2',
    'hail mary novena day 2',
    'three hail marys day 2',
    'day 2 three hail marys novena',
    'purity of heart prayer',
    'hail mary novena purity of heart',
    'three hail marys purity of heart',
    'blessed virgin mary novena day 2'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 2: Purity of Heart',
    description: 'Pray The Three Hail Marys Novena - Day 2 focusing on Purity of Heart. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-2',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 2: Purity of Heart',
    description: 'Pray The Three Hail Marys Novena - Day 2 focusing on Purity of Heart. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 2: Purity of Heart
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for purity of heart and strength to overcome all the enemies of our soul. We ask Our Lady to obtain these graces for us through her power.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Purity of heart is essential for spiritual growth. Through the intercession of Our Lady, we can obtain the strength to overcome all enemies of our soul and maintain purity of heart.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to overcome all enemies of our soul through your power. May we always seek purity of heart through your intercession. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 2: Purity of Heart" 
            url="/novenas/three-hail-marys/day-2"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 2 focusing on Purity of Heart." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-1"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Power of the Virgin
          </Link>
