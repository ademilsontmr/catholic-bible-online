...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 8: Perfect Contrition',
  description: "Pray The Three Hail Marys Novena - Day 8 focusing on Perfect Contrition. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 8',
    'hail mary novena day 8',
    'three hail marys day 8',
    'day 8 three hail marys novena',
    'perfect contrition prayer',
    'hail mary novena perfect contrition',
    'three hail marys perfect contrition',
    'blessed virgin mary novena day 8'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 8: Perfect Contrition',
    description: 'Pray The Three Hail Marys Novena - Day 8 focusing on Perfect Contrition. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-8',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 8: Perfect Contrition',
    description: 'Pray The Three Hail Marys Novena - Day 8 focusing on Perfect Contrition. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 8: Perfect Contrition
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Perfect Contrition</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for true and perfect contrition for our sins. We ask Our Lady to help us hate and detest our sins with all our heart because we love God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Perfect contrition is a precious gift that comes from loving God above all things. Through Our Lady's mercy, we can obtain this grace and truly repent of our sins.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to hate and detest our sins with all our heart. May we always love God above all things through your mercy. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 8: Perfect Contrition" 
            url="/novenas/three-hail-marys/day-8"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 8 focusing on Perfect Contrition." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-7"
          ...
          <Link
            href="/novenas/three-hail-marys/day-9"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Eyes of Mercy →
          </Link>
