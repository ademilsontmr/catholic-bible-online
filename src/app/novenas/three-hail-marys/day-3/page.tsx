...
export const metadata: Metadata = {
  title: 'The Three Hail Marys Novena - Day 3: Wisdom of Mary',
  description: "Pray The Three Hail Marys Novena - Day 3 focusing on Wisdom of Mary. Join in praying the traditional novena with daily Hail Marys.",
  keywords: [
    'three hail marys novena day 3',
    'hail mary novena day 3',
    'three hail marys day 3',
    'day 3 three hail marys novena',
    'wisdom of mary prayer',
    'hail mary novena wisdom of mary',
    'three hail marys wisdom of mary',
    'blessed virgin mary novena day 3'
  ],
  openGraph: {
    title: 'The Three Hail Marys Novena - Day 3: Wisdom of Mary',
    description: 'Pray The Three Hail Marys Novena - Day 3 focusing on Wisdom of Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/three-hail-marys/day-3',
  },
  twitter: {
    title: 'The Three Hail Marys Novena - Day 3: Wisdom of Mary',
    description: 'Pray The Three Hail Marys Novena - Day 3 focusing on Wisdom of Mary. Join in praying the traditional novena.',
...
export default function ThreeHailMarysNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Three Hail Marys Novena – Day 3: Wisdom of Mary
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Wisdom of Mary</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying through the ineffable Wisdom bestowed upon the Virgin Mary by the Incarnate Word of God. We honor her wisdom and seek her guidance.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Wisdom of Mary is ineffable and comes from the Incarnate Word of God. Through this wisdom, she can guide us in the path of Christian virtue and perfection.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, help us to honor your Wisdom and attain meekness and humility. May we always follow your guidance in the path of virtue. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Three Hail Marys Novena - Day 3: Wisdom of Mary" 
            url="/novenas/three-hail-marys/day-3"
            excerpt="Join me in praying The Three Hail Marys Novena - Day 3 focusing on Wisdom of Mary." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/three-hail-marys/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Meekness and Humility →
          </Link>
