...
export const metadata: Metadata = {
  title: 'Novena for God\'s Blessings - Day 7: Love of God',
  description: 'Pray the Novena for God\'s Blessings - Day 7 focusing on Love of God. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 7',
    'god\'s blessings prayer day 7',
    'love of god god\'s blessings prayer',
    'god\'s blessings novena day 7',
    'catholic god\'s blessings prayer day 7',
    'god\'s blessings love of god novena day 7',
    'prayer for god\'s blessings day 7',
    'god\'s blessings novena prayer day 7',
    'catholic novena god\'s blessings day 7',
    'god\'s blessings love of god prayer day 7'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 7: Love of God',
    description: 'Pray the Novena for God\'s Blessings - Day 7 focusing on Love of God. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-7',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 7: Love of God',
    description: 'Pray the Novena for God\'s Blessings - Day 7 focusing on Love of God. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 7: Love of God
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Pray for deeper love and worship of God our Creator.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for deeper love and worship of God our Creator.
Love of God is the greatest commandment and the foundation of our spiritual life.
God wants us to love Him with all our heart, soul, mind, and strength.
The title "God's Blessings" reminds us that God's love is the source of all blessings.
As we continue this novena, let us ask God to increase our love for Him.
Remember that loving God leads us to receive His abundant blessings and grace.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for God's Blessings - Day 7: Love of God" 
            url="/novenas/gods-blessings/day-7"
            excerpt="Join me in praying the Novena for God's Blessings - Day 7 focusing on Love of God." 
          />
        </div>
