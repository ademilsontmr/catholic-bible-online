...
export const metadata: Metadata = {
  title: 'Novena for God\'s Blessings - Day 1: Material Assistance',
  description: 'Pray the Novena for God\'s Blessings - Day 1 focusing on Material Assistance. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 1',
    'god\'s blessings prayer day 1',
    'material assistance god\'s blessings prayer',
    'god\'s blessings novena day 1',
    'catholic god\'s blessings prayer day 1',
    'god\'s blessings material assistance novena day 1',
    'prayer for god\'s blessings day 1',
    'god\'s blessings novena prayer day 1',
    'catholic novena god\'s blessings day 1',
    'god\'s blessings material assistance prayer day 1'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 1: Material Assistance',
    description: 'Pray the Novena for God\'s Blessings - Day 1 focusing on Material Assistance. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-1',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 1: Material Assistance',
    description: 'Pray the Novena for God\'s Blessings - Day 1 focusing on Material Assistance. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 1: Material Assistance
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Material Assistance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for God's Blessings, we pray for God's material assistance
            and provision of all our needs. We ask God to help us trust in His generosity and His ability
            to provide everything we need for our well-being.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for God's material assistance and provision of all our needs.
                Trust is the foundation of our relationship with God and our ability to receive His blessings.
              </p>

              <p className="mb-4">
                God is our loving Father who wants to bless us with everything we need for our spiritual and material well-being.
                As our Father, He loves us with a perfect paternal love and is always ready to provide for us.
              </p>

              <p className="mb-4">
                The title "God's Blessings" reminds us that every good thing comes from God.
                He is the source of all blessings, and He wants to pour out His grace and favor upon us in abundance.
              </p>
              ...
              <p className="mb-4">
                ...
                knowing that He will always provide for us and bless us abundantly.
              </p>

              <p>
                Remember that God's blessings are not limited by time or circumstance.
                He is always ready to bless us, and we can trust completely in His generous care.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for God's Blessings - Day 1: Material Assistance" 
            url="/novenas/gods-blessings/day-1"
            excerpt="Join me in praying the Novena for God's Blessings - Day 1 focusing on Material Assistance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/gods-blessings/day-2"
