...
export const metadata: Metadata = {
  title: 'Novena for God\'s Blessings - Day 2: Contentment',
  description: 'Pray the Novena for God\'s Blessings - Day 2 focusing on Contentment. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 2',
    'god\'s blessings prayer day 2',
    'contentment god\'s blessings prayer',
    'god\'s blessings novena day 2',
    'catholic god\'s blessings prayer day 2',
    'god\'s blessings contentment novena day 2',
    'prayer for god\'s blessings day 2',
    'god\'s blessings novena prayer day 2',
    'catholic novena god\'s blessings day 2',
    'god\'s blessings contentment prayer day 2'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 2: Contentment',
    description: 'Pray the Novena for God\'s Blessings - Day 2 focusing on Contentment. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-2',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 2: Contentment',
    description: 'Pray the Novena for God\'s Blessings - Day 2 focusing on Contentment. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 2: Contentment
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Contentment</h2>
          <p className="text-gray-700 leading-relaxed">
            Pray for contentment and happiness in our earthly lives.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for contentment and happiness in our earthly lives.
Contentment is a virtue that helps us find joy and satisfaction in what God has given us.
God wants us to be content with His blessings and to find happiness in His love.
The title "God's Blessings" reminds us that every good thing comes from God.
As we continue this novena, let us ask God to help us find contentment in His blessings.
Remember that true contentment comes from trusting in God's plan for our lives.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for God's Blessings - Day 2: Contentment" 
            url="/novenas/gods-blessings/day-2"
            excerpt="Join me in praying the Novena for God's Blessings - Day 2 focusing on Contentment." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/gods-blessings/day-3"
