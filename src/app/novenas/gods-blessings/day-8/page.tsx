...
export const metadata: Metadata = {
  title: 'Novena for God\'s Blessings - Day 8: Gratitude',
  description: 'Pray the Novena for God\'s Blessings - Day 8 focusing on Gratitude. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 8',
    'god\'s blessings prayer day 8',
    'gratitude god\'s blessings prayer',
    'god\'s blessings novena day 8',
    'catholic god\'s blessings prayer day 8',
    'god\'s blessings gratitude novena day 8',
    'prayer for god\'s blessings day 8',
    'god\'s blessings novena prayer day 8',
    'catholic novena god\'s blessings day 8',
    'god\'s blessings gratitude prayer day 8'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 8: Gratitude',
    description: 'Pray the Novena for God\'s Blessings - Day 8 focusing on Gratitude. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-8',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 8: Gratitude',
    description: 'Pray the Novena for God\'s Blessings - Day 8 focusing on Gratitude. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 8: Gratitude
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Pray for gratitude and appreciation of God's many blessings.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for gratitude and appreciation of God's many blessings.
Gratitude is essential for recognizing and receiving God's blessings in our lives.
God wants us to be grateful for all the gifts He has given us and continues to give us.
The title "God's Blessings" reminds us that we should always be thankful for God's generosity.
As we continue this novena, let us ask God to help us grow in gratitude.
Remember that gratitude opens our hearts to receive even more blessings from God.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for God's Blessings - Day 8: Gratitude" 
            url="/novenas/gods-blessings/day-8"
            excerpt="Join me in praying the Novena for God's Blessings - Day 8 focusing on Gratitude." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/gods-blessings/day-9"
