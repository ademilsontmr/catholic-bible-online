...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for God\'s Blessings - Day 4 focusing on Friendship with God. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 4',
    'god\'s blessings prayer day 4',
    'friendship with god god\'s blessings prayer',
    'god\'s blessings novena day 4',
    'catholic god\'s blessings prayer day 4',
    'god\'s blessings friendship with god novena day 4',
    'prayer for god\'s blessings day 4',
    'god\'s blessings novena prayer day 4',
    'catholic novena god\'s blessings day 4',
    'god\'s blessings friendship with god prayer day 4'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 4: Friendship with God',
    description: 'Pray the Novena for God\'s Blessings - Day 4 focusing on Friendship with God. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-4',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 4: Friendship with God',
    description: 'Pray the Novena for God\'s Blessings - Day 4 focusing on Friendship with God. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 4: Friendship with God
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Pray for deeper friendship and intimacy with God.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for deeper friendship and intimacy with God.
Friendship with God is the most important relationship we can have in our lives.
God wants to be our closest friend and to share His love with us intimately.
The title "God's Blessings" reminds us that God's friendship is the greatest blessing.
As we continue this novena, let us ask God to deepen our friendship with Him.
Remember that God is always ready to be our friend and to share His love with us.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/gods-blessings/day-5"
