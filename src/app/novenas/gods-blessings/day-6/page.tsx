...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for God\'s Blessings - Day 6 focusing on Humility. Join in praying for God\'s abundant blessings and divine favor.',
  keywords: [
    'novena for god\'s blessings day 6',
    'god\'s blessings prayer day 6',
    'humility god\'s blessings prayer',
    'god\'s blessings novena day 6',
    'catholic god\'s blessings prayer day 6',
    'god\'s blessings humility novena day 6',
    'prayer for god\'s blessings day 6',
    'god\'s blessings novena prayer day 6',
    'catholic novena god\'s blessings day 6',
    'god\'s blessings humility prayer day 6'
  ],
  openGraph: {
    title: 'Novena for God\'s Blessings - Day 6: Humility',
    description: 'Pray the Novena for God\'s Blessings - Day 6 focusing on Humility. Join in praying for God\'s abundant blessings and divine favor.',
    url: 'https://catholicbibleonline.com/novenas/gods-blessings/day-6',
  },
  twitter: {
    title: 'Novena for God\'s Blessings - Day 6: Humility',
    description: 'Pray the Novena for God\'s Blessings - Day 6 focusing on Humility. Join in praying for God\'s abundant blessings and divine favor.',
...
export default function NovenaForGodsBlessingsDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for God's Blessings – Day 6: Humility
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Pray for humility and recognition of our dependence on God.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for humility and recognition of our dependence on God.
Humility is the foundation of all virtues and helps us recognize our need for God.
God wants us to be humble and to recognize that everything we have comes from Him.
The title "God's Blessings" reminds us that we are completely dependent on God's generosity.
As we continue this novena, let us ask God to help us grow in humility.
Remember that humility opens our hearts to receive God's abundant blessings.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/gods-blessings/day-7"
