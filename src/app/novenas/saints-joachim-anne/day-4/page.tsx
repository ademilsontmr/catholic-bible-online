...
export const metadata: Metadata = {
  ...
  description: 'Pray Saints Joachim and Anne Novena - Day 4 focusing on devotion as parents. Join in praying for holiness in marriage and family life.',
  keywords: [
    'saints joachim and anne novena day 4',
    'st joachim st anne novena day 4',
    'day 4 saints joachim anne novena',
    'devotion as parents joachim anne'
  ],
  openGraph: {
    title: 'Saints Joachim and Anne Novena - Day 4: Devotion as Parents',
    description: 'Pray Saints Joachim and Anne Novena - Day 4 focusing on Devotion as Parents.',
    url: 'https://catholicbibleonline.com/novenas/saints-joachim-anne/day-4',
  },
  twitter: {
    title: 'Saints Joachim and Anne Novena - Day 4: Devotion as Parents',
    description: 'Pray Saints Joachim and Anne Novena - Day 4 focusing on Devotion as Parents.',
...
export default function SaintsJoachimAnneNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Saints Joachim and Anne Novena – Day 4: Devotion as Parents
          </h1>
        ...
        <section className="bg-emerald-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Devotion as Parents</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for devotion in carrying out parental duties faithfully.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Sts. Joachim and Anne as examples of holiness. Help us to imitate the devotion to You they showed in faithfully carrying out their duties as parents.</p>

              <p className="mb-4">Sts. Joachim and Anne, you prayed for a child for many years. When God eventually answered your prayers and made you the parents of Our Lady, you did all you could to raise her faithfully.</p>

              <p className="mb-4">You chose to dedicate Mary to God in the Temple when she was young. You raised her to be virtuous and set a holy example for her.</p>

              <p className="mb-4">Pray for me, that I may always seek to be a holy example to others. Pray that I may do all I can to lead others to holiness.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on devotion as parents. This aspect of honoring Saints Joachim and Anne helps us to grow in holiness 
