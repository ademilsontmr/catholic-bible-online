...
export const metadata: Metadata = {
  ...
  description: 'Pray Saints Joachim and Anne Novena - Day 8 focusing on cultivating holy family. Join in praying for holiness in marriage and family life.',
  keywords: [
    'saints joachim and anne novena day 8',
    'st joachim st anne novena day 8',
    'day 8 saints joachim anne novena',
    'cultivating holy family joachim anne'
  ],
  openGraph: {
    title: 'Saints Joachim and Anne Novena - Day 8: Cultivating Holy Family',
    description: 'Pray Saints Joachim and Anne Novena - Day 8 focusing on Cultivating Holy Family.',
    url: 'https://catholicbibleonline.com/novenas/saints-joachim-anne/day-8',
  },
  twitter: {
    title: 'Saints Joachim and Anne Novena - Day 8: Cultivating Holy Family',
    description: 'Pray Saints Joachim and Anne Novena - Day 8 focusing on Cultivating Holy Family.',
...
export default function SaintsJoachimAnneNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Saints Joachim and Anne Novena – Day 8: Cultivating Holy Family
          </h1>
        ...
        <section className="bg-emerald-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Cultivating Holy Family</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for cultivating a holy family life and appreciation.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Sts. Joachim and Anne as examples of holiness. Help us to imitate the love of You they showed in cultivating a holy family life.</p>

              <p className="mb-4">Sts. Joachim and Anne, you were grateful and happy to be able to raise your daughter, the Blessed Virgin Mary. You did all you could to give her a holy upbringing and family life.</p>

              <p className="mb-4">You must have raised Mary with an appreciation for the gift of family, as she went on to raise her Son among their extended family members.</p>

              <p className="mb-4">Pray for me, that I may always appreciate the gift of family in my life and in the world. Pray that I may do all I can to contribute to the holiness of those around me.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on cultivating holy family. This aspect of honoring Saints Joachim and Anne helps us to grow in holiness 
