...
export const metadata: Metadata = {
  title: 'Saints Joachim and Anne Novena - Day 5: Deep Trust in God',
  description: 'Pray Saints Joachim and Anne Novena - Day 5 focusing on deep trust in god. Join in praying for holiness in marriage and family life.',
  keywords: [
    'saints joachim and anne novena day 5',
    'st joachim st anne novena day 5',
    'day 5 saints joachim anne novena',
    'deep trust in god joachim anne'
  ],
  openGraph: {
    title: 'Saints Joachim and Anne Novena - Day 5: Deep Trust in God',
    description: 'Pray Saints Joachim and Anne Novena - Day 5 focusing on Deep Trust in God.',
    url: 'https://catholicbibleonline.com/novenas/saints-joachim-anne/day-5',
  },
  twitter: {
    title: 'Saints Joachim and Anne Novena - Day 5: Deep Trust in God',
    description: 'Pray Saints Joachim and Anne Novena - Day 5 focusing on Deep Trust in God.',
...
export default function SaintsJoachimAnneNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Saints Joachim and Anne Novena – Day 5: Deep Trust in God
          </h1>
        ...
        <section className="bg-emerald-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Deep Trust in God</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for deep trust in God even when His plan is unclear.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Sts. Joachim and Anne as examples of holiness. Help us to imitate the virtue they showed in their deep trust in You.</p>

              <p className="mb-4">Sts. Joachim and Anne, you prayed that you might conceive a child for many years. Even though you were advanced in age when an angel told you that you would conceive, you did not waver in your trust in God.</p>

              <p className="mb-4">We do not know for certain if you understood the significance of your mission as the parents of the Mother of God. But we know that you faithfully did all you could to raise Mary to be virtuous and holy.</p>

              <p className="mb-4">Pray for me, that I may be as faithful a servant of God as you were. Pray that I may always trust in God, even when I don't fully understand His plan.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on deep trust in god. This aspect of honoring Saints Joachim and Anne helps us to grow in holiness 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Saints Joachim and Anne Novena - Day 5: Deep Trust in God" 
            url="/novenas/saints-joachim-anne/day-5"
            excerpt="Join me in praying Saints Joachim and Anne Novena - Day 5 focusing on deep trust in god." 
          />
        </div>
