...
export const metadata: Metadata = {
  title: 'Saints Joachim and Anne Novena - Day 6: Holy Family Life',
  description: 'Pray Saints Joachim and Anne Novena - Day 6 focusing on holy family life. Join in praying for holiness in marriage and family life.',
  keywords: [
    'saints joachim and anne novena day 6',
    'st joachim st anne novena day 6',
    'day 6 saints joachim anne novena',
    'holy family life joachim anne'
  ],
  openGraph: {
    title: 'Saints Joachim and Anne Novena - Day 6: Holy Family Life',
    description: 'Pray Saints Joachim and Anne Novena - Day 6 focusing on Holy Family Life.',
    url: 'https://catholicbibleonline.com/novenas/saints-joachim-anne/day-6',
  },
  twitter: {
    title: 'Saints Joachim and Anne Novena - Day 6: Holy Family Life',
    description: 'Pray Saints Joachim and Anne Novena - Day 6 focusing on Holy Family Life.',
...
export default function SaintsJoachimAnneNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Saints Joachim and Anne Novena – Day 6: Holy Family Life
          </h1>
        ...
        <section className="bg-emerald-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Holy Family Life</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for a family life centered around God and holiness.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Sts. Joachim and Anne as examples of holiness. Help us to imitate the devotion to You they showed in striving for a holy family life centered around You.</p>

              <p className="mb-4">Sts. Joachim and Anne, we know few details for certain about your life. But as you set about the important task of raising the Blessed Virgin Mary, you must have taken great care to center your family life around God.</p>

              <p className="mb-4">You were holy examples to Mary in the family life that you shared with her. You helped her to become a virtuous servant of God.</p>

              <p className="mb-4">Pray for me, that I may always do all I can to lead others to God. Pray that I may be eager to serve God in every aspect of my life.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on holy family life. This aspect of honoring Saints Joachim and Anne helps us to grow in holiness 
        ...
        <ShareButton 
          title="Saints Joachim and Anne Novena - Day 6: Holy Family Life"
          text="Join me in praying Saints Joachim and Anne Novena - Day 6 focusing on holy family life."
        />
