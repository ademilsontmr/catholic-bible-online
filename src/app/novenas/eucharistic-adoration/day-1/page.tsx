    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Adoration of the Eucharist - Day 1: Growing in Faith in the Real Presence" 
            url="/novenas/eucharistic-adoration/day-1"
            excerpt="Join me in praying the Novena for Adoration of the Eucharist - Day 1 focusing on growing in faith in the real presence." 
          />
        </div>
