...
export const metadata: Metadata = {
  title: 'Novena to St. Benedict - Day 8: Powerful Intercession',
  description: 'Pray the Novena to St. Benedict - Day 8 focusing on Powerful Intercession. Join in praying the traditional novena to seek St. Benedict\'s intercession.',
  keywords: [
    'novena to st benedict day 8',
    'st benedict novena day 8',
    'benedict novena day 8',
    'st benedict prayer day 8',
    'day 8 st benedict novena',
    'powerful intercession prayer',
    'st benedict novena powerful intercession',
    'benedict novena powerful intercession'
  ],
  openGraph: {
    title: 'Novena to St. Benedict - Day 8: Powerful Intercession',
    description: 'Pray the Novena to St. Benedict - Day 8 focusing on Powerful Intercession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-benedict/day-8',
  },
  twitter: {
    title: 'Novena to St. Benedict - Day 8: Powerful Intercession',
    description: 'Pray the Novena to St. Benedict - Day 8 focusing on Powerful Intercession. Join in praying the traditional novena.',
...
export default function StBenedictNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Benedict – Day 8: Powerful Intercession
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Benedict\'s powerful intercession. As a saint in heaven, he continues to pray for us and intercede for our needs before God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Benedict\'s intercession is powerful because of his great love for God and his faithfulness during his earthly life. We can trust that he will bring our prayers to God with love and urgency.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Benedict, thank you for your powerful intercession on my behalf. May your prayers bring me closer to God and help me to grow in holiness and virtue. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Benedict - Day 8: Powerful Intercession" 
            url="/novenas/st-benedict/day-8"
            excerpt="Join me in praying the Novena to St. Benedict - Day 8 focusing on Powerful Intercession." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            href="/novenas/st-benedict/day-7"
          ...
          >
            ← Day 7: Compassion and Mercy
          </Link>
          
          
          <Link
            href="/novenas/st-benedict/day-9"
            className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Eternal Happiness →
          </Link>
