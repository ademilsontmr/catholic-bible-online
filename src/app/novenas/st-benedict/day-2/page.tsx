...
export const metadata: Metadata = {
  title: 'Novena to St. Benedict - Day 2: Protection and Guidance',
  description: 'Pray the Novena to St. Benedict - Day 2 focusing on Protection and Guidance. Join in praying the traditional novena to seek St. Benedict\'s intercession.',
  keywords: [
    'novena to st benedict day 2',
    'st benedict novena day 2',
    'benedict novena day 2',
    'st benedict prayer day 2',
    'day 2 st benedict novena',
    'protection and guidance prayer',
    'st benedict novena protection and guidance',
    'benedict novena protection and guidance'
  ],
  openGraph: {
    title: 'Novena to St. Benedict - Day 2: Protection and Guidance',
    description: 'Pray the Novena to St. Benedict - Day 2 focusing on Protection and Guidance. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-benedict/day-2',
  },
  twitter: {
    title: 'Novena to St. Benedict - Day 2: Protection and Guidance',
    description: 'Pray the Novena to St. Benedict - Day 2 focusing on Protection and Guidance. Join in praying the traditional novena.',
...
export default function StBenedictNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Benedict – Day 2: Protection and Guidance
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Protection and Guidance</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day of our novena, we focus on seeking St. Benedict\'s protection and guidance. In a world filled with spiritual dangers and temptations, we need the intercession of this powerful saint.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Benedict was known for his ability to recognize and overcome evil. When he lived in the cave at Subiaco, he faced many temptations and attacks from the devil, but through prayer and the sign of the cross, he was always victorious.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Benedict, protect me from all dangers and temptations that surround me daily. May your powerful intercession shield me from evil and guide me safely through the challenges of life. Help me to always seek God's will and to trust in His loving protection. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Benedict - Day 2: Protection and Guidance" 
            url="/novenas/st-benedict/day-2"
            excerpt="Join me in praying the Novena to St. Benedict - Day 2 focusing on Protection and Guidance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            href="/novenas/st-benedict/day-1"
          ...
          <Link
            href="/novenas/st-benedict/day-3"
            className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Selflessness and Charity →
          </Link>
