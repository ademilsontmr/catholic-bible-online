...
export const metadata: Metadata = {
  title: 'Novena to St. Benedict - Day 6: Divine Favor',
  description: 'Pray the Novena to St. Benedict - Day 6 focusing on Divine Favor. Join in praying the traditional novena to seek St. Benedict\'s intercession.',
  keywords: [
    'novena to st benedict day 6',
    'st benedict novena day 6',
    'benedict novena day 6',
    'st benedict prayer day 6',
    'day 6 st benedict novena',
    'divine favor prayer',
    'st benedict novena divine favor',
    'benedict novena divine favor'
  ],
  openGraph: {
    title: 'Novena to St. Benedict - Day 6: Divine Favor',
    description: 'Pray the Novena to St. Benedict - Day 6 focusing on Divine Favor. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-benedict/day-6',
  },
  twitter: {
    title: 'Novena to St. Benedict - Day 6: Divine Favor',
    description: 'Pray the Novena to St. Benedict - Day 6 focusing on Divine Favor. Join in praying the traditional novena.',
...
export default function StBenedictNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Benedict – Day 6: Divine Favor
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Favor</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on seeking God's divine favor and grace. St. Benedict knew that we need God's help to overcome the trials and afflictions of life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Benedict himself faced many trials and difficulties, but he always turned to God for strength and guidance. His example teaches us to trust in God's grace in all circumstances.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Benedict, help me to seek God's divine favor and grace in all my trials and difficulties. May your example of trust in God's providence strengthen me in times of need. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Benedict - Day 6: Divine Favor" 
            url="/novenas/st-benedict/day-6"
            excerpt="Join me in praying the Novena to St. Benedict - Day 6 focusing on Divine Favor." 
          />
        </div>
