...
export const metadata: Metadata = {
  title: 'Novena to St. Benedict - Day 1: Faith and Trust',
  description: "Pray the Novena to St. Benedict - Day 1 focusing on Faith and Trust. Join in praying the traditional novena to seek St. Benedict's intercession.",
  keywords: [
    'novena to st benedict day 1',
    'st benedict novena day 1',
    'benedict novena day 1',
    'st benedict prayer day 1',
    'day 1 st benedict novena',
    'faith and trust prayer',
    'st benedict novena faith and trust',
    'benedict novena faith and trust'
  ],
  openGraph: {
    title: 'Novena to St. Benedict - Day 1: Faith and Trust',
    description: 'Pray the Novena to St. Benedict - Day 1 focusing on Faith and Trust. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-benedict/day-1',
  },
  twitter: {
    title: 'Novena to St. Benedict - Day 1: Faith and Trust',
    description: 'Pray the Novena to St. Benedict - Day 1 focusing on Faith and Trust. Join in praying the traditional novena.',
...
export default function StBenedictNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Benedict – Day 1: Faith and Trust
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to St. Benedict, we pray for faith and trust in St. Benedict\'s powerful intercession. We ask St. Benedict to help us trust in his protection and his ability to bring our prayers to God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Benedict\'s life was marked by an unwavering faith in God's providence. When he left the world to seek God in solitude, he trusted that God would guide his path. This same trust sustained him through all the challenges he faced in founding monastic communities.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Benedict, help me to begin this novena with faith and trust in your powerful intercession. May your example of complete trust in God inspire me to surrender my worries and fears to His loving care. Guide me through these nine days of prayer, that I may grow closer to God and experience His grace in my life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Benedict - Day 1: Faith and Trust" 
            url="/novenas/st-benedict/day-1"
            excerpt="Join me in praying the Novena to St. Benedict - Day 1 focusing on Faith and Trust." 
          />
        </div>
