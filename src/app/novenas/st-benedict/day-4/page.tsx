...
export const metadata: Metadata = {
  title: 'Novena to St. Benedict - Day 4: Imitation of Virtues',
  description: 'Pray the Novena to St. Benedict - Day 4 focusing on Imitation of Virtues. Join in praying the traditional novena to seek St. Benedict\'s intercession.',
  keywords: [
    'novena to st benedict day 4',
    'st benedict novena day 4',
    'benedict novena day 4',
    'st benedict prayer day 4',
    'day 4 st benedict novena',
    'imitation of virtues prayer',
    'st benedict novena imitation of virtues',
    'benedict novena imitation of virtues'
  ],
  openGraph: {
    title: 'Novena to St. Benedict - Day 4: Imitation of Virtues',
    description: 'Pray the Novena to St. Benedict - Day 4 focusing on Imitation of Virtues. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-benedict/day-4',
  },
  twitter: {
    title: 'Novena to St. Benedict - Day 4: Imitation of Virtues',
    description: 'Pray the Novena to St. Benedict - Day 4 focusing on Imitation of Virtues. Join in praying the traditional novena.',
...
export default function StBenedictNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Benedict – Day 4: Imitation of Virtues
          </h1>
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Imitation of Virtues</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on imitating the virtues of St. Benedict. His life was marked by humility, obedience, prayer, and a deep love for God and neighbor.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Benedict\'s virtues were not acquired overnight, but through years of prayer, self-discipline, and faithful service to God. We too can grow in virtue through daily practice and God's grace.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-amber-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Benedict, help me to imitate your virtues in my daily life. May your example of humility, obedience, and prayer guide me in my journey toward holiness. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Benedict - Day 4: Imitation of Virtues" 
            url="/novenas/st-benedict/day-4"
            excerpt="Join me in praying the Novena to St. Benedict - Day 4 focusing on Imitation of Virtues." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            href="/novenas/st-benedict/day-5"
            className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 5: Service to Christ →
          </Link>
