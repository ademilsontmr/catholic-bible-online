...
export const metadata: Metadata = {
  title: 'Novena of the Holy Spirit - Day 9: Eternal Jubilation',
  description: "Pray the Novena of the Holy Spirit - Day 9 focusing on Eternal Jubilation. Join in praying the traditional novena to seek the Holy Spirit's intercession.",
  keywords: [
    'novena of the holy spirit day 9',
    'holy spirit novena day 9',
    'spirit novena day 9',
    'holy spirit prayer day 9',
    'day 9 holy spirit novena',
    'eternal jubilation prayer',
    'holy spirit novena eternal jubilation',
    'spirit novena eternal jubilation'
  ],
  openGraph: {
    title: 'Novena of the Holy Spirit - Day 9: Eternal Jubilation',
    description: 'Pray the Novena of the Holy Spirit - Day 9 focusing on Eternal Jubilation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-spirit/day-9',
  },
  twitter: {
    title: 'Novena of the Holy Spirit - Day 9: Eternal Jubilation',
    description: 'Pray the Novena of the Holy Spirit - Day 9 focusing on Eternal Jubilation. Join in praying the traditional novena.',
...
export default function HolySpiritNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena of the Holy Spirit – Day 9: Eternal Jubilation
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Eternal Jubilation</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on the Holy Spirit as the sweet song of love and of holy awe that eternally resounds around the triune throne. He weds in Himself the clear chimes of each and every being.
          </p>
        </section>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                ...
                That weds in itself the clear chimes of each and every being?<br/>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Spirit's eternal jubilation reminds us that He is the harmony that joins together the members to the Head. In Him, each one finds the mysterious meaning of his being blessed and joyously surges forth.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of the Holy Spirit. 
            May you always remember His divine presence and His miraculous help in all your needs. 
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena of the Holy Spirit! As you continue your spiritual journey, 
            may your heart be filled with sweet light, eternal love, sweet manna, eternal life, 
            penetrating rays, victorious power, God's molding hand, creative power, and eternal jubilation. 
            May the Holy Spirit continue to watch over you and work miracles in your life.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena of the Holy Spirit - Day 9: Eternal Jubilation" 
            url="/novenas/holy-spirit/day-9"
            excerpt="Join me in praying the Novena of the Holy Spirit - Day 9 focusing on Eternal Jubilation." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Holy Spirit Novena" />
    </div>
  )
}
