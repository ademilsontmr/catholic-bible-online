...
export const metadata: Metadata = {
  title: 'Novena of the Holy Spirit - Day 5: Penetrating Ray',
  description: "Pray the Novena of the Holy Spirit - Day 5 focusing on Penetrating Ray. Join in praying the traditional novena to seek the Holy Spirit's intercession.",
  keywords: [
    'novena of the holy spirit day 5',
    'holy spirit novena day 5',
    'spirit novena day 5',
    'holy spirit prayer day 5',
    'day 5 holy spirit novena',
    'penetrating ray prayer',
    'holy spirit novena penetrating ray',
    'spirit novena penetrating ray'
  ],
  openGraph: {
    title: 'Novena of the Holy Spirit - Day 5: Penetrating Ray',
    description: 'Pray the Novena of the Holy Spirit - Day 5 focusing on Penetrating Ray. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-spirit/day-5',
  },
  twitter: {
    title: 'Novena of the Holy Spirit - Day 5: Penetrating Ray',
    description: 'Pray the Novena of the Holy Spirit - Day 5 focusing on Penetrating Ray. Join in praying the traditional novena.',
...
export default function HolySpiritNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena of the Holy Spirit – Day 5: Penetrating Ray
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Penetrating Ray</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on the Holy Spirit as the ray that flashes down from the eternal Judge's throne and breaks into the night of the soul. Mercifully and relentlessly, He penetrates hidden folds.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Are you the master who builds the eternal cathedral,</strong><br/>
                Which towers from the earth through the heavens?<br/>
                Animated by you, the columns are raised high<br/>
                And stand immovably firm.
              </p>

              <p className="mb-6">
                <strong>Marked with the eternal name of God,</strong><br/>
                They stretch up to the light,<br/>
                Bearing the dome,<br/>
                Which crowns the holy cathedral,<br/>
                Your work that encircles the world:<br/>
                <strong>Holy Spirit God's molding hand!</strong>
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Spirit's penetrating ray reminds us that He illumines the darkness of our souls and reveals to us the truth about ourselves. His light brings holy fear, the beginning of wisdom.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Spirit, penetrating ray of divine light, help me to see myself as You see me. May Your light bring holy fear and the beginning of wisdom to my soul. Amen.
          </p>
        </section>
        ...
        <ShareButton 
          title="Novena of the Holy Spirit - Day 5: Penetrating Ray"
          text="Join me in praying the Novena of the Holy Spirit - Day 5 focusing on Penetrating Ray."
        />
