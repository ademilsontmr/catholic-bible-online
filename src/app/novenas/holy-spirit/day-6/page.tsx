...
export const metadata: Metadata = {
  title: 'Novena of the Holy Spirit - Day 6: Victorious Power',
  description: "Pray the Novena of the Holy Spirit - Day 6 focusing on Victorious Power. Join in praying the traditional novena to seek the Holy Spirit's intercession.",
  keywords: [
    'novena of the holy spirit day 6',
    'holy spirit novena day 6',
    'spirit novena day 6',
    'holy spirit prayer day 6',
    'day 6 holy spirit novena',
    'victorious power prayer',
    'holy spirit novena victorious power',
    'spirit novena victorious power'
  ],
  openGraph: {
    title: 'Novena of the Holy Spirit - Day 6: Victorious Power',
    description: 'Pray the Novena of the Holy Spirit - Day 6 focusing on Victorious Power. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-spirit/day-6',
  },
  twitter: {
    title: 'Novena of the Holy Spirit - Day 6: Victorious Power',
    description: 'Pray the Novena of the Holy Spirit - Day 6 focusing on Victorious Power. Join in praying the traditional novena.',
...
export default function HolySpiritNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena of the Holy Spirit – Day 6: Victorious Power
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Victorious Power</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we focus on the Holy Spirit as the spirit's fullness and power by which the Lamb releases the seal of God's eternal decree. Driven by Him, the messengers of judgment ride through the world.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Are you the one who created the unclouded mirror</strong><br/>
                Next to the Almighty's throne,<br/>
                Like a crystal sea,<br/>
                In which Divinity lovingly looks at itself?
              </p>

              <p className="mb-6">
                <strong>You bend over the fairest work of your creation,</strong><br/>
                And radiantly your own gaze<br/>
                Is illumined in return.<br/>
                And of all creatures the pure beauty<br/>
                Is joined in one in the dear form<br/>
                Of the Virgin, your immaculate bride:<br/>
                <strong>Holy Spirit Creator of all!</strong>
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Spirit's victorious power reminds us that He is the force that separates the kingdom of light from the kingdom of night. Through His power, heaven becomes new and new the earth.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Spirit, victorious power, help me to be strong in the face of spiritual battles. May Your power separate light from darkness in my life and make all things new. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena of the Holy Spirit - Day 6: Victorious Power" 
            url="/novenas/holy-spirit/day-6"
            excerpt="Join me in praying the Novena of the Holy Spirit - Day 6 focusing on Victorious Power." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/holy-spirit/day-5"
