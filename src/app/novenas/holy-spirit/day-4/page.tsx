...
export const metadata: Metadata = {
  title: 'Novena of the Holy Spirit - Day 4: Eternal Life',
  description: "Pray the Novena of the Holy Spirit - Day 4 focusing on Eternal Life. Join in praying the traditional novena to seek the Holy Spirit's intercession.",
  keywords: [
    'novena of the holy spirit day 4',
    'holy spirit novena day 4',
    'spirit novena day 4',
    'holy spirit prayer day 4',
    'day 4 holy spirit novena',
    'eternal life prayer',
    'holy spirit novena eternal life',
    'spirit novena eternal life'
  ],
  openGraph: {
    title: 'Novena of the Holy Spirit - Day 4: Eternal Life',
    description: 'Pray the Novena of the Holy Spirit - Day 4 focusing on Eternal Life. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/holy-spirit/day-4',
  },
  twitter: {
    title: 'Novena of the Holy Spirit - Day 4: Eternal Life',
    description: 'Pray the Novena of the Holy Spirit - Day 4 focusing on Eternal Life. Join in praying the traditional novena.',
...
export default function HolySpiritNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena of the Holy Spirit – Day 4: Eternal Life
          </h1>
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we focus on the Holy Spirit as eternal life. He who raised Himself from death to life has also awakened us to new life from the sleep of death, giving us new life from day to day.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Are you the spirit's fullness and the power</strong><br/>
                By which the Lamb releases the seal<br/>
                Of God's eternal decree?<br/>
                Driven by you<br/>
                The messengers of judgment ride through the world<br/>
                And separate with a sharp sword<br/>
                The kingdom of light from the kingdom of night.
              </p>

              <p className="mb-6">
                <strong>Then heaven becomes new and new the earth,</strong><br/>
                And all finds its proper place<br/>
                Through your breath:<br/>
                <strong>Holy Spirit victorious power!</strong>
              </p>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Holy Spirit's gift of eternal life reminds us that He is the source of our spiritual rebirth. Through Him, we are awakened from the sleep of sin and given new life in Christ.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-yellow-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Holy Spirit, source of eternal life, help me to be awakened to new life in Christ. May Your life-giving power renew me from day to day and prepare me for eternal life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena of the Holy Spirit - Day 4: Eternal Life" 
            url="/novenas/holy-spirit/day-4"
            excerpt="Join me in praying the Novena of the Holy Spirit - Day 4 focusing on Eternal Life." 
          />
        </div>
