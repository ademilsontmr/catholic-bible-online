...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 2: Mother of Fear',
  description: "Pray the Novena to Our Lady of Hope - Day 2 focusing on Mother of Fear. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 2',
    'our lady of hope novena day 2',
    'lady of hope novena day 2',
    'hope novena day 2',
    'day 2 novena to our lady of hope',
    'mother of fear prayer',
    'our lady of hope novena mother of fear',
    'hope prayer novena mother of fear'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 2: Mother of Fear',
    description: 'Pray the Novena to Our Lady of Hope - Day 2 focusing on Mother of Fear. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-2',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 2: Mother of Fear',
    description: 'Pray the Novena to Our Lady of Hope - Day 2 focusing on Mother of Fear. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 2: Mother of Fear
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother of Fear</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying to Our Lady as Mother of holy fear of the Lord. We ask her to help us develop a proper reverence and awe for God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Holy fear of the Lord is not about being afraid, but about having deep reverence and respect for God. Our Lady of Hope helps us develop this important virtue.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, teach us holy fear of the Lord. Help us to develop proper reverence and awe for God in all things. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 2: Mother of Fear" 
            url="/novenas/our-lady-of-hope/day-2"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 2 focusing on Mother of Fear." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-hope/day-1"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Mother of Fair Love
          </Link>
