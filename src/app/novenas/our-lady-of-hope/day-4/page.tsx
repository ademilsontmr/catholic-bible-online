...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 4: Mother of Holy Hope',
  description: "Pray the Novena to Our Lady of Hope - Day 4 focusing on Mother of Holy Hope. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 4',
    'our lady of hope novena day 4',
    'lady of hope novena day 4',
    'hope novena day 4',
    'day 4 novena to our lady of hope',
    'mother of holy hope prayer',
    'our lady of hope novena mother of holy hope',
    'hope prayer novena mother of holy hope'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 4: Mother of Holy Hope',
    description: 'Pray the Novena to Our Lady of Hope - Day 4 focusing on Mother of Holy Hope. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-4',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 4: Mother of Holy Hope',
    description: 'Pray the Novena to Our Lady of Hope - Day 4 focusing on Mother of Holy Hope. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 4: Mother of Holy Hope
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother of Holy Hope</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying to Our Lady as Mother of holy hope. We ask her to fill our hearts with the virtue of hope, especially in times of difficulty.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Holy hope is the virtue that helps us trust in God's promises and look forward to eternal life. Our Lady of Hope is the perfect teacher of this virtue.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, fill our hearts with holy hope. May we always trust in God's promises and look forward to eternal life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 4: Mother of Holy Hope" 
            url="/novenas/our-lady-of-hope/day-4"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 4 focusing on Mother of Holy Hope." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-hope/day-3"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 3: Mother of Knowledge
          </Link>
          
          
          <Link
            href="/novenas/our-lady-of-hope/day-5"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 5: Grace of the Way →
          </Link>
