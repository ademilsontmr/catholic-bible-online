...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 3: Mother of Knowledge',
  description: "Pray the Novena to Our Lady of Hope - Day 3 focusing on Mother of Knowledge. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 3',
    'our lady of hope novena day 3',
    'lady of hope novena day 3',
    'hope novena day 3',
    'day 3 novena to our lady of hope',
    'mother of knowledge prayer',
    'our lady of hope novena mother of knowledge',
    'hope prayer novena mother of knowledge'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 3: Mother of Knowledge',
    description: 'Pray the Novena to Our Lady of Hope - Day 3 focusing on Mother of Knowledge. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-3',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 3: Mother of Knowledge',
    description: 'Pray the Novena to Our Lady of Hope - Day 3 focusing on Mother of Knowledge. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 3: Mother of Knowledge
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother of Knowledge</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying to Our Lady as Mother of divine knowledge. We ask her to help us grow in wisdom and understanding of God's ways.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Divine knowledge comes from God and helps us understand His will and His ways. Our Lady of Hope can help us receive this precious gift.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, grant us divine knowledge. Help us to understand God's ways and grow in wisdom. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 3: Mother of Knowledge" 
            url="/novenas/our-lady-of-hope/day-3"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 3 focusing on Mother of Knowledge." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-hope/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Mother of Holy Hope →
          </Link>
