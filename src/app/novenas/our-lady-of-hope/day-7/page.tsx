...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 7: Hope of Life',
  description: "Pray the Novena to Our Lady of Hope - Day 7 focusing on Hope of Life. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 7',
    'our lady of hope novena day 7',
    'lady of hope novena day 7',
    'hope novena day 7',
    'day 7 novena to our lady of hope',
    'hope of life prayer',
    'our lady of hope novena hope of life',
    'hope prayer novena hope of life'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 7: Hope of Life',
    description: 'Pray the Novena to Our Lady of Hope - Day 7 focusing on Hope of Life. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-7',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 7: Hope of Life',
    description: 'Pray the Novena to Our Lady of Hope - Day 7 focusing on Hope of Life. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 7: Hope of Life
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Hope of Life</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for the hope of life through Our Lady. We ask her to help us hope for eternal life and live this life with purpose.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The hope of life helps us look forward to eternal life with God and gives meaning to our earthly existence. Our Lady of Hope strengthens this hope in us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, strengthen our hope of life. Help us to hope for eternal life and live this life with purpose and meaning. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 7: Hope of Life" 
            url="/novenas/our-lady-of-hope/day-7"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 7 focusing on Hope of Life." 
          />
        </div>
