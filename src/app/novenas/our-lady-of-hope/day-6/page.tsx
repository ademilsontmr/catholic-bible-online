...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to Our Lady of Hope - Day 6 focusing on Grace of the Truth. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 6',
    'our lady of hope novena day 6',
    'lady of hope novena day 6',
    'hope novena day 6',
    'day 6 novena to our lady of hope',
    'grace of the truth prayer',
    'our lady of hope novena grace of the truth',
    'hope prayer novena grace of the truth'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 6: Grace of the Truth',
    description: 'Pray the Novena to Our Lady of Hope - Day 6 focusing on Grace of the Truth. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-6',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 6: Grace of the Truth',
    description: 'Pray the Novena to Our Lady of Hope - Day 6 focusing on Grace of the Truth. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 6: Grace of the Truth
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Grace of the Truth</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the grace of the truth through Our Lady. We ask her to help us know and live the truth of God's love and His teachings.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The grace of the truth helps us recognize what is true and good, and reject what is false and evil. Our Lady of Hope helps us discern the truth.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, grant us the grace of the truth. Help us to know and live the truth of God's love and teachings. Amen.
          </p>
        </section>
