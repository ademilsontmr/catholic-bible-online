...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 1: Mother of Fair Love',
  description: "Pray the Novena to Our Lady of Hope - Day 1 focusing on Mother of Fair Love. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 1',
    'our lady of hope novena day 1',
    'lady of hope novena day 1',
    'hope novena day 1',
    'day 1 novena to our lady of hope',
    'mother of fair love prayer',
    'our lady of hope novena mother of fair love',
    'hope prayer novena mother of fair love'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 1: Mother of Fair Love',
    description: 'Pray the Novena to Our Lady of Hope - Day 1 focusing on Mother of Fair Love. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-1',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 1: Mother of Fair Love',
    description: 'Pray the Novena to Our Lady of Hope - Day 1 focusing on Mother of Fair Love. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 1: Mother of Fair Love
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Mother of Fair Love</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to Our Lady of Hope, we focus on praying to Our Lady as Mother of fair love and grace. We recognize her as the source of all love and grace in our lives.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Hope is the mother of fair love, which means she teaches us to love God and others with pure, selfless love. Through her intercession, we can grow in this beautiful virtue.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, help us to grow in fair love and grace. May we always turn to you as our Mother and learn to love as you do. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 1: Mother of Fair Love" 
            url="/novenas/our-lady-of-hope/day-1"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 1 focusing on Mother of Fair Love." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-hope/day-2"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 2: Mother of Fear →
          </Link>
