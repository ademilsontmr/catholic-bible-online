...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Hope - Day 5: Grace of the Way',
  description: "Pray the Novena to Our Lady of Hope - Day 5 focusing on Grace of the Way. Join in praying the traditional novena for hope and grace.",
  keywords: [
    'novena to our lady of hope day 5',
    'our lady of hope novena day 5',
    'lady of hope novena day 5',
    'hope novena day 5',
    'day 5 novena to our lady of hope',
    'grace of the way prayer',
    'our lady of hope novena grace of the way',
    'hope prayer novena grace of the way'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Hope - Day 5: Grace of the Way',
    description: 'Pray the Novena to Our Lady of Hope - Day 5 focusing on Grace of the Way. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-hope/day-5',
  },
  twitter: {
    title: 'Novena to Our Lady of Hope - Day 5: Grace of the Way',
    description: 'Pray the Novena to Our Lady of Hope - Day 5 focusing on Grace of the Way. Join in praying the traditional novena.',
...
export default function OurLadyOfHopeNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Hope – Day 5: Grace of the Way
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Grace of the Way</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for the grace of the way through Our Lady. We ask her to help us follow the path that leads to God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The grace of the way helps us stay on the right path in life, following God's will and avoiding sin. Our Lady of Hope guides us along this way.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Blessed Virgin Mary, Mother of Hope, give us the grace of the way. Help us to follow the path that leads to God and avoid the path of sin. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Hope - Day 5: Grace of the Way" 
            url="/novenas/our-lady-of-hope/day-5"
            excerpt="Join me in praying the Novena to Our Lady of Hope - Day 5 focusing on Grace of the Way." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-hope/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Grace of the Truth →
          </Link>
