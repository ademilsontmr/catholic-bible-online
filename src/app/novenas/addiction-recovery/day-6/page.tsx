...
export const metadata: Metadata = {
  title: 'Novena for Addiction Recovery - Day 6: Perseverance',
  description: 'Pray the Novena for Addiction Recovery - Day 6 focusing on perseverance. Join in praying for strength and healing from addiction.',
  keywords: [
    'novena for addiction recovery day 6',
    'addiction recovery prayer day 6',
    'day 6 addiction novena',
    'perseverance addiction recovery'
  ],
  openGraph: {
    title: 'Novena for Addiction Recovery - Day 6: Perseverance',
    description: 'Pray the Novena for Addiction Recovery - Day 6 focusing on Perseverance.',
    url: 'https://catholicbibleonline.com/novenas/addiction-recovery/day-6',
  },
  twitter: {
    title: 'Novena for Addiction Recovery - Day 6: Perseverance',
    description: 'Pray the Novena for Addiction Recovery - Day 6 focusing on Perseverance.',
...
export default function NovenaForAddictionRecoveryDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Addiction Recovery – Day 6: Perseverance
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for perseverance for those facing difficulties in recovery.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">The path to recovery from addiction is not an easy one. You know that all who seek to recover from an addiction will face many difficulties and struggles on their journey. You, all-powerful Lord, are able to help all those on this journey to grow in the virtue of perseverance as they face these struggles.</p>

              <p className="mb-4">Please pour Your merciful assistance on all who struggle with addiction, and help all who are facing difficulty on their recovery journey to grow in perseverance!</p>

              <p className="mb-4">Help us to turn to You always as we face sufferings and trials in our lives. Help us to remember Your loving mercy every day of our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on perseverance. This aspect of addiction recovery helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Addiction Recovery - Day 6: Perseverance" 
            url="/novenas/addiction-recovery/day-6"
            excerpt="Join me in praying the Novena for Addiction Recovery - Day 6 focusing on perseverance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/addiction-recovery/day-7"
