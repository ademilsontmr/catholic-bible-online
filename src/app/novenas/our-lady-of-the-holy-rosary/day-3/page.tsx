    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Holy Rosary Novena - Day 3: Atonement for Offenses" 
            url="/novenas/our-lady-of-the-holy-rosary/day-3"
            excerpt="Join me in praying the Our Lady of the Holy Rosary Novena - Day 3 focusing on Atonement for Offenses." 
          />
        </div>
