...
export const metadata: Metadata = {
  title: 'Our Lady of the Holy Rosary Novena - Day 7: Confidence in Mary',
  description: "Pray the Our Lady of the Holy Rosary Novena - Day 7 focusing on Confidence in Mary. Join in praying the traditional novena with daily Rosary.",
  keywords: [
    'our lady of the holy rosary novena day 7',
    'holy rosary novena day 7',
    'rosary novena day 7',
    'our lady of the rosary novena day 7',
    'day 7 our lady of the holy rosary novena',
    'confidence in mary prayer',
    'holy rosary novena confidence in mary',
    'rosary prayer novena confidence in mary'
  ],
  openGraph: {
    title: 'Our Lady of the Holy Rosary Novena - Day 7: Confidence in Mary',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 7 focusing on Confidence in Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-holy-rosary/day-7',
  },
  twitter: {
    title: 'Our Lady of the Holy Rosary Novena - Day 7: Confidence in Mary',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 7 focusing on Confidence in Mary. Join in praying the traditional novena.',
...
export default function OurLadyOfTheHolyRosaryNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Holy Rosary Novena – Day 7: Confidence in Mary
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Confidence in Mary</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on putting all our confidence in Our Lady's powerful prayers. We trust that if she prays for us, we cannot be refused.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady's prayers before God are most powerful. She is the Queen of Heaven and Earth, and her intercession is always heard and answered.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Our Lady of the Holy Rosary, increase our confidence in your powerful prayers. May we trust that you will never refuse to help us. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Holy Rosary Novena - Day 7: Confidence in Mary" 
            url="/novenas/our-lady-of-the-holy-rosary/day-7"
            excerpt="Join me in praying the Our Lady of the Holy Rosary Novena - Day 7 focusing on Confidence in Mary." 
          />
        </div>
