...
export const metadata: Metadata = {
  title: 'Our Lady of the Holy Rosary Novena - Day 1: Tender Love for Mary',
  description: "Pray the Our Lady of the Holy Rosary Novena - Day 1 focusing on Tender Love for Mary. Join in praying the traditional novena with daily Rosary.",
  keywords: [
    'our lady of the holy rosary novena day 1',
    'holy rosary novena day 1',
    'rosary novena day 1',
    'our lady of the rosary novena day 1',
    'day 1 our lady of the holy rosary novena',
    'tender love for mary prayer',
    'holy rosary novena tender love for mary',
    'rosary prayer novena tender love for mary'
  ],
  openGraph: {
    title: 'Our Lady of the Holy Rosary Novena - Day 1: Tender Love for Mary',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 1 focusing on Tender Love for Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-holy-rosary/day-1',
  },
  twitter: {
    title: 'Our Lady of the Holy Rosary Novena - Day 1: Tender Love for Mary',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 1 focusing on Tender Love for Mary. Join in praying the traditional novena.',
...
export default function OurLadyOfTheHolyRosaryNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Holy Rosary Novena – Day 1: Tender Love for Mary
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Tender Love for Mary</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Our Lady of the Holy Rosary Novena, we focus on praying with tender love for Our Lady. We offer the Holy Rosary as a proof of our tender love for her.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of the Holy Rosary calls us to love her with tender devotion. Through the Rosary, we express our love for her and seek her maternal care and intercession.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Our Lady of the Holy Rosary, help us to love you with tender devotion. May we always offer the Rosary as a proof of our love for you. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Holy Rosary Novena - Day 1: Tender Love for Mary" 
            url="/novenas/our-lady-of-the-holy-rosary/day-1"
            excerpt="Join me in praying the Our Lady of the Holy Rosary Novena - Day 1 focusing on Tender Love for Mary." 
          />
        </div>
