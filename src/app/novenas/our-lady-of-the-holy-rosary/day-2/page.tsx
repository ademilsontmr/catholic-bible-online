...
export const metadata: Metadata = {
  ...
  description: "Pray the Our Lady of the Holy Rosary Novena - Day 2 focusing on Intentions of the Sacred Heart. Join in praying the traditional novena with daily Rosary.",
  keywords: [
    'our lady of the holy rosary novena day 2',
    'holy rosary novena day 2',
    'rosary novena day 2',
    'our lady of the rosary novena day 2',
    'day 2 our lady of the holy rosary novena',
    'intentions of the sacred heart prayer',
    'holy rosary novena intentions of the sacred heart',
    'rosary prayer novena intentions of the sacred heart'
  ],
  openGraph: {
    title: 'Our Lady of the Holy Rosary Novena - Day 2: Intentions of the Sacred Heart',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 2 focusing on Intentions of the Sacred Heart. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-holy-rosary/day-2',
  },
  twitter: {
    title: 'Our Lady of the Holy Rosary Novena - Day 2: Intentions of the Sacred Heart',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 2 focusing on Intentions of the Sacred Heart. Join in praying the traditional novena.',
...
export default function OurLadyOfTheHolyRosaryNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Holy Rosary Novena – Day 2: Intentions of the Sacred Heart
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Intentions of the Sacred Heart</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the intentions of the Sacred Heart of Jesus. We offer our Rosary for His intentions and for the glory of His Sacred Heart.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Sacred Heart of Jesus has many intentions for the world and for each of us. By offering our Rosary for His intentions, we align our prayers with His divine will.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Our Lady of the Holy Rosary, help us to pray for the intentions of the Sacred Heart of Jesus. May our prayers always be aligned with His divine will. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-the-holy-rosary/day-1"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Tender Love for Mary
          </Link>
          
          
          <Link
            href="/novenas/our-lady-of-the-holy-rosary/day-3"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Atonement for Offenses →
          </Link>
