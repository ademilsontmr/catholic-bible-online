...
export const metadata: Metadata = {
  title: 'Our Lady of the Holy Rosary Novena - Day 6: Spiritual Bouquet',
  description: "Pray the Our Lady of the Holy Rosary Novena - Day 6 focusing on Spiritual Bouquet. Join in praying the traditional novena with daily Rosary.",
  keywords: [
    'our lady of the holy rosary novena day 6',
    'holy rosary novena day 6',
    'rosary novena day 6',
    'our lady of the rosary novena day 6',
    'day 6 our lady of the holy rosary novena',
    'spiritual bouquet prayer',
    'holy rosary novena spiritual bouquet',
    'rosary prayer novena spiritual bouquet'
  ],
  openGraph: {
    title: 'Our Lady of the Holy Rosary Novena - Day 6: Spiritual Bouquet',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 6 focusing on Spiritual Bouquet. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-holy-rosary/day-6',
  },
  twitter: {
    title: 'Our Lady of the Holy Rosary Novena - Day 6: Spiritual Bouquet',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 6 focusing on Spiritual Bouquet. Join in praying the traditional novena.',
...
export default function OurLadyOfTheHolyRosaryNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Holy Rosary Novena – Day 6: Spiritual Bouquet
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spiritual Bouquet</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on offering a spiritual bouquet of roses to Our Lady. Each Hail Mary is like a rose offered to her Immaculate Heart.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              When we pray the Rosary, we create a beautiful spiritual bouquet for Our Lady. Each prayer is a flower of love and devotion offered to her.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Our Lady of the Holy Rosary, accept our spiritual bouquet of roses. May each Hail Mary be a flower of love offered to your Immaculate Heart. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Holy Rosary Novena - Day 6: Spiritual Bouquet" 
            url="/novenas/our-lady-of-the-holy-rosary/day-6"
            excerpt="Join me in praying the Our Lady of the Holy Rosary Novena - Day 6 focusing on Spiritual Bouquet." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-the-holy-rosary/day-5"
