...
export const metadata: Metadata = {
  title: 'Our Lady of the Holy Rosary Novena - Day 5: Divine Will',
  description: "Pray the Our Lady of the Holy Rosary Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena with daily Rosary.",
  keywords: [
    'our lady of the holy rosary novena day 5',
    'holy rosary novena day 5',
    'rosary novena day 5',
    'our lady of the rosary novena day 5',
    'day 5 our lady of the holy rosary novena',
    'divine will prayer',
    'holy rosary novena divine will',
    'rosary prayer novena divine will'
  ],
  openGraph: {
    title: 'Our Lady of the Holy Rosary Novena - Day 5: Divine Will',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-holy-rosary/day-5',
  },
  twitter: {
    title: 'Our Lady of the Holy Rosary Novena - Day 5: Divine Will',
    description: 'Pray the Our Lady of the Holy Rosary Novena - Day 5 focusing on Divine Will. Join in praying the traditional novena.',
...
export default function OurLadyOfTheHolyRosaryNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Holy Rosary Novena – Day 5: Divine Will
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying to seek God's holy Will concerning our request. We ask Our Lady to help us accept whatever is best for our soul.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Sometimes what we ask for may not be what is best for us. Our Lady helps us seek God's will and accept His plan with trust and surrender.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Our Lady of the Holy Rosary, help us to seek God's holy Will in all things. May we accept His plan with trust and surrender. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Holy Rosary Novena - Day 5: Divine Will" 
            url="/novenas/our-lady-of-the-holy-rosary/day-5"
            excerpt="Join me in praying the Our Lady of the Holy Rosary Novena - Day 5 focusing on Divine Will." 
          />
        </div>
