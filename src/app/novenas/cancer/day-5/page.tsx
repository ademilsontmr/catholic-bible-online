...
export const metadata: Metadata = {
  title: 'Novena for Cancer - Day 5: Purity',
  description: 'Pray the Novena for Cancer - Day 5 focusing on Purity. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 5',
    'cancer novena day 5',
    'purity prayer cancer',
  ...
  openGraph: {
    title: 'Novena for Cancer - Day 5: Purity',
    description: 'Pray the Novena for Cancer - Day 5 focusing on Purity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-5',
  },
  twitter: {
    title: 'Novena for Cancer - Day 5: Purity',
    description: 'Pray the Novena for Cancer - Day 5 focusing on Purity. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Cancer – Day 5: Purity
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day of the Novena for Cancer, we pray for purity in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on enduring difficult cancer treatments and ask God to help us grow in purity and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">The process of fighting cancer can be difficult and full of suffering for many reasons. Often, the medical treatment for cancer is very difficult and can bring the patient a variety of other physical sufferings and side effects. Those being treated for cancer are in need of a lot of help to persevere through their sufferings.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to help all those who are suffering from the effects of their cancer treatment!</p>
              <p className="mb-6">Help us to grow in our relationship with You each day, even in the midst of suffering. Help us to grow in all virtues necessary for our holiness.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for purity in God\'s plan and His ability to grant us healing and strength in all situations.
                Purity is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on enduring difficult cancer treatments reminds us that healing is not just about physical recovery, but about 
        ...
        {/* Share Section */}
        <section className="mb-12">
          <ShareButton title="Novena for Cancer - Day 5: Purity" text="Join me in praying the Novena for Cancer - Day 5 focusing on Purity. Pray for God's healing and strength for cancer patients and their families." />
        </section>

        {/* Navigation */}
        <div className="flex justify-between items-center mb-12">
          <Link
            href="/novenas/cancer/day-4"
