...
export const metadata: Metadata = {
  title: 'Novena for Cancer - Day 2: Hope',
  description: 'Pray the Novena for Cancer - Day 2 focusing on Hope. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 2',
    'cancer novena day 2',
    'hope prayer cancer',
  ...
  openGraph: {
    title: 'Novena for Cancer - Day 2: Hope',
    description: 'Pray the Novena for Cancer - Day 2 focusing on Hope. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-2',
  },
  twitter: {
    title: 'Novena for Cancer - Day 2: Hope',
    description: 'Pray the Novena for Cancer - Day 2 focusing on Hope. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this second day of the Novena for Cancer, we pray for hope in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on enduring long battles with cancer and ask God to help us grow in hope and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">A battle with cancer is often a very long and difficult process that requires immense strength and perseverance. Those who struggle with cancer for a long time endure a lot of physical suffering, and many endure emotional and mental suffering as well. You are able to give all the grace needed to those who have had a long battle with cancer.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to help all those who have battled cancer for a long time!</p>
              <p className="mb-6">Help us to grow closer to You in all of our sufferings. Help us to take every opportunity to grow in holiness in our lives.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for hope in God\'s plan and His ability to grant us healing and strength in all situations.
                Hope is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on enduring long battles with cancer reminds us that healing is not just about physical recovery, but about 
        ...
        {/* Share Section */}
        <section className="mb-12">
          <ShareButton title="Novena for Cancer - Day 2: Hope" text="Join me in praying the Novena for Cancer - Day 2 focusing on Hope. Pray for God's healing and strength for cancer patients and their families." />
        </section>

        {/* Navigation */}
        <div className="flex justify-between items-center mb-12">
          <Link
            href="/novenas/cancer/day-1"
