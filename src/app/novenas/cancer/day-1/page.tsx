...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for Cancer - Day 1 focusing on Trust. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 1',
    'cancer novena day 1',
    'trust prayer cancer',
  ...
  openGraph: {
    title: 'Novena for Cancer - Day 1: Trust',
    description: 'Pray the Novena for Cancer - Day 1 focusing on Trust. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-1',
  },
  twitter: {
    title: 'Novena for Cancer - Day 1: Trust',
    description: 'Pray the Novena for Cancer - Day 1 focusing on Trust. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Cancer, we pray for trust in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on facing a new cancer diagnosis and ask God to help us grow in trust and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">A cancer diagnosis can be a very difficult and overwhelming event in a person's life, as they prepare for great suffering and danger to their life. Those who have recently been diagnosed with cancer can turn to You as they struggle to prepare for the difficulties ahead, and You can bring them the help they need.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to help all those who have recently been diagnosed with cancer!</p>
              <p className="mb-6">Help us to rely on You more fully in all of the trials of our lives. Help us to offer all of our suffering in union with Yours.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for trust in God\'s plan and His ability to grant us healing and strength in all situations.
                Trust is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on facing a new cancer diagnosis reminds us that healing is not just about physical recovery, but about 
