...
export const metadata: Metadata = {
  title: 'Novena for Cancer - Day 7: Perseverance',
  description: 'Pray the Novena for Cancer - Day 7 focusing on Perseverance. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 7',
    'cancer novena day 7',
    'perseverance prayer cancer',
    'catholic prayer for perseverance',
    'novena for cancer prayer',
    'day 7 cancer novena',
    'perseverance god cancer',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Cancer - Day 7: Perseverance',
    description: 'Pray the Novena for Cancer - Day 7 focusing on Perseverance. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-7',
  },
  twitter: {
    title: 'Novena for Cancer - Day 7: Perseverance',
    description: 'Pray the Novena for Cancer - Day 7 focusing on Perseverance. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Cancer – Day 7: Perseverance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day of the Novena for Cancer, we pray for perseverance in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on persevering through physical and emotional suffering and ask God to help us grow in perseverance and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">Those who suffer from cancer endure a great amount of physical suffering that can be overwhelming. They often also face a lot of emotional and mental trials as well, including fear, anxiety, and depression. Those who suffer from cancer need grace to be able to persevere in their battle against cancer.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to grant the grace of perseverance to all cancer patients!</p>
              <p className="mb-6">Help us to seek growth in virtue and holiness in all of the sufferings we face in our lives. Help us to grow closer to You each day, no matter what difficulties we might face.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for perseverance in God\'s plan and His ability to grant us healing and strength in all situations.
                Perseverance is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on persevering through physical and emotional suffering reminds us that healing is not just about physical recovery, but about 
        ...
        {/* Share Section */}
        <section className="mb-12">
          <ShareButton title="Novena for Cancer - Day 7: Perseverance" text="Join me in praying the Novena for Cancer - Day 7 focusing on Perseverance. Pray for God's healing and strength for cancer patients and their families." />
        </section>

        {/* Navigation */}
        <div className="flex justify-between items-center mb-12">
          <Link
            href="/novenas/cancer/day-6"
