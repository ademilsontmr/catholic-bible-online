...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for Cancer - Day 3 focusing on Love. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 3',
    'cancer novena day 3',
    'love prayer cancer',
  ...
  openGraph: {
    title: 'Novena for Cancer - Day 3: Love',
    description: 'Pray the Novena for Cancer - Day 3 focusing on Love. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-3',
  },
  twitter: {
    title: 'Novena for Cancer - Day 3: Love',
    description: 'Pray the Novena for Cancer - Day 3 focusing on Love. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day of the Novena for Cancer, we pray for love in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on coping with cancer recurrence and ask God to help us grow in love and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">Though cancer remission must be a great joy and relief to cancer patients, some people experience a return of their cancer. Returning cancer can be a cause of deep mental and emotional anguish, and those whose cancer has returned are in great need of help and renewed strength.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to help all those whose cancer has returned after a time of remission!</p>
              <p className="mb-6">Help us to rely on You for strength in even the most difficult times in our lives. Help us to grow in imitation of You during times of suffering.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for love in God\'s plan and His ability to grant us healing and strength in all situations.
                Love is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on coping with cancer recurrence reminds us that healing is not just about physical recovery, but about 
