    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Cancer - Day 4: Humility" 
            url="/novenas/cancer/day-4"
            excerpt="Join me in praying the Novena for Cancer - Day 4 focusing on Humility. Pray for God's healing and strength for cancer patients and their families." 
          />
        </div>
        </section>
