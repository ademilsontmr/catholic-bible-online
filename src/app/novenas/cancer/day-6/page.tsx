...
export const metadata: Metadata = {
  title: 'Novena for Cancer - Day 6: Obedience',
  description: 'Pray the Novena for Cancer - Day 6 focusing on Obedience. Join in praying the traditional novena to seek God\'s healing and strength.',
  keywords: [
    'novena for cancer day 6',
    'cancer novena day 6',
    'obedience prayer cancer',
    'catholic prayer for obedience',
    'novena for cancer prayer',
    'day 6 cancer novena',
    'obedience god cancer',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Cancer - Day 6: Obedience',
    description: 'Pray the Novena for Cancer - Day 6 focusing on Obedience. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/cancer/day-6',
  },
  twitter: {
    title: 'Novena for Cancer - Day 6: Obedience',
    description: 'Pray the Novena for Cancer - Day 6 focusing on Obedience. Join in praying the traditional novena.',
...
export default function NovenaForCancerDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Cancer – Day 6: Obedience
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this sixth day of the Novena for Cancer, we pray for obedience in God\'s plan and His ability
            to grant us healing and strength. We focus particularly on overcoming discouragement in cancer battle and ask God to help us grow in obedience and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">For many cancer patients, the fight against cancer can be a long and difficult process that tests their faith and endurance. The continuation of suffering and the possibility of losing the battle can be sources of great discouragement for cancer patients. Those who suffer from cancer are in great need of assistance and grace, in order to overcome discouragement.</p>
              <p className="mb-6">Please bless and assist all people with cancer, and we especially ask You today to help all cancer patients who are becoming discouraged!</p>
              <p className="mb-6">Help us to rely on You more fully in all of our difficulties. Help us to see all of our sufferings as opportunities for growth in holiness.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for obedience in God\'s plan and His ability to grant us healing and strength in all situations.
                Obedience is the foundation of our relationship with God and the key to finding strength in challenging health circumstances.
              </p>
              ...
              <p className="mb-4">
                The focus on overcoming discouragement in cancer battle reminds us that healing is not just about physical recovery, but about 
        ...
        {/* Share Section */}
        <section className="mb-12">
          <ShareButton title="Novena for Cancer - Day 6: Obedience" text="Join me in praying the Novena for Cancer - Day 6 focusing on Obedience. Pray for God's healing and strength for cancer patients and their families." />
        </section>
