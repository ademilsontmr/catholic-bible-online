...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 9: Eternal Salvation',
  description: "Pray the Novena for Grace - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 9',
    'grace novena day 9',
    'st francis xavier novena day 9',
    'st francis xavier prayer day 9',
    'day 9 novena for grace',
    'eternal salvation prayer',
    'novena for grace eternal salvation',
    'grace novena eternal salvation'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 9: Eternal Salvation',
    description: 'Pray the Novena for Grace - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-9',
  },
  twitter: {
    title: 'Novena for Grace - Day 9: Eternal Salvation',
    description: 'Pray the Novena for Grace - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay9Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 9: Eternal Salvation
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on praying for the grace to live and die in the state of grace. We honor the memory of St. Francis Xavier and thank God for his intercession.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The ultimate goal of our spiritual life is to live and die in the state of grace. St. Francis Xavier's life and death remind us of the importance of this goal and the power of God's grace.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of St. Francis Xavier. 
            May you always remember his example of missionary zeal and his powerful intercession for God's grace. 
            May you continue to grow in holiness and virtue through his prayers.
          </p>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena for Grace! As you continue your spiritual journey, 
            may your heart be filled with divine grace, missionary spirit, church renewal, Christian unity, 
            repentance, baptismal commitment, God's glory, divine mercy, and eternal salvation. 
            May St. Francis Xavier continue to watch over you and obtain the graces you need.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 9: Eternal Salvation" 
            url="/novenas/novena-for-grace/day-9"
            excerpt="Join me in praying the Novena for Grace - Day 9 focusing on Eternal Salvation." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/novena-for-grace/day-8"
      ...
      <RelatedNovenas currentNovena="Novena for Grace" />
    </div>
  )
}
