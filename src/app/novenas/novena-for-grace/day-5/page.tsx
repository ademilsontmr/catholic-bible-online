...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 5: Repentance',
  description: "Pray the Novena for Grace - Day 5 focusing on Repentance. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 5',
    'grace novena day 5',
    'st francis xavier novena day 5',
    'st francis xavier prayer day 5',
    'day 5 novena for grace',
    'repentance prayer',
    'novena for grace repentance',
    'grace novena repentance'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 5: Repentance',
    description: 'Pray the Novena for Grace - Day 5 focusing on Repentance. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-5',
  },
  twitter: {
    title: 'Novena for Grace - Day 5: Repentance',
    description: 'Pray the Novena for Grace - Day 5 focusing on Repentance. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 5: Repentance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for the unrepentant, that moved by God's loving mercy revealed in Jesus, they may repent their sins and open their hearts to the divine life of grace.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              God's mercy is always available to those who repent. St. Francis Xavier's missionary work shows us that no one is beyond the reach of God's grace and mercy.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to pray for the repentance of sinners. May God's loving mercy touch the hearts of all who need to repent and open their hearts to grace. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 5: Repentance" 
            url="/novenas/novena-for-grace/day-5"
            excerpt="Join me in praying the Novena for Grace - Day 5 focusing on Repentance." 
          />
        </div>
