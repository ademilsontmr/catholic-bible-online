...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 8: Divine Mercy',
  description: "Pray the Novena for Grace - Day 8 focusing on Divine Mercy. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 8',
    'grace novena day 8',
    'st francis xavier novena day 8',
    'st francis xavier prayer day 8',
    'day 8 novena for grace',
    'divine mercy prayer',
    'novena for grace divine mercy',
    'grace novena divine mercy'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 8: Divine Mercy',
    description: 'Pray the Novena for Grace - Day 8 focusing on Divine Mercy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-8',
  },
  twitter: {
    title: 'Novena for Grace - Day 8: Divine Mercy',
    description: 'Pray the Novena for Grace - Day 8 focusing on Divine Mercy. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 8: Divine Mercy
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for God's loving mercy to be revealed in Jesus. We ask that God's mercy may touch the hearts of all who need it.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              God's mercy is infinite and available to all. St. Francis Xavier's missionary work was motivated by his understanding of God's mercy and his desire to share it with others.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to trust in God's loving mercy. May God's mercy be revealed in Jesus and touch the hearts of all who need it. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 8: Divine Mercy" 
            url="/novenas/novena-for-grace/day-8"
            excerpt="Join me in praying the Novena for Grace - Day 8 focusing on Divine Mercy." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-grace/day-9"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
