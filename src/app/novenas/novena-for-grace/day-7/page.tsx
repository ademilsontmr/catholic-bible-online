...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 7: God\'s Glory',
  description: "Pray the Novena for Grace - Day 7 focusing on God's Glory. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 7',
    'grace novena day 7',
    'st francis xavier novena day 7',
    'st francis xavier prayer day 7',
    'day 7 novena for grace',
    'god\'s glory prayer',
    'novena for grace god\'s glory',
    'grace novena god\'s glory'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 7: God\'s Glory',
    description: 'Pray the Novena for Grace - Day 7 focusing on God\'s Glory. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-7',
  },
  twitter: {
    title: 'Novena for Grace - Day 7: God\'s Glory',
    description: 'Pray the Novena for Grace - Day 7 focusing on God\'s Glory. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 7: God's Glory
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: God's Glory</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying that our requests may be for the glory of God and the good of our souls. We ask that if what we ask is not for God's glory, He may grant us what is more conducive to both.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              All our prayers should be directed towards God's glory and the good of our souls. St. Francis Xavier's life was completely oriented towards God's glory and the salvation of souls.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to pray that all my requests may be for the glory of God and the good of my soul. May God grant me what is most conducive to both. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 7: God's Glory" 
            url="/novenas/novena-for-grace/day-7"
            excerpt="Join me in praying the Novena for Grace - Day 7 focusing on God's Glory." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-grace/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Baptismal Commitment
          </Link>
