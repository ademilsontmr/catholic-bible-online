...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 6: Baptismal Commitment',
  description: "Pray the Novena for Grace - Day 6 focusing on Baptismal Commitment. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 6',
    'grace novena day 6',
    'st francis xavier novena day 6',
    'st francis xavier prayer day 6',
    'day 6 novena for grace',
    'baptismal commitment prayer',
    'novena for grace baptismal commitment',
    'grace novena baptismal commitment'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 6: Baptismal Commitment',
    description: 'Pray the Novena for Grace - Day 6 focusing on Baptismal Commitment. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-6',
  },
  twitter: {
    title: 'Novena for Grace - Day 6: Baptismal Commitment',
    description: 'Pray the Novena for Grace - Day 6 focusing on Baptismal Commitment. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 6: Baptismal Commitment
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Baptismal Commitment</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for ourselves, that we may be ever faithful to our baptismal commitment to Christ, and bring Christ's word and Christ's love to the world in which we live.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our baptismal commitment calls us to be witnesses of Christ in the world. St. Francis Xavier's life shows us how to live out this commitment with zeal and love.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to be faithful to my baptismal commitment to Christ. May I bring Christ's word and love to the world in which I live. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 6: Baptismal Commitment" 
            url="/novenas/novena-for-grace/day-6"
            excerpt="Join me in praying the Novena for Grace - Day 6 focusing on Baptismal Commitment." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-grace/day-7"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 7: God's Glory →
          </Link>
