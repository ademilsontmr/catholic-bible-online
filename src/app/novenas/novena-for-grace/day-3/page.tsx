...
export const metadata: Metadata = {
  title: 'Novena for Grace - Day 3: Church Renewal',
  description: "Pray the Novena for Grace - Day 3 focusing on Church Renewal. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 3',
    'grace novena day 3',
    'st francis xavier novena day 3',
    'st francis xavier prayer day 3',
    'day 3 novena for grace',
    'church renewal prayer',
    'novena for grace church renewal',
    'grace novena church renewal'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 3: Church Renewal',
    description: 'Pray the Novena for Grace - Day 3 focusing on Church Renewal. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-3',
  },
  twitter: {
    title: 'Novena for Grace - Day 3: Church Renewal',
    description: 'Pray the Novena for Grace - Day 3 focusing on Church Renewal. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 3: Church Renewal
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Church Renewal</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for the Church, that renewed by the Holy Spirit, she may show forth to the world the mystery of the Lord and be an instrument of redemption for all.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Church's mission is to be an instrument of redemption for all people. St. Francis Xavier's work reminds us that the Church must constantly be renewed by the Holy Spirit to fulfill this mission.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to pray for the renewal of the Church. May the Holy Spirit renew the Church and make her an instrument of redemption for all people. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Grace - Day 3: Church Renewal" 
            url="/novenas/novena-for-grace/day-3"
            excerpt="Join me in praying the Novena for Grace - Day 3 focusing on Church Renewal." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-grace/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Christian Unity →
          </Link>
