...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena for Grace - Day 2 focusing on Missionary Spirit. Join in praying the traditional novena to seek God's grace through St. Francis Xavier's intercession.",
  keywords: [
    'novena for grace day 2',
    'grace novena day 2',
    'st francis xavier novena day 2',
    'st francis xavier prayer day 2',
    'day 2 novena for grace',
    'missionary spirit prayer',
    'novena for grace missionary spirit',
    'grace novena missionary spirit'
  ],
  openGraph: {
    title: 'Novena for Grace - Day 2: Missionary Spirit',
    description: 'Pray the Novena for Grace - Day 2 focusing on Missionary Spirit. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/novena-for-grace/day-2',
  },
  twitter: {
    title: 'Novena for Grace - Day 2: Missionary Spirit',
    description: 'Pray the Novena for Grace - Day 2 focusing on Missionary Spirit. Join in praying the traditional novena.',
...
export default function NovenaForGraceDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Grace – Day 2: Missionary Spirit
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Missionary Spirit</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for missions and missionaries throughout the world, that through the proclamation of the Good News of salvation, all people may come to know the one true God and Jesus Christ whom He has sent.
          </p>
        </section>
...
Amen.
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Francis Xavier's missionary spirit inspires us to pray for all those who spread the Gospel throughout the world. His tireless work for the salvation of souls shows us the importance of missionary efforts.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Francis Xavier, help me to support the missionary efforts of the Church. May your missionary spirit inspire me to pray for and support those who spread the Gospel throughout the world. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/novena-for-grace/day-1"
