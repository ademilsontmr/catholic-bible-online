...
export const metadata: Metadata = {
  title: 'Immaculate Conception Novena - Day 3: Increase in Faith',
  description: 'Pray the Immaculate Conception Novena - Day 3 focusing on increase in faith. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 3',
    'immaculate conception prayer day 3',
    'day 3 immaculate conception novena',
    'increase in faith mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 3: Increase in Faith',
    description: 'Pray the Immaculate Conception Novena - Day 3 focusing on Increase in Faith.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-3',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 3: Increase in Faith',
    description: 'Pray the Immaculate Conception Novena - Day 3 focusing on Increase in Faith.',
...
export default function ImmaculateConceptionNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 3: Increase in Faith
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Increase in Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we pray for increase in faith in our risen Lord.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on increase in faith. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Immaculate Conception Novena - Day 3: Increase in Faith" 
            url="/novenas/immaculate-conception/day-3"
            excerpt="Join me in praying the Immaculate Conception Novena - Day 3 focusing on increase in faith." 
          />
        </div>
