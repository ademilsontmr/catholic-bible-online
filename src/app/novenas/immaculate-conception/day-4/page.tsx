...
export const metadata: Metadata = {
  ...
  description: 'Pray the Immaculate Conception Novena - Day 4 focusing on increase in hope. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 4',
    'immaculate conception prayer day 4',
    'day 4 immaculate conception novena',
    'increase in hope mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 4: Increase in Hope',
    description: 'Pray the Immaculate Conception Novena - Day 4 focusing on Increase in Hope.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-4',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 4: Increase in Hope',
    description: 'Pray the Immaculate Conception Novena - Day 4 focusing on Increase in Hope.',
...
export default function ImmaculateConceptionNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 4: Increase in Hope
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Increase in Hope</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we pray for increase in hope in our risen Lord.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on increase in hope. This aspect of honoring the Immaculate Conception helps us to grow in faith 
