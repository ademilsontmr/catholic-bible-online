...
export const metadata: Metadata = {
  title: 'Immaculate Conception Novena - Day 7: Divine Grace',
  description: 'Pray the Immaculate Conception Novena - Day 7 focusing on divine grace. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 7',
    'immaculate conception prayer day 7',
    'day 7 immaculate conception novena',
    'divine grace mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 7: Divine Grace',
    description: 'Pray the Immaculate Conception Novena - Day 7 focusing on Divine Grace.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-7',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 7: Divine Grace',
    description: 'Pray the Immaculate Conception Novena - Day 7 focusing on Divine Grace.',
...
export default function ImmaculateConceptionNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 7: Divine Grace
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for God\'s grace and submission to His will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on divine grace. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Immaculate Conception Novena - Day 7: Divine Grace" 
            url="/novenas/immaculate-conception/day-7"
            excerpt="Join me in praying the Immaculate Conception Novena - Day 7 focusing on divine grace." 
          />
        </div>
