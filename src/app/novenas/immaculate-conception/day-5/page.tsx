...
export const metadata: Metadata = {
  title: 'Immaculate Conception Novena - Day 5: Increase in Love',
  description: 'Pray the Immaculate Conception Novena - Day 5 focusing on increase in love. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 5',
    'immaculate conception prayer day 5',
    'day 5 immaculate conception novena',
    'increase in love mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 5: Increase in Love',
    description: 'Pray the Immaculate Conception Novena - Day 5 focusing on Increase in Love.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-5',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 5: Increase in Love',
    description: 'Pray the Immaculate Conception Novena - Day 5 focusing on Increase in Love.',
...
export default function ImmaculateConceptionNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 5: Increase in Love
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Increase in Love</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for increase in love for the risen Jesus.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on increase in love. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Immaculate Conception Novena - Day 5: Increase in Love" 
            url="/novenas/immaculate-conception/day-5"
            excerpt="Join me in praying the Immaculate Conception Novena - Day 5 focusing on increase in love." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/immaculate-conception/day-4"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 4: Increase in Hope
          </Link>
          
          
          
          <Link 
            href="/novenas/immaculate-conception/day-6"
