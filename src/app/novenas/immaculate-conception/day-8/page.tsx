...
export const metadata: Metadata = {
  title: 'Immaculate Conception Novena - Day 8: Holiness and Salvation',
  description: 'Pray the Immaculate Conception Novena - Day 8 focusing on holiness and salvation. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 8',
    'immaculate conception prayer day 8',
    'day 8 immaculate conception novena',
    'holiness and salvation mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 8: Holiness and Salvation',
    description: 'Pray the Immaculate Conception Novena - Day 8 focusing on Holiness and Salvation.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-8',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 8: Holiness and Salvation',
    description: 'Pray the Immaculate Conception Novena - Day 8 focusing on Holiness and Salvation.',
...
export default function ImmaculateConceptionNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 8: Holiness and Salvation
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Continue praying the Immaculate Conception Novena to honor Mary and grow in holiness.
          </p>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Holiness and Salvation</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for holiness and salvation through Mary's prayers.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on holiness and salvation. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Immaculate Conception Novena - Day 8: Holiness and Salvation" 
            url="/novenas/immaculate-conception/day-8"
            excerpt="Join me in praying the Immaculate Conception Novena - Day 8 focusing on holiness and salvation." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/immaculate-conception/day-7"
          ...
          <Link 
            href="/novenas/immaculate-conception/day-9"
            className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
          >
            Day 9: Perfect Submission →
          </Link>
