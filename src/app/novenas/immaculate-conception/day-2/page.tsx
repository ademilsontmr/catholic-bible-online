...
export const metadata: Metadata = {
  title: 'Immaculate Conception Novena - Day 2: Queen of Heaven',
  description: 'Pray the Immaculate Conception Novena - Day 2 focusing on queen of heaven. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 2',
    'immaculate conception prayer day 2',
    'day 2 immaculate conception novena',
    'queen of heaven mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 2: Queen of Heaven',
    description: 'Pray the Immaculate Conception Novena - Day 2 focusing on Queen of Heaven.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-2',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 2: Queen of Heaven',
    description: 'Pray the Immaculate Conception Novena - Day 2 focusing on Queen of Heaven.',
...
export default function ImmaculateConceptionNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 2: Queen of Heaven
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Queen of Heaven</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day, we pray for Mary's intercession and God\'s grace with humility.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on queen of heaven. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Immaculate Conception Novena - Day 2: Queen of Heaven" 
            url="/novenas/immaculate-conception/day-2"
            excerpt="Join me in praying the Immaculate Conception Novena - Day 2 focusing on queen of heaven." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ← Day 1: Immaculate Conception
          </Link>
          
          
          
          <Link 
            href="/novenas/immaculate-conception/day-3"
            className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
          >
            Day 3: Increase in Faith →
          </Link>
