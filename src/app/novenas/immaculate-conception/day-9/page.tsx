...
export const metadata: Metadata = {
  ...
  description: 'Pray the Immaculate Conception Novena - Day 9 focusing on perfect submission. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 9',
    'immaculate conception prayer day 9',
    'day 9 immaculate conception novena',
    'perfect submission mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 9: Perfect Submission',
    description: 'Pray the Immaculate Conception Novena - Day 9 focusing on Perfect Submission.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-9',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 9: Perfect Submission',
    description: 'Pray the Immaculate Conception Novena - Day 9 focusing on Perfect Submission.',
...
export default function ImmaculateConceptionNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 9: Perfect Submission
          </h1>
          <p className="text-xl text-gray-600 mb-6">
            Today we pray for perfect submission to Jesus and the Divine Will.
          </p>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Perfect Submission</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day, we pray for perfect submission to Jesus and the Divine Will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on perfect submission. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless you abundantly with holiness and help you submit perfectly to His will. May you always remember 
            Mary's Immaculate Conception and find strength in her powerful intercession throughout your spiritual journey.
          </p>
        </section>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Immaculate Conception Novena! As you continue to honor Mary and grow in holiness, 
            may your heart be filled with grace and divine guidance. May God continue to 
            bless you and provide all the strength you need to imitate Mary's perfect obedience to the Divine Will.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <Link 
            href="/novenas/immaculate-conception/day-8"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 8: Holiness and Salvation
          </Link>
      ...
      <RelatedNovenas currentNovena="Immaculate Conception Novena" />
