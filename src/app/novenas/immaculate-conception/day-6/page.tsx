...
export const metadata: Metadata = {
  ...
  description: 'Pray the Immaculate Conception Novena - Day 6 focusing on obedience to god\'s will. Join in praying for holiness and submission to God\'s will.',
  keywords: [
    'immaculate conception novena day 6',
    'immaculate conception prayer day 6',
    'day 6 immaculate conception novena',
    'obedience to god\'s will mary immaculate'
  ],
  openGraph: {
    title: 'Immaculate Conception Novena - Day 6: Obedience to God\'s Will',
    description: 'Pray the Immaculate Conception Novena - Day 6 focusing on Obedience to God\'s Will.',
    url: 'https://catholicbibleonline.com/novenas/immaculate-conception/day-6',
  },
  twitter: {
    title: 'Immaculate Conception Novena - Day 6: Obedience to God\'s Will',
    description: 'Pray the Immaculate Conception Novena - Day 6 focusing on Obedience to God\'s Will.',
...
export default function ImmaculateConceptionNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Immaculate Conception Novena – Day 6: Obedience to God's Will
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Obedience to God's Will</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we pray for obedience to God's perfect will.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on obedience to god's will. This aspect of honoring the Immaculate Conception helps us to grow in faith 
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/immaculate-conception/day-5"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 5: Increase in Love
          </Link>
