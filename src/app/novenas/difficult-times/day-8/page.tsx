...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novena for Difficult Times - Day 8 focusing on Intercession. Join in praying the traditional novena to seek God\'s strength during challenging periods.',
  keywords: [
    'novena for difficult times day 8',
    'difficult times novena day 8',
    'intercession prayer difficult times',
    'catholic prayer for intercession',
    'novena for difficult times prayer',
    'day 8 difficult times novena',
    'intercession god difficult times',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Difficult Times - Day 8: Intercession',
    description: 'Pray the Novena for Difficult Times - Day 8 focusing on Intercession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/difficult-times/day-8',
  },
  twitter: {
    title: 'Novena for Difficult Times - Day 8: Intercession',
    description: 'Pray the Novena for Difficult Times - Day 8 focusing on Intercession. Join in praying the traditional novena.',
...
export default function NovenaForDifficultTimesDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Difficult Times – Day 8: Intercession
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day of the Novena for Difficult Times, we pray for intercession in God's plan and His ability
            to help us through challenging periods. We ask God to help us grow in intercession and to trust in His divine wisdom
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Heavenly Father,</strong> you are the source of all intercession and the foundation of our faith.
                You know exactly what we need to get through our difficult times.
                We come to you today with intercession in your divine plan for our lives.
              </p>
              ...
              <p className="mb-6">
                <strong>O God of all intercession, increase our intercession in you!</strong> Help us to intercession completely
              ...
              <p className="mb-6">
                <strong>O God of all intercession, hear our prayer!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for intercession in God's plan and His ability to help us through difficult times.
                Intercession is the foundation of our relationship with God and the key to finding peace in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The title "God of all intercession" reminds us that God's intercession is constant and never-ending.
                He is always available to us, always ready to give us intercession, and always ready to guide us through our difficulties.
              </p>
              ...
              <p>
                ...
                He is perpetually ready to help us, and we can intercession completely in His divine care.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all intercession, increase our intercession in you. Help us to turn to you with confidence
            in every need, knowing that you will always help us and provide us with the strength we need.
            May we always intercession in your divine care and your perpetual help. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/difficult-times/day-9"
