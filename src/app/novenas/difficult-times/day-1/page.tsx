...
export const metadata: Metadata = {
  title: 'Novena for Difficult Times - Day 1: Trust',
  description: 'Pray the Novena for Difficult Times - Day 1 focusing on Trust. Join in praying the traditional novena to seek God\'s strength during challenging periods.',
  keywords: [
    'novena for difficult times day 1',
    'difficult times novena day 1',
    'trust prayer difficult times',
    'catholic prayer for trust',
    'novena for difficult times prayer',
    'day 1 difficult times novena',
    'trust god difficult times',
    'catholic novena prayer'
  ],
  openGraph: {
    title: 'Novena for Difficult Times - Day 1: Trust',
    description: 'Pray the Novena for Difficult Times - Day 1 focusing on Trust. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/difficult-times/day-1',
  },
  twitter: {
    title: 'Novena for Difficult Times - Day 1: Trust',
    description: 'Pray the Novena for Difficult Times - Day 1 focusing on Trust. Join in praying the traditional novena.',
...
export default function NovenaForDifficultTimesDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Difficult Times – Day 1: Trust
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Difficult Times, we pray for trust in God's plan and His ability
            to help us through challenging periods. We ask God to help us trust in His divine wisdom and His promise
            to never abandon us, even in our darkest moments.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                <strong>Heavenly Father,</strong> you are the source of all strength and wisdom.
                You know exactly what we need to get through our difficult times.
                We come to you today with trust in your divine plan for our lives.
              </p>
              ...
              <p className="mb-6">
                <strong>O God of all comfort, increase our trust in you!</strong> Help us to trust completely
              ...
              <p className="mb-6">
                <strong>O God of all comfort, hear our prayer!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for trust in God's plan and His ability to help us through difficult times.
                Trust is the foundation of our relationship with God and the key to finding peace in challenging circumstances.
              </p>
              ...
              <p className="mb-4">
                The title "God of all comfort" reminds us that God's help is constant and never-ending.
                He is always available to us, always ready to comfort us, and always ready to guide us through our difficulties.
              </p>
              ...
              <p>
                Remember that God's help is not limited by time or circumstance.
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O God of all comfort, increase our trust in you. Help us to turn to you with confidence
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Difficult Times - Day 1: Trust" 
            url="/novenas/difficult-times/day-1"
            excerpt="Join me in praying the Novena for Difficult Times - Day 1 focusing on Trust." 
          />
        </div>
