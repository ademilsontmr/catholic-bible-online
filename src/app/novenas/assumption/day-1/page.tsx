...
export const metadata: Metadata = {
  title: 'The Assumption Novena - Day 1: Heavenly Glory',
  description: "Pray The Assumption Novena - Day 1 focusing on Heavenly Glory. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 1',
    'assumption novena day 1',
    'mary assumption novena day 1',
    'assumption prayer day 1',
    'day 1 assumption novena',
    'heavenly glory prayer',
    'assumption novena heavenly glory',
    'mary assumption novena heavenly glory'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 1: Heavenly Glory',
    description: 'Pray The Assumption Novena - Day 1 focusing on Heavenly Glory. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-1',
  },
  twitter: {
    title: 'The Assumption Novena - Day 1: Heavenly Glory',
    description: 'Pray The Assumption Novena - Day 1 focusing on Heavenly Glory. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 1: Heavenly Glory
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of The Assumption Novena, we focus on rejoicing in Mary's glorious Assumption into heaven. We celebrate that after years of heroic martyrdom on earth, she has been taken to the throne prepared for her in heaven by the Holy Trinity.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Mary's Assumption into heaven is a cause for great joy and celebration. It reminds us that our earthly struggles are temporary and that heaven awaits those who remain faithful to God. Her Assumption gives us hope for our own eternal destiny.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, help me to rejoice in your glorious Assumption and to live my life in preparation for heaven. May I always remember that you are my model and intercessor. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Assumption Novena - Day 1: Heavenly Glory" 
            url="/novenas/assumption/day-1"
            excerpt="Join me in praying The Assumption Novena - Day 1 focusing on Heavenly Glory." 
          />
        </div>
