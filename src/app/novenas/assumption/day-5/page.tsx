...
export const metadata: Metadata = {
  ...
  description: "Pray The Assumption Novena - Day 5 focusing on Heavenly Perspective. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 5',
    'assumption novena day 5',
    'mary assumption novena day 5',
    'assumption prayer day 5',
    'day 5 assumption novena',
    'heavenly perspective prayer',
    'assumption novena heavenly perspective',
    'mary assumption novena heavenly perspective'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 5: Heavenly Perspective',
    description: 'Pray The Assumption Novena - Day 5 focusing on Heavenly Perspective. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-5',
  },
  twitter: {
    title: 'The Assumption Novena - Day 5: Heavenly Perspective',
    description: 'Pray The Assumption Novena - Day 5 focusing on Heavenly Perspective. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 5: Heavenly Perspective
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Heavenly Perspective</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on asking Mary to teach us how small earth becomes when viewed from heaven. We pray for the grace to see our earthly life from a heavenly perspective.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              From heaven's perspective, our earthly concerns and struggles appear small compared to the eternal glory that awaits us. Mary helps us to focus on what truly matters - our relationship with God and our eternal salvation.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, teach me to see earth from heaven's perspective. Help me to focus on what truly matters - my relationship with God and my eternal salvation. Amen.
          </p>
        </section>
