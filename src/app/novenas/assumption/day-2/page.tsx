...
export const metadata: Metadata = {
  title: 'The Assumption Novena - Day 2: Heroic Martyrdom',
  description: "Pray The Assumption Novena - Day 2 focusing on Heroic Martyrdom. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 2',
    'assumption novena day 2',
    'mary assumption novena day 2',
    'assumption prayer day 2',
    'day 2 assumption novena',
    'heroic martyrdom prayer',
    'assumption novena heroic martyrdom',
    'mary assumption novena heroic martyrdom'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 2: Heroic Martyrdom',
    description: 'Pray The Assumption Novena - Day 2 focusing on Heroic Martyrdom. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-2',
  },
  twitter: {
    title: 'The Assumption Novena - Day 2: Heroic Martyrdom',
    description: 'Pray The Assumption Novena - Day 2 focusing on Heroic Martyrdom. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 2: Heroic Martyrdom
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Heroic Martyrdom</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on Mary's heroic martyrdom on earth and pray for the strength to endure our own trials with the same courage and faithfulness that she showed throughout her life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Mary endured many trials and sufferings during her earthly life, from the prophecy of Simeon to standing at the foot of the Cross. Her heroic endurance teaches us to bear our crosses with faith and trust in God's plan.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, give me the strength to endure trials as you did on earth. Help me to bear my crosses with faith and trust in God's plan for my life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Assumption Novena - Day 2: Heroic Martyrdom" 
            url="/novenas/assumption/day-2"
            excerpt="Join me in praying The Assumption Novena - Day 2 focusing on Heroic Martyrdom." 
          />
        </div>
