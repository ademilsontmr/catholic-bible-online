...
export const metadata: Metadata = {
  title: 'The Assumption Novena - Day 7: Body and Soul',
  description: "Pray The Assumption Novena - Day 7 focusing on Body and Soul. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 7',
    'assumption novena day 7',
    'mary assumption novena day 7',
    'assumption prayer day 7',
    'day 7 assumption novena',
    'body and soul prayer',
    'assumption novena body and soul',
    'mary assumption novena body and soul'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 7: Body and Soul',
    description: 'Pray The Assumption Novena - Day 7 focusing on Body and Soul. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-7',
  },
  twitter: {
    title: 'The Assumption Novena - Day 7: Body and Soul',
    description: 'Pray The Assumption Novena - Day 7 focusing on Body and Soul. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 7: Body and Soul
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Body and Soul</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for the hope that someday our body shall rejoin our soul in the unending bliss of heaven, just as Mary's body and soul were reunited in her Assumption.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Mary's Assumption body and soul into heaven is a promise of our own resurrection. It reminds us that our bodies are temples of the Holy Spirit and will one day be glorified and reunited with our souls in heaven.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, give me hope that my body and soul will be reunited in heaven. Help me to treat my body as a temple of the Holy Spirit. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Assumption Novena - Day 7: Body and Soul" 
            url="/novenas/assumption/day-7"
            excerpt="Join me in praying The Assumption Novena - Day 7 focusing on Body and Soul." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/assumption/day-6"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Triumphant Death
          </Link>
