...
export const metadata: Metadata = {
  title: 'The Assumption Novena - Day 3: Throne in Heaven',
  description: "Pray The Assumption Novena - Day 3 focusing on Throne in Heaven. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 3',
    'assumption novena day 3',
    'mary assumption novena day 3',
    'assumption prayer day 3',
    'day 3 assumption novena',
    'throne in heaven prayer',
    'assumption novena throne in heaven',
    'mary assumption novena throne in heaven'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 3: Throne in Heaven',
    description: 'Pray The Assumption Novena - Day 3 focusing on Throne in Heaven. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-3',
  },
  twitter: {
    title: 'The Assumption Novena - Day 3: Throne in Heaven',
    description: 'Pray The Assumption Novena - Day 3 focusing on Throne in Heaven. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 3: Throne in Heaven
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Throne in Heaven</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on the throne prepared for Mary in heaven and pray for the grace to be prepared for our own heavenly destiny. We ask Mary to help us live lives worthy of heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Mary's throne in heaven was prepared for her by the Holy Trinity as a reward for her faithfulness. This reminds us that God has prepared a place for each of us in heaven, and we must live our lives in preparation for that glorious day.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, help me to be prepared for my heavenly throne. May I live a life worthy of the glory that awaits me in heaven. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Assumption Novena - Day 3: Throne in Heaven" 
            url="/novenas/assumption/day-3"
            excerpt="Join me in praying The Assumption Novena - Day 3 focusing on Throne in Heaven." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/assumption/day-2"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 2: Heroic Martyrdom
          </Link>
          
          
          <Link
            href="/novenas/assumption/day-4"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Freedom from Sin →
          </Link>
