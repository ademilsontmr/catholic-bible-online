...
export const metadata: Metadata = {
  title: 'The Assumption Novena - Day 6: Triumphant Death',
  description: "Pray The Assumption Novena - Day 6 focusing on Triumphant Death. Join in praying the traditional novena to honor Mary's Assumption into heaven.",
  keywords: [
    'the assumption novena day 6',
    'assumption novena day 6',
    'mary assumption novena day 6',
    'assumption prayer day 6',
    'day 6 assumption novena',
    'triumphant death prayer',
    'assumption novena triumphant death',
    'mary assumption novena triumphant death'
  ],
  openGraph: {
    title: 'The Assumption Novena - Day 6: Triumphant Death',
    description: 'Pray The Assumption Novena - Day 6 focusing on Triumphant Death. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/assumption/day-6',
  },
  twitter: {
    title: 'The Assumption Novena - Day 6: Triumphant Death',
    description: 'Pray The Assumption Novena - Day 6 focusing on Triumphant Death. Join in praying the traditional novena.',
...
export default function AssumptionNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Assumption Novena – Day 6: Triumphant Death
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Triumphant Death</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the courage to face death as the triumphant gate through which we shall pass to Jesus. We ask Mary to help us see death as the beginning of eternal life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Mary's Assumption shows us that death is not the end but the beginning of eternal glory. Her death was truly a "falling asleep" that led to her glorious Assumption, giving us hope for our own death and resurrection.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, Queen Assumed into Heaven, give me courage to face death as the triumphant gate to heaven. Help me to see death as the beginning of eternal life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Assumption Novena - Day 6: Triumphant Death" 
            url="/novenas/assumption/day-6"
            excerpt="Join me in praying The Assumption Novena - Day 6 focusing on Triumphant Death." 
          />
        </div>
