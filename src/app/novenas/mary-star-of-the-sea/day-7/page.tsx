...
export const metadata: Metadata = {
  title: 'Novena to Mary Star of the Sea - Day 7: Deepening of Faith',
  description: 'Pray Novena to Mary Star of the Sea - Day 7 focusing on deepening of faith. Join in praying for protection, guidance, and safe navigation through life\'s journey.',
  keywords: [
    'mary star of the sea novena day 7',
    'star of the sea novena day 7',
    'day 7 mary star of the sea novena',
    'deepening of faith mary star of the sea'
  ],
  openGraph: {
    title: 'Novena to Mary Star of the Sea - Day 7: Deepening of Faith',
    description: 'Pray Novena to Mary Star of the Sea - Day 7 focusing on Deepening of Faith.',
    url: 'https://catholicbibleonline.com/novenas/mary-star-of-the-sea/day-7',
  },
  twitter: {
    title: 'Novena to Mary Star of the Sea - Day 7: Deepening of Faith',
    description: 'Pray Novena to Mary Star of the Sea - Day 7 focusing on Deepening of Faith.',
...
export default function MaryStarOfTheSeaNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Mary Star of the Sea – Day 7: Deepening of Faith
          </h1>
        ...
        <section className="bg-sky-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Deepening of Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we pray for strengthening and nurturing of faith in Jesus Christ.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Mary, Star of the Sea, we seek your assistance in deepening our faith in your Son, Jesus Christ. We know that faith is a gift from God, and we ask you, our loving mother, to help nurture and strengthen this precious gift within us. As you once held the infant Jesus in your arms, we ask you to hold us close to your heart, that we may feel the warmth of His love and the strength of His presence.</p>

              <p className="mb-4">Grant us unwavering trust in God's providence and in His plan for our lives. May our faith be steadfast, and may it serve as a beacon of hope to others in times of doubt and darkness.</p>

              <p className="mb-4">O Mary, help us to grow in faith and to become shining examples of discipleship, living out our faith in love and service to others.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on deepening of faith. This aspect of honoring Mary, Star of the Sea, helps us to navigate 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Mary Star of the Sea - Day 7: Deepening of Faith" 
            url="/novenas/mary-star-of-the-sea/day-7"
            excerpt="Join me in praying Novena to Mary Star of the Sea - Day 7 focusing on deepening of faith." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/mary-star-of-the-sea/day-6"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors"
          >
            ← Day 6: Peace in the World
          </Link>
