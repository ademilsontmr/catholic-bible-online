...
export const metadata: Metadata = {
  title: 'Novena to Mary Star of the Sea - Day 5: Protection of Families',
  description: 'Pray Novena to Mary Star of the Sea - Day 5 focusing on protection of families. Join in praying for protection, guidance, and safe navigation through life\'s journey.',
  keywords: [
    'mary star of the sea novena day 5',
    'star of the sea novena day 5',
    'day 5 mary star of the sea novena',
    'protection of families mary star of the sea'
  ],
  openGraph: {
    title: 'Novena to Mary Star of the Sea - Day 5: Protection of Families',
    description: 'Pray Novena to Mary Star of the Sea - Day 5 focusing on Protection of Families.',
    url: 'https://catholicbibleonline.com/novenas/mary-star-of-the-sea/day-5',
  },
  twitter: {
    title: 'Novena to Mary Star of the Sea - Day 5: Protection of Families',
    description: 'Pray Novena to Mary Star of the Sea - Day 5 focusing on Protection of Families.',
...
export default function MaryStarOfTheSeaNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Mary Star of the Sea – Day 5: Protection of Families
          </h1>
        ...
        <section className="bg-sky-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Protection of Families</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we pray for protection and strengthening of family bonds.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Mary, Star of the Sea, we turn to you as the protector of families. We know the unique challenges and trials that families face in the world today. As the guiding light of our homes, we ask you to encircle our families with your mantle of love and protection.</p>

              <p className="mb-4">Strengthen the bonds of love that unite us, and grant us the grace to grow in holiness together. We entrust to your care our homes, our loved ones, and all the joys and concerns of family life.</p>

              <p className="mb-4">O loving Mother, shield us from harm, intercede for our needs, and help us build homes that radiate love of your Son, Jesus Christ, to all who enter.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on protection of families. This aspect of honoring Mary, Star of the Sea, helps us to navigate 
        ...
        <ShareButton 
          title="Novena to Mary Star of the Sea - Day 5: Protection of Families"
          text="Join me in praying Novena to Mary Star of the Sea - Day 5 focusing on protection of families."
        />
