...
export const metadata: Metadata = {
  ...
  description: "Pray the Corpus Christi Novena - Day 2 focusing on Hidden Majesty. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 2',
    'body and blood of christ novena day 2',
    'eucharist novena day 2',
    'corpus christi prayer day 2',
    'day 2 corpus christi novena',
    'hidden majesty prayer',
    'corpus christi novena hidden majesty',
    'eucharist novena hidden majesty'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 2: Hidden Majesty',
    description: 'Pray the Corpus Christi Novena - Day 2 focusing on Hidden Majesty. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-2',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 2: Hidden Majesty',
    description: 'Pray the Corpus Christi Novena - Day 2 focusing on Hidden Majesty. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 2: Hidden Majesty
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Hidden Majesty</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on thanking Jesus for hiding beneath the Eucharistic species His infinite majesty and beauty, which His Angels delight to behold, so that we might have courage to approach the throne of His Mercy.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus hides His divine majesty under the simple appearances of bread and wine so that we might approach Him without fear. This is an act of great love and mercy, allowing us to come close to Him despite our unworthiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for hiding Your majesty under the Eucharistic species. Give me the courage to approach Your throne of mercy with confidence and trust. Amen.
          </p>
        </section>
