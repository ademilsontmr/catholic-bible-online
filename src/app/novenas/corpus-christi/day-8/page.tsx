...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 8: Thanksgiving',
  description: "Pray the Corpus Christi Novena - Day 8 focusing on Thanksgiving. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 8',
    'body and blood of christ novena day 8',
    'eucharist novena day 8',
    'corpus christi prayer day 8',
    'day 8 corpus christi novena',
    'thanksgiving prayer',
    'corpus christi novena thanksgiving',
    'eucharist novena thanksgiving'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 8: Thanksgiving',
    description: 'Pray the Corpus Christi Novena - Day 8 focusing on Thanksgiving. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-8',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 8: Thanksgiving',
    description: 'Pray the Corpus Christi Novena - Day 8 focusing on Thanksgiving. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 8: Thanksgiving
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on thanking Jesus for offering Himself in thanksgiving to God for all His benefits, spiritual and temporal, which He has bestowed upon us.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus offers perfect thanksgiving to the Father for all the gifts He has given us. In the Eucharist, we join our thanksgiving to His, acknowledging all the blessings we have received from God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for offering perfect thanksgiving to the Father. Help me to be grateful for all the benefits I have received from God. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 8: Thanksgiving" 
            url="/novenas/corpus-christi/day-8"
            excerpt="Join me in praying the Corpus Christi Novena - Day 8 focusing on Thanksgiving." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/corpus-christi/day-9"
            className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
