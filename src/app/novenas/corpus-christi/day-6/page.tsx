...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 6: Divine Priest',
  description: "Pray the Corpus Christi Novena - Day 6 focusing on Divine Priest. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 6',
    'body and blood of christ novena day 6',
    'eucharist novena day 6',
    'corpus christi prayer day 6',
    'day 6 corpus christi novena',
    'divine priest prayer',
    'corpus christi novena divine priest',
    'eucharist novena divine priest'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 6: Divine Priest',
    description: 'Pray the Corpus Christi Novena - Day 6 focusing on Divine Priest. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-6',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 6: Divine Priest',
    description: 'Pray the Corpus Christi Novena - Day 6 focusing on Divine Priest. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 6: Divine Priest
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Priest</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on thanking Jesus, our Divine Priest, for offering Himself as a Sacrifice daily upon our altars in adoration and homage to the Most Blessed Trinity, and for making amends for our poor and miserable adorations.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus, as our High Priest, offers perfect worship to the Father on our behalf. He makes up for our inadequate prayers and adoration, presenting Himself as the perfect sacrifice that pleases the Father.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for being our Divine Priest and making amends for our poor adorations. Help me to worship You with greater love and devotion. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 6: Divine Priest" 
            url="/novenas/corpus-christi/day-6"
            excerpt="Join me in praying the Corpus Christi Novena - Day 6 focusing on Divine Priest." 
          />
        </div>
