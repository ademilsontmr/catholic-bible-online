...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 9: Eternal Salvation',
  description: "Pray the Corpus Christi Novena - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 9',
    'body and blood of christ novena day 9',
    'eucharist novena day 9',
    'corpus christi prayer day 9',
    'day 9 corpus christi novena',
    'eternal salvation prayer',
    'corpus christi novena eternal salvation',
    'eucharist novena eternal salvation'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 9: Eternal Salvation',
    description: 'Pray the Corpus Christi Novena - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-9',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 9: Eternal Salvation',
    description: 'Pray the Corpus Christi Novena - Day 9 focusing on Eternal Salvation. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 9: Eternal Salvation
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on praying for the grace of perseverance in Jesus' love and faithful service, a holy death, and a happy eternity with Him in Heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Eucharist is the pledge of our future glory. Through this sacrament, we receive the grace to persevere in faith and love, preparing us for eternal life with Christ in heaven.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of Jesus in the Most Holy Eucharist. 
            May you always remember the gift of His Body and Blood and grow in Eucharistic devotion. 
            May your heart be filled with love for the Eucharist and gratitude for this greatest gift.
          </p>
        </section>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Corpus Christi Novena! As you continue your spiritual journey, 
            may your heart be filled with gratitude for the institution of the Eucharist, courage to approach Divine Mercy, 
            union with Christ, appreciation for the greatest gift, grace to offer yourself with Him, renewal of His sacrifice, 
            confidence in His merits, thanksgiving for all benefits, and perseverance for eternal salvation. May Jesus in the Eucharist 
            continue to watch over you and nourish your soul with His Body and Blood.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 9: Eternal Salvation" 
            url="/novenas/corpus-christi/day-9"
            excerpt="Join me in praying the Corpus Christi Novena - Day 9 focusing on Eternal Salvation." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/corpus-christi/day-8"
      ...
      <RelatedNovenas currentNovena="Corpus Christi Novena" />
    </div>
  )
}
