...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 1: Divine Institution',
  description: "Pray the Corpus Christi Novena - Day 1 focusing on Divine Institution. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 1',
    'body and blood of christ novena day 1',
    'eucharist novena day 1',
    'corpus christi prayer day 1',
    'day 1 corpus christi novena',
    'divine institution prayer',
    'corpus christi novena divine institution',
    'eucharist novena divine institution'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 1: Divine Institution',
    description: 'Pray the Corpus Christi Novena - Day 1 focusing on Divine Institution. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-1',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 1: Divine Institution',
    description: 'Pray the Corpus Christi Novena - Day 1 focusing on Divine Institution. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 1: Divine Institution
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Institution</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Corpus Christi Novena, we focus on giving thanks to Jesus for coming upon the earth for our sake and for instituting the adorable Sacrament of the Holy Eucharist in order to remain with us until the end of the world.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The institution of the Eucharist is the greatest gift that Jesus left to His Church. Through this sacrament, He remains with us always, providing us with spiritual nourishment and the grace we need for our salvation. We should be eternally grateful for this divine gift.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for instituting the Holy Eucharist for our sake. Help me to always appreciate this greatest gift and to approach You with love and reverence. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 1: Divine Institution" 
            url="/novenas/corpus-christi/day-1"
            excerpt="Join me in praying the Corpus Christi Novena - Day 1 focusing on Divine Institution." 
          />
        </div>
