...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 4: Greatest Gift',
  description: "Pray the Corpus Christi Novena - Day 4 focusing on Greatest Gift. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 4',
    'body and blood of christ novena day 4',
    'eucharist novena day 4',
    'corpus christi prayer day 4',
    'day 4 corpus christi novena',
    'greatest gift prayer',
    'corpus christi novena greatest gift',
    'eucharist novena greatest gift'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 4: Greatest Gift',
    description: 'Pray the Corpus Christi Novena - Day 4 focusing on Greatest Gift. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-4',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 4: Greatest Gift',
    description: 'Pray the Corpus Christi Novena - Day 4 focusing on Greatest Gift. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 4: Greatest Gift
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Greatest Gift</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on thanking Jesus for giving Himself to us in this Blessed Sacrament and so enriching it with the treasures of His love that He has no greater gift to give us.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Eucharist is the greatest gift that Jesus could give us - His very own Body and Blood. In this sacrament, He gives us everything He has, holding nothing back. This is the ultimate expression of His love for us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for the greatest gift of Your Body and Blood. Help me to treasure this gift and to receive it worthily. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 4: Greatest Gift" 
            url="/novenas/corpus-christi/day-4"
            excerpt="Join me in praying the Corpus Christi Novena - Day 4 focusing on Greatest Gift." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/corpus-christi/day-3"
