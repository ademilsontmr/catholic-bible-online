...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 7: Priceless Victim',
  description: "Pray the Corpus Christi Novena - Day 7 focusing on Priceless Victim. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 7',
    'body and blood of christ novena day 7',
    'eucharist novena day 7',
    'corpus christi prayer day 7',
    'day 7 corpus christi novena',
    'priceless victim prayer',
    'corpus christi novena priceless victim',
    'eucharist novena priceless victim'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 7: Priceless Victim',
    description: 'Pray the Corpus Christi Novena - Day 7 focusing on Priceless Victim. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-7',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 7: Priceless Victim',
    description: 'Pray the Corpus Christi Novena - Day 7 focusing on Priceless Victim. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 7: Priceless Victim
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Priceless Victim</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on thanking Jesus for having become the priceless Victim to merit for us the fullness of heavenly favors. We pray for confidence in Him that their fullness may descend ever more fruitfully upon our souls.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus is the priceless Victim whose sacrifice merits for us all the graces we need. Through His merits, we can approach the Father with confidence, knowing that His sacrifice is sufficient for our salvation.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for being the priceless Victim who merits all heavenly favors for us. Give me confidence in Your merits and help me to trust in Your love. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 7: Priceless Victim" 
            url="/novenas/corpus-christi/day-7"
            excerpt="Join me in praying the Corpus Christi Novena - Day 7 focusing on Priceless Victim." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/corpus-christi/day-6"
