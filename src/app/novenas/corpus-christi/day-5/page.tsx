...
export const metadata: Metadata = {
  title: 'Corpus Christi Novena - Day 5: Continual Sacrifice',
  description: "Pray the Corpus Christi Novena - Day 5 focusing on Continual Sacrifice. Join in praying the traditional novena to honor the Body and Blood of Christ.",
  keywords: [
    'corpus christi novena day 5',
    'body and blood of christ novena day 5',
    'eucharist novena day 5',
    'corpus christi prayer day 5',
    'day 5 corpus christi novena',
    'continual sacrifice prayer',
    'corpus christi novena continual sacrifice',
    'eucharist novena continual sacrifice'
  ],
  openGraph: {
    title: 'Corpus Christi Novena - Day 5: Continual Sacrifice',
    description: 'Pray the Corpus Christi Novena - Day 5 focusing on Continual Sacrifice. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/corpus-christi/day-5',
  },
  twitter: {
    title: 'Corpus Christi Novena - Day 5: Continual Sacrifice',
    description: 'Pray the Corpus Christi Novena - Day 5 focusing on Continual Sacrifice. Join in praying the traditional novena.',
...
export default function CorpusChristiNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Corpus Christi Novena – Day 5: Continual Sacrifice
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Continual Sacrifice</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on thanking Jesus not only for becoming our food but also for offering Himself as a continual sacrifice to His Eternal Father for our salvation.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The Eucharist is not only a sacrament but also a sacrifice, renewing the sacrifice of the Cross. Jesus continues to offer Himself to the Father for our salvation, showing us the way to offer ourselves with Him.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus in the Eucharist, thank You for offering Yourself as a continual sacrifice. Help me to offer myself with You to the Father for the salvation of souls. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Corpus Christi Novena - Day 5: Continual Sacrifice" 
            url="/novenas/corpus-christi/day-5"
            excerpt="Join me in praying the Corpus Christi Novena - Day 5 focusing on Continual Sacrifice." 
          />
        </div>
