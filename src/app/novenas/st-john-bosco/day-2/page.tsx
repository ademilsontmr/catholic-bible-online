...
export const metadata: Metadata = {
  title: 'Novena in Honor of St. John Bosco - Day 2: Spiritual Graces',
  description: "Pray the Novena in Honor of St. John Bosco - Day 2 focusing on Spiritual Graces. Join in praying the traditional novena to seek St. John Bosco's intercession.",
  keywords: [
    'novena in honor of st john bosco day 2',
    'st john bosco novena day 2',
    'john bosco novena day 2',
    'don bosco novena day 2',
    'st john bosco prayer day 2',
    'day 2 st john bosco novena',
    'spiritual graces prayer',
    'st john bosco novena spiritual graces',
    'john bosco novena spiritual graces'
  ],
  openGraph: {
    title: 'Novena in Honor of St. John Bosco - Day 2: Spiritual Graces',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 2 focusing on Spiritual Graces. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-bosco/day-2',
  },
  twitter: {
    title: 'Novena in Honor of St. John Bosco - Day 2: Spiritual Graces',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 2 focusing on Spiritual Graces. Join in praying the traditional novena.',
...
export default function StJohnBoscoNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of St. John Bosco – Day 2: Spiritual Graces
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spiritual Graces</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day of our novena, we focus on spiritual graces. We ask St. John Bosco to obtain for us the spiritual graces we need to grow in holiness and draw closer to God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Bosco was a great spiritual guide who helped countless souls grow in holiness. His own life was marked by deep prayer, devotion to the Eucharist, and love for Mary Help of Christians.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. John Bosco, help me to obtain the spiritual graces I need to grow in holiness. May your example of deep prayer and devotion inspire me to seek spiritual growth and draw closer to God. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena in Honor of St. John Bosco - Day 2: Spiritual Graces" 
            url="/novenas/st-john-bosco/day-2"
            excerpt="Join me in praying the Novena in Honor of St. John Bosco - Day 2 focusing on Spiritual Graces." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-john-bosco/day-1"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Trust and Confidence
          </Link>
