...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena in Honor of St. John Bosco - Day 3 focusing on Temporal Needs. Join in praying the traditional novena to seek St. John Bosco's intercession.",
  keywords: [
    'novena in honor of st john bosco day 3',
    'st john bosco novena day 3',
    'john bosco novena day 3',
    'don bosco novena day 3',
    'st john bosco prayer day 3',
    'day 3 st john bosco novena',
    'temporal needs prayer',
    'st john bosco novena temporal needs',
    'john bosco novena temporal needs'
  ],
  openGraph: {
    title: 'Novena in Honor of St. John Bosco - Day 3: Temporal Needs',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 3 focusing on Temporal Needs. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-bosco/day-3',
  },
  twitter: {
    title: 'Novena in Honor of St. John Bosco - Day 3: Temporal Needs',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 3 focusing on Temporal Needs. Join in praying the traditional novena.',
...
export default function StJohnBoscoNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of St. John Bosco – Day 3: Temporal Needs
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Temporal Needs</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on temporal needs. We ask St. John Bosco to help us with our material needs and to provide for us in times of difficulty, just as he provided for the many young people under his care.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Bosco was known for his ability to provide for the material needs of his boys, often through miraculous means. He trusted that God would provide for all their needs.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. John Bosco, help me with my temporal needs and provide for me in times of difficulty. May your example of trust in God's providence inspire me to trust that God will provide for all my needs. Amen.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-john-bosco/day-4"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Devotion to Eucharist →
          </Link>
