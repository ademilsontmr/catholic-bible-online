...
export const metadata: Metadata = {
  title: 'Novena in Honor of St. John Bosco - Day 6: Compassion for Suffering',
  description: "Pray the Novena in Honor of St. John Bosco - Day 6 focusing on Compassion for Suffering. Join in praying the traditional novena to seek St. John Bosco's intercession.",
  keywords: [
    'novena in honor of st john bosco day 6',
    'st john bosco novena day 6',
    'john bosco novena day 6',
    'don bosco novena day 6',
    'st john bosco prayer day 6',
    'day 6 st john bosco novena',
    'compassion for suffering prayer',
    'st john bosco novena compassion for suffering',
    'john bosco novena compassion for suffering'
  ],
  openGraph: {
    title: 'Novena in Honor of St. John Bosco - Day 6: Compassion for Suffering',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 6 focusing on Compassion for Suffering. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-bosco/day-6',
  },
  twitter: {
    title: 'Novena in Honor of St. John Bosco - Day 6: Compassion for Suffering',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 6 focusing on Compassion for Suffering. Join in praying the traditional novena.',
...
export default function StJohnBoscoNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of St. John Bosco – Day 6: Compassion for Suffering
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Compassion for Suffering</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we focus on compassion for those who are suffering. We ask St. John Bosco to help us develop the same compassion he had for those in need and to be moved to help them.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Bosco always had compassion for those who were suffering. He dedicated his life to helping young people who were poor, abandoned, or at risk, showing them God's love.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. John Bosco, help me to have compassion for those who are suffering like you did. May your example of caring for the poor and abandoned inspire me to be moved by the suffering of others and to help them. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena in Honor of St. John Bosco - Day 6: Compassion for Suffering" 
            url="/novenas/st-john-bosco/day-6"
            excerpt="Join me in praying the Novena in Honor of St. John Bosco - Day 6 focusing on Compassion for Suffering." 
          />
        </div>
