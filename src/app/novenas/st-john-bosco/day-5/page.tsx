...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena in Honor of St. John Bosco - Day 5 focusing on Devotion to Mary. Join in praying the traditional novena to seek St. John Bosco's intercession.",
  keywords: [
    'novena in honor of st john bosco day 5',
    'st john bosco novena day 5',
    'john bosco novena day 5',
    'don bosco novena day 5',
    'st john bosco prayer day 5',
    'day 5 st john bosco novena',
    'devotion to mary prayer',
    'st john bosco novena devotion to mary',
    'john bosco novena devotion to mary'
  ],
  openGraph: {
    title: 'Novena in Honor of St. John Bosco - Day 5: Devotion to Mary',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 5 focusing on Devotion to Mary. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-john-bosco/day-5',
  },
  twitter: {
    title: 'Novena in Honor of St. John Bosco - Day 5: Devotion to Mary',
    description: 'Pray the Novena in Honor of St. John Bosco - Day 5 focusing on Devotion to Mary. Join in praying the traditional novena.',
...
export default function StJohnBoscoNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena in Honor of St. John Bosco – Day 5: Devotion to Mary
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on devotion to Mary Help of Christians. We ask St. John Bosco to help us develop the same great devotion to Our Lady that he had, and to trust in her powerful intercession.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. John Bosco had a special devotion to Mary Help of Christians and attributed many miracles and graces to her intercession. He often turned to her in times of need.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. John Bosco, help me to develop a great devotion to Mary Help of Christians like you had. May your trust in her intercession inspire me to turn to Our Lady with confidence in every need. Amen.
          </p>
        </section>
