...
export const metadata: Metadata = {
  ...
  description: 'Pray the Novenas For Marriage - Day 9 focusing on marriage eternity.',
  keywords: ['marriage novena day 9', 'marriage prayer day 9'],
  openGraph: {
    title: 'Novenas For Marriage - Day 9: Marriage Eternity',
    description: 'Pray the Novenas For Marriage - Day 9 focusing on marriage eternity.',
    url: 'https://catholic-bible-online.com/novenas/marriage/day-9',
  },
  twitter: {
    title: 'Novenas For Marriage - Day 9: Marriage Eternity',
    description: 'Pray the Novenas For Marriage - Day 9 focusing on marriage eternity.',
...
export default function NovenasForMarriageDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novenas For Marriage – Day 9: Marriage Eternity
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Marriage Eternity</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on marriage eternity in our marriage prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on marriage eternity, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on marriage eternity. This aspect of marriage helps us to grow spiritually 
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May God bless all marriages abundantly and fill them with His love, unity, and grace.
          </p>
        </section>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novenas For Marriage! May God continue to guide you and bless you.
          </p>
        </section>
      ...
      <RelatedNovenas currentNovena="Marriage Novena" />
    </div>
  )
}
