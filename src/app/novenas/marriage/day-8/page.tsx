...
export const metadata: Metadata = {
  title: 'Novenas For Marriage - Day 8: Marriage Blessings',
  description: 'Pray the Novenas For Marriage - Day 8 focusing on marriage blessings.',
  keywords: ['marriage novena day 8', 'marriage prayer day 8'],
  openGraph: {
    title: 'Novenas For Marriage - Day 8: Marriage Blessings',
    description: 'Pray the Novenas For Marriage - Day 8 focusing on marriage blessings.',
    url: 'https://catholic-bible-online.com/novenas/marriage/day-8',
  },
  twitter: {
    title: 'Novenas For Marriage - Day 8: Marriage Blessings',
    description: 'Pray the Novenas For Marriage - Day 8 focusing on marriage blessings.',
...
export default function NovenasForMarriageDay8Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novenas For Marriage – Day 8: Marriage Blessings
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Marriage Blessings</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on marriage blessings in our marriage prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on marriage blessings, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on marriage blessings. This aspect of marriage helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novenas For Marriage - Day 8: Marriage Blessings" 
            url="/novenas/marriage/day-8"
            excerpt="Join me in praying the Novenas For Marriage - Day 8 focusing on marriage blessings." 
          />
        </div>
