...
export const metadata: Metadata = {
  title: 'Novenas For Marriage - Day 3: Marriage Communication',
  description: 'Pray the Novenas For Marriage - Day 3 focusing on marriage communication.',
  keywords: ['marriage novena day 3', 'marriage prayer day 3'],
  openGraph: {
    title: 'Novenas For Marriage - Day 3: Marriage Communication',
    description: 'Pray the Novenas For Marriage - Day 3 focusing on marriage communication.',
    url: 'https://catholic-bible-online.com/novenas/marriage/day-3',
  },
  twitter: {
    title: 'Novenas For Marriage - Day 3: Marriage Communication',
    description: 'Pray the Novenas For Marriage - Day 3 focusing on marriage communication.',
...
export default function NovenasForMarriageDay3Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novenas For Marriage – Day 3: Marriage Communication
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Marriage Communication</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on marriage communication in our marriage prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on marriage communication, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on marriage communication. This aspect of marriage helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novenas For Marriage - Day 3: Marriage Communication" 
            url="/novenas/marriage/day-3"
            excerpt="Join me in praying the Novenas For Marriage - Day 3 focusing on marriage communication." 
          />
        </div>
