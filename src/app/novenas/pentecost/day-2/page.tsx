...
export const metadata: Metadata = {
  title: 'Pentecost Novena - Day 2: Understanding',
  description: 'Pray the Pentecost Novena - Day 2 focusing on understanding. Join in praying the traditional novena.',
  keywords: [
    'pentecost novena day 2',
    'pentecost prayer day 2',
    'day 2 pentecost novena',
    'understanding pentecost novena'
  ],
  openGraph: {
    title: 'Pentecost Novena - Day 2: Understanding',
    description: 'Pray the Pentecost Novena - Day 2 focusing on understanding.',
    url: 'https://catholicbible-online.com/novenas/pentecost/day-2',
  },
  twitter: {
    title: 'Pentecost Novena - Day 2: Understanding',
    description: 'Pray the Pentecost Novena - Day 2 focusing on understanding.',
...
export default function PentecostNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Pentecost Novena – Day 2: Understanding
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Understanding</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on understanding in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on understanding, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on understanding. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Pentecost Novena - Day 2: Understanding" 
            url="/novenas/pentecost/day-2"
            excerpt="Join me in praying the Pentecost Novena - Day 2 focusing on understanding." 
          />
        </div>
