...
export const metadata: Metadata = {
  title: 'Pentecost Novena - Day 4: Fortitude',
  description: 'Pray the Pentecost Novena - Day 4 focusing on fortitude. Join in praying the traditional novena.',
  keywords: [
    'pentecost novena day 4',
    'pentecost prayer day 4',
    'day 4 pentecost novena',
    'fortitude pentecost novena'
  ],
  openGraph: {
    title: 'Pentecost Novena - Day 4: Fortitude',
    description: 'Pray the Pentecost Novena - Day 4 focusing on fortitude.',
    url: 'https://catholicbible-online.com/novenas/pentecost/day-4',
  },
  twitter: {
    title: 'Pentecost Novena - Day 4: Fortitude',
    description: 'Pray the Pentecost Novena - Day 4 focusing on fortitude.',
...
export default function PentecostNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Pentecost Novena – Day 4: Fortitude
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Focusing on fortitude in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on fortitude, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on fortitude. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Pentecost Novena - Day 4: Fortitude" 
            url="/novenas/pentecost/day-4"
            excerpt="Join me in praying the Pentecost Novena - Day 4 focusing on fortitude." 
          />
        </div>
