...
export const metadata: Metadata = {
  title: 'Pentecost Novena - Day 7: Fear of the Lord',
  description: 'Pray the Pentecost Novena - Day 7 focusing on fear of the lord. Join in praying the traditional novena.',
  keywords: [
    'pentecost novena day 7',
    'pentecost prayer day 7',
    'day 7 pentecost novena',
    'fear of the lord pentecost novena'
  ],
  openGraph: {
    title: 'Pentecost Novena - Day 7: Fear of the Lord',
    description: 'Pray the Pentecost Novena - Day 7 focusing on fear of the lord.',
    url: 'https://catholicbible-online.com/novenas/pentecost/day-7',
  },
  twitter: {
    title: 'Pentecost Novena - Day 7: Fear of the Lord',
    description: 'Pray the Pentecost Novena - Day 7 focusing on fear of the lord.',
...
export default function PentecostNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Pentecost Novena – Day 7: Fear of the Lord
          </h1>
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Fear of the Lord</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on fear of the lord in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on fear of the lord, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on fear of the lord. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Pentecost Novena - Day 7: Fear of the Lord" 
            url="/novenas/pentecost/day-7"
            excerpt="Join me in praying the Pentecost Novena - Day 7 focusing on fear of the lord." 
          />
        </div>
