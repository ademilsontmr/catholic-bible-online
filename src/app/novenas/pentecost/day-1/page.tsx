...
export const metadata: Metadata = {
  title: 'Pentecost Novena - Day 1: Wisdom',
  description: 'Pray the Pentecost Novena - Day 1 focusing on wisdom. Join in praying the traditional novena.',
  keywords: [
    'pentecost novena day 1',
    'pentecost prayer day 1',
    'day 1 pentecost novena',
    'wisdom pentecost novena'
  ],
  openGraph: {
    title: 'Pentecost Novena - Day 1: Wisdom',
    description: 'Pray the Pentecost Novena - Day 1 focusing on wisdom.',
    url: 'https://catholicbible-online.com/novenas/pentecost/day-1',
  },
  twitter: {
    title: 'Pentecost Novena - Day 1: Wisdom',
    description: 'Pray the Pentecost Novena - Day 1 focusing on wisdom.',
...
export default function PentecostNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Focusing on wisdom in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on wisdom, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on wisdom. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Pentecost Novena - Day 1: Wisdom" 
            url="/novenas/pentecost/day-1"
            excerpt="Join me in praying the Pentecost Novena - Day 1 focusing on wisdom." 
          />
        </div>
