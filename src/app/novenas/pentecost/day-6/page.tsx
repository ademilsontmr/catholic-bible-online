...
export const metadata: Metadata = {
  title: 'Pentecost Novena - Day 6: Piety',
  description: 'Pray the Pentecost Novena - Day 6 focusing on piety. Join in praying the traditional novena.',
  keywords: [
    'pentecost novena day 6',
    'pentecost prayer day 6',
    'day 6 pentecost novena',
    'piety pentecost novena'
  ],
  openGraph: {
    title: 'Pentecost Novena - Day 6: Piety',
    description: 'Pray the Pentecost Novena - Day 6 focusing on piety.',
    url: 'https://catholicbible-online.com/novenas/pentecost/day-6',
  },
  twitter: {
    title: 'Pentecost Novena - Day 6: Piety',
    description: 'Pray the Pentecost Novena - Day 6 focusing on piety.',
...
export default function PentecostNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Focusing on piety in our prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">
                Lord, as we pray today focusing on piety, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on piety. This aspect of our faith helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Pentecost Novena - Day 6: Piety" 
            url="/novenas/pentecost/day-6"
            excerpt="Join me in praying the Pentecost Novena - Day 6 focusing on piety." 
          />
        </div>
