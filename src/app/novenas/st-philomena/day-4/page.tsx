...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 4: Divine Protection',
  description: "Pray the Novena to St. Philomena - Day 4 focusing on Divine Protection. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 4',
    'st philomena novena day 4',
    'philomena novena day 4',
    'st philomena prayer day 4',
    'day 4 st philomena novena',
    'divine protection prayer',
    'st philomena novena divine protection',
    'philomena novena divine protection'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 4: Divine Protection',
    description: 'Pray the Novena to St. Philomena - Day 4 focusing on Divine Protection. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-4',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 4: Divine Protection',
    description: 'Pray the Novena to St. Philomena - Day 4 focusing on Divine Protection. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 4: Divine Protection
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we focus on St. Philomena's divine protection. She is known for protecting her clients in the dangers surrounding them. We seek her powerful intercession for our safety.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's protection extends to all who invoke her. She watches over her clients and protects them from both physical and spiritual dangers.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, protect me in all dangers as you protect your clients. May your divine protection surround me and keep me safe from all harm, both physical and spiritual. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 4: Divine Protection" 
            url="/novenas/st-philomena/day-4"
            excerpt="Join me in praying the Novena to St. Philomena - Day 4 focusing on Divine Protection." 
          />
        </div>
