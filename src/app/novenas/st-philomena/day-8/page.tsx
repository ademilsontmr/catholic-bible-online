...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 8: Divine Mercy',
  description: "Pray the Novena to St. Philomena - Day 8 focusing on Divine Mercy. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 8',
    'st philomena novena day 8',
    'philomena novena day 8',
    'st philomena prayer day 8',
    'day 8 st philomena novena',
    'divine mercy prayer',
    'st philomena novena divine mercy',
    'philomena novena divine mercy'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 8: Divine Mercy',
    description: 'Pray the Novena to St. Philomena - Day 8 focusing on Divine Mercy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-8',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 8: Divine Mercy',
    description: 'Pray the Novena to St. Philomena - Day 8 focusing on Divine Mercy. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 8: Divine Mercy
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we focus on God's divine mercy through St. Philomena's intercession. We thank God for the graces bestowed upon her and implore His mercy through her prayers.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's intercession brings us God's mercy. Through her prayers, we receive the graces we need and experience God's loving mercy in our lives.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, obtain for me God's divine mercy through your intercession. May your prayers bring me the mercy and graces I need in my life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 8: Divine Mercy" 
            url="/novenas/st-philomena/day-8"
            excerpt="Join me in praying the Novena to St. Philomena - Day 8 focusing on Divine Mercy." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-philomena/day-9"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Holy Trinity →
          </Link>
