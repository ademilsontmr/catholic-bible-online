...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 5: Suffering and Fortitude',
  description: "Pray the Novena to St. Philomena - Day 5 focusing on Suffering and Fortitude. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 5',
    'st philomena novena day 5',
    'philomena novena day 5',
    'st philomena prayer day 5',
    'day 5 st philomena novena',
    'suffering and fortitude prayer',
    'st philomena novena suffering and fortitude',
    'philomena novena suffering and fortitude'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 5: Suffering and Fortitude',
    description: 'Pray the Novena to St. Philomena - Day 5 focusing on Suffering and Fortitude. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-5',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 5: Suffering and Fortitude',
    description: 'Pray the Novena to St. Philomena - Day 5 focusing on Suffering and Fortitude. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 5: Suffering and Fortitude
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Suffering and Fortitude</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Philomena's suffering and fortitude. As a martyr, she endured great suffering with courage and strength. We pray for her help in our own trials and temptations.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's fortitude in suffering teaches us that God gives us the strength to endure any trial when we trust in Him. She can help us find courage in our own difficulties.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, help me to find strength in suffering and temptation like you. May your fortitude in the face of persecution inspire me to endure my own trials with courage. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 5: Suffering and Fortitude" 
            url="/novenas/st-philomena/day-5"
            excerpt="Join me in praying the Novena to St. Philomena - Day 5 focusing on Suffering and Fortitude." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-philomena/day-6"
            className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Heavenly Intercession →
          </Link>
