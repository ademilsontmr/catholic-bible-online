...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 9: Holy Trinity',
  description: "Pray the Novena to St. Philomena - Day 9 focusing on Holy Trinity. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 9',
    'st philomena novena day 9',
    'philomena novena day 9',
    'st philomena prayer day 9',
    'day 9 st philomena novena',
    'holy trinity prayer',
    'st philomena novena holy trinity',
    'philomena novena holy trinity'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 9: Holy Trinity',
    description: 'Pray the Novena to St. Philomena - Day 9 focusing on Holy Trinity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-9',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 9: Holy Trinity',
    description: 'Pray the Novena to St. Philomena - Day 9 focusing on Holy Trinity. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 9: Holy Trinity
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Holy Trinity</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on the Most Holy Trinity. We thank God for the graces bestowed upon St. Philomena and upon the Blessed Virgin Mary, and we implore His mercy.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's life was a reflection of the Holy Trinity's love and grace. Through her intercession, we receive the graces of the Father, Son, and Holy Spirit.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of St. Philomena. 
            May you always remember her powerful protection and her miraculous help in all your needs. 
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena to St. Philomena! As you continue your spiritual journey, 
            may your heart be filled with virgin purity, eminent chastity, profession of virtue, 
            divine protection, suffering fortitude, heavenly intercession, spouse devotion, divine mercy, 
            and Holy Trinity graces. May St. Philomena continue to watch over you and work miracles in your life.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 9: Holy Trinity" 
            url="/novenas/st-philomena/day-9"
            excerpt="Join me in praying the Novena to St. Philomena - Day 9 focusing on Holy Trinity." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/st-philomena/day-8"
      ...
      <RelatedNovenas currentNovena="Novena to St. Philomena" />
    </div>
  )
}
