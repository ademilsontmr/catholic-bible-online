...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 2: Eminent Chastity',
  description: "Pray the Novena to St. Philomena - Day 2 focusing on Eminent Chastity. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 2',
    'st philomena novena day 2',
    'philomena novena day 2',
    'st philomena prayer day 2',
    'day 2 st philomena novena',
    'eminent chastity prayer',
    'st philomena novena eminent chastity',
    'philomena novena eminent chastity'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 2: Eminent Chastity',
    description: 'Pray the Novena to St. Philomena - Day 2 focusing on Eminent Chastity. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-2',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 2: Eminent Chastity',
    description: 'Pray the Novena to St. Philomena - Day 2 focusing on Eminent Chastity. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 2: Eminent Chastity
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Eminent Chastity</h2>
          <p className="text-gray-700 leading-relaxed">
            On this second day of our novena, we focus on St. Philomena's eminent chastity. Her purity of heart and body made her always pleasing in God's sight. We pray for the grace to imitate her virtue.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's eminent chastity was not just physical, but also spiritual. Her heart was pure and focused entirely on God, making her a model of virtue for all Christians.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, help me to grow in the virtue of chastity like you. May your eminent chastity inspire me to keep my heart and mind pure, always pleasing in God's sight. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 2: Eminent Chastity" 
            url="/novenas/st-philomena/day-2"
            excerpt="Join me in praying the Novena to St. Philomena - Day 2 focusing on Eminent Chastity." 
          />
        </div>
