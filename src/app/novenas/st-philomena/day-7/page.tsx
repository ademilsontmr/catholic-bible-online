...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 7: Spouse of Christ',
  description: "Pray the Novena to St. Philomena - Day 7 focusing on Spouse of Christ. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 7',
    'st philomena novena day 7',
    'philomena novena day 7',
    'st philomena prayer day 7',
    'day 7 st philomena novena',
    'spouse of christ prayer',
    'st philomena novena spouse of christ',
    'philomena novena spouse of christ'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 7: Spouse of Christ',
    description: 'Pray the Novena to St. Philomena - Day 7 focusing on Spouse of Christ. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-7',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 7: Spouse of Christ',
    description: 'Pray the Novena to St. Philomena - Day 7 focusing on Spouse of Christ. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 7: Spouse of Christ
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spouse of Christ</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Philomena as a spouse of Christ. Through her virginity and martyrdom, she became a perfect spouse of Christ, giving her life completely to Him.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's relationship with Christ as His spouse shows us the depth of love we should have for Him. She teaches us to give ourselves completely to God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, help me to be a faithful spouse of Christ like you. May your complete dedication to Christ inspire me to give myself entirely to God. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 7: Spouse of Christ" 
            url="/novenas/st-philomena/day-7"
            excerpt="Join me in praying the Novena to St. Philomena - Day 7 focusing on Spouse of Christ." 
          />
        </div>
