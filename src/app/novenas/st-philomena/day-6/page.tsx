...
export const metadata: Metadata = {
  title: 'Novena to St. Philomena - Day 6: Heavenly Intercession',
  description: "Pray the Novena to St. Philomena - Day 6 focusing on Heavenly Intercession. Join in praying the traditional novena to seek St. Philomena's intercession.",
  keywords: [
    'novena to st philomena day 6',
    'st philomena novena day 6',
    'philomena novena day 6',
    'st philomena prayer day 6',
    'day 6 st philomena novena',
    'heavenly intercession prayer',
    'st philomena novena heavenly intercession',
    'philomena novena heavenly intercession'
  ],
  openGraph: {
    title: 'Novena to St. Philomena - Day 6: Heavenly Intercession',
    description: 'Pray the Novena to St. Philomena - Day 6 focusing on Heavenly Intercession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-philomena/day-6',
  },
  twitter: {
    title: 'Novena to St. Philomena - Day 6: Heavenly Intercession',
    description: 'Pray the Novena to St. Philomena - Day 6 focusing on Heavenly Intercession. Join in praying the traditional novena.',
...
export default function StPhilomenaNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Philomena – Day 6: Heavenly Intercession
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Heavenly Intercession</h2>
          <p className="text-gray-700 leading-relaxed">
            On this sixth day, we focus on St. Philomena's heavenly intercession. From the heights of Heaven, she casts a glance upon her humble clients and intercedes powerfully with God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Philomena's heavenly intercession is powerful because she is close to God. Her prayers on our behalf are heard and answered, bringing us the graces we need.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O St. Philomena, intercede for me with God from the heights of Heaven. May your powerful heavenly intercession bring me the graces I need and help me to grow in holiness. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Philomena - Day 6: Heavenly Intercession" 
            url="/novenas/st-philomena/day-6"
            excerpt="Join me in praying the Novena to St. Philomena - Day 6 focusing on Heavenly Intercession." 
          />
        </div>
