    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Family Difficulties - Day 2: Grief and Loss" 
            url="/novenas/family-difficulties/day-2"
            excerpt="Join me in praying the Novena for Family Difficulties - Day 2 focusing on grief and loss for God\'s blessing." 
          />
        </div>
