    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for First Communion - Day 4: Religious Education" 
            url="/novenas/first-communion/day-4"
            excerpt="Join me in praying the Novena for First Communion - Day 4 focusing on religious education for receiving the Holy Eucharist." 
          />
        </div>
