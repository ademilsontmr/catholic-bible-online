...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 9: Gratitude',
  description: 'Pray the Novena for Heart Disease - Day 9 focusing on Gratitude. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 9: Gratitude</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this ninth day of the Novena for Heart Disease, we pray with gratitude for God\'s help and care in managing heart disease. We thank God for His guidance and His love for us.</p>
        </section>
...
We come to you today with trust in your intercession.
              ...
              <p className="mb-6">
                <strong>O Lord Jesus Christ, help us to surrender and trust!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for surrender and trust in managing heart health.
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            May you always remember His care and His perfect plan for your heart health. 
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena for Heart Disease! As you continue your spiritual journey, 
            ...
            May God continue to watch over you and help you in managing your heart health.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 9: Surrender and Trust" 
            url="/novenas/heart-disease/day-9"
            excerpt="Join me in praying the Novena for Heart Disease - Day 9 focusing on Surrender and Trust." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/heart-disease/day-8"
      ...
      <RelatedNovenas currentNovena="Novena for Heart Disease" />
    </div>
  )
}