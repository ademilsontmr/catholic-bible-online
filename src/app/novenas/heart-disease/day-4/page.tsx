...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 4: Humility',
  description: 'Pray the Novena for Heart Disease - Day 4 focusing on Humility. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 4: Humility</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Novena for Heart Disease, we pray for humility, following Jesus\' example of perfect humility before God. We ask God to help us imitate His humility and trust in God\'s will.</p>
        </section>
...
We come to you today with trust in your intercession.
              ...
              <p className="mb-6">
                <strong>Your timing is perfect and your plan is good.</strong>
              </p>
              <p className="mb-6">
              ...
              <p className="mb-6">
                <strong>O Lord Jesus Christ, give us patience and perseverance! Help us to wait for your healing
with patience and to persevere in maintaining healthy habits.
Teach us to trust in your timing.</strong>
              </p>
              <p className="mb-6">
              ...
              <p className="mb-6">
                <strong>O Lord Jesus Christ, heal us and guide us!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for patience and perseverance in managing heart health.
                Patience and Perseverance are gifts from God that help us face life's challenges.
              </p>
              ...
              <p className="mb-4">
                As we continue this novena, let us ask God to give us the patience and perseverance we need
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Lord Jesus Christ, give us patience and perseverance. Help us to wait for your healing
with patience and to persevere in maintaining healthy habits.
May we always trust in your timing. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 4: Patience and Perseverance" 
            url="/novenas/heart-disease/day-4"
            excerpt="Join me in praying the Novena for Heart Disease - Day 4 focusing on Patience and Perseverance." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/heart-disease/day-3"
          ...
          <Link 
            href="/novenas/heart-disease/day-5"
