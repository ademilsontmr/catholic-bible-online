...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 3: Love',
  description: 'Pray the Novena for Heart Disease - Day 3 focusing on Love. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 3: Love</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day of the Novena for Heart Disease, we pray for love for God and to imitate His love for us in managing heart disease. We ask God to help us grow in love for Him and through Him.</p>
        </section>
...
and to understand how to manage our heart health effectively.
Teach us to seek your guidance in every decision.</strong>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for wisdom and understanding in managing heart health.
...
May we always seek your guidance in every decision. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 3: Wisdom and Understanding" 
            url="/novenas/heart-disease/day-3"
            excerpt="Join me in praying the Novena for Heart Disease - Day 3 focusing on Wisdom and Understanding." 
          />
        </div>
