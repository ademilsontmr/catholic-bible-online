...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 2: Hope',
  description: 'Pray the Novena for Heart Disease - Day 2 focusing on Hope. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 2: Hope</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this second day of the Novena for Heart Disease, we pray for hope in God\'s care and His ability to help us with heart disease. We ask God to help us hope in His healing power and His love for us.</p>
        </section>
...
we need to manage our heart health daily and the courage to face each challenge with hope.
Teach us to rely on your power when we feel weak.</strong>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for strength and courage in managing heart health.
...
to manage our heart health daily and the courage to face each challenge with hope.
May we always rely on your power when we feel weak. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 2: Strength and Courage" 
            url="/novenas/heart-disease/day-2"
            excerpt="Join me in praying the Novena for Heart Disease - Day 2 focusing on Strength and Courage." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/heart-disease/day-1"
