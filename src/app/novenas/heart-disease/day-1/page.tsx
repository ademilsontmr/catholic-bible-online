...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 1: Trust',
  description: 'Pray the Novena for Heart Disease - Day 1 focusing on Trust. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 1: Trust</h1>
          <p className="text-xl text-gray-600 mb-6">
            Join in praying the Novena for Heart Disease to seek God's intercession and guidance in managing heart health.
          </p>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena for Heart Disease, we pray for trust in God\'s healing power and guidance in managing heart disease. We ask God to help us trust in His care and His ability to guide us.</p>
        </section>
...
We come to you today with trust in your intercession.
              ...
              <p className="mb-6">
                <strong>Your love for us is endless and your care is constant.</strong>
              </p>
              <p className="mb-6">
...
in your healing power and your ability to help us in all our needs. Teach us to turn to you
with confidence in every difficulty. Help us to trust completely
...
with confidence in every difficulty.
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for faith and trust in managing heart health.
...
in every need, knowing that you will always help us and guide us in managing our heart health.
May we always trust in your intercession and your care for us. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 1: Faith and Trust" 
            url="/novenas/heart-disease/day-1"
            excerpt="Join me in praying the Novena for Heart Disease - Day 1 focusing on Faith and Trust." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/heart-disease/day-2"
