...
export const metadata: Metadata = {
  title: 'Novena for Heart Disease - Day 6: Obedience',
  description: 'Pray the Novena for Heart Disease - Day 6 focusing on Obedience. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Heart Disease – Day 6: Obedience</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this sixth day of the Novena for Heart Disease, we pray for obedience to God\'s will and His plan for our heart disease journey. We ask God to help us be obedient to His plan for our lives.</p>
        </section>
...
We come to you today with trust in your intercession.
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for gratitude and acceptance in managing heart health.
...
May we always be grateful in all circumstances. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Heart Disease - Day 6: Gratitude and Acceptance" 
            url="/novenas/heart-disease/day-6"
            excerpt="Join me in praying the Novena for Heart Disease - Day 6 focusing on Gratitude and Acceptance." 
          />
        </div>
