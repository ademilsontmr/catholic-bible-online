...
export const metadata: Metadata = {
  ...
  description: 'Pray Mother Angelica Novena - Day 8 focusing on media evangelization. Join in praying for holiness, evangelization, and faithfulness to God\'s will.',
  keywords: [
    'mother angelica novena day 8',
    'mother angelica prayer novena day 8',
    'day 8 mother angelica novena',
    'media evangelization mother angelica'
  ],
  openGraph: {
    title: 'Mother Angelica Novena - Day 8: Media Evangelization',
    description: 'Pray Mother Angelica Novena - Day 8 focusing on Media Evangelization.',
    url: 'https://catholicbibleonline.com/novenas/mother-angelica/day-8',
  },
  twitter: {
    title: 'Mother Angelica Novena - Day 8: Media Evangelization',
    description: 'Pray Mother Angelica Novena - Day 8 focusing on Media Evangelization.',
...
export default function MotherAngelicaNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Mother Angelica Novena – Day 8: Media Evangelization
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Media Evangelization</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for courage and talent in using media to spread the Catholic faith.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Your servant, Mother Angelica, as an example of holiness. Help us to imitate the love of You she showed in choosing to make use of the media for evangelization.</p>

              <p className="mb-4">Mother Angelica, your bishop saw that you had talent in talking to lay people about the truths of the Faith. He encouraged you to do more of this, so you continued your work in evangelization.</p>

              <p className="mb-4">You toured a television studio run by Baptists, and you knew that a Catholic-run television studio would be a very worthwhile enterprise. You worked hard to bring about the establishment of EWTN.</p>

              <p className="mb-4">Pray for me, that I may always do all I can to spread the Gospel. Pray that I may be eager to serve God in whatever ways He calls me to.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on media evangelization. This aspect of honoring Mother Angelica helps you to understand 
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/mother-angelica/day-9"
            className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
          >
            Day 9: Lifelong Dedication →
          </Link>
