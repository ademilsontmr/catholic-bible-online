...
export const metadata: Metadata = {
  ...
  description: 'Pray Mother Angelica Novena - Day 3 focusing on perseverance in faith. Join in praying for holiness, evangelization, and faithfulness to God\'s will.',
  keywords: [
    'mother angelica novena day 3',
    'mother angelica prayer novena day 3',
    'day 3 mother angelica novena',
    'perseverance in faith mother angelica'
  ],
  openGraph: {
    title: 'Mother Angelica Novena - Day 3: Perseverance in Faith',
    description: 'Pray Mother Angelica Novena - Day 3 focusing on Perseverance in Faith.',
    url: 'https://catholicbibleonline.com/novenas/mother-angelica/day-3',
  },
  twitter: {
    title: 'Mother Angelica Novena - Day 3: Perseverance in Faith',
    description: 'Pray Mother Angelica Novena - Day 3 focusing on Perseverance in Faith.',
...
export default function MotherAngelicaNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Mother Angelica Novena – Day 3: Perseverance in Faith
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Perseverance in Faith</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we pray for perseverance through trials and devotion to God's call.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">Dear Lord, we thank You for giving us Your servant, Mother Angelica, as an example of holiness. Help us to imitate the love of You she grew in despite many obstacles.</p>

              <p className="mb-4">Mother Angelica, you suffered a lot during your childhood because of your parents' divorce and your mother's mental health difficulties. Despite these sufferings, you chose to devote your life to God.</p>

              <p className="mb-4">You persevered through years of turmoil in your youth, and you followed God's call to religious life when you became an adult. You spent the rest of your life serving Him wholeheartedly.</p>

              <p className="mb-4">Pray for me, that I may choose to serve God no matter what trials I might be facing. Pray that I may be eager to devote my life fully to God.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on perseverance in faith. This aspect of honoring Mother Angelica helps you to understand 
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/mother-angelica/day-4"
            className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
          >
            Day 4: Religious Vocation →
          </Link>
