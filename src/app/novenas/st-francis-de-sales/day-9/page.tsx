...
export default function StFrancisDeSalesNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Francis de Sales Novena – Day 9: Devout Life
          </h1>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="St. Francis de Sales Novena - Day 9: Devout Life" 
            url="/novenas/st-francis-de-sales/day-9"
            excerpt="Join me in praying the St. Francis de Sales Novena - Day 9 focusing on Devout Life." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Novena to St. Francis de Sales" />
    </div>
  )
} 