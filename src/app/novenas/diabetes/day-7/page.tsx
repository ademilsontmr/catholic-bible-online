...
export const metadata: Metadata = {
  title: 'Novena for Diabetes - Day 7: Perseverance',
  description: 'Pray the Novena for Diabetes - Day 7 focusing on Perseverance. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Diabetes – Day 7: Perseverance</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day of the Novena for Diabetes, we pray for perseverance in prayer and in managing diabetes with faith. We ask God to help us persevere in our spiritual journey.</p>
        </section>
...
We come to you today with trust in your healing power.
              ...
              <p className="mb-6">
                <strong>O Mother of Perpetual Help, give us peace and serenity! Help us to find peace in your presence
...
Teach us to rest in your peace.</strong>
              ...
              <p className="mb-6">
                <strong>O Mother of Perpetual Help, be our peace and our serenity!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for peace and serenity in managing health.
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of Perpetual Help, give us peace and serenity. Help us to find peace in your presence
and serenity in trusting your care for us.
May we always rest in your peace. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Diabetes - Day 7: Peace and Serenity" 
            url="/novenas/diabetes/day-7"
            excerpt="Join me in praying the Novena for Diabetes - Day 7 focusing on Peace and Serenity." 
          />
        </div>
