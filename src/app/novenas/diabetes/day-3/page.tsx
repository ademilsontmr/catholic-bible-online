...
export const metadata: Metadata = {
  title: 'Novena for Diabetes - Day 3: Love',
  description: 'Pray the Novena for Diabetes - Day 3 focusing on Love. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Diabetes – Day 3: Love</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this third day of the Novena for Diabetes, we pray for love for God and to imitate His love for us in managing diabetes. We ask God to help us grow in love for Him and through Him.</p>
        </section>
...
We come to you today with trust in your healing power.
              ...
              <p className="mb-6">
                <strong>O Mother of Perpetual Help, give us wisdom and understanding! Help us to make good health decisions
and to understand how to manage our health effectively.
Teach us to seek your guidance in every decision.</strong>
              ...
              <p className="mb-6">
                <strong>O Mother of Perpetual Help, guide us with your wisdom!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for wisdom and understanding in managing health.
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of Perpetual Help, give us wisdom and understanding. Help us to make good health decisions
and to understand how to manage our health effectively.
May we always seek your guidance in every decision. Amen.
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Diabetes - Day 3: Wisdom and Understanding" 
            url="/novenas/diabetes/day-3"
            excerpt="Join me in praying the Novena for Diabetes - Day 3 focusing on Wisdom and Understanding." 
          />
        </div>
