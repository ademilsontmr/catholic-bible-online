...
export const metadata: Metadata = {
  title: 'Novena for Diabetes - Day 8: Intercession',
  description: 'Pray the Novena for Diabetes - Day 8 focusing on Intercession. Join in praying for healing and strength.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">Novena for Diabetes – Day 8: Intercession</h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this eighth day of the Novena for Diabetes, we pray for God\'s powerful intercession and His ability to help us with diabetes. We ask God to intercede for us and guide us.</p>
        </section>
...
We come to you today with trust in your healing power.
              ...
              <p className="mb-6">
                <strong>O Mother of Perpetual Help, help us to love and care for ourselves!</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for love and self-care in managing health.
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of Perpetual Help, help us to love and care for ourselves. Help us to love ourselves
