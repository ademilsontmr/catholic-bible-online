...
export const metadata: Metadata = {
  ...
  description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 5 focusing on Spirit of Prayer. Join in praying the traditional novena to seek her intercession.',
  keywords: [
    'our lady of the miraculous medal novena day 5',
    'miraculous medal novena day 5',
    'mary novena day 5',
    'miraculous medal prayer spirit of prayer',
    'day 5 miraculous medal novena',
    'spirit of prayer mary prayer',
    'miraculous medal novena spirit of prayer',
    'mary novena spirit of prayer'
  ],
  openGraph: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 5: Spirit of Prayer',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 5 focusing on Spirit of Prayer. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-miraculous-medal/day-5',
  },
  twitter: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 5: Spirit of Prayer',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 5 focusing on Spirit of Prayer. Join in praying the traditional novena.',
...
export default function OurLadyOfTheMiraculousMedalNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Miraculous Medal Novena – Day 5: Spirit of Prayer
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Spirit of Prayer</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day of the Our Lady of the Miraculous Medal Novena, we ask for a spirit of prayer and self-denial 
            to recover what we have lost by sin. We seek to grow in our prayer life and spiritual discipline.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we ask for a spirit of prayer and self-denial to recover what we have lost by sin. 
                We seek to grow in our prayer life and spiritual discipline.
              </p>

              <p className="mb-4">
                Prayer is the lifeblood of our relationship with God. It is through prayer that we communicate with Him, 
                listen to His voice, and grow in our love for Him. A spirit of prayer means having a heart that is always 
                turned toward God, ready to pray at any moment, and finding joy in spending time with Him.
              </p>

              <p className="mb-4">
                Self-denial is also essential for spiritual growth. It helps us to overcome our selfish desires 
                and focus on what is truly important. Through self-denial, we learn to put God first and to serve others 
                with love and generosity. This is how we recover what we have lost by sin and grow in holiness.
              </p>

              <p className="mb-4">
                Mary is our perfect model of both prayer and self-denial. She was always in prayer, 
                constantly communing with God and seeking His will. She also practiced self-denial throughout her life, 
                putting God's plan above her own desires and serving others with complete selflessness.
              </p>

              <p>
                As we pray today, let us ask Mary to help us develop a spirit of prayer and self-denial. 
                Let us also ask her to help us recover what we have lost by sin through penance and spiritual discipline. 
                Through her intercession, may we grow in our prayer life and learn to deny ourselves for the sake of God and others.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, conceived without sin, pray for us who have recourse to you. Help us to develop a spirit of prayer 
            and self-denial so that we may recover what we have lost by sin. May we grow in our prayer life and learn 
            to deny ourselves for the sake of God and others. Through your intercession, may we always be ready to pray 
            and to serve with love and generosity, following your example of perfect prayer and self-denial. Amen.
          </p>
        </section>
