...
export const metadata: Metadata = {
  title: 'Our Lady of the Miraculous Medal Novena - Day 2: Immaculate Conception',
  description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 2 focusing on Immaculate Conception. Join in praying the traditional novena to seek her intercession.',
  keywords: [
    'our lady of the miraculous medal novena day 2',
    'miraculous medal novena day 2',
    'mary novena day 2',
    'miraculous medal prayer immaculate conception',
    'day 2 miraculous medal novena',
    'immaculate conception mary prayer',
    'miraculous medal novena immaculate conception',
    'mary novena immaculate conception'
  ],
  openGraph: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 2: Immaculate Conception',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 2 focusing on Immaculate Conception. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-miraculous-medal/day-2',
  },
  twitter: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 2: Immaculate Conception',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 2 focusing on Immaculate Conception. Join in praying the traditional novena.',
...
export default function OurLadyOfTheMiraculousMedalNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Miraculous Medal Novena – Day 2: Immaculate Conception
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this second day of the Our Lady of the Miraculous Medal Novena, we meditate on Mary's Immaculate Conception 
            and her role as the Mother of God. We contemplate the mystery of her sinless nature and perfect purity.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we meditate on Mary's Immaculate Conception and her role as the Mother of God. 
                We contemplate the mystery of her sinless nature and perfect purity.
              </p>

              <p className="mb-4">
                The Immaculate Conception is the dogma that Mary was conceived without original sin. 
                This unique privilege was given to her by God in preparation for her role as the Mother of Jesus Christ. 
                The Miraculous Medal prominently displays this truth with the words "O Mary, conceived without sin, pray for us who have recourse to you."
              </p>

              <p className="mb-4">
                Mary's Immaculate Conception shows us the beauty of perfect purity and the power of God's grace. 
                Through her intercession, we can grow in holiness and strive for greater purity of heart. 
                She is our model of perfect love for God and complete trust in His will.
              </p>

              <p className="mb-4">
                As we pray today, let us ask Mary to help us develop a deep hatred of sin and a purity of heart 
                that will attach us to God alone. Let us also ask for her help in glorifying the mystery of her Immaculate Conception 
                by our words and works.
              </p>

              <p>
                Mary's Immaculate Conception reminds us that God has a special plan for each of us and that He gives us the graces 
                we need to fulfill our vocation. Through her intercession, may we grow in holiness and purity, 
                always seeking to do God's will with love and trust.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, conceived without sin, pray for us who have recourse to you. Help us to meditate on the mystery of your Immaculate Conception 
            and to grow in purity of heart. May we develop a deep hatred of sin and attach ourselves to God alone. 
            Through your intercession, may we glorify this mystery by our words and works, always seeking to do God's will with love and trust. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Miraculous Medal Novena - Day 2: Immaculate Conception" 
            url="/novenas/our-lady-of-the-miraculous-medal/day-2"
            excerpt="Join me in praying the Our Lady of the Miraculous Medal Novena - Day 2 focusing on Immaculate Conception." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/our-lady-of-the-miraculous-medal/day-1"
