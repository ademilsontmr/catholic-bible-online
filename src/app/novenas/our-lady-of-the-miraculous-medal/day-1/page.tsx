...
export const metadata: Metadata = {
  title: 'Our Lady of the Miraculous Medal Novena - Day 1: Faith and Trust',
  description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 1 focusing on Faith and Trust. Join in praying the traditional novena to seek her intercession.',
  keywords: [
    'our lady of the miraculous medal novena day 1',
    'miraculous medal novena day 1',
    'mary novena day 1',
    'miraculous medal prayer faith and trust',
    'day 1 miraculous medal novena',
    'faith and trust mary prayer',
    'miraculous medal novena faith and trust',
    'mary novena faith and trust'
  ],
  openGraph: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 1: Faith and Trust',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 1 focusing on Faith and Trust. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-miraculous-medal/day-1',
  },
  twitter: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 1: Faith and Trust',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 1 focusing on Faith and Trust. Join in praying the traditional novena.',
...
export default function OurLadyOfTheMiraculousMedalNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Miraculous Medal Novena – Day 1: Faith and Trust
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Our Lady of the Miraculous Medal Novena, we begin with faith and trust in Mary's powerful intercession 
            through the Miraculous Medal. We open our hearts to her maternal care and protection.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we begin our novena with faith and trust in Mary's powerful intercession through the Miraculous Medal. 
                We open our hearts to her maternal care and protection.
              </p>

              <p className="mb-4">
                The Miraculous Medal, revealed to St. Catherine Laboure in 1830, is a powerful sacramental that has brought 
                countless graces and miracles to those who wear it with faith and devotion. Through this medal, Mary shows us 
                her special love and protection.
              </p>

              <p className="mb-4">
                As we begin this novena, let us place our complete trust in Mary's intercession. She is our Mother, 
                and she wants to help us in all our needs. The Miraculous Medal is a sign of her affection for us 
                and a constant reminder of our duties toward her.
              </p>

              <p className="mb-4">
                Today's prayers remind us of Mary's Immaculate Conception and her role as the Mother of God. 
                We consecrate ourselves to her under the title of Our Lady of the Miraculous Medal, 
                asking for her loving protection and preservation in the grace of her Son.
              </p>

              <p>
                Let us begin this novena with confidence, knowing that Mary will not fail to help those who turn to her with trust. 
                Through her intercession, may we grow in faith, hope, and love, and experience the power of the Miraculous Medal in our lives.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, conceived without sin, pray for us who have recourse to you. Help us to begin this novena with faith and trust 
            in your powerful intercession through the Miraculous Medal. May this Medal be for us a sure sign of your affection 
            and a constant reminder of our duties toward you. Keep us close to you every moment of our lives. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Miraculous Medal Novena - Day 1: Faith and Trust" 
            url="/novenas/our-lady-of-the-miraculous-medal/day-1"
            excerpt="Join me in praying the Our Lady of the Miraculous Medal Novena - Day 1 focusing on Faith and Trust." 
          />
        </div>
