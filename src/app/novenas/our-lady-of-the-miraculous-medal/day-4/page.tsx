...
export const metadata: Metadata = {
  title: 'Our Lady of the Miraculous Medal Novena - Day 4: Purity of Heart',
  description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 4 focusing on Purity of Heart. Join in praying the traditional novena to seek her intercession.',
  keywords: [
    'our lady of the miraculous medal novena day 4',
    'miraculous medal novena day 4',
    'mary novena day 4',
    'miraculous medal prayer purity of heart',
    'day 4 miraculous medal novena',
    'purity of heart mary prayer',
    'miraculous medal novena purity of heart',
    'mary novena purity of heart'
  ],
  openGraph: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 4: Purity of Heart',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 4 focusing on Purity of Heart. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-the-miraculous-medal/day-4',
  },
  twitter: {
    title: 'Our Lady of the Miraculous Medal Novena - Day 4: Purity of Heart',
    description: 'Pray the Our Lady of the Miraculous Medal Novena - Day 4 focusing on Purity of Heart. Join in praying the traditional novena.',
...
export default function OurLadyOfTheMiraculousMedalNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Our Lady of the Miraculous Medal Novena – Day 4: Purity of Heart
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this fourth day of the Our Lady of the Miraculous Medal Novena, we pray for purity of heart 
            and a deep hatred of sin to attach us to God alone. We seek to make our every thought, word and deed tend to His greater glory.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for purity of heart and a deep hatred of sin to attach us to God alone. 
                We seek to make our every thought, word and deed tend to His greater glory.
              </p>

              <p className="mb-4">
                Purity of heart is one of the Beatitudes that Jesus taught us: "Blessed are the pure in heart, for they shall see God." 
                This purity is not just about avoiding sinful actions, but about having a heart that is completely focused on God 
                and His will. It means having pure intentions, pure thoughts, and pure desires.
              </p>

              <p className="mb-4">
                Mary, as the Immaculate Conception, is our perfect model of purity of heart. She was conceived without sin 
                and remained sinless throughout her life. Her heart was always pure and completely focused on God. 
                Through her intercession, we can grow in this virtue and develop a deep hatred of sin.
              </p>

              <p className="mb-4">
                The prayer today reminds us that our souls have been "the sanctuaries of your Son who hates iniquity." 
                This means that through Baptism, our souls have been made temples of the Holy Spirit. 
                We must keep these temples pure and holy, avoiding anything that would defile them.
              </p>

              <p>
                As we pray today, let us ask Mary to help us develop a deep hatred of sin and a purity of heart 
                that will attach us to God alone. Let us also ask her to help us make our every thought, word, and deed 
                tend to God's greater glory, so that we may one day attain to that blessed abode where she is the Queen of angels and of men.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mary, conceived without sin, pray for us who have recourse to you. Help us to develop a deep hatred of sin 
            and a purity of heart that will attach us to God alone. May our every thought, word, and deed tend to His greater glory. 
            Through your intercession, may we keep our souls as pure sanctuaries for your Son and one day attain to that blessed abode 
            where you are the Queen of angels and of men. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Our Lady of the Miraculous Medal Novena - Day 4: Purity of Heart" 
            url="/novenas/our-lady-of-the-miraculous-medal/day-4"
            excerpt="Join me in praying the Our Lady of the Miraculous Medal Novena - Day 4 focusing on Purity of Heart." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/our-lady-of-the-miraculous-medal/day-3"
          ...
          <Link 
            href="/novenas/our-lady-of-the-miraculous-medal/day-5"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 5: Spirit of Prayer →
          </Link>
        </div>
      </div>
    </div>
