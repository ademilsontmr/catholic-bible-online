...
export const metadata: Metadata = {
  title: 'Novena for Families - Day 8: Family Peace',
  description: 'Pray the Novena for Families - Day 8 focusing on family peace.',
  keywords: ['family novena day 8', 'family prayer day 8'],
  openGraph: {
    title: 'Novena for Families - Day 8: Family Peace',
    description: 'Pray the Novena for Families - Day 8 focusing on family peace.',
    url: 'https://catholic-bible-online.com/novenas/families/day-8',
  },
  twitter: {
    title: 'Novena for Families - Day 8: Family Peace',
    description: 'Pray the Novena for Families - Day 8 focusing on family peace.',
...
export default function NovenaForFamiliesDay8Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Families – Day 8: Family Peace
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Family Peace</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on family peace in our family prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on family peace, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on family peace. This aspect of family life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Families - Day 8: Family Peace" 
            url="/novenas/families/day-8"
            excerpt="Join me in praying the Novena for Families - Day 8 focusing on family peace." 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/novenas/families/day-9"
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Day 9: Family Gratitude →
          </Link>
