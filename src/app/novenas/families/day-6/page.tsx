...
export const metadata: Metadata = {
  title: 'Novena for Families - Day 6: Family Healing',
  description: 'Pray the Novena for Families - Day 6 focusing on family healing.',
  keywords: ['family novena day 6', 'family prayer day 6'],
  openGraph: {
    title: 'Novena for Families - Day 6: Family Healing',
    description: 'Pray the Novena for Families - Day 6 focusing on family healing.',
    url: 'https://catholic-bible-online.com/novenas/families/day-6',
  },
  twitter: {
    title: 'Novena for Families - Day 6: Family Healing',
    description: 'Pray the Novena for Families - Day 6 focusing on family healing.',
...
export default function NovenaForFamiliesDay6Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Families – Day 6: Family Healing
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Family Healing</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on family healing in our family prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on family healing, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on family healing. This aspect of family life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Families - Day 6: Family Healing" 
            url="/novenas/families/day-6"
            excerpt="Join me in praying the Novena for Families - Day 6 focusing on family healing." 
          />
        </div>
