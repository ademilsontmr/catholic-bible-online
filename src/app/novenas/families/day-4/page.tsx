...
export const metadata: Metadata = {
  title: 'Novena for Families - Day 4: Family Communication',
  description: 'Pray the Novena for Families - Day 4 focusing on family communication.',
  keywords: ['family novena day 4', 'family prayer day 4'],
  openGraph: {
    title: 'Novena for Families - Day 4: Family Communication',
    description: 'Pray the Novena for Families - Day 4 focusing on family communication.',
    url: 'https://catholic-bible-online.com/novenas/families/day-4',
  },
  twitter: {
    title: 'Novena for Families - Day 4: Family Communication',
    description: 'Pray the Novena for Families - Day 4 focusing on family communication.',
...
export default function NovenaForFamiliesDay4Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Families – Day 4: Family Communication
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Family Communication</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on family communication in our family prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on family communication, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on family communication. This aspect of family life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Families - Day 4: Family Communication" 
            url="/novenas/families/day-4"
            excerpt="Join me in praying the Novena for Families - Day 4 focusing on family communication." 
          />
        </div>
