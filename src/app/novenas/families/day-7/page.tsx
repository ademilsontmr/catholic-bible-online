...
export const metadata: Metadata = {
  title: 'Novena for Families - Day 7: Family Blessings',
  description: 'Pray the Novena for Families - Day 7 focusing on family blessings.',
  keywords: ['family novena day 7', 'family prayer day 7'],
  openGraph: {
    title: 'Novena for Families - Day 7: Family Blessings',
    description: 'Pray the Novena for Families - Day 7 focusing on family blessings.',
    url: 'https://catholic-bible-online.com/novenas/families/day-7',
  },
  twitter: {
    title: 'Novena for Families - Day 7: Family Blessings',
    description: 'Pray the Novena for Families - Day 7 focusing on family blessings.',
...
export default function NovenaForFamiliesDay7Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Families – Day 7: Family Blessings
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Focusing on family blessings in our family prayer today.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                Lord, as we pray today focusing on family blessings, help us to grow in our faith and draw closer to You. 
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on family blessings. This aspect of family life helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Families - Day 7: Family Blessings" 
            url="/novenas/families/day-7"
            excerpt="Join me in praying the Novena for Families - Day 7 focusing on family blessings." 
          />
        </div>
