    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Families - Day 9: Family Gratitude" 
            url="/novenas/families/day-9"
            excerpt="Join me in praying the Novena for Families - Day 9 focusing on family gratitude." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Families Novena" />
    </div>
  )
}
