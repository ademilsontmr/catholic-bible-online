...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 8: Zeal for Salvation',
  description: "Pray the Novena to St. Peregrine - Day 8 focusing on Zeal for Salvation. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 8',
    'st peregrine novena day 8',
    'peregrine novena day 8',
    'st peregrine prayer day 8',
    'day 8 st peregrine novena',
    'zeal for salvation prayer',
    'st peregrine novena zeal for salvation',
    'peregrine novena zeal for salvation'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 8: Zeal for Salvation',
    description: 'Pray the Novena to St. Peregrine - Day 8 focusing on Zeal for Salvation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-8',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 8: Zeal for Salvation',
    description: 'Pray the Novena to St. Peregrine - Day 8 focusing on Zeal for Salvation. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 8: Zeal for Salvation
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Zeal for Salvation</h2>
          <p className="text-gray-700 leading-relaxed">
            On this eighth day, we pray for a consuming zeal for the salvation of all men. We ask St. Peregrine to enkindle in our hearts this same zeal that burned in his own heart.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's zeal for the salvation of souls should inspire us to be more active in our efforts to bring others to Christ. Every prayer, every act of charity, every word of encouragement can help save a soul.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, enkindle in my heart a consuming zeal for the salvation of all men like the zeal that burned in your heart. Help me to be more active in bringing others to Christ. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Peregrine - Day 8: Zeal for Salvation" 
            url="/novenas/st-peregrine/day-8"
            excerpt="Join me in praying the Novena to St. Peregrine - Day 8 focusing on Zeal for Salvation." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-peregrine/day-9"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Perfect Resignation →
          </Link>
