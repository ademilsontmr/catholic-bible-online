...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 4: Union with Christ Crucified',
  description: "Pray the Novena to St. Peregrine - Day 4 focusing on Union with Christ Crucified. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 4',
    'st peregrine novena day 4',
    'peregrine novena day 4',
    'st peregrine prayer day 4',
    'day 4 st peregrine novena',
    'union with christ crucified prayer',
    'st peregrine novena union with christ crucified',
    'peregrine novena union with christ crucified'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 4: Union with Christ Crucified',
    description: 'Pray the Novena to St. Peregrine - Day 4 focusing on Union with Christ Crucified. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-4',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 4: Union with Christ Crucified',
    description: 'Pray the Novena to St. Peregrine - Day 4 focusing on Union with Christ Crucified. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 4: Union with Christ Crucified
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Union with Christ Crucified</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fourth day, we reflect on St. Peregrine's union with Christ crucified. In union with Jesus crucified, he endured painful sufferings with such patience as to deserve miraculous healing.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's union with Christ in suffering teaches us that our sufferings, when united to Christ's, can become a source of grace and even miracles. Suffering is not meaningless when offered to God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, help me to unite my sufferings with Christ crucified like you did. May your example teach me that my sufferings, when offered to God, can become a source of grace and even miracles. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Peregrine - Day 4: Union with Christ Crucified" 
            url="/novenas/st-peregrine/day-4"
            excerpt="Join me in praying the Novena to St. Peregrine - Day 4 focusing on Union with Christ Crucified." 
          />
        </div>
