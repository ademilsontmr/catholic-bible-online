...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 1: Divine Call and Obedience',
  description: "Pray the Novena to St. Peregrine - Day 1 focusing on Divine Call and Obedience. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 1',
    'st peregrine novena day 1',
    'peregrine novena day 1',
    'st peregrine prayer day 1',
    'day 1 st peregrine novena',
    'divine call and obedience prayer',
    'st peregrine novena divine call and obedience',
    'peregrine novena divine call and obedience'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 1: Divine Call and Obedience',
    description: 'Pray the Novena to St. Peregrine - Day 1 focusing on Divine Call and Obedience. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-1',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 1: Divine Call and Obedience',
    description: 'Pray the Novena to St. Peregrine - Day 1 focusing on Divine Call and Obedience. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 1: Divine Call and Obedience
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Call and Obedience</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to St. Peregrine, we reflect on his response to God's divine call. St. Peregrine answered the divine call with a ready spirit, forsaking all the comforts of a life of ease and all the empty honors of the world to dedicate himself to God in the Order of His holy Mother.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's response to God's call teaches us about the importance of obedience and sacrifice. When God calls us, He often asks us to leave behind our comfort zones and worldly attachments to follow Him more closely.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, help me to answer God's call with a ready spirit like you did. May your example of obedience and sacrifice inspire me to dedicate myself more fully to God's service. Guide me through these nine days of prayer, that I may grow closer to God and experience His healing grace. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Peregrine - Day 1: Divine Call and Obedience" 
            url="/novenas/st-peregrine/day-1"
            excerpt="Join me in praying the Novena to St. Peregrine - Day 1 focusing on Divine Call and Obedience." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-peregrine/day-2"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 2: Sacrifice and Dedication →
          </Link>
