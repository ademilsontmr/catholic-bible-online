...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 7: Divine Will and Obedience',
  description: "Pray the Novena to St. Peregrine - Day 7 focusing on Divine Will and Obedience. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 7',
    'st peregrine novena day 7',
    'peregrine novena day 7',
    'st peregrine prayer day 7',
    'day 7 st peregrine novena',
    'divine will and obedience prayer',
    'st peregrine novena divine will and obedience',
    'peregrine novena divine will and obedience'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 7: Divine Will and Obedience',
    description: 'Pray the Novena to St. Peregrine - Day 7 focusing on Divine Will and Obedience. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-7',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 7: Divine Will and Obedience',
    description: 'Pray the Novena to St. Peregrine - Day 7 focusing on Divine Will and Obedience. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 7: Divine Will and Obedience
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Will and Obedience</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on divine will and obedience. We ask St. Peregrine to obtain for us the grace to answer every call of God and to fulfill His will in all the events of life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's obedience to God's will throughout his life shows us that true holiness comes from surrendering our own will to God's perfect plan for us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, help me to fulfill God's will in all the events of life like you did. May your obedience to God's will inspire me to surrender my own will to God's perfect plan for me. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Peregrine - Day 7: Divine Will and Obedience" 
            url="/novenas/st-peregrine/day-7"
            excerpt="Join me in praying the Novena to St. Peregrine - Day 7 focusing on Divine Will and Obedience." 
          />
        </div>
