...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 9: Perfect Resignation',
  description: "Pray the Novena to St. Peregrine - Day 9 focusing on Perfect Resignation. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 9',
    'st peregrine novena day 9',
    'peregrine novena day 9',
    'st peregrine prayer day 9',
    'day 9 st peregrine novena',
    'perfect resignation prayer',
    'st peregrine novena perfect resignation',
    'peregrine novena perfect resignation'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 9: Perfect Resignation',
    description: 'Pray the Novena to St. Peregrine - Day 9 focusing on Perfect Resignation. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-9',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 9: Perfect Resignation',
    description: 'Pray the Novena to St. Peregrine - Day 9 focusing on Perfect Resignation. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 9: Perfect Resignation
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Perfect Resignation</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on perfect resignation to God's will. We ask for a perfect resignation to the sufferings it may please God to send us, so that we may merit eternal glory in heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's perfect resignation to God's will, even in the face of great suffering, shows us the path to eternal glory. When we accept God's will with love and trust, we grow in holiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of St. Peregrine. 
            May you always remember his powerful protection and his miraculous healing in all your needs. 
        ...
        <section className="bg-red-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed the Novena to St. Peregrine! As you continue your spiritual journey, 
            may your heart be filled with divine call, sacrifice, salvation, union with Christ, patience, 
            miraculous healing, divine will, zeal, and perfect resignation. May St. Peregrine continue to 
            watch over you and work miracles in your life.
          </p>
        </section>
        ...
        <ShareButton 
          title="Novena to St. Peregrine - Day 9: Perfect Resignation"
          text="Join me in praying the Novena to St. Peregrine - Day 9 focusing on Perfect Resignation."
        />

        {/* Navigation */}
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/st-peregrine/day-8"
      ...
      <RelatedNovenas currentNovena="Novena to St. Peregrine" />
    </div>
  )
}
