...
export const metadata: Metadata = {
  ...
  description: "Pray the Novena to St. Peregrine - Day 3 focusing on Salvation of Souls. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 3',
    'st peregrine novena day 3',
    'peregrine novena day 3',
    'st peregrine prayer day 3',
    'day 3 st peregrine novena',
    'salvation of souls prayer',
    'st peregrine novena salvation of souls',
    'peregrine novena salvation of souls'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 3: Salvation of Souls',
    description: 'Pray the Novena to St. Peregrine - Day 3 focusing on Salvation of Souls. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-3',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 3: Salvation of Souls',
    description: 'Pray the Novena to St. Peregrine - Day 3 focusing on Salvation of Souls. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 3: Salvation of Souls
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Salvation of Souls</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Peregrine's mission to save souls. He labored manfully for the salvation of souls, dedicating his life to bringing others closer to God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's zeal for the salvation of souls reminds us that our primary mission as Christians is to help others find their way to God. Every act of charity and prayer contributes to this great work.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, help me to labor for the salvation of souls like you did. May your zeal for bringing others to God inspire me to be more active in my efforts to help others find their way to Christ. Amen.
          </p>
        </section>
