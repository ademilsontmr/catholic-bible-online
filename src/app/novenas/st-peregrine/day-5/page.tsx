...
export const metadata: Metadata = {
  title: 'Novena to St. Peregrine - Day 5: Patience in Suffering',
  description: "Pray the Novena to St. Peregrine - Day 5 focusing on Patience in Suffering. Join in praying the traditional novena to seek St. Peregrine's intercession.",
  keywords: [
    'novena to st peregrine day 5',
    'st peregrine novena day 5',
    'peregrine novena day 5',
    'st peregrine prayer day 5',
    'day 5 st peregrine novena',
    'patience in suffering prayer',
    'st peregrine novena patience in suffering',
    'peregrine novena patience in suffering'
  ],
  openGraph: {
    title: 'Novena to St. Peregrine - Day 5: Patience in Suffering',
    description: 'Pray the Novena to St. Peregrine - Day 5 focusing on Patience in Suffering. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-peregrine/day-5',
  },
  twitter: {
    title: 'Novena to St. Peregrine - Day 5: Patience in Suffering',
    description: 'Pray the Novena to St. Peregrine - Day 5 focusing on Patience in Suffering. Join in praying the traditional novena.',
...
export default function StPeregrineNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to St. Peregrine – Day 5: Patience in Suffering
          </h1>
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Patience in Suffering</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Peregrine's patience in suffering. He endured painful sufferings with such patience as to deserve to be healed miraculously of an incurable cancer in his leg by a touch of His divine hand.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Peregrine's patience in suffering is a powerful example for all who are suffering. His patience was not passive resignation, but active trust in God's love and mercy.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-purple-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O glorious St. Peregrine, help me to endure sufferings with patience like you did. May your patience in the face of great pain inspire me to trust in God's love and mercy even in my darkest moments. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to St. Peregrine - Day 5: Patience in Suffering" 
            url="/novenas/st-peregrine/day-5"
            excerpt="Join me in praying the Novena to St. Peregrine - Day 5 focusing on Patience in Suffering." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-peregrine/day-4"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 4: Union with Christ Crucified
          </Link>
          
          
          <Link
            href="/novenas/st-peregrine/day-6"
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Miraculous Healing →
          </Link>
