...
export const metadata: Metadata = {
  title: 'Novena for Physical Healing - Day 6: Organ Healing',
  description: 'Pray the Novena for Physical Healing - Day 6 focusing on organ healing.',
  keywords: ['physical healing novena day 6', 'physical healing prayer day 6'],
  openGraph: {
    title: 'Novena for Physical Healing - Day 6: Organ Healing',
    description: 'Pray the Novena for Physical Healing - Day 6 focusing on organ healing.',
    url: 'https://catholic-bible-online.com/novenas/physical-healing/day-6',
  },
  twitter: {
    title: 'Novena for Physical Healing - Day 6: Organ Healing',
    description: 'Pray the Novena for Physical Healing - Day 6 focusing on organ healing.',
...
export default function NovenaForPhysicalHealingDay6Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena for Physical Healing – Day 6: Organ Healing
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Organ Healing</h2>
          <p className="text-gray-700 leading-relaxed">
            Focusing on organ healing in our physical healing prayer today.
          </p>
        </section>
...
<p className="mb-4">We pray that You would help us to be grateful for the healing that is taking place in our bodies, even if we cannot see it immediately. Give us the faith to believe that You are working in ways that we cannot understand, bringing restoration and renewal to every part of our physical being. May our healing be a testimony to Your power and Your love.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we focus on organ healing. This aspect of physical healing helps us to grow spiritually 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena for Physical Healing - Day 6: Organ Healing" 
            url="/novenas/physical-healing/day-6"
            excerpt="Join me in praying the Novena for Physical Healing - Day 6 focusing on organ healing." 
          />
        </div>
