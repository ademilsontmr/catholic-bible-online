...
export const metadata: Metadata = {
  title: `St. Thérèse of Lisieux Novena - Day 5: Love and Sacrifice`,
  description: `Pray the St. Thérèse of Lisieux Novena - Day 5 focusing on Love and Sacrifice. Join in praying the traditional novena to seek St. Thérèse's intercession.`,
  keywords: [
    'st therese of lisieux novena day 5',
    'little flower novena day 5',
    'st therese novena day 5',
    'therese of lisieux prayer love and sacrifice',
    'day 5 st therese novena',
    'love and sacrifice st therese prayer',
    'little flower novena love and sacrifice',
    'st therese of lisieux love and sacrifice',
    'therese novena love and sacrifice'
  ],
  openGraph: {
    title: `St. Thérèse of Lisieux Novena - Day 5: Love and Sacrifice`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 5 focusing on Love and Sacrifice. Join in praying the traditional novena.`,
    url: `https://catholicbible-online.com/novenas/st-therese-lisieux/day-5`,
  },
  twitter: {
    title: `St. Thérèse of Lisieux Novena - Day 5: Love and Sacrifice`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 5 focusing on Love and Sacrifice. Join in praying the traditional novena.`,
...
export default function StThereseLisieuxNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Thérèse of Lisieux Novena – Day 5: Love and Sacrifice
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Love and Sacrifice</h2>
          <p className="text-gray-700 leading-relaxed">
            Offering our daily sacrifices with love
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for love and sacrifice. St. Thérèse teaches us that holiness is found not in great deeds, 
              ...
              <p>
                Love and Sacrifice is essential to following St. Thérèse's "Little Way." Let us ask her to help us grow 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title={`St. Thérèse of Lisieux Novena - Day 5: Love and Sacrifice`} 
            url="/novenas/st-therese-lisieux/day-5"
            excerpt={`Join me in praying the St. Thérèse of Lisieux Novena - Day 5 focusing on Love and Sacrifice.`} 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href={`/novenas/st-therese-lisieux/day-4`}
