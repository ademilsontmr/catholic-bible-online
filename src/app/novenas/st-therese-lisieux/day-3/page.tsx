...
export const metadata: Metadata = {
  ...
  description: `Pray the St. Thérèse of Lisieux Novena - Day 3 focusing on Childlike Confidence. Join in praying the traditional novena to seek St. Thérèse's intercession.`,
  keywords: [
    'st therese of lisieux novena day 3',
    'little flower novena day 3',
    'st therese novena day 3',
    'therese of lisieux prayer childlike confidence',
    'day 3 st therese novena',
    'childlike confidence st therese prayer',
    'little flower novena childlike confidence',
    'st therese of lisieux childlike confidence',
    'therese novena childlike confidence'
  ],
  openGraph: {
    title: `St. Thérèse of Lisieux Novena - Day 3: Childlike Confidence`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 3 focusing on Childlike Confidence. Join in praying the traditional novena.`,
    url: `https://catholicbible-online.com/novenas/st-therese-lisieux/day-3`,
  },
  twitter: {
    title: `St. Thérèse of Lisieux Novena - Day 3: Childlike Confidence`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 3 focusing on Childlike Confidence. Join in praying the traditional novena.`,
...
export default function StThereseLisieuxNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Thérèse of Lisieux Novena – Day 3: Childlike Confidence
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Childlike Confidence</h2>
          <p className="text-gray-700 leading-relaxed">
            Approaching God with the trust of a child
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-6">Dear St. Thérèse, the Little Flower, please pick for me a rose from the heavenly gardens and send it to me as a message of love.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for childlike confidence. St. Thérèse teaches us that holiness is found not in great deeds, 
              ...
              <p>
                Childlike Confidence is essential to following St. Thérèse's "Little Way." Let us ask her to help us grow 
