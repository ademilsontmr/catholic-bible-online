...
export const metadata: Metadata = {
  title: `St. Thérèse of Lisieux Novena - Day 6: Hidden Life`,
  description: `Pray the St. Thérèse of Lisieux Novena - Day 6 focusing on Hidden Life. Join in praying the traditional novena to seek St. Thérèse's intercession.`,
  keywords: [
    'st therese of lisieux novena day 6',
    'little flower novena day 6',
    'st therese novena day 6',
    'therese of lisieux prayer hidden life',
    'day 6 st therese novena',
    'hidden life st therese prayer',
    'little flower novena hidden life',
    'st therese of lisieux hidden life',
    'therese novena hidden life'
  ],
  openGraph: {
    title: `St. Thérèse of Lisieux Novena - Day 6: Hidden Life`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 6 focusing on Hidden Life. Join in praying the traditional novena.`,
    url: `https://catholicbible-online.com/novenas/st-therese-lisieux/day-6`,
  },
  twitter: {
    title: `St. Thérèse of Lisieux Novena - Day 6: Hidden Life`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 6 focusing on Hidden Life. Join in praying the traditional novena.`,
...
export default function StThereseLisieuxNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Thérèse of Lisieux Novena – Day 6: Hidden Life
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Finding holiness in ordinary, hidden acts of love
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for hidden life. St. Thérèse teaches us that holiness is found not in great deeds, 
              ...
              <p>
                Hidden Life is essential to following St. Thérèse's "Little Way." Let us ask her to help us grow 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title={`St. Thérèse of Lisieux Novena - Day 6: Hidden Life`} 
            url="/novenas/st-therese-lisieux/day-6"
            excerpt={`Join me in praying the St. Thérèse of Lisieux Novena - Day 6 focusing on Hidden Life.`} 
          />
        </div>
