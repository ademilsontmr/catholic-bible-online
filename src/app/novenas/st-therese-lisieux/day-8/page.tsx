...
export const metadata: Metadata = {
  title: `St. Thérèse of Lisieux Novena - Day 8: Rose Petals`,
  description: `Pray the St. Thérèse of Lisieux Novena - Day 8 focusing on Rose Petals. Join in praying the traditional novena to seek St. Thérèse's intercession.`,
  keywords: [
    'st therese of lisieux novena day 8',
    'little flower novena day 8',
    'st therese novena day 8',
    'therese of lisieux prayer rose petals',
    'day 8 st therese novena',
    'rose petals st therese prayer',
    'little flower novena rose petals',
    'st therese of lisieux rose petals',
    'therese novena rose petals'
  ],
  openGraph: {
    title: `St. Thérèse of Lisieux Novena - Day 8: Rose Petals`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 8 focusing on Rose Petals. Join in praying the traditional novena.`,
    url: `https://catholicbible-online.com/novenas/st-therese-lisieux/day-8`,
  },
  twitter: {
    title: `St. Thérèse of Lisieux Novena - Day 8: Rose Petals`,
    description: `Pray the St. Thérèse of Lisieux Novena - Day 8 focusing on Rose Petals. Join in praying the traditional novena.`,
...
export default function StThereseLisieuxNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            St. Thérèse of Lisieux Novena – Day 8: Rose Petals
          </h1>
        ...
        <section className="bg-pink-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Rose Petals</h2>
          <p className="text-gray-700 leading-relaxed">
            Believing in the shower of roses from heaven
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Today we pray for rose petals. St. Thérèse teaches us that holiness is found not in great deeds, 
              ...
              <p>
                Rose Petals is essential to following St. Thérèse's "Little Way." Let us ask her to help us grow 
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title={`St. Thérèse of Lisieux Novena - Day 8: Rose Petals`} 
            url="/novenas/st-therese-lisieux/day-8"
            excerpt={`Join me in praying the St. Thérèse of Lisieux Novena - Day 8 focusing on Rose Petals.`} 
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link 
            href={`/novenas/st-therese-lisieux/day-7`}
          ...
          <Link 
            href={`/novenas/st-therese-lisieux/day-9`}
