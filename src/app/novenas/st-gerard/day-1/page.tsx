...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 1: Gratitude for Gifts',
  description: "Pray the Novena to Saint Gerard - Day 1 focusing on Gratitude for Gifts. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 1',
    'st gerard novena day 1',
    'gerard novena day 1',
    'st gerard prayer day 1',
    'day 1 st gerard novena',
    'gratitude for gifts prayer',
    'st gerard novena gratitude for gifts',
    'gerard novena gratitude for gifts'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 1: Gratitude for Gifts',
    description: 'Pray the Novena to Saint Gerard - Day 1 focusing on Gratitude for Gifts. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-1',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 1: Gratitude for Gifts',
    description: 'Pray the Novena to Saint Gerard - Day 1 focusing on Gratitude for Gifts. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 1: Gratitude for Gifts
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Gratitude for Gifts</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of the Novena to Saint Gerard, we focus on gratitude for all the gifts and privileges which God granted to St. Gerard, especially for those virtues with which He adorned him on earth and the glory which He now imparts to him in heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's life reminds us to be grateful for all the gifts God has given us and to use them for His glory. His virtues and holiness inspire us to grow in our own spiritual life.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to be grateful for all the gifts God has given me as you were. May your example of gratitude inspire me to use my gifts for God's glory and to grow in holiness. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 1: Gratitude for Gifts" 
            url="/novenas/st-gerard/day-1"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 1 focusing on Gratitude for Gifts." 
          />
        </div>
