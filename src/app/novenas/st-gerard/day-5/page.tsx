...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 5: Parenthood',
  description: "Pray the Novena to Saint Gerard - Day 5 focusing on Parenthood. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 5',
    'st gerard novena day 5',
    'gerard novena day 5',
    'st gerard prayer day 5',
    'day 5 st gerard novena',
    'parenthood prayer',
    'st gerard novena parenthood',
    'gerard novena parenthood'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 5: Parenthood',
    description: 'Pray the Novena to Saint Gerard - Day 5 focusing on Parenthood. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-5',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 5: Parenthood',
    description: 'Pray the Novena to Saint Gerard - Day 5 focusing on Parenthood. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 5: Parenthood
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Parenthood</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on the gift of parenthood and the responsibility of raising children in the faith. We pray for the grace to be good parents who guide their children toward God.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's care for families and children shows us that parenthood is a sacred vocation. He helps parents to fulfill their role in raising children who will be faithful to God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to be a good parent who raises children in the faith. May your care for families inspire me to fulfill my vocation as a parent with love and dedication. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 5: Parenthood" 
            url="/novenas/st-gerard/day-5"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 5 focusing on Parenthood." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-gerard/day-4"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 4: Master of Life
          </Link>
