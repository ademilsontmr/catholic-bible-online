...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 3: God\'s Will',
  description: "Pray the Novena to Saint Gerard - Day 3 focusing on God's Will. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 3',
    'st gerard novena day 3',
    'gerard novena day 3',
    'st gerard prayer day 3',
    'day 3 st gerard novena',
    'god\'s will prayer',
    'st gerard novena god\'s will',
    'gerard novena god\'s will'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 3: God\'s Will',
    description: 'Pray the Novena to Saint Gerard - Day 3 focusing on God\'s Will. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-3',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 3: God\'s Will',
    description: 'Pray the Novena to Saint Gerard - Day 3 focusing on God\'s Will. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 3: God's Will
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: God's Will</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on St. Gerard's obedience to God's will. While on earth, he always fulfilled God's designs, and we ask for his help to do God's holy will in our own lives.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's complete obedience to God's will teaches us that true holiness comes from surrendering our own will to God's divine plan. His example inspires us to trust in God's providence.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to always fulfill God's holy will as you did. May your obedience to God's designs inspire me to surrender my will to His divine plan. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 3: God's Will" 
            url="/novenas/st-gerard/day-3"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 3 focusing on God's Will." 
          />
        </div>
