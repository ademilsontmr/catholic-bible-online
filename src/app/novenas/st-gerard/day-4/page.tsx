...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 4: Master of Life',
  description: "Pray the Novena to Saint Gerard - Day 4 focusing on Master of Life. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 4',
    'st gerard novena day 4',
    'gerard novena day 4',
    'st gerard prayer day 4',
    'day 4 st gerard novena',
    'master of life prayer',
    'st gerard novena master of life',
    'gerard novena master of life'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 4: Master of Life',
    description: 'Pray the Novena to Saint Gerard - Day 4 focusing on Master of Life. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-4',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 4: Master of Life',
    description: 'Pray the Novena to Saint Gerard - Day 4 focusing on Master of Life. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay4Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 4: Master of Life
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Master of Life</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying to the Master of Life, from whom all parenthood proceeds. We ask for His blessing to be granted with offspring, that we may raise up children to God in this life.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's intercession for the blessing of children reminds us that all life comes from God. He helps us to understand that children are a gift from God and should be raised to serve Him.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to pray to the Master of Life for the blessing of children. May your intercession help me to understand that all life comes from God and should be used for His glory. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 4: Master of Life" 
            url="/novenas/st-gerard/day-4"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 4 focusing on Master of Life." 
          />
        </div>
