...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 8: Wonder Worker',
  description: "Pray the Novena to Saint Gerard - Day 8 focusing on Wonder Worker. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 8',
    'st gerard novena day 8',
    'gerard novena day 8',
    'st gerard prayer day 8',
    'day 8 st gerard novena',
    'wonder worker prayer',
    'st gerard novena wonder worker',
    'gerard novena wonder worker'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 8: Wonder Worker',
    description: 'Pray the Novena to Saint Gerard - Day 8 focusing on Wonder Worker. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-8',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 8: Wonder Worker',
    description: 'Pray the Novena to Saint Gerard - Day 8 focusing on Wonder Worker. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 8: Wonder Worker
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Wonder Worker</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on St. Gerard as the wonder-worker of our day. We call upon him and seek his help, trusting in his miraculous intercession for our needs and intentions.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's reputation as a wonder-worker reminds us that God continues to work miracles through His saints. His powerful intercession gives us hope that our prayers will be answered.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, wonder-worker of our day, help me to trust in your miraculous intercession. May your powerful prayers bring about the miracles I need in my life. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 8: Wonder Worker" 
            url="/novenas/st-gerard/day-8"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 8 focusing on Wonder Worker." 
          />
        </div>
