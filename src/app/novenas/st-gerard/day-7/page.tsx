...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 7: Powerful Intercession',
  description: "Pray the Novena to Saint Gerard - Day 7 focusing on Powerful Intercession. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 7',
    'st gerard novena day 7',
    'gerard novena day 7',
    'st gerard prayer day 7',
    'day 7 st gerard novena',
    'powerful intercession prayer',
    'st gerard novena powerful intercession',
    'gerard novena powerful intercession'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 7: Powerful Intercession',
    description: 'Pray the Novena to Saint Gerard - Day 7 focusing on Powerful Intercession. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-7',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 7: Powerful Intercession',
    description: 'Pray the Novena to Saint Gerard - Day 7 focusing on Powerful Intercession. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 7: Powerful Intercession
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on St. Gerard's powerful intercession in all our needs. We confide our important and urgent affairs to him, trusting that he will take our cause in hand.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's powerful intercession shows us that the saints in heaven continue to help us on earth. His readiness to help those who have recourse to him gives us confidence in his prayers.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to trust in your powerful intercession in all my needs. May your readiness to help those who have recourse to you give me confidence in your prayers. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 7: Powerful Intercession" 
            url="/novenas/st-gerard/day-7"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 7 focusing on Powerful Intercession." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-gerard/day-6"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Heirs of Heaven
          </Link>
