...
export const metadata: Metadata = {
  title: 'Novena to Saint Gerard - Day 6: Heirs of Heaven',
  description: "Pray the Novena to Saint Gerard - Day 6 focusing on Heirs of Heaven. Join in praying the traditional novena to seek St. Gerard's intercession.",
  keywords: [
    'novena to saint gerard day 6',
    'st gerard novena day 6',
    'gerard novena day 6',
    'st gerard prayer day 6',
    'day 6 st gerard novena',
    'heirs of heaven prayer',
    'st gerard novena heirs of heaven',
    'gerard novena heirs of heaven'
  ],
  openGraph: {
    title: 'Novena to Saint Gerard - Day 6: Heirs of Heaven',
    description: 'Pray the Novena to Saint Gerard - Day 6 focusing on Heirs of Heaven. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/st-gerard/day-6',
  },
  twitter: {
    title: 'Novena to Saint Gerard - Day 6: Heirs of Heaven',
    description: 'Pray the Novena to Saint Gerard - Day 6 focusing on Heirs of Heaven. Join in praying the traditional novena.',
...
export default function StGerardNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Saint Gerard – Day 6: Heirs of Heaven
          </h1>
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Heirs of Heaven</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for children who will be heirs to the kingdom of God's glory in the life to come. We ask that our children may inherit eternal life through their faith and good works.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              St. Gerard's intercession for children to be heirs of heaven reminds us that our ultimate goal is eternal life. He helps us to focus on what truly matters - the salvation of our souls and those of our children.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-green-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Saint Gerard, help me to pray for children who will be heirs to the kingdom of God's glory. May your intercession help me to focus on eternal life and the salvation of souls. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Saint Gerard - Day 6: Heirs of Heaven" 
            url="/novenas/st-gerard/day-6"
            excerpt="Join me in praying the Novena to Saint Gerard - Day 6 focusing on Heirs of Heaven." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/st-gerard/day-7"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 7: Powerful Intercession →
          </Link>
