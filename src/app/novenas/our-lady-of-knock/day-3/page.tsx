...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Knock - Day 3: Pilgrims on the Road',
  description: "Pray Novena to Our Lady of Knock - Day 3 focusing on Pilgrims on the Road. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 3',
    'our lady of knock novena day 3',
    'our lady of knock day 3',
    'day 3 our lady of knock novena',
    'pilgrims on the road prayer',
    'knock novena pilgrims on the road',
    'our lady of knock pilgrims on the road',
    'blessed virgin mary novena day 3'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 3: Pilgrims on the Road',
    description: 'Pray Novena to Our Lady of Knock - Day 3 focusing on Pilgrims on the Road. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-3',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 3: Pilgrims on the Road',
    description: 'Pray Novena to Our Lady of Knock - Day 3 focusing on Pilgrims on the Road. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 3: Pilgrims on the Road
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Pilgrims on the Road</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on remembering that we are all pilgrims on the road to heaven. We ask Our Lady to help us remember this important truth.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              We are all pilgrims on the road to heaven. This truth helps us keep our priorities straight and reminds us that our ultimate destination is eternal life with God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of Pilgrims, help us to remember that we are all pilgrims on the road to heaven. May we always keep our eyes fixed on our eternal destination. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Knock - Day 3: Pilgrims on the Road" 
            url="/novenas/our-lady-of-knock/day-3"
            excerpt="Join me in praying Novena to Our Lady of Knock - Day 3 focusing on Pilgrims on the Road." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-knock/day-2"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 2: Hope in Distress
          </Link>
          
          
          <Link
            href="/novenas/our-lady-of-knock/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 4: Love for Brothers and Sisters →
          </Link>
