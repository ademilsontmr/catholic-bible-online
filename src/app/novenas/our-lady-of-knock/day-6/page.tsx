...
export const metadata: Metadata = {
  ...
  description: "Pray Novena to Our Lady of Knock - Day 6 focusing on Reverent Participation in Mass. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 6',
    'our lady of knock novena day 6',
    'our lady of knock day 6',
    'day 6 our lady of knock novena',
    'reverent participation in mass prayer',
    'knock novena reverent participation in mass',
    'our lady of knock reverent participation in mass',
    'blessed virgin mary novena day 6'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 6: Reverent Participation in Mass',
    description: 'Pray Novena to Our Lady of Knock - Day 6 focusing on Reverent Participation in Mass. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-6',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 6: Reverent Participation in Mass',
    description: 'Pray Novena to Our Lady of Knock - Day 6 focusing on Reverent Participation in Mass. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 6: Reverent Participation in Mass
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Reverent Participation in Mass</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on learning to take part more reverently in the Holy Mass. We ask Our Lady to teach us how to participate with greater devotion.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Reverent participation in the Holy Mass is essential to our spiritual life. Our Lady helps us understand the importance of this sacred liturgy.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Teacher of Reverence, help us to participate more reverently in the Holy Mass. May we always approach the sacred liturgy with devotion. Amen.
          </p>
        </section>
