...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Knock - Day 8: Prayer at the Hour of Death',
  description: "Pray Novena to Our Lady of Knock - Day 8 focusing on Prayer at the Hour of Death. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 8',
    'our lady of knock novena day 8',
    'our lady of knock day 8',
    'day 8 our lady of knock novena',
    'prayer at the hour of death prayer',
    'knock novena prayer at the hour of death',
    'our lady of knock prayer at the hour of death',
    'blessed virgin mary novena day 8'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 8: Prayer at the Hour of Death',
    description: 'Pray Novena to Our Lady of Knock - Day 8 focusing on Prayer at the Hour of Death. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-8',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 8: Prayer at the Hour of Death',
    description: 'Pray Novena to Our Lady of Knock - Day 8 focusing on Prayer at the Hour of Death. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 8: Prayer at the Hour of Death
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Prayer at the Hour of Death</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on asking Our Lady to pray for us at the hour of our death. We entrust this important moment to her maternal care.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              The hour of death is a crucial moment in our spiritual journey. Our Lady's prayers at this time are especially powerful and comforting.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of Mercy, pray for us at the hour of our death. May we always trust in your maternal care at that crucial moment. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Knock - Day 8: Prayer at the Hour of Death" 
            url="/novenas/our-lady-of-knock/day-8"
            excerpt="Join me in praying Novena to Our Lady of Knock - Day 8 focusing on Prayer at the Hour of Death." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-knock/day-7"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 7: Love of Jesus in the Blessed Sacrament
          </Link>
          
          
          <Link
            href="/novenas/our-lady-of-knock/day-9"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 9: Special Intentions →
          </Link>
