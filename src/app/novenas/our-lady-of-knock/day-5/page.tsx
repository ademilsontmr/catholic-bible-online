...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Knock - Day 5: Comfort in Sickness',
  description: "Pray Novena to Our Lady of Knock - Day 5 focusing on Comfort in Sickness. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 5',
    'our lady of knock novena day 5',
    'our lady of knock day 5',
    'day 5 our lady of knock novena',
    'comfort in sickness prayer',
    'knock novena comfort in sickness',
    'our lady of knock comfort in sickness',
    'blessed virgin mary novena day 5'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 5: Comfort in Sickness',
    description: 'Pray Novena to Our Lady of Knock - Day 5 focusing on Comfort in Sickness. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-5',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 5: Comfort in Sickness',
    description: 'Pray Novena to Our Lady of Knock - Day 5 focusing on Comfort in Sickness. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 5: Comfort in Sickness
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Comfort in Sickness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on seeking comfort when we are sick, lonely, or depressed. We ask Our Lady of Knock to comfort us in these difficult times.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Knock is a source of comfort in times of sickness, loneliness, and depression. She understands our suffering and offers us her maternal care.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Comforter of the Afflicted, help us to find comfort in times of sickness, loneliness, and depression. May we always turn to you for solace. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Knock - Day 5: Comfort in Sickness" 
            url="/novenas/our-lady-of-knock/day-5"
            excerpt="Join me in praying Novena to Our Lady of Knock - Day 5 focusing on Comfort in Sickness." 
          />
        </div>
