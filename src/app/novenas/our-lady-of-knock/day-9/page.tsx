...
export const metadata: Metadata = {
  ...
  description: "Pray Novena to Our Lady of Knock - Day 9 focusing on Special Intentions. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 9',
    'our lady of knock novena day 9',
    'our lady of knock day 9',
    'day 9 our lady of knock novena',
    'special intentions prayer',
    'knock novena special intentions',
    'our lady of knock special intentions',
    'blessed virgin mary novena day 9'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 9: Special Intentions',
    description: 'Pray Novena to Our Lady of Knock - Day 9 focusing on Special Intentions. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-9',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 9: Special Intentions',
    description: 'Pray Novena to Our Lady of Knock - Day 9 focusing on Special Intentions. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 9: Special Intentions
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Special Intentions</h2>
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on presenting our special intentions to Our Lady of Knock. We trust in her powerful intercession.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Knock is always ready to hear our special intentions and present them to her divine Son. We can trust in her maternal care.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May Our Lady of Knock bless you abundantly through this devotion. 
            May you always remember to call upon her as Queen of Ireland and find comfort 
            and guidance through her powerful intercession.
          </p>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed Novena to Our Lady of Knock! As you continue your spiritual journey, 
            may your heart be filled with devotion to Our Lady of Knock and trust in her power 
            to provide guidance and comfort. Remember to continue calling upon her as Queen of Ireland 
            and to live as pilgrims on the road to heaven. May Our Lady of Knock continue to bless you 
            and help you grow in your love for her and her divine Son.
          </p>
        </section>
        ...
        <div className="flex justify-between items-center">
          <Link 
            href="/novenas/our-lady-of-knock/day-8"
          ...
          <Link 
            href="/novenas/our-lady-of-knock"
      ...
      <RelatedNovenas currentNovena="Our Lady of Knock Novena" />
    </div>
  )
}
