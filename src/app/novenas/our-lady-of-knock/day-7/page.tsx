...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Knock - Day 7: Love of Jesus in the Blessed Sacrament',
  description: "Pray Novena to Our Lady of Knock - Day 7 focusing on Love of Jesus in the Blessed Sacrament. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 7',
    'our lady of knock novena day 7',
    'our lady of knock day 7',
    'day 7 our lady of knock novena',
    'love of jesus in the blessed sacrament prayer',
    'knock novena love of jesus in the blessed sacrament',
    'our lady of knock love of jesus in the blessed sacrament',
    'blessed virgin mary novena day 7'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 7: Love of Jesus in the Blessed Sacrament',
    description: 'Pray Novena to Our Lady of Knock - Day 7 focusing on Love of Jesus in the Blessed Sacrament. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-7',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 7: Love of Jesus in the Blessed Sacrament',
    description: 'Pray Novena to Our Lady of Knock - Day 7 focusing on Love of Jesus in the Blessed Sacrament. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 7: Love of Jesus in the Blessed Sacrament
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Love of Jesus in the Blessed Sacrament</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for greater love of Jesus in the Blessed Sacrament. We ask Our Lady to help us develop this love.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Love for Jesus in the Blessed Sacrament is a precious gift. Our Lady helps us grow in this love and devotion to the Eucharist.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Mother of the Eucharist, help us to love Jesus more deeply in the Blessed Sacrament. May we always cherish this precious gift. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Knock - Day 7: Love of Jesus in the Blessed Sacrament" 
            url="/novenas/our-lady-of-knock/day-7"
            excerpt="Join me in praying Novena to Our Lady of Knock - Day 7 focusing on Love of Jesus in the Blessed Sacrament." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/our-lady-of-knock/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 6: Reverent Participation in Mass
          </Link>
