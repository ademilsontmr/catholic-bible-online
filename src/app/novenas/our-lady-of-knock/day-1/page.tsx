...
export const metadata: Metadata = {
  title: 'Novena to Our Lady of Knock - Day 1: Queen of Ireland',
  description: "Pray Novena to Our Lady of Knock - Day 1 focusing on Queen of Ireland. Join in praying the traditional novena for special intentions.",
  keywords: [
    'novena to our lady of knock day 1',
    'our lady of knock novena day 1',
    'our lady of knock day 1',
    'day 1 our lady of knock novena',
    'queen of ireland prayer',
    'knock novena queen of ireland',
    'our lady of knock queen of ireland',
    'blessed virgin mary novena day 1'
  ],
  openGraph: {
    title: 'Novena to Our Lady of Knock - Day 1: Queen of Ireland',
    description: 'Pray Novena to Our Lady of Knock - Day 1 focusing on Queen of Ireland. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/our-lady-of-knock/day-1',
  },
  twitter: {
    title: 'Novena to Our Lady of Knock - Day 1: Queen of Ireland',
    description: 'Pray Novena to Our Lady of Knock - Day 1 focusing on Queen of Ireland. Join in praying the traditional novena.',
...
export default function OurLadyOfKnockNovenaDay1Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            Novena to Our Lady of Knock – Day 1: Queen of Ireland
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Queen of Ireland</h2>
          <p className="text-gray-700 leading-relaxed">
            On this first day of Our Lady of Knock Novena, we focus on honoring Our Lady of Knock as Queen of Ireland. We recognize her special relationship with the Irish people and her role as their protector and comforter.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Our Lady of Knock as Queen of Ireland holds a special place in the hearts of the Irish people. Through this title, we acknowledge her role as protector and comforter of Ireland and all who turn to her.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Queen of Ireland, help us to honor you properly and trust in your power to intercede for us. May we always honor you as our Queen and Mother. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="Novena to Our Lady of Knock - Day 1: Queen of Ireland" 
            url="/novenas/our-lady-of-knock/day-1"
            excerpt="Join me in praying Novena to Our Lady of Knock - Day 1 focusing on Queen of Ireland." 
          />
        </div>
