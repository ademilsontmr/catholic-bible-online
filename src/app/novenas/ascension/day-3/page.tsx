...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 3: Eternal Joy',
  description: "Pray The Ascension Novena - Day 3 focusing on Eternal Joy. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 3',
    'ascension novena day 3',
    'jesus ascension novena day 3',
    'ascension prayer day 3',
    'day 3 ascension novena',
    'eternal joy prayer',
    'ascension novena eternal joy',
    'jesus ascension novena eternal joy'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 3: Eternal Joy',
    description: 'Pray The Ascension Novena - Day 3 focusing on Eternal Joy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-3',
  },
  twitter: {
    title: 'The Ascension Novena - Day 3: Eternal Joy',
    description: 'Pray The Ascension Novena - Day 3 focusing on Eternal Joy. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay3Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 3: Eternal Joy
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Eternal Joy</h2>
          <p className="text-gray-700 leading-relaxed">
            On this third day, we focus on praying for the grace to share in Jesus' joy and triumph in heaven for all eternity. We ask that when the struggle of this life is over, we may share in His eternal glory.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus' Ascension brings Him eternal joy and triumph. He has conquered sin and death, and now reigns in glory. We are called to share in this joy, not only in heaven but even now through our faith and hope.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, help me to share in Your eternal joy and triumph. May the struggles of this life lead me to share in Your glory in heaven for all eternity. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 3: Eternal Joy" 
            url="/novenas/ascension/day-3"
            excerpt="Join me in praying The Ascension Novena - Day 3 focusing on Eternal Joy." 
          />
        </div>
