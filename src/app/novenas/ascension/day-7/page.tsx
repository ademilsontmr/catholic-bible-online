...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 7: Human Weakness',
  description: "Pray The Ascension Novena - Day 7 focusing on Human Weakness. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 7',
    'ascension novena day 7',
    'jesus ascension novena day 7',
    'ascension prayer day 7',
    'day 7 ascension novena',
    'human weakness prayer',
    'ascension novena human weakness',
    'jesus ascension novena human weakness'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 7: Human Weakness',
    description: 'Pray The Ascension Novena - Day 7 focusing on Human Weakness. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-7',
  },
  twitter: {
    title: 'The Ascension Novena - Day 7: Human Weakness',
    description: 'Pray The Ascension Novena - Day 7 focusing on Human Weakness. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay7Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 7: Human Weakness
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Human Weakness</h2>
          <p className="text-gray-700 leading-relaxed">
            On this seventh day, we focus on praying for the grace to rise above our human weakness. We ask that Jesus' Humanity may give us courage in our weakness and free us from our sins.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus understands our human weakness because He shared in our humanity. His Humanity gives us courage and strength to overcome our weaknesses and grow in holiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, give me the grace to rise above my human weakness. May Your Humanity give me courage and free me from my sins. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 7: Human Weakness" 
            url="/novenas/ascension/day-7"
            excerpt="Join me in praying The Ascension Novena - Day 7 focusing on Human Weakness." 
          />
        </div>
