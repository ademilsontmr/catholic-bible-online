...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 5: Divine Friendship',
  description: "Pray The Ascension Novena - Day 5 focusing on Divine Friendship. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 5',
    'ascension novena day 5',
    'jesus ascension novena day 5',
    'ascension prayer day 5',
    'day 5 ascension novena',
    'divine friendship prayer',
    'ascension novena divine friendship',
    'jesus ascension novena divine friendship'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 5: Divine Friendship',
    description: 'Pray The Ascension Novena - Day 5 focusing on Divine Friendship. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-5',
  },
  twitter: {
    title: 'The Ascension Novena - Day 5: Divine Friendship',
    description: 'Pray The Ascension Novena - Day 5 focusing on Divine Friendship. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay5Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 5: Divine Friendship
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Divine Friendship</h2>
          <p className="text-gray-700 leading-relaxed">
            On this fifth day, we focus on praying for the grace to seek only the joys of Jesus' friendship and love, so that we may deserve to be united with Him in heaven.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus offers us His divine friendship and love. When we seek these above all earthly things, we prepare ourselves for union with Him in heaven. His friendship is the greatest treasure we can possess.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, help me to seek only the joys of Your friendship and love. May I deserve to be united with You in heaven through my love for You. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 5: Divine Friendship" 
            url="/novenas/ascension/day-5"
            excerpt="Join me in praying The Ascension Novena - Day 5 focusing on Divine Friendship." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/ascension/day-4"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 4: Prepared Place
          </Link>
          
          
          <Link
            href="/novenas/ascension/day-6"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 6: Divine Mercy →
          </Link>
