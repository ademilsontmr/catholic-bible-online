...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 8: Perseverance',
  description: "Pray The Ascension Novena - Day 8 focusing on Perseverance. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 8',
    'ascension novena day 8',
    'jesus ascension novena day 8',
    'ascension prayer day 8',
    'day 8 ascension novena',
    'perseverance prayer',
    'ascension novena perseverance',
    'jesus ascension novena perseverance'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 8: Perseverance',
    description: 'Pray The Ascension Novena - Day 8 focusing on Perseverance. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-8',
  },
  twitter: {
    title: 'The Ascension Novena - Day 8: Perseverance',
    description: 'Pray The Ascension Novena - Day 8 focusing on Perseverance. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay8Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 8: Perseverance
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for the courage of perseverance. We ask that through Jesus' grace, we may hold fast to the life He has given us and persevere in faith.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Perseverance is essential for our salvation. Jesus has called and justified us by faith, and He gives us the grace to persevere until the end. We must hold fast to the life He has given us.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, give me the courage of perseverance. May I hold fast to the life You have given me and come to the eternal gifts You promised. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 8: Perseverance" 
            url="/novenas/ascension/day-8"
            excerpt="Join me in praying The Ascension Novena - Day 8 focusing on Perseverance." 
          />
        </div>
