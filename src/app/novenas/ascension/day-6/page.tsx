...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 6: Divine Mercy',
  description: "Pray The Ascension Novena - Day 6 focusing on Divine Mercy. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 6',
    'ascension novena day 6',
    'jesus ascension novena day 6',
    'ascension prayer day 6',
    'day 6 ascension novena',
    'divine mercy prayer',
    'ascension novena divine mercy',
    'jesus ascension novena divine mercy'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 6: Divine Mercy',
    description: 'Pray The Ascension Novena - Day 6 focusing on Divine Mercy. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-6',
  },
  twitter: {
    title: 'The Ascension Novena - Day 6: Divine Mercy',
    description: 'Pray The Ascension Novena - Day 6 focusing on Divine Mercy. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay6Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 6: Divine Mercy
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Today we focus on praying for mercy in the hour of our own homecoming, when we appear before the Father to give an account of our life on earth. We ask Jesus to have mercy on us.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              We will all stand before the Father to give an account of our lives. Jesus' mercy is our hope and our refuge. Through His intercession, we can trust in the Father's mercy and forgiveness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, have mercy on me when I appear before the Father to give account of my life. May Your mercy be my hope and refuge in the hour of judgment. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 6: Divine Mercy" 
            url="/novenas/ascension/day-6"
            excerpt="Join me in praying The Ascension Novena - Day 6 focusing on Divine Mercy." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/ascension/day-5"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 5: Divine Friendship
          </Link>
          
          
          <Link
            href="/novenas/ascension/day-7"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 7: Human Weakness →
          </Link>
