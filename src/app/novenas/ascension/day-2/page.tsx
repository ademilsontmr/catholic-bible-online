...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 2: Kingship of Heaven',
  description: "Pray The Ascension Novena - Day 2 focusing on Kingship of Heaven. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 2',
    'ascension novena day 2',
    'jesus ascension novena day 2',
    'ascension prayer day 2',
    'day 2 ascension novena',
    'kingship of heaven prayer',
    'ascension novena kingship of heaven',
    'jesus ascension novena kingship of heaven'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 2: Kingship of Heaven',
    description: 'Pray The Ascension Novena - Day 2 focusing on Kingship of Heaven. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-2',
  },
  twitter: {
    title: 'The Ascension Novena - Day 2: Kingship of Heaven',
    description: 'Pray The Ascension Novena - Day 2 focusing on Kingship of Heaven. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay2Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 2: Kingship of Heaven
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Today's Focus: Kingship of Heaven</h2>
          <p className="text-gray-700 leading-relaxed">
            Today we focus on recognizing Jesus as King of heaven and earth. We pray for the grace to acknowledge His reign over all creation and to submit ourselves to His divine authority.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Jesus ascended to reign as King over all creation. He sits at the right hand of the Father, exercising His authority over heaven and earth. His kingship is not of this world but of the eternal kingdom of God.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            O Jesus, King of heaven and earth, help me to recognize Your reign over all creation. May I submit myself to Your divine authority and serve You with love. Amen.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 2: Kingship of Heaven" 
            url="/novenas/ascension/day-2"
            excerpt="Join me in praying The Ascension Novena - Day 2 focusing on Kingship of Heaven." 
          />
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="/novenas/ascension/day-1"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            ← Day 1: Heavenly Glory
          </Link>
          
          
          <Link
            href="/novenas/ascension/day-3"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
          >
            Day 3: Eternal Joy →
          </Link>
