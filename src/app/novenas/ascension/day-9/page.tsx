...
export const metadata: Metadata = {
  title: 'The Ascension Novena - Day 9: Eternal Life',
  description: "Pray The Ascension Novena - Day 9 focusing on Eternal Life. Join in praying the traditional novena to honor Jesus' Ascension into heaven.",
  keywords: [
    'the ascension novena day 9',
    'ascension novena day 9',
    'jesus ascension novena day 9',
    'ascension prayer day 9',
    'day 9 ascension novena',
    'eternal life prayer',
    'ascension novena eternal life',
    'jesus ascension novena eternal life'
  ],
  openGraph: {
    title: 'The Ascension Novena - Day 9: Eternal Life',
    description: 'Pray The Ascension Novena - Day 9 focusing on Eternal Life. Join in praying the traditional novena.',
    url: 'https://catholicbibleonline.com/novenas/ascension/day-9',
  },
  twitter: {
    title: 'The Ascension Novena - Day 9: Eternal Life',
    description: 'Pray The Ascension Novena - Day 9 focusing on Eternal Life. Join in praying the traditional novena.',
...
export default function AscensionNovenaDay9Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">
            The Ascension Novena – Day 9: Eternal Life
          </h1>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            On this final day of our novena, we focus on praying for the grace to come to the eternal gifts Jesus promised. We ask Him to guide our steps toward the life of glory He has prepared.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-lg p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              Eternal life is the ultimate gift that Jesus promises to those who love Him. Through His unceasing care, He guides us toward this glorious destiny and helps us grow in holiness.
            </p>
            <p className="mb-4">
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            May the Lord bless you abundantly through the intercession of Jesus, our ascended King. 
            May you always remember His example of faithfulness and His promise to prepare a place for you in heaven. 
            May your heart be lifted with Him in the glory of His Ascension.
          </p>
        </section>
        ...
        <section className="bg-blue-50 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center">
            You have completed The Ascension Novena! As you continue your spiritual journey, 
            may your heart be filled with heavenly glory, recognition of Jesus' kingship, eternal joy, 
            trust in His prepared place, divine friendship, mercy, strength over weakness, perseverance, 
            and eternal life. May Jesus, our ascended King, continue to watch over you and lead you to eternal glory.
          </p>
        </section>
        ...
        <div className="text-center">
          ...
          <ShareButton 
            title="The Ascension Novena - Day 9: Eternal Life" 
            url="/novenas/ascension/day-9"
            excerpt="Join me in praying The Ascension Novena - Day 9 focusing on Eternal Life." 
          />
        </div>
      ...
      <RelatedNovenas currentNovena="Ascension Novena" />
    </div>
  )
}
