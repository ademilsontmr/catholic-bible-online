      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-gray-50 border border-gray-200 rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4 mb-6">
            ...
            <CopyButton text={shareText} className="inline-flex items-center justify-center px-6 py-3 border border-blue-600 text-base font-medium rounded-md transition-colors duration-200 shadow-sm bg-white text-blue-600 hover:bg-blue-50">
              Copy verse
            </CopyButton>
          </div>
