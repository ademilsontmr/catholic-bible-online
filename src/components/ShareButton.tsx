...
export default function ShareButton({ title, url, excerpt }: ShareButtonProps) {
  ...
  // Não renderizar até que estejamos no lado do cliente
  if (!isClient) {
    return (
      <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 font-semibold rounded-lg">
  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-700 font-semibold rounded-lg transition-all duration-200 hover:shadow-md transform hover:scale-105"
          ...
          <div className="p-4">
            ...
            <div className="space-y-2 mb-4">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 text-left text-gray-700 hover:bg-blue-50 rounded-md transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 text-left text-gray-700 hover:bg-green-50 rounded-md transition-colors"
              >
