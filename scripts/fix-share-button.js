...
function fixShareButtonInFile(filePath) {
  try {
    ...
    // Padrão para encontrar ShareButton com text=
...
console.log('🔍 Procurando por arquivos com ShareButton antigo...');

const totalFixed = processDirectory(mainDir);
console.log(`\n🎉 Total de arquivos corrigidos: ${totalFixed}`);
console.log('✅ Todos os ShareButton foram atualizados para a nova API!'); 